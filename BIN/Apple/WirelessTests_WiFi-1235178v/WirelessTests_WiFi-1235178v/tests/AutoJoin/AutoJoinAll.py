...
Created by aomoto on 2013-06-07
...
from AutoJoinBase import AutoJoinBase

#----------------------------------------------------------------------
#
#----------------------------------------------------------------------

class AutoJoinAll(AutoJoinBase):
    """ Runs all AutoJoin configurations in Tests folder """
