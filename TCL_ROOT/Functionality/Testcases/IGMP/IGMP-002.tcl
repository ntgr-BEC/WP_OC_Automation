################################################################################
#
#  File Name    : IGMP-002.tcl
#
#  Description  : This testcase used to test processing leave message and
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-002.tcl" "******************** Starting Test case IGMP-002.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-002.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-002.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-002.tcl" "******************** Complete Test case IGMP-002.tcl ********************"
#*************************  End of Test case  **********************************