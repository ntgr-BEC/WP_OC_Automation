################################################################################
#
#  File Name    : IGMP-003.tcl
#
#  Description  : This testcase used to test IGMP snooping multicast MAC table
#                 aging and multicast traffic forwarding.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-003.tcl" "******************** Starting Test case IGMP-003.tcl ********************"
...
sleep 300; # Wait for max response + membership interval
set TxRx4 [UALReportPortRate $ntgrTG $ntgrPort4]
set TxRx5 [UALReportPortRate $ntgrTG $ntgrPort5]
set TxRx6 [UALReportPortRate $ntgrTG $ntgrPort6]
set rx5 [expr [lindex $TxRx5 1]/[lindex $TxRx4 0]]
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-003.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-003.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-003.tcl" "******************** Complete Test case IGMP-003.tcl ********************"
#*************************  End of Test case  **********************************