################################################################################
#
#  File Name    : IGMP-011.tcl
#
#  Description  : This testcase used to test adding/deleting a port
#                 as static multicast router port with multicast traffic flowing.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-011.tcl" "******************** Starting Test case IGMP-011.tcl ********************"
...
CALIgmpSnpMRouterDisable $ntgrDUT $ntgrMRouterPort $ntgrMRouterVlan
set TxRx4 [UALReportPortRate $ntgrTG $ntgrPort4]
set TxRx5 [UALReportPortRate $ntgrTG $ntgrPort5]
set TxRx6 [UALReportPortRate $ntgrTG $ntgrPort6]
set rx5 [expr [lindex $TxRx5 1]/[lindex $TxRx4 0]]
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-011.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-011.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-011.tcl" "******************** Complete Test case IGMP-011.tcl ********************"
#*************************  End of Test case  **********************************