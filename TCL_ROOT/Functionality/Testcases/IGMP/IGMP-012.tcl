################################################################################
#
#  File Name    : IGMP-012.tcl
#
#  Description  : This testcase used to test enable/disable multicast router
#                 in a VLAN with multicast traffic flowing.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-012.tcl" "******************** Starting Test case IGMP-012.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-012.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-012.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-012.tcl" "******************** Complete Test case IGMP-012.tcl ********************"
#*************************  End of Test case  **********************************