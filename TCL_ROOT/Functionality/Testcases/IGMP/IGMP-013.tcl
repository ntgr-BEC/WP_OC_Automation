################################################################################
#
#  File Name    : IGMP-013.tcl
#
#  Description  : This testcase used to verify whether multicast router detached
#                 when present time expired.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-013.tcl" "******************** Starting Test case IGMP-013.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-013.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-013.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-013.tcl" "******************** Complete Test case IGMP-013.tcl ********************"
#*************************  End of Test case  **********************************