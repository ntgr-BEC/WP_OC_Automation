...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-015.tcl" "******************** Starting Test case IGMP-015.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-015.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-015.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-015.tcl" "******************** Complete Test case IGMP-015.tcl ********************"
#*************************  End of Test case  **********************************