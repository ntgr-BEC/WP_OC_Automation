################################################################################
#
#  File Name    : IGMP-016.tcl
#
#  Description  : This testcase used to test shutdown/no shutdown the group
#                 ports with traffic flowing.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-016.tcl" "******************** Starting Test case IGMP-016.tcl ********************"
...
CALPortLinkDown $ntgrDUT $ntgrGroupPort
...
CALPortLinkUp $ntgrDUT $ntgrGroupPort
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-016.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-016.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-016.tcl" "******************** Complete Test case IGMP-016.tcl ********************"
#*************************  End of Test case  **********************************