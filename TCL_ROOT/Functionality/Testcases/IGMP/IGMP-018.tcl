################################################################################
#
#  File Name    : IGMP-018.tcl
#
#  Description  : This testcase used to test disconnect/reconnect the cable of
#                 the group ports with traffic flowing.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-018.tcl" "******************** Starting Test case IGMP-018.tcl ********************"
...
## Here we down the port of the Tester to simulate cable out
UALPortLinkDown $ntgrTG $ntgrPort6
...
set rx5 [expr [lindex $TxRx5 1]/[lindex $TxRx4 0]]
set rx6 [expr [lindex $TxRx6 1]/[lindex $TxRx4 0]]
if {$rx5>0.95 && $rx5<1.05} {
    set bRet [expr $bRet & 1]
} else {
    set bRet [expr $bRet & 0]
}

UALPortLinkUP $ntgrTG $ntgrPort6
sleep 5
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-018.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-018.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-018.tcl" "******************** Complete Test case IGMP-018.tcl ********************"
#*************************  End of Test case  **********************************