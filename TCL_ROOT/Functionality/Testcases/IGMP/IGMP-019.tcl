################################################################################
#
#  File Name    : IGMP-019.tcl
#
#  Description  : This testcase used to test enable/disable IGMP Snooping on
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-019.tcl" "******************** Starting Test case IGMP-019.tcl ********************"
...
CALIgmpSnpPortDisable $ntgrDUT $ntgrGroupPortEnable
...
CALIgmpSnpPortEnable $ntgrDUT $ntgrGroupPortEnable
sleep 5
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-019.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-019.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-019.tcl" "******************** Complete Test case IGMP-019.tcl ********************"
#*************************  End of Test case  **********************************