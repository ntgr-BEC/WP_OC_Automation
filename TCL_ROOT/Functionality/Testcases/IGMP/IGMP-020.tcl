################################################################################
#
#  File Name    : IGMP-020.tcl
#
#  Description  : This testcase used to test enable/disable IGMP Snooping
#                 globally with traffic flowing.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-020.tcl" "******************** Starting Test case IGMP-020.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-020.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-020.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-020.tcl" "******************** Complete Test case IGMP-020.tcl ********************"
#*************************  End of Test case  **********************************