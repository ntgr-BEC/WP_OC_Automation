################################################################################
#
#  File Name    : IGMP-022.tcl
#
#  Description  : This testcase used to test clearing all multicast entries
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-022.tcl" "******************** Starting Test case IGMP-022.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-022.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-022.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-022.tcl" "******************** Complete Test case IGMP-022.tcl ********************"
#*************************  End of Test case  **********************************