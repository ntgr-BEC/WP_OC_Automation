################################################################################
#
#  File Name    : IGMP-023.tcl
#
#  Description  : This testcase used to test repeatedly enable/disable IGMP
#                 snooping globally with multicast traffic traffic flowing.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-023.tcl" "******************** Starting Test case IGMP-023.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(IGMP-023.tcl) "OK"
} else {
    set NtgrTestResult(IGMP-023.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "IGMP-023.tcl" "******************** Complete Test case IGMP-023.tcl ********************"
#*************************  End of Test case  **********************************