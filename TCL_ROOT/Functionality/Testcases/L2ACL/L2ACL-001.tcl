...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-001.tcl" "******************** Starting Test case L2ACL-001.tcl ********************"
...
if { $txrx>0.2 && $txrx<0.3} {
    set NtgrTestResult(L2ACL-001.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-001.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-001.tcl" "******************** Complete Test case L2ACL-001.tcl ********************"
#*************************  End of Test case  **********************************