...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-003.tcl" "******************** Starting Test case L2ACL-003.tcl ********************"
...
if { $txrx>0.9 && $txrx<1.1} {
    set NtgrTestResult(L2ACL-003.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-003.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-003.tcl" "******************** Complete Test case L2ACL-003.tcl ********************"
#*************************  End of Test case  **********************************