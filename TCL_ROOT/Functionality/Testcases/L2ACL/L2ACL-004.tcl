...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-004.tcl" "******************** Starting Test case L2ACL-004.tcl ********************"
...
if { $txrx<0.05} {
    set NtgrTestResult(L2ACL-004.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-004.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-004.tcl" "******************** Complete Test case L2ACL-004.tcl ********************"
#*************************  End of Test case  **********************************