################################################################################
#
#  File Name    : L2ACL-007.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule permit any destination MAC address traffic.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-007.tcl" "******************** Starting Test case L2ACL-007.tcl ********************"
...
if { $txrx>0.9 && $txrx<1.1} {
    set NtgrTestResult(L2ACL-007.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-007.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-007.tcl" "******************** Complete Test case L2ACL-007.tcl ********************"
#*************************  End of Test case  **********************************