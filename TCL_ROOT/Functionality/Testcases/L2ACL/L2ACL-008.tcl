################################################################################
#
#  File Name    : L2ACL-008.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule deny any destination MAC address traffic.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-008.tcl" "******************** Starting Test case L2ACL-008.tcl ********************"
...
if { $txrx<0.05 } {
    set NtgrTestResult(L2ACL-008.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-008.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-008.tcl" "******************** Complete Test case L2ACL-008.tcl ********************"
#*************************  End of Test case  **********************************