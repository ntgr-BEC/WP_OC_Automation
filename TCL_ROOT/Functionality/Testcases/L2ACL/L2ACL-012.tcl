...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-012.tcl" "******************** Starting Test case L2ACL-012.tcl ********************"
...
if { $txrx>0.7 && $txrx<0.8} {
    set NtgrTestResult(L2ACL-012.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-012.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-012.tcl" "******************** Complete Test case L2ACL-012.tcl ********************"
#*************************  End of Test case  **********************************