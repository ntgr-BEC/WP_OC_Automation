################################################################################
#
#  File Name    : L2ACL-013.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule to permit traffic with specified source MAC and VLAN.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-013.tcl" "******************** Starting Test case L2ACL-013.tcl ********************"
...
if { $txrx>0.2 && $txrx<0.3} {
    set NtgrTestResult(L2ACL-013.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-013.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-013.tcl" "******************** Complete Test case L2ACL-013.tcl ********************"
#*************************  End of Test case  **********************************