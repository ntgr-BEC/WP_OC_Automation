################################################################################
#
#  File Name    : L2ACL-017.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule to permit specified source/destination MAC address
#                 and VLAN ID.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-017.tcl" "******************** Starting Test case L2ACL-017.tcl ********************"
...
if { $txrx>0.2 && $txrx<0.3} {
    set NtgrTestResult(L2ACL-017.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-017.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-017.tcl" "******************** Complete Test case L2ACL-017.tcl ********************"
#*************************  End of Test case  **********************************