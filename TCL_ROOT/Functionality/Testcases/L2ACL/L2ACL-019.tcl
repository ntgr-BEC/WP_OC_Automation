################################################################################
#
#  File Name    : L2ACL-019.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule to permit traffic with specified ethernet type.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-019.tcl" "******************** Starting Test case L2ACL-019.tcl ********************"
...
if { $txrx>0.2 && $txrx<0.3} {
    set NtgrTestResult(L2ACL-019.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-019.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-019.tcl" "******************** Complete Test case L2ACL-019.tcl ********************"
#*************************  End of Test case  **********************************