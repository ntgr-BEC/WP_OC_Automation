################################################################################
#
#  File Name    : L2ACL-022.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule to deny traffic with specified ethernet type in a VLAN.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-022.tcl" "******************** Starting Test case L2ACL-022.tcl ********************"
...
if { $txrx>0.7 && $txrx<0.8} {
    set NtgrTestResult(L2ACL-022.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-022.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-022.tcl" "******************** Complete Test case L2ACL-022.tcl ********************"
#*************************  End of Test case  **********************************