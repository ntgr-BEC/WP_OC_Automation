...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-025.tcl" "******************** Starting Test case L2ACL-025.tcl ********************"
...
if { $txrx>0.2 && $txrx<0.3} {
    set NtgrTestResult(L2ACL-025.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-025.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-025.tcl" "******************** Complete Test case L2ACL-025.tcl ********************"
#*************************  End of Test case  **********************************