...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-028.tcl" "******************** Starting Test case L2ACL-028.tcl ********************"
...
if { $txrx>0.7 && $txrx<0.8} {
    set NtgrTestResult(L2ACL-028.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-028.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-028.tcl" "******************** Complete Test case L2ACL-028.tcl ********************"
#*************************  End of Test case  **********************************