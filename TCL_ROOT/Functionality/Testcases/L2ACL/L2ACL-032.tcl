...
#                 and source/destination MAC address.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-032.tcl" "******************** Starting Test case L2ACL-032.tcl ********************"
...
if { $txrx>0.7 && $txrx<0.8} {
    set NtgrTestResult(L2ACL-032.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-032.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-032.tcl" "******************** Complete Test case L2ACL-032.tcl ********************"
#*************************  End of Test case  **********************************