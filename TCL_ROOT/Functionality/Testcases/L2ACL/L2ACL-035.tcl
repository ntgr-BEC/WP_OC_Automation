################################################################################
#
#  File Name    : L2ACL-035.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule to permit traffic with specified Cos value and ethernet type.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-035.tcl" "******************** Starting Test case L2ACL-035.tcl ********************"
...
if { $txrx>0.2 && $txrx<0.3} {
    set NtgrTestResult(L2ACL-035.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-035.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-035.tcl" "******************** Complete Test case L2ACL-035.tcl ********************"
#*************************  End of Test case  **********************************