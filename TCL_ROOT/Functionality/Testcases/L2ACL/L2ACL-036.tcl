################################################################################
#
#  File Name    : L2ACL-036.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule to deny traffic with specified Cos value and ethernet type.
#
#  Revision     :
#        Date        Programmer        Description
#        2006/12/21  Scott             Newly created    
#
################################################################################

#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-036.tcl" "******************** Starting Test case L2ACL-036.tcl ********************"
...
if { $txrx>0.7 && $txrx<0.8} {
    set NtgrTestResult(L2ACL-036.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-036.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-036.tcl" "******************** Complete Test case L2ACL-036.tcl ********************"
#*************************  End of Test case  **********************************