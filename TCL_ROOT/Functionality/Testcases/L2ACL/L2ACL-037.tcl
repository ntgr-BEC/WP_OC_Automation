...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-037.tcl" "******************** Starting Test case L2ACL-037.tcl ********************"
...
if { $txrx>0.2 && $txrx<0.3} {
    set NtgrTestResult(L2ACL-037.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-037.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-037.tcl" "******************** Complete Test case L2ACL-037.tcl ********************"
#*************************  End of Test case  **********************************