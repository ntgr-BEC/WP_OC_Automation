################################################################################
#
#  File Name    : L2ACL-041.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With rule to redirect the matched traffic to another port.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-041.tcl" "******************** Starting Test case L2ACL-041.tcl ********************"
...
if { $txrx>0.2 && $txrx<0.3} {
    set NtgrTestResult(L2ACL-041.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-041.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-041.tcl" "******************** Complete Test case L2ACL-041.tcl ********************"
#*************************  End of Test case  **********************************