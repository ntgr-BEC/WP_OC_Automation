################################################################################
#
#  File Name    : L2ACL-043.tcl
#
#  Description  : This testcase used to test filtering function of layer2 ACL.
#                 With max number of rules and test each work correctly.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-043.tcl" "******************** Starting Test case L2ACL-043.tcl ********************"
...
if { $txrx>0.3 && $txrx<0.35} {
    set NtgrTestResult(L2ACL-043.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-043.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-043.tcl" "******************** Complete Test case L2ACL-043.tcl ********************"
#*************************  End of Test case  **********************************