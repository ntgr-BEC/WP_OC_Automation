...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-045.tcl" "******************** Starting Test case L2ACL-045.tcl ********************"
...
if { $txrx>0.35 && $txrx<0.4} {
    set NtgrTestResult(L2ACL-045.tcl) "OK"
} else {
    set NtgrTestResult(L2ACL-045.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2ACL-045.tcl" "******************** Complete Test case L2ACL-045.tcl ********************"
#*************************  End of Test case  **********************************