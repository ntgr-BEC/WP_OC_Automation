...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-002.tcl" "******************** Starting Test case L2L3ACL-002.tcl ********************"
...
if { $txrx>0.7 && $txrx<0.8} {
    set NtgrTestResult(L2L3ACL-002.tcl) "OK"
} else {
    set NtgrTestResult(L2L3ACL-002.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-002.tcl" "------------------- Complete Test case L2L3ACL-002.tcl, Testing result: $NtgrTestResult(L2L3ACL-002.tcl) ---------------------"
#*************************  End of Test case  **********************************