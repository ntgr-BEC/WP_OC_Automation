...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-003.tcl" "******************** Starting Test case L2L3ACL-003.tcl ********************"
...
## The expected $txrx is 2/3
if { $txrx>0.6 && $txrx<0.7} {
    set NtgrTestResult(L2L3ACL-003.tcl) "OK"
} else {
    set NtgrTestResult(L2L3ACL-003.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-003.tcl" "------------------- Complete Test case L2L3ACL-003.tcl, Testing result: $NtgrTestResult(L2L3ACL-003.tcl) ---------------------"
#*************************  End of Test case  **********************************