...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-005.tcl" "******************** Starting Test case L2L3ACL-005.tcl ********************"
...
if { $txrx>0.9 && $txrx<1.1} {
    set NtgrTestResult(L2L3ACL-005.tcl) "OK"
} else {
    set NtgrTestResult(L2L3ACL-005.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-005.tcl" "------------------- Complete Test case L2L3ACL-005.tcl, Testing result: $NtgrTestResult(L2L3ACL-005.tcl) ---------------------"
#*************************  End of Test case  **********************************