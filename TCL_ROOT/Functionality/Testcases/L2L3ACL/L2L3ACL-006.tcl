################################################################################
#
#  File Name    : L2L3ACL-006.tcl
#
#  Description  : This testcase used to test combined layer2/3 ACLs.
#                 With match conditions: Permit specified dst MAC, VLAN,
#                 dst IP, TCP dst Port, Precedence.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-006.tcl" "******************** Starting Test case L2L3ACL-006.tcl ********************"
...
if { $txrx>0.9 && $txrx<1.1} {
    set NtgrTestResult(L2L3ACL-006.tcl) "OK"
} else {
    set NtgrTestResult(L2L3ACL-006.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-006.tcl" "------------------- Complete Test case L2L3ACL-006.tcl, Testing result: $NtgrTestResult(L2L3ACL-006.tcl) ---------------------"
#*************************  End of Test case  **********************************