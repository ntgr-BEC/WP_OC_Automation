################################################################################
#
#  File Name    : L2L3ACL-007.tcl
#
#  Description  : This testcase used to test combined layer2/3 ACLs.
#                 With match conditions: Permit specified COS, VLAN, 2nd COS,
#                 2nd VLAN, src/dst IP, TOS.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-007.tcl" "******************** Starting Test case L2L3ACL-007.tcl ********************"
...
if { $txrx>0.9 && $txrx<1.1} {
    set NtgrTestResult(L2L3ACL-007.tcl) "OK"
} else {
    set NtgrTestResult(L2L3ACL-007.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-007.tcl" "------------------- Complete Test case L2L3ACL-007.tcl, Testing result: $NtgrTestResult(L2L3ACL-007.tcl) ---------------------"
#*************************  End of Test case  **********************************