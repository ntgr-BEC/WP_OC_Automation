################################################################################
#
#  File Name    : L2L3ACL-008.tcl
#
#  Description  : This testcase used to test combined layer2/3 ACLs.
#                 With match conditions: Permit specified src/dst MAC, 2nd COS
#                 2nd VLAN, UDP src/dst Port, DSCP.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-008.tcl" "******************** Starting Test case L2L3ACL-008.tcl ********************"
...
if { $txrx>0.10 && $txrx<0.14 } {
    set NtgrTestResult(L2L3ACL-008.tcl) "OK"
} else {
    set NtgrTestResult(L2L3ACL-008.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-008.tcl" "------------------- Complete Test case L2L3ACL-008.tcl, Testing result: $NtgrTestResult(L2L3ACL-008.tcl) ---------------------"
#*************************  End of Test case  **********************************