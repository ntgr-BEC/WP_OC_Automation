################################################################################
#
#  File Name    : L2L3ACL-014.tcl
#
#  Description  : This testcase used to test combined layer2/3 ACLs.
#                 Generate combined ACL relative configuration script and apply again.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-014.tcl" "******************** Starting Test case L2L3ACL-014.tcl ********************"
...
## Generate script file and apply again
...
## The expected $txrx is 2/14
if { $bRet == 1 } {
    set NtgrTestResult(L2L3ACL-014.tcl) "OK"
} else {
    set NtgrTestResult(L2L3ACL-014.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-014.tcl" "------------------- Complete Test case L2L3ACL-014.tcl, Testing result: $NtgrTestResult(L2L3ACL-014.tcl) ---------------------"
#*************************  End of Test case  **********************************