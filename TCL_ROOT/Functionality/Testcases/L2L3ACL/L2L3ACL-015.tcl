################################################################################
#
#  File Name    : L2L3ACL-015.tcl
#
#  Description  : This testcase used to test combined layer2/3 ACLs.
#                 Reloading switch with combined ACL configuration.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-015.tcl" "******************** Starting Test case L2L3ACL-015.tcl ********************"
...
## The expected $txrx is 2/14
if { $bRet == 1 } {
    set NtgrTestResult(L2L3ACL-015.tcl) "OK"
} else {
    set NtgrTestResult(L2L3ACL-015.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "L2L3ACL-015.tcl" "------------------- Complete Test case L2L3ACL-015.tcl, Testing result: $NtgrTestResult(L2L3ACL-015.tcl) ---------------------"
#*************************  End of Test case  **********************************