...
Netgear_log_file "TC-L3ACL-024.tcl" "******** Starting Test case TC-L3ACL-024.tcl **********"

foreach switch_name $MTSW_L3ACL_024 {
    Netgear_log_file "TC-L3ACL-024.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-L3ACL-024.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-L3ACL-024.tcl" "Started configuration of ACL on the Switches"

foreach switch_name $ntgr_L3ACL_List_024 {
...
Netgear_log_file "TC-L3ACL-024.tcl" "Started deleting ACL on the Switches"
...
if {$result1 == 1 && $result2 == 1} {
	Netgear_log_file "TC-L3ACL-024.tcl" "***** TC-L3ACL-024.tcl passed *****"
} else {
	Netgear_log_file "TC-L3ACL-024.tcl" "***** TC-L3ACL-024.tcl failed *****"
}

Netgear_log_file "TC-L3ACL-024.tcl" "***** Completed Test case TC-L3ACL-024.tcl *****"
