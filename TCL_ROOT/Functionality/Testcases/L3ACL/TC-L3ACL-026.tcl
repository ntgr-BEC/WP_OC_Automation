#################################################################################
#
#  File Name	    	: TC-L3ACL-026.tcl
#
#  Description     	: Match the keyword --- echo
#
#  Config file          : TC-L3ACL-026.cfg
#				  
#  Revision History 	:
...
Netgear_log_file "TC-L3ACL-026.tcl" "******** Starting Test case TC-L3ACL-026.tcl **********"

foreach switch_name $MTSW_L3ACL_026 {
    Netgear_log_file "TC-L3ACL-026.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-L3ACL-026.tcl" "Started routing on the Switches"
...
foreach switch_name $ntgr_L3ACL_List_026 {
...
Netgear_log_file "TC-L3ACL-026.tcl" "Started Configuration of RIP on IXIA"
...
if {$dif >= 0.45 && $dif <= 0.55} {
	Netgear_log_file "TC-L3ACL-026.tcl" "***** TC-L3ACL-026.tcl passed *****"
} else {
	Netgear_log_file "TC-L3ACL-026.tcl" "***** TC-L3ACL-026.tcl failed *****"
}

Netgear_log_file "TC-L3ACL-026.tcl" "***** Completed Test case TC-L3ACL-026.tcl *****"
