...
foreach switch_name $ntgr_L3ACL_List_033 {
...
Netgear_log_file "TC-L3ACL-033.tcl" "Started deleting ACL on the Switches"
...
if {$result1 == 1 && $result2 == 1 && $result3 == 1 && $result4 == 1} {
	Netgear_log_file "TC-L3ACL-033.tcl" "***** TC-L3ACL-033.tcl passed *****"
} else {
	Netgear_log_file "TC-L3ACL-033.tcl" "***** TC-L3ACL-033.tcl failed *****"
}
...
Netgear_log_file "TC-L3ACL-033.tcl" "***** Completed Test case TC-L3ACL-033.tcl *****"
