################################################################################
#
#  File Name    : TC-L3ACL-034.tcl
#
#  Description  : ACL service on IGMP packet --- match source, action is deny
#
#  Revision     :
...
foreach switch_name $ntgr_L3ACL_List_034 {
...
Netgear_log_file "TC-L3ACL-034.tcl" "Started deleting ACL on the Switches"
...
if {$result1 == 1 && $result2 == 1 && $result3 == 1 && $result4 == 1} {
	Netgear_log_file "TC-L3ACL-034.tcl" "***** TC-L3ACL-034.tcl passed *****"
} else {
	Netgear_log_file "TC-L3ACL-034.tcl" "***** TC-L3ACL-034.tcl failed *****"
}
...
Netgear_log_file "TC-L3ACL-034.tcl" "***** Completed Test case TC-L3ACL-034.tcl *****"
