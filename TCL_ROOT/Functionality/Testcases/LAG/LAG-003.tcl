...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "LAG-003.tcl" "******************** Starting Test case LAG-003.tcl ********************"
...
# Create LAG
foreach lag_index $ntgrLAGIndexList003  {
	CALCreatePortChannel $lag_index
}

# Create VLANs
foreach vlan_index $ntgrVlanIndexList003  {
	CALCreateVlan $vlan_index
}

# Loading traffic
foreach {chassis_id portlist} [array get ntgrTGPortList003] {
...
if {$bRet == 1} {
    set NtgrTestResult(LAG-003.tcl) "OK"
} else {
    set NtgrTestResult(LAG-003.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "LAG-003.tcl" "******************** Complete Test case LAG-003.tcl ********************"
#*************************  End of Test case  **********************************