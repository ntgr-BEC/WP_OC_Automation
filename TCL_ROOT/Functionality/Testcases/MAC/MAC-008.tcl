...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-008.tcl" "******************** Starting Test case MAC-008.tcl ********************"
...
CALPortLinkDown $ntgrDUT $ntgrDUTPort
...
CALPortLinkUp $ntgrDUT $ntgrDUTPort
Netgear_disconnect_switch $ntgrDUT
sleep 10
__GetTxRxResult

if {$bRet == 1} {
    set NtgrTestResult(MAC-008.tcl) "OK"
} else {
    set NtgrTestResult(MAC-008.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-008.tcl" "******************** Complete Test case MAC-008.tcl ********************"
#*************************  End of Test case  **********************************