################################################################################
#
#  File Name    : MAC-012.tcl
#
#  Description  : This testcase used to test repeatedly clear MAC address in a VLAN
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-012.tcl" "******************** Starting Test case MAC-012.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(MAC-012.tcl) "OK"
} else {
    set NtgrTestResult(MAC-012.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-012.tcl" "******************** Complete Test case MAC-012.tcl ********************"
#*************************  End of Test case  **********************************