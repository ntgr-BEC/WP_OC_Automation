...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-015.tcl" "******************** Starting Test case MAC-015.tcl ********************"
...
while {$ntgrRebootTimes !=0} {
    ...
    incr ntgrRebootTimes -1
}

if { $bRet == 1 } {
    set NtgrTestResult(MAC-015.tcl) "OK"
} else {
    set NtgrTestResult(MAC-015.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-015.tcl" "******************** Complete Test case MAC-015.tcl ********************"
#*************************  End of Test case  **********************************