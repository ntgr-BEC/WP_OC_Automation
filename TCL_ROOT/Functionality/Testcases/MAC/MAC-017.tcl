...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-017.tcl" "******************** Starting Test case MAC-017.tcl ********************"
...
foreach dut $ntgrDUTList {
    CALClearMacSwitch $dut
}

# Flowing traffic on port22 and port28
...
if {$bRet == 1} {
    set NtgrTestResult(MAC-017.tcl) "OK"
} else {
    set NtgrTestResult(MAC-017.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-017.tcl" "******************** Complete Test case MAC-017.tcl ********************"
#*************************  End of Test case  **********************************