################################################################################
#
#  File Name    : MAC-019.tcl
#
#  Description  : This testcase used to test forwarding layer2 traffic while reload
#                 an unused unit of the switch.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-019.tcl" "******************** Starting Test case MAC-019.tcl ********************"
...
for {set tm 0} {$tm<$ntgrRepeatTimes} {incr tm} {
    CALRebootSwitch $ntgrDUT2 $ntgrReloadUnitID
...
if {$bRet == 1} {
    set NtgrTestResult(MAC-019.tcl) "OK"
} else {
    set NtgrTestResult(MAC-019.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-019.tcl" "******************** Complete Test case MAC-019.tcl ********************"
#*************************  End of Test case  **********************************