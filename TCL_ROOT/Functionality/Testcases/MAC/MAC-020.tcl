################################################################################
#
#  File Name    : MAC-020.tcl
#
#  Description  : This testcase used to test forwarding layer2 traffic while
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-020.tcl" "******************** Starting Test case MAC-020.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(MAC-020.tcl) "OK"
} else {
    set NtgrTestResult(MAC-020.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "MAC-020.tcl" "******************** Complete Test case MAC-020.tcl ********************"
#*************************  End of Test case  **********************************