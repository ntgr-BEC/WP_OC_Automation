#################################################################################
#
#  File Name	    	: TC-OSPF-007.tcl
#
#  Description     	: Default route for stub area
#
#  Config file       	: TC-OSPF-007.cfg
#				  
#  Revision History 	:
...
Netgear_log_file "TC-OSPF-007.tcl" "******** Starting Test case TC-OSPF-007.tcl **********"

foreach switch_name $ntgr_OSPF_List_007 {
    Netgear_log_file "TC-OSPF-007.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-OSPF-007.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-OSPF-007.tcl" "Started Configuration of OSPF"
...
if { $result == 1} {
Netgear_log_file "TC-OSPF-007.tcl" "***** TC-OSPF-007.tcl passed *****"} else {
Netgear_log_file "TC-OSPF-007.tcl" "***** TC-OSPF-007.tcl failed *****"
}	 
Netgear_log_file "TC-OSPF-007.tcl" "***** Completed Test case TC-OSPF-007.tcl *****"
