#################################################################################
#
#  File Name	    	: TC-OSPF-011.tcl
#
#  Description     	: NSSA-lsa summary test
#
#  Config file       	: TC-OSPF-011.cfg
#				  
#  Revision History 	:
...
Netgear_log_file "TC-OSPF-011.tcl" "******** Starting Test case TC-OSPF-011.tcl **********"

foreach switch_name $ntgr_OSPF_List_011 {
    Netgear_log_file "TC-OSPF-011.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-OSPF-011.tcl" "Started to Modify TOPO"
Netgear_connect_switch $TOPO_SW
CALPortLinkDown $TOPO_SW $port_down
Netgear_disconnect_switch $TOPO_SW

Netgear_log_file "TC-OSPF-011.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-OSPF-011.tcl" "Started Configuration of OSPF"
...
Netgear_log_file "TC-OSPF-011.tcl" "Started Configuration of RIP on DUT"
foreach switch_name $switch_RIP_list_011 {
...
Netgear_log_file "TC-OSPF-011.tcl" "Started Configuration of RIP on IXIA"

foreach {chassis_id portlist} [array get ntgr_RipPortList_011] {
...
if { $result == 1} {
	Netgear_log_file "TC-OSPF-011.tcl" "***** TC-OSPF-011.tcl passed *****"
} else {
	Netgear_log_file "TC-OSPF-011.tcl" "***** TC-OSPF-011.tcl failed *****"
	}
		 
Netgear_log_file "TC-OSPF-011.tcl" "***** Completed Test case TC-OSPF-011.tcl *****"

#Netgear_log_file "TC-OSPF-011.tcl" "clear owner ship of RIP on IXIA"
#
#foreach {chassis_id port} [array get ntgr_RipPortList_011] {
#
