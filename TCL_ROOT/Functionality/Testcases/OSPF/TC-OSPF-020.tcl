#################################################################################
#
#  File Name	    	: TC-OSPF-020.tcl
#
#  Description     	: Totally stub area test
#
#  Config file       	: TC-OSPF-020.cfg
#				  
#  Revision History 	:
...
Netgear_log_file "TC-OSPF-020.tcl" "******** Starting Test case TC-OSPF-020.tcl **********"

foreach switch_name $ntgr_OSPF_List_020 {
    Netgear_log_file "TC-OSPF-020.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-OSPF-020.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-OSPF-020.tcl" "Started Configuration of OSPF"
...
Netgear_log_file "TC-OSPF-020.tcl" "Started Configuration of RIP on DUT"
foreach switch_name $switch_RIP_list_020 {
...
Netgear_log_file "TC-OSPF-020.tcl" "Started Configuration of RIP on IXIA"

foreach {chassis_id port} [array get ntgr_RipPortList_020] {
...
set result2 [CALCheckExpect $SW_checked $cmds $expect_string_list2 0] 
if { $result1 == 1 && $result2 == 1} {
Netgear_log_file "TC-OSPF-020.tcl" "***** TC-OSPF-020.tcl passed *****"} else {
Netgear_log_file "TC-OSPF-020.tcl" "***** TC-OSPF-020.tcl failed *****"
}	 
Netgear_log_file "TC-OSPF-020.tcl" "***** Completed Test case TC-OSPF-020.tcl *****"

#Netgear_log_file "TC-OSPF-020.tcl" "clear owner ship of RIP on IXIA"
#
#foreach {chassis_id port} [array get ntgr_RipPortList_020] {
#
