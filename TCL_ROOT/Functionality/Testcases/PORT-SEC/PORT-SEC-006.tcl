################################################################################
#
#  File Name    : PORT-SEC-006.tcl
#
#  Description  : This testcase used to test static port security and it should
#                 discard non-configured addresses' traffic.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-006.tcl" "******************** Starting Test case PORT-SEC-006.tcl ********************"
## Initialize the DUTs
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-SEC-006.tcl) "OK"
} else {
    set NtgrTestResult(PORT-SEC-006.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-006.tcl" "******************** Complete Test case PORT-SEC-006.tcl ********************"
#*************************  End of Test case  **********************************