################################################################################
#
#  File Name    : PORT-SEC-007.tcl
#
#  Description  : This testcase used to test configure static port security to max limit
#                 and whether corresponding traffic could go thru the security port.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-007.tcl" "******************** Starting Test case PORT-SEC-007.tcl ********************"
## Initialize the DUTs
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-SEC-007.tcl) "OK"
} else {
    set NtgrTestResult(PORT-SEC-007.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-007.tcl" "******************** Complete Test case PORT-SEC-007.tcl ********************"
#*************************  End of Test case  **********************************