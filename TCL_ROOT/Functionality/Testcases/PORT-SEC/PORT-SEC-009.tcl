################################################################################
#
#  File Name    : PORT-SEC-009.tcl
#
#  Description  : This testcase used to test deleting static port security by
#                 setting max limit smaller and corresponding traffic will be
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-009.tcl" "******************** Starting Test case PORT-SEC-009.tcl ********************"
## Initialize the DUTs
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-SEC-009.tcl) "OK"
} else {
    set NtgrTestResult(PORT-SEC-009.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-009.tcl" "******************** Complete Test case PORT-SEC-009.tcl ********************"
#*************************  End of Test case  **********************************