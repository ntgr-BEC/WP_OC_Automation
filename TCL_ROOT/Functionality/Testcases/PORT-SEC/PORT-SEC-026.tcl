################################################################################
#
#  File Name    : PORT-SEC-026.tcl
#
#  Description  : This testcase used to test traffic could come in only the allowed
#                 port, from other chipset's/unit's ports should be discarded.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-026.tcl" "******************** Starting Test case PORT-SEC-026.tcl ********************"
## Initialize the DUTs
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-SEC-026.tcl) "OK"
} else {
    set NtgrTestResult(PORT-SEC-026.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-026.tcl" "******************** Complete Test case PORT-SEC-026.tcl ********************"
#*************************  End of Test case  **********************************