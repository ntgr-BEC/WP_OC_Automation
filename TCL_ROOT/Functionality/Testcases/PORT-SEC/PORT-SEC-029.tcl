################################################################################
#
#  File Name    : PORT-SEC-029.tcl
#
#  Description  : This testcase used to test the corporation between MAC ACL
#                 and MAC security.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-029.tcl" "******************** Starting Test case PORT-SEC-029.tcl ********************"
## Initialize the DUTs
...
## Create MAC ACL
CALCheckExpect $ntgrDUT1 $ntgrMacACL1 ""

set TxRx4 [UALReportPortRate $ntgrTG $ntgrPort4]
set TxRx6 [UALReportPortRate $ntgrTG $ntgrPort6]
set rx4 [expr [lindex $TxRx4 1]/[lindex $TxRx6 0]]
if {$rx4>0.49 && $rx4<0.51} {
    set bRet [expr $bRet & 1]
} else {
    set bRet [expr $bRet & 0]
}
...
CALDeleteMacACL $ntgrDUT1 $ntgrACLName
set TxRx4 [UALReportPortRate $ntgrTG $ntgrPort4]
set TxRx6 [UALReportPortRate $ntgrTG $ntgrPort6]
set rx4 [expr [lindex $TxRx4 1]/[lindex $TxRx6 0]]
if {$rx4>0.49 && $rx4<0.51} {
...
## Create MAC acl
CALCheckExpect $ntgrDUT1 $ntgrMacACL2 ""
set TxRx4 [UALReportPortRate $ntgrTG $ntgrPort4]
set TxRx6 [UALReportPortRate $ntgrTG $ntgrPort6]
set rx4 [expr [lindex $TxRx4 1]/[lindex $TxRx6 0]]
if {$rx4<0.01} {
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-SEC-029.tcl) "OK"
} else {
    set NtgrTestResult(PORT-SEC-029.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-SEC-029.tcl" "******************** Complete Test case PORT-SEC-029.tcl ********************"
#*************************  End of Test case  **********************************