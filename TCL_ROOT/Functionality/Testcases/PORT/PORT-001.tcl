...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-001.tcl" "******************** Starting Test case PORT-001.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-001.tcl) "OK"
} else {
    set NtgrTestResult(PORT-001.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-001.tcl" "******************** Complete Test case PORT-001.tcl ********************"
#*************************  End of Test case  **********************************