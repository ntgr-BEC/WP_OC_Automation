...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-002.tcl" "******************** Starting Test case PORT-002.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-002.tcl) "OK"
} else {
    set NtgrTestResult(PORT-002.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-002.tcl" "******************** Complete Test case PORT-002.tcl ********************"
#*************************  End of Test case  **********************************