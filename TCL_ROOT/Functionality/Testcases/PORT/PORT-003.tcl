...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-003.tcl" "******************** Starting Test case PORT-003.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-003.tcl) "OK"
} else {
    set NtgrTestResult(PORT-003.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-003.tcl" "******************** Complete Test case PORT-003.tcl ********************"
#*************************  End of Test case  **********************************