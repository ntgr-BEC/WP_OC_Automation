...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-005.tcl" "******************** Starting Test case PORT-005.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-005.tcl) "OK"
} else {
    set NtgrTestResult(PORT-005.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-005.tcl" "******************** Complete Test case PORT-005.tcl ********************"
#*************************  End of Test case  **********************************