################################################################################
#
#  File Name    : PORT-006.tcl
#
#  Description  : This testcase used to test one side's port working at 10M
#                 half-duplex mode arbitrarily, another at auto-negotiate mode.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-006.tcl" "******************** Starting Test case PORT-006.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-006.tcl) "OK"
} else {
    set NtgrTestResult(PORT-006.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-006.tcl" "******************** Complete Test case PORT-006.tcl ********************"
#*************************  End of Test case  **********************************