...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-008.tcl" "******************** Starting Test case PORT-008.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-008.tcl) "OK"
} else {
    set NtgrTestResult(PORT-008.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-008.tcl" "******************** Complete Test case PORT-008.tcl ********************"
#*************************  End of Test case  **********************************