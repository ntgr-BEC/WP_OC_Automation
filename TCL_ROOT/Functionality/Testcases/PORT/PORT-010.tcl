################################################################################
#
#  File Name    : PORT-010.tcl
#
#  Description  : This testcase used to test one side's port working at 1000M
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-010.tcl" "******************** Starting Test case PORT-010.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-010.tcl) "OK"
} else {
    set NtgrTestResult(PORT-010.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-010.tcl" "******************** Complete Test case PORT-010.tcl ********************"
#*************************  End of Test case  **********************************