################################################################################
#
#  File Name    : PORT-011.tcl
#
#  Description  : This testcase used to test ports' status while setting all
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-011.tcl" "******************** Starting Test case PORT-011.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-011.tcl) "OK"
} else {
    set NtgrTestResult(PORT-011.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-011.tcl" "******************** Complete Test case PORT-011.tcl ********************"
#*************************  End of Test case  **********************************