################################################################################
#
#  File Name    : PORT-012.tcl
#
#  Description  : This testcase used to test SFP module's status while setting
#                 its mode to at 1000M full-duplex arbitrarily.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-012.tcl" "******************** Starting Test case PORT-012.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-012.tcl) "OK"
} else {
    set NtgrTestResult(PORT-012.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-012.tcl" "******************** Complete Test case PORT-012.tcl ********************"
#*************************  End of Test case  **********************************