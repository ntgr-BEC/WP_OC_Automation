################################################################################
#
#  File Name    : PORT-015.tcl
#
#  Description  : This testcase used to test plugging/unplugging the SFP modules.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-015.tcl" "******************** Starting Test case PORT-015.tcl ********************"
...
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-015.tcl" "Please unplug the SFP modules and plug them again, press any key when you done."
gets stdin
set bRet [expr $bRet & [CALCheckExpect $ntgrDUT1 $ntgrCmd1 $ntgrExpect1]]
set bRet [expr $bRet & [CALCheckExpect $ntgrDUT2 $ntgrCmd2 $ntgrExpect2]]
set bRet [expr $bRet & [CALCheckExpect $ntgrDUT1 $ntgrCmd3 $ntgrExpect3]]
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-015.tcl) "OK"
} else {
    set NtgrTestResult(PORT-015.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-015.tcl" "******************** Complete Test case PORT-015.tcl ********************"
#*************************  End of Test case  **********************************