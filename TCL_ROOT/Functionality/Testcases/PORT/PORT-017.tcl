...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-017.tcl" "******************** Starting Test case PORT-017.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(PORT-017.tcl) "OK"
} else {
    set NtgrTestResult(PORT-017.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "PORT-017.tcl" "******************** Complete Test case PORT-017.tcl ********************"
#*************************  End of Test case  **********************************