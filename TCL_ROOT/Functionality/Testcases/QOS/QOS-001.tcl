################################################################################
#
#  File Name    : QOS-001.tcl
#
#  Description  : This testcase used to test modifying dot1P mapping and
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-001.tcl" "******************** Starting Test case QOS-001.tcl ********************"
...
CALQosSetDot1PMap $ntgrDUT1 "3" "3"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-001.tcl) "OK"
} else {
    set NtgrTestResult(QOS-001.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-001.tcl" "******************** Complete Test case QOS-001.tcl ********************"
#*************************  End of Test case  **********************************