################################################################################
#
#  File Name    : QOS-003.tcl
#
#  Description  : This testcase used to test modifying IP Precedence mapping and
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-003.tcl" "******************** Starting Test case QOS-003.tcl ********************"
...
CALQosSetPrecedenceMap $ntgrDUT1 "3" "3"
sleep 2
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-003.tcl) "OK"
} else {
    set NtgrTestResult(QOS-003.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-003.tcl" "******************** Complete Test case QOS-003.tcl ********************"
#*************************  End of Test case  **********************************