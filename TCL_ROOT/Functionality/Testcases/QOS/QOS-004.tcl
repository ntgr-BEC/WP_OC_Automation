################################################################################
#
#  File Name    : QOS-004.tcl
#
#  Description  : This testcase used to test the match condition of source MAC.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-004.tcl" "******************** Starting Test case QOS-004.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-004.tcl) "OK"
} else {
    set NtgrTestResult(QOS-004.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-004.tcl" "******************** Complete Test case QOS-004.tcl ********************"
#*************************  End of Test case  **********************************