################################################################################
#
#  File Name    : QOS-005.tcl
#
#  Description  : This testcase used to test the match condition of destination MAC.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-005.tcl" "******************** Starting Test case QOS-005.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-005.tcl) "OK"
} else {
    set NtgrTestResult(QOS-005.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-005.tcl" "******************** Complete Test case QOS-005.tcl ********************"
#*************************  End of Test case  **********************************