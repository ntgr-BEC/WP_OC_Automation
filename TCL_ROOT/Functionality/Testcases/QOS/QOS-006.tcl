################################################################################
#
#  File Name    : QOS-006.tcl
#
#  Description  : This testcase used to test the match condition of ethernet type.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-006.tcl" "******************** Starting Test case QOS-006.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-006.tcl) "OK"
} else {
    set NtgrTestResult(QOS-006.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-006.tcl" "******************** Complete Test case QOS-006.tcl ********************"
#*************************  End of Test case  **********************************