################################################################################
#
#  File Name    : QOS-008.tcl
#
#  Description  : This testcase used to test the match condition of COS.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-008.tcl" "******************** Starting Test case QOS-008.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-008.tcl) "OK"
} else {
    set NtgrTestResult(QOS-008.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-008.tcl" "******************** Complete Test case QOS-008.tcl ********************"
#*************************  End of Test case  **********************************