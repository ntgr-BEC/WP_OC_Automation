################################################################################
#
#  File Name    : QOS-009.tcl
#
#  Description  : This testcase used to test the match condition of source IP.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-009.tcl" "******************** Starting Test case QOS-009.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-009.tcl) "OK"
} else {
    set NtgrTestResult(QOS-009.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-009.tcl" "******************** Complete Test case QOS-009.tcl ********************"
#*************************  End of Test case  **********************************