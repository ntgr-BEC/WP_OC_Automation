################################################################################
#
#  File Name    : QOS-010.tcl
#
#  Description  : This testcase used to test the match condition of destination IP.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-010.tcl" "******************** Starting Test case QOS-010.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-010.tcl) "OK"
} else {
    set NtgrTestResult(QOS-010.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-010.tcl" "******************** Complete Test case QOS-010.tcl ********************"
#*************************  End of Test case  **********************************