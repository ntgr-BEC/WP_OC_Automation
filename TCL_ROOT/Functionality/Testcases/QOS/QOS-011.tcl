################################################################################
#
#  File Name    : QOS-011.tcl
#
#  Description  : This testcase used to test the match condition of IP TOS.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-011.tcl" "******************** Starting Test case QOS-011.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-011.tcl) "OK"
} else {
    set NtgrTestResult(QOS-011.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-011.tcl" "******************** Complete Test case QOS-011.tcl ********************"
#*************************  End of Test case  **********************************