################################################################################
#
#  File Name    : QOS-013.tcl
#
#  Description  : This testcase used to test the match condition of IP DSCP.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-013.tcl" "******************** Starting Test case QOS-013.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-013.tcl) "OK"
} else {
    set NtgrTestResult(QOS-013.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-013.tcl" "******************** Complete Test case QOS-013.tcl ********************"
#*************************  End of Test case  **********************************