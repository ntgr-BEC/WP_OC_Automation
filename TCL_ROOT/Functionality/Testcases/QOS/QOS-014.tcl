################################################################################
#
#  File Name    : QOS-014.tcl
#
#  Description  : This testcase used to test the match condition of IP Protocol.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-014.tcl" "******************** Starting Test case QOS-014.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-014.tcl) "OK"
} else {
    set NtgrTestResult(QOS-014.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-014.tcl" "******************** Complete Test case QOS-014.tcl ********************"
#*************************  End of Test case  **********************************