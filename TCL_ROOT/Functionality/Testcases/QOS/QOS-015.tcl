################################################################################
#
#  File Name    : QOS-015.tcl
#
#  Description  : This testcase used to test the match condition of layer4 source port.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-015.tcl" "******************** Starting Test case QOS-015.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-015.tcl) "OK"
} else {
    set NtgrTestResult(QOS-015.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-015.tcl" "******************** Complete Test case QOS-015.tcl ********************"
#*************************  End of Test case  **********************************