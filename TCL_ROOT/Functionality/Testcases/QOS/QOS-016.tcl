################################################################################
#
#  File Name    : QOS-016.tcl
#
#  Description  : This testcase used to test the match condition of layer4 destination port.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-016.tcl" "******************** Starting Test case QOS-016.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-016.tcl) "OK"
} else {
    set NtgrTestResult(QOS-016.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-016.tcl" "******************** Complete Test case QOS-016.tcl ********************"
#*************************  End of Test case  **********************************