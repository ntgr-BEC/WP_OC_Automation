################################################################################
#
#  File Name    : QOS-017.tcl
#
#  Description  : This testcase used to test the match condition of nested class-map.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-017.tcl" "******************** Starting Test case QOS-017.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-017.tcl) "OK"
} else {
    set NtgrTestResult(QOS-017.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-017.tcl" "******************** Complete Test case QOS-017.tcl ********************"
#*************************  End of Test case  **********************************