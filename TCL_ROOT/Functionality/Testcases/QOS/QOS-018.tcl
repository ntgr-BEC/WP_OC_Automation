################################################################################
#
#  File Name    : QOS-018.tcl
#
#  Description  : This testcase used to test the match condition of any traffic.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-018.tcl" "******************** Starting Test case QOS-018.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-018.tcl) "OK"
} else {
    set NtgrTestResult(QOS-018.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-018.tcl" "******************** Complete Test case QOS-018.tcl ********************"
#*************************  End of Test case  **********************************