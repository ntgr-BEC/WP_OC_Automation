################################################################################
#
#  File Name    : QOS-019.tcl
#
#  Description  : This testcase used to test the match condition of source/
#                 destination IP, DSCP, Protocol, layer4 source/destination port.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-019.tcl" "******************** Starting Test case QOS-019.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-019.tcl) "OK"
} else {
    set NtgrTestResult(QOS-019.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-019.tcl" "******************** Complete Test case QOS-019.tcl ********************"
#*************************  End of Test case  **********************************