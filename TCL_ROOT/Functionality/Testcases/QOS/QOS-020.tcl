################################################################################
#
#  File Name    : QOS-020.tcl
#
#  Description  : This testcase used to test the match condition of source/
#                 destination MAC, COS, VLAN, EthernetType and nested class-map.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-020.tcl" "******************** Starting Test case QOS-020.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-020.tcl) "OK"
} else {
    set NtgrTestResult(QOS-020.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-020.tcl" "******************** Complete Test case QOS-020.tcl ********************"
#*************************  End of Test case  **********************************