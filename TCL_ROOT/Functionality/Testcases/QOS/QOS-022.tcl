################################################################################
#
#  File Name    : QOS-022.tcl
#
#  Description  : This testcase used to test drop operation with the matched.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-022.tcl" "******************** Starting Test case QOS-022.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-022.tcl) "OK"
} else {
    set NtgrTestResult(QOS-022.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-022.tcl" "******************** Complete Test case QOS-022.tcl ********************"
#*************************  End of Test case  **********************************