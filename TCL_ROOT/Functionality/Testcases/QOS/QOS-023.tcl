################################################################################
#
#  File Name    : QOS-023.tcl
#
#  Description  : This testcase used to test mark new COS of the matched.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-023.tcl" "******************** Starting Test case QOS-023.tcl ********************"
...
## In the following, think of the performance of the switch, we just use '$rx6>0.3'
set TxRx4 [UALReportPortRate $ntgrTG $ntgrPort4]
set TxRx6 [UALReportPortRate $ntgrTG $ntgrPort6]
set rx6 [expr [lindex $TxRx6 1]/[lindex $TxRx4 0]]
if {$rx6>0.3 && $rx6<0.55} {
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-023.tcl) "OK"
} else {
    set NtgrTestResult(QOS-023.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-023.tcl" "******************** Complete Test case QOS-023.tcl ********************"
#*************************  End of Test case  **********************************