################################################################################
#
#  File Name    : QOS-024.tcl
#
#  Description  : This testcase used to test mark ip dscp of the matched.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-024.tcl" "******************** Starting Test case QOS-024.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-024.tcl) "OK"
} else {
    set NtgrTestResult(QOS-024.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-024.tcl" "******************** Complete Test case QOS-024.tcl ********************"
#*************************  End of Test case  **********************************