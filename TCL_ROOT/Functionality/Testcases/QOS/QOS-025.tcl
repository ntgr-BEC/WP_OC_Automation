################################################################################
#
#  File Name    : QOS-025.tcl
#
#  Description  : This testcase used to test mark ip precedence of the matched.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-025.tcl" "******************** Starting Test case QOS-025.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-025.tcl) "OK"
} else {
    set NtgrTestResult(QOS-025.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-025.tcl" "******************** Complete Test case QOS-025.tcl ********************"
#*************************  End of Test case  **********************************