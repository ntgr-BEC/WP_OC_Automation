################################################################################
#
#  File Name    : QOS-029.tcl
#
#  Description  : This testcase used to test stability of repeatedly rename policy-map.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-029.tcl" "******************** Starting Test case QOS-029.tcl ********************"
...
for {set t 1} {$t<=$ntgrRepeatTimes} {incr t} {
    ...
    CALQosRenamePolicyMap $ntgrDUT1 "plc_$t" "plc_[expr $t+1]"
    sleep 5
}
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-029.tcl) "OK"
} else {
    set NtgrTestResult(QOS-029.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-029.tcl" "******************** Complete Test case QOS-029.tcl ********************"
#*************************  End of Test case  **********************************