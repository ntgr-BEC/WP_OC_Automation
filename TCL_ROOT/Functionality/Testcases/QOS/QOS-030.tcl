################################################################################
#
#  File Name    : QOS-030.tcl
#
#  Description  : This testcase used to test stability of rebooting switch.
#
#  Revision     :
...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-030.tcl" "******************** Starting Test case QOS-030.tcl ********************"
...
if {$bRet == 1} {
    set NtgrTestResult(QOS-030.tcl) "OK"
} else {
    set NtgrTestResult(QOS-030.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "QOS-030.tcl" "******************** Complete Test case QOS-030.tcl ********************"
#*************************  End of Test case  **********************************