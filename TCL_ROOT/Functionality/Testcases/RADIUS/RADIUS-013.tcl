...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-013.tcl" "******************** Starting Test case RADIUS-013.tcl ********************"
## Initialize the DUT
...
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-013.tcl" "Complete configuration, please use the name 'aaa' and password 'aaa' to logon on DUT manually by 802.1X client on Windows XP."
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-013.tcl" "Capture packets on windows2003, if can't logon and no response packets from server were captured , press 'y' to continue; otherwise press any key."
set key [gets stdin]
...
if {$bRet ==1} {
    set NtgrTestResult(RADIUS-013.tcl) "OK"
} else {
    set NtgrTestResult(RADIUS-013.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-013.tcl" "******************** Complete Test case RADIUS-013.tcl ********************"
#*************************  End of Test case  **********************************