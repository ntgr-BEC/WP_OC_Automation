...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-016.tcl" "******************** Starting Test case RADIUS-016.tcl ********************"
## Initialize the DUT
...
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-016.tcl" "Complete configuration, please use the name 'aaa' and password 'aaa' to logon on DUT manually by 802.1X client on Windows XP."
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-016.tcl" "Capture packets on windows2003, if you succeed logon and accounting start packets were captured, press 'y' to continue; otherwise press any key."
set key [gets stdin]
...
if {$bRet ==1} {
    set NtgrTestResult(RADIUS-016.tcl) "OK"
} else {
    set NtgrTestResult(RADIUS-016.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-016.tcl" "******************** Complete Test case RADIUS-016.tcl ********************"
#*************************  End of Test case  **********************************