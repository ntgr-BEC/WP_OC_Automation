...
#*************************  Start of Test case  ********************************
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-017.tcl" "******************** Starting Test case RADIUS-017.tcl ********************"
## Initialize the DUT
...
## Too long secret should not be configured OK
...
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-017.tcl" "Complete configuration, please use the name 'aaa' and password 'aaa' to logon on DUT manually by 802.1X client on Windows XP."
NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-017.tcl" "Capture packets on windows2003, if you succeed logon and accounting start packets were captured, press 'y' to continue; otherwise press any key."
set key [gets stdin]
...
if {$bRet ==1} {
    set NtgrTestResult(RADIUS-017.tcl) "OK"
} else {
    set NtgrTestResult(RADIUS-017.tcl) "NG"
}

NtgrDumpLog  $NTGR_LOG_TERSE  "RADIUS-017.tcl" "******************** Complete Test case RADIUS-017.tcl ********************"
#*************************  End of Test case  **********************************