...
#
#  Description     	: Effects on the RIP route table of deleting static routes when redistribution static routes
#
...
foreach switch_name $NTGR_CLEAR_CONFIG_SW_LIST_007 {
    Netgear_log_file "TC-RIP-007.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

foreach switch_name $MTSW_RIP_007 {
	Netgear_log_file "TC-RIP-007.tcl" "Started to Modify TOPO"
	CALAllPortsLinkDown $MTSW_RIP_007
}

Netgear_log_file "TC-RIP-007.tcl" "Started Configuration of VLAN"

foreach vlan_index $VLAN_RIP_list_007 {
	Netgear_log_file "TC-RIP-007.tcl" "Started Configuration of VLAN $vlan_index"
	CALCreateVlan $vlan_index
}

Netgear_log_file "TC-RIP-007.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-RIP-007.tcl" "Started Configuring Static Routes"
...
Netgear_log_file "TC-RIP-007.tcl" "Started Configuring another Static Routes"
...
if {$result1 == 1 && $result2 == 1} {Netgear_log_file "TC-RIP-007.tcl" "***** TC-RIP-007.tcl passed *****"} else {
Netgear_log_file "TC-RIP-007.tcl" "***** TC-RIP-007.tcl failed *****"}
