...
foreach switch_name $NTGR_CLEAR_CONFIG_SW_LIST_008 {
    Netgear_log_file "TC-RIP-008.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

foreach switch_name $MTSW_RIP_008 {
	Netgear_log_file "TC-RIP-008.tcl" "Started to Modify TOPO"
	CALAllPortsLinkDown $MTSW_RIP_008
}
Netgear_log_file "TC-RIP-008.tcl" "Started Configuration of VLAN"

foreach vlan_index $VLAN_RIP_list_008 {
	Netgear_log_file "TC-RIP-008.tcl" "Started Configuration of VLAN $vlan_index"
	CALCreateVlan $vlan_index
}

Netgear_log_file "TC-RIP-008.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-RIP-008.tcl" "Started Configuration of RIP"

foreach switch_name $ntgr_RIPList_008 {
...
Netgear_log_file "TC-RIP-008.tcl" "Started Configuring Static Routes"

foreach switch_name $ntgr_staticIP_008 {
...
if {$result1 == 1 && $result2 == 1} {Netgear_log_file "TC-RIP-008.tcl" "***** TC-RIP-008.tcl passed *****"} else {
Netgear_log_file "TC-RIP-008.tcl" "***** TC-RIP-008.tcl failed *****"}
