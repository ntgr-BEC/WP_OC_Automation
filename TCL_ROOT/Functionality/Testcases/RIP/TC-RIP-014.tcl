#################################################################################
#
#  File Name	    	: TC-RIP-014.tcl
#
#  Description     	: Effects on the RIP route table of adding OSPF routes when redistribution OSPF routes
#
#  Config file          : TC-RIP-014.cfg
#				  
#  Revision History 	:
...
Netgear_log_file "TC-RIP-014.tcl" "******** Starting Test case TC-RIP-014.tcl **********"

foreach switch_name $NTGR_CLEAR_CONFIG_SW_LIST_014 {
    Netgear_log_file "TC-RIP-014.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-RIP-014.tcl" "Started to Modify TOPO"
CALAllPortsLinkDown $MTSW_RIP_014
CALPortLinkDown $SW_TC_014 $port_down
Netgear_log_file "TC-RIP-014.tcl" "Started Configuration of VLAN"

foreach vlan_index $VLAN_RIP_list_014 {
	Netgear_log_file "TC-RIP-014.tcl" "Started Configuration of VLAN $vlan_index"
	CALCreateVlan $vlan_index
}

Netgear_log_file "TC-RIP-014.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-RIP-014.tcl" "Started Configuring OSPF"

foreach switch_name $ntgr_OSPFList_014 {
...
Netgear_log_file "TC-RIP-014.tcl" "Started Configuration of RIP"

foreach switch_name $ntgr_RIPList_014 {
...
CALPortLinkUp $SW_TC_014 $port_down
...
if {$result1 == 1 && $result2 == 1} {
	Netgear_log_file "TC-RIP-014.tcl" "***** TC-RIP-014.tcl passed *****"
} else {
	Netgear_log_file "TC-RIP-014.tcl" "***** TC-RIP-014.tcl failed *****"
}
...
Netgear_log_file "TC-RIP-014.tcl" "***** Completed Test case TC-RIP-014.tcl *****"
