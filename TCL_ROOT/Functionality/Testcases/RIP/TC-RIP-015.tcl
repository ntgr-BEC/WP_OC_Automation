...
Netgear_log_file "TC-RIP-015.tcl" "******** Starting Test case TC-RIP-015.tcl **********"

foreach switch_name $NTGR_CLEAR_CONFIG_SW_LIST_015 {
    Netgear_log_file "TC-RIP-015.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-RIP-015.tcl" "Started to Modify TOPO"
CALAllPortsLinkDown $MTSW_RIP_015

Netgear_log_file "TC-RIP-015.tcl" "Started Configuration of VLAN"

foreach vlan_index $VLAN_RIP_list_015 {
	Netgear_log_file "TC-RIP-015.tcl" "Started Configuration of VLAN $vlan_index"
	CALCreateVlan $vlan_index
}

Netgear_log_file "TC-RIP-015.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-RIP-015.tcl" "Started Configuring OSPF"

foreach switch_name $ntgr_OSPFList_015 {
...
Netgear_log_file "TC-RIP-015.tcl" "Started Configuration of RIP"

foreach switch_name $ntgr_RIPList_015 {
...
CALPortLinkDown $SW_TC_015 $port_down

sleep 90

for {set i 1} {$i <= 3} {incr i} {
	sleep 2
	set result2 [CALCheckExpect $switch_checked $cmds $expect_string_list2 0] 
}

###############################Check the Configuration ################################# 	
if {$result1 == 1 && $result2 == 1} {Netgear_log_file "TC-RIP-015.tcl" "***** TC-RIP-015.tcl passed *****"} else {
Netgear_log_file "TC-RIP-015.tcl" "***** TC-RIP-015.tcl failed *****"}
...
Netgear_log_file "TC-RIP-015.tcl" "***** Completed Test case TC-RIP-015.tcl *****"
