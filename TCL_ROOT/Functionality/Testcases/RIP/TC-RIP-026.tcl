#################################################################################
#
#  File Name	    	: TC-RIP-026.tcl
#
#  Description     	: Effects of deleting OSPF process when redistribution routes from OSPF
#
#  Config file          : TC-RIP-026.cfg
#				  
#  Revision History 	:
...
Netgear_log_file "TC-RIP-026.tcl" "******** Starting Test case TC-RIP-026.tcl **********"

foreach switch_name $NTGR_CLEAR_CONFIG_SW_LIST_026 {
    Netgear_log_file "TC-RIP-026.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-RIP-026.tcl" "Started to Modify TOPO"
CALAllPortsLinkDown $MTSW_RIP_026
Netgear_log_file "TC-RIP-026.tcl" "Started Configuration of VLAN"

foreach vlan_index $VLAN_RIP_list_026 {
	Netgear_log_file "TC-RIP-026.tcl" "Started Configuration of VLAN $vlan_index"
	CALCreateVlan $vlan_index
}

Netgear_log_file "TC-RIP-026.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-RIP-026.tcl" "Started Configuring OSPF"

foreach switch_name $ntgr_OSPFList_026 {
...
Netgear_log_file "TC-RIP-026.tcl" "Started Configuration of RIP"

foreach switch_name $ntgr_RIPList_026 {
...
Netgear_connect_switch $SW_TC_026 
CALOspfDisable $SW_TC_026 "disable"
Netgear_disconnect_switch $SW_TC_026
...
if {$result1 == 1 && $result2 == 1} {Netgear_log_file "TC-RIP-026.tcl" "***** TC-RIP-026.tcl passed *****"} else {
Netgear_log_file "TC-RIP-026.tcl" "***** TC-RIP-026.tcl failed *****"}
...
Netgear_log_file "TC-RIP-026.tcl" "***** Completed Test case TC-RIP-026.tcl *****"
