#################################################################################
#
#  File Name	    	: TC-RIP-039.tcl
#
#  Description     	: Inter-working with LAG
#
#  Config file          : TC-RIP-039.cfg
#				  
#  Revision History 	:
...
Netgear_log_file "TC-RIP-039.tcl" "******** Starting Test case TC-RIP-039.tcl **********"

foreach switch_name $NTGR_CLEAR_CONFIG_SW_LIST_039 {
    Netgear_log_file "TC-RIP-039.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-RIP-039.tcl" "Started to Modify TOPO"

CALAllPortsLinkDown $MTSW_RIP_039

Netgear_log_file "TC-OSPF-039.tcl" "Started Configuration of LAG"

foreach channel_name $poch_list_039 {
	Netgear_log_file "TC-OSPF-039.tcl" "Configure port channel($channel_name) on each switch(es)."
	CALCreatePortChannel $channel_name
}

Netgear_log_file "TC-RIP-039.tcl" "Started Configuration of VLAN"

foreach vlan_index $VLAN_RIP_list_039 {
	Netgear_log_file "TC-RIP-039.tcl" "Started Configuration of VLAN $vlan_index"
	CALCreateVlan $vlan_index
}

Netgear_log_file "TC-RIP-039.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-RIP-039.tcl" "Started Configuring OSPF"

foreach switch_name $ntgr_OSPFList_039 {
...
Netgear_log_file "TC-RIP-039.tcl" "Started Configuration of RIP"

foreach switch_name $ntgr_RIPList_039 {
...
if {$result == 1} {Netgear_log_file "TC-RIP-039.tcl" "***** TC-RIP-039.tcl passed *****"} else {
Netgear_log_file "TC-RIP-039.tcl" "***** TC-RIP-039.tcl failed *****"}
...
Netgear_log_file "TC-RIP-039.tcl" "***** Completed Test case TC-RIP-039.tcl *****"
