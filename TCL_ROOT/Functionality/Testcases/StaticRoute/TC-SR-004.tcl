...
Netgear_log_file "TC-SR-004.tcl" "******** Starting Test case TC-SR-004.tcl **********"

foreach switch_name $NTGR_CLEAR_CONFIG_SW_LIST_004 {
    Netgear_log_file "TC-SR-004.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-SR-004.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-RIP-004.tcl" "Started Configuring OSPF"

foreach switch_name $ntgr_OSPFList_004 {
...
Netgear_log_file "TC-SR-004.tcl" "Started configuration of static routes"

foreach switch_name $DUT_SR_004 {
...
if {$result1 == 1 && $result2 == 1} {
	Netgear_log_file "TC-SR-004.tcl" "***** TC-SR-004.tcl passed *****"
} else {
	Netgear_log_file "TC-SR-004.tcl" "***** TC-SR-004.tcl failed *****"
}
...
Netgear_log_file "TC-SR-004.tcl" "***** Completed Test case TC-SR-004.tcl *****"
