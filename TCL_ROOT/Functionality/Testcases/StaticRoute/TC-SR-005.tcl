...
Netgear_log_file "TC-SR-005.tcl" "******** Starting Test case TC-SR-005.tcl **********"

foreach switch_name $NTGR_CLEAR_CONFIG_SW_LIST_005 {
    Netgear_log_file "TC-SR-005.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
    CALSetSwitchMngrIPAddr $switch_name
}

Netgear_log_file "TC-SR-005.tcl" "Started routing on the Switches"
...
Netgear_log_file "TC-RIP-005.tcl" "Started Configuring OSPF"

foreach switch_name $ntgr_OSPFList_005 {
...
Netgear_log_file "TC-SR-005.tcl" "Started Configuration of OSPF on IXIA"
...
Netgear_log_file "TC-SR-005.tcl" "Started configuration of static routes"

foreach switch_name $DUT_SR_005 {
...
if {$result1 == 1 && $result2 == 1} {
	Netgear_log_file "TC-SR-005.tcl" "***** TC-SR-005.tcl passed *****"
} else {
	Netgear_log_file "TC-SR-005.tcl" "***** TC-SR-005.tcl failed *****"
}
...
Netgear_log_file "TC-SR-005.tcl" "***** Completed Test case TC-SR-005.tcl *****"
