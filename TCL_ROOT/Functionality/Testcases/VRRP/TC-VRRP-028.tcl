...
foreach switch_name $switch_VRRP_list {
    Netgear_log_file "TC-VRRP-028.tcl" "Clear current configuration on switch $switch_name and configure some initial info"
    CALResetConfiguration $switch_name
    CALSetSwitchPrompt $switch_name
}

Netgear_log_file "TC-VRRP-028.tcl" "Started Configuration of VRRP"
...
foreach switch_name $switch_VRRP_list {
   ...
   if {$result == 1} {
       Netgear_log_file "TC-VRRP-028.tcl" "*******TC-VRRP-028.tcl passed********************"} else {
       Netgear_log_file "TC-VRRP-028.tcl" "*******TC-VRRP-028.tcl failed********************"} 
}
