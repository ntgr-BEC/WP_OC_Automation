################################################################################
#
#  File Name		: TC-TCP-Burst-Low-TrafficStart-039.tcl
#
#  Description       	: This test script is used for generating TCP Busrt Traffic 
#                         during off peak hours. It is using one port of Spirent Tester 
#		              1G port and 9 ports of IXIA 100 Mbps ports. It grenerate 
#                         simulates TCP FTP. Each port generate traffic at the rate of 20%.
...
#
#  Config File          : TC-TCP-Burst-Low-TrafficStart-039.cfg
#
...
NtgrDumpLog  $NTGR_LOG_TERSE  "TC-TCP-Burst-Low-TrafficStart-039.tcl" "******************** Starting Test case TC-TCP-Burst-Low-TrafficStart-039.tcl ********************"
...
for_array_keys chassis_id ntgr_trafficTestInfo {
	...
	NtgrDumpLog  $NTGR_LOG_TERSE "TC-TCP-Burst-Low-TrafficStart-039.tcl" "Connecting to Traffic Generator $chassis_id"
	UALConnectTester $chassis_id
	NtgrDumpLog  $NTGR_LOG_TERSE "TC-TCP-Burst-Low-TrafficStart-039.tcl" "Loading the configuration on ports"
	UALLoadTester $chassis_id
	NtgrDumpLog  $NTGR_LOG_TERSE "TC-TCP-Burst-Low-TrafficStart-039.tcl" "Cycle Started Traffic on chassis $chassis_id"
