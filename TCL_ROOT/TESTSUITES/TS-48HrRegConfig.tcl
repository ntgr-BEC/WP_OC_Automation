...
###########################################################################
#
#  File Name		: TS-48HrRegConfig.tcl
#
#  Description       	:
#         This TCL sends traffic between 2 Spirent ports
#
#  Test Script List 	: TC-REGCFG-001.tcl
#
#  CFG file Name 		: TC-REGCFG-001.cfg
#
#  Usage                : TS-48HrRegConfig.tcl
# 
#  Revision History 	:
...
# set the script name
set NTGR_SCRIPT_NAME   	"TS-48HrRegConfig"
...
source $NTGR_TEST_SCRIPT_PATH/TC-REGCFG-001.tcl
if {$NTGR_TEST_RESULT == TRUE} {
	set NTGR_TEST_RESULT FALSE
} else {
	incr NTGR_SUITE_RESULT
	lappend NTGR_TEST_LIST "TC-REGCFG-001.tcl"
}
