...
###########################################################################
#
#  File Name		: TS-48HrRegConfigDeleteDelete.tcl
#
#  Description       	:
#         This TCL sends traffic between 2 Spirent ports
#
#  Test Script List 	: TC-REGDELETECFG-001.tcl
#
#  CFG file Name 		: TC-REGCFG-001.cfg
#
#  Usage                : TS-48HrRegConfigDelete.tcl
# 
#  Revision History 	:
...
# set the script name
set NTGR_SCRIPT_NAME   	"TS-48HrRegConfigDelete"

#List the Switches and Tester Used in this Test Suite
keylset ntgr_productList			\
	SWITCH_LIST		{A1 A2 A3 A4 B1 B2 B3 B4 C1 C2 C3 C4}\
	TESTER_LIST		{S1 I1 I2}
...
# Execute Test Case 1
source $NTGR_CONFIG_PATH/TC-REGCFG-001.cfg
source $NTGR_TEST_SCRIPT_PATH/TC-REGDELETECFG-001.tcl
if {$NTGR_TEST_RESULT == TRUE} {
	set NTGR_TEST_RESULT FALSE
} else {
	incr NTGR_SUITE_RESULT
	lappend NTGR_TEST_LIST "TC-REGDELETECFG-001.tcl"
}
