...
# set the script name
set NTGR_SCRIPT_NAME   	"TS-IPFunc"
...
# Execute Test Case 1
source $NTGR_CONFIG_PATH/TC-IP-009.cfg
source $NTGR_TEST_SCRIPT_PATH/TC-IP-009.tcl
if {$NTGR_TEST_RESULT == TRUE} {
	set NTGR_TEST_RESULT FALSE
} else {
	incr NTGR_SUITE_RESULT
	lappend NTGR_TEST_LIST "TC-IP-009.tcl"
}
