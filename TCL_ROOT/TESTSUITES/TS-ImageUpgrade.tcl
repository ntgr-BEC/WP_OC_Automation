...
###########################################################################
#
#  File Name		: TS-ImageUpgrade.tcl
#
#  Description       	:
#         This TCL upgrades the new image on the swicthes.
#
#  Test Script List 	: TC-TFT-001.tcl
#
#  CFG file Name 		: A1-TC-TFT-001.cfg
#			  	  A2-TC-TFT-001.cfg
#
#  Usage                : TS-ImageUpgrade.tcl
# 
#  Revision History 	:
...
set NTGR_SCRIPT_NAME   	"TS-ImageUpgrade"
...
# Execute Test Case 1
source $NTGR_CONFIG_PATH/TC-TFT-001.cfg
source $NTGR_TEST_SCRIPT_PATH/TC-TFT-001.tcl
if {$NTGR_TEST_RESULT == TRUE} {
	incr NTGR_SUITE_RESULT
	set NTGR_TEST_RESULT FALSE
} else {
	lappend NTGR_TEST_LIST "TC-TFT-001.tcl"
}
