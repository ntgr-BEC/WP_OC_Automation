...
###########################################################################
#
#  File Name		: TS-StormControlFunc.tcl
#
#  Description       	:
#         This TCL tests storm control functionality
#
#  Test Script List 	: TC-STORMCTRL-012.tcl
#
#  CFG file Name 		: TC-STORMCTRL-012.cfg
#
#  Usage                : TS-StormControlFunc.tcl
# 
#  Revision History 	:
...
# set the script name
set NTGR_SCRIPT_NAME   	"TS-StormControlFunc"
...
# Execute Test Case 1
source $NTGR_CONFIG_PATH/TC-STORMCTRL-012.cfg
source $NTGR_TEST_SCRIPT_PATH/TC-STORMCTRL-012.tcl
if {$NTGR_TEST_RESULT == TRUE} {
	set NTGR_TEST_RESULT FALSE
} else {
	incr NTGR_SUITE_RESULT
	lappend NTGR_TEST_LIST "TC-STORMCTRL-012.tcl"
}
