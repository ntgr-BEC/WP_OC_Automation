...
###########################################################################
#
#  File Name		: TS-TimeWheel-FUNC-DOT1X.tcl
#
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-DOT1X.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-DOT1X.tcl
