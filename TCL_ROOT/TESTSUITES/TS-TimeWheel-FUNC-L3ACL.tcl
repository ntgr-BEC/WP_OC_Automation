...
###########################################################################
#
#  File Name		: TS-TimeWheel-FUNC-L3ACL.tcl
#
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-L3ACL.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-L3ACL.tcl
