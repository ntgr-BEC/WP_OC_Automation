...
###########################################################################
#
#  File Name		: TS-TimeWheel-Func-OSPF.tcl
#
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-OSPF.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-OSPF.tcl
