...
###########################################################################
#
#  File Name		: TS-TimeWheel-FUNC-OneWayACL.tcl
#
#  Description       	: This TCL configure time wheel to run multiple scripts
#                         at their respective time slots.
#
#  Test Script List 	: TC-TimeWheel-FUNC-OneWayACL.tcl
#
#  CFG file Name 	: TC-TimeWheel-FUNC-OneWayACL.cfg
#
#  Usage             	: Goto the current dir in the console, and exec 'TS-TimeWheel.tcl'
# 
#  Revision History 	:
...
set NTGR_SCRIPT_NAME   	"TS-TimeWheel-FUNC-OneWayACL.tcl"
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-OneWayACL.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-OneWayACL.tcl
