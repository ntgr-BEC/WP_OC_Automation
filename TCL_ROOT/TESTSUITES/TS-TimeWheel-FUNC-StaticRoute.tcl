...
###########################################################################
#
#  File Name		: TS-TimeWheel-Func-StaticRoute.tcl
#
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-StaticRoute.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-StaticRoute.tcl
