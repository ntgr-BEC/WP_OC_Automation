...
set NTGR_SCRIPT_NAME   	"TS-TimeWheel-Func-PORT.tcl"
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-PORT.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-PORT.tcl
