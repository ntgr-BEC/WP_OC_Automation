...
set NTGR_SCRIPT_NAME   	"TS-TimeWheel-FUNC-RADIUS.tcl"
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-RADIUS.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-RADIUS.tcl
