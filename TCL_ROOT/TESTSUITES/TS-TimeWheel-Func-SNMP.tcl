...
set NTGR_SCRIPT_NAME   	"TS-TimeWheel-Func-SNMP.tcl"
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-SNMP.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-SNMP.tcl
