...
set NTGR_SCRIPT_NAME   	"TS-TimeWheel-Func-STK.tcl"
...
source $NTGR_FUNC_CFG/$NTGR_TEST_ENVIRONMENT/TC-TIMEWHEEL-FUNC-STK.cfg
source $NTGR_FUNC_TC/TC-TIMEWHEEL-FUNC-STK.tcl
