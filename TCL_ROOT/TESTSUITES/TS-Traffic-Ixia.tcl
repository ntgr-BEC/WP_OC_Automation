...
###########################################################################
#
#  File Name		: TS-Traffic_Ixia.tcl
#
#  Description       	:
#         This TCL sends traffic between 2 Spirent ports
#
#  Test Script List 	: TC-TRAFFIC-008.tcl
#				  TC-TRAFFIC-009.tcl
#
#  CFG file Name 		: TC-TRAFFIC-008.cfg
#				  TC-TRAFFIC-009.cfg
#
#  Usage                : TS-Traffic_Ixia.tcl
# 
#  Revision History 	:
...
# set the script name
set NTGR_SCRIPT_NAME   	"TS-Traffic_Ixia"
...
# Execute Test Case 1
source $NTGR_CONFIG_PATH/TC-TRAFFIC-008.cfg
source $NTGR_TEST_SCRIPT_PATH/TC-TRAFFIC-008.tcl
if {$NTGR_TEST_RESULT == TRUE} {
	set NTGR_TEST_RESULT FALSE
} else {
	incr NTGR_SUITE_RESULT
	lappend NTGR_TEST_LIST "TC-TRAFFIC-008.tcl"
}

# # Execute Test Case 2
# source $NTGR_CONFIG_PATH/TC-TRAFFIC-009.cfg
# source $NTGR_TEST_SCRIPT_PATH/TC-TRAFFIC-009.tcl
# if {$NTGR_TEST_RESULT == TRUE} {
# 	set NTGR_TEST_RESULT FALSE
# } else {
# 	incr NTGR_SUITE_RESULT
# 	lappend NTGR_TEST_LIST "TC-TRAFFIC-009.tcl"
# }
