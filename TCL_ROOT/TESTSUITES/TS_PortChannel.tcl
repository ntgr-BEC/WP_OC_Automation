...
set NTGR_SCRIPT_NAME   	"TS-PortChannel"
...
#******************  Start of Test Suite *****************************************
# Execute Test Case 1
source $NTGR_CONFIG_PATH/TC-POCH-005.cfg
source $NTGR_TEST_SCRIPT_PATH/TC-POCH-005.tcl
...
if {$NTGR_TEST_RESULT == TRUE} {
	...
	lappend NTGR_TEST_LIST "TC-POCH-005.tcl"
}
