package businessrouter.BusinessRouterFunction.Advanced_DDNS.BR_T226;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T226";
    ...
    String LanClientMac;
    final static Logger logger = Logger.getLogger("BR_T226");
    @Feature("Business Router.Advanced_DDNS") // 必须要加，对应目录名
    @Story("BR_T226") // 对应testrunkey
    @Description("002-Netgear-DDNS all info is correct") // 对应用例名A字
    @TmsLink("1455229") // 对应用例详情页的URL最后几位数字
