...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T230";
    ...
    String LanClientMac;
    final static Logger logger = Logger.getLogger("BR_T230");
    @Feature("Business Router.Advanced_DDNS") // 必须要加，对应目录名
    @Story("BR_T230") // 对应testrunkey
    @Description("006-Netgear - Max. Hostname(114)") // 对应用例名A字
    @TmsLink("1455233") // 对应用例详情页的URL最后几位数字
    ...
    public void tearDown() {
      ...
      @Step("Test Step 2:Able to set hostname up to 114 characters")
        public void step2() {
          boolean Result = false;
          boolean Result2 = false;
          brddnspage.OpenDynamicDNSPage();
          handle.sleepi(15);
          Result = brddnspage.NetgearAccountMaxEmailAndMaxHosename(NewDDNSAccountInfo);
          if (Result == true) {
              micResult =  true;
