package businessrouter.BusinessRouterFunction.AttachedDevices.BR_T546;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T546";
    ...
    String LanClientMac;
    final static Logger logger = Logger.getLogger("BR_T546");
    @Feature("Business Router.Attached Devices") // 必须要加，对应目录名
    @Story("BR_T546") // 对应testrunkey
    @Description("007-Access Control enabled") // 对应用例名A字
    @TmsLink("1460186") // 对应用例详情页的URL最后几位数字
    ...
    public void tearDown() {
      ...
      @Step("Test Step 2:Get new lan client MAC ")
       ...
       @Step("Test Step 3: Enable Access Control .")
        public void step3() {
       ...
       @Step("Test Step 4:Go to Administration-Attached Devices page,This device status should be allowed In Attached Devices table.")
       public void step4() {
           boolean Result;
           ...
           if (Result == true) {
               micResult =  true;
               assertTrue(micResult,"Pass:This device status is allowed In Attached Devices table!");  
           }else {
               micResult =  false;
               assertTrue(micResult,"Failed:This device status isn't allowed In Attached Devices table!"); 
           } 
        }   
