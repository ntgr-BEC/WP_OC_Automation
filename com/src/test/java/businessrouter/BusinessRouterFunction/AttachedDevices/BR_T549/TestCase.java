package businessrouter.BusinessRouterFunction.AttachedDevices.BR_T549;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T549";
    ...
    String LanClientMac;
    final static Logger logger = Logger.getLogger("BR_T549");
    @Feature("Business Router.Attached Devices") // 必须要加，对应目录名
    @Story("BR_T549") // 对应testrunkey
    @Description("010-Device Identification - Dynamic QoS disabled") // 对应用例名A字
    @TmsLink("1460189") // 对应用例详情页的URL最后几位数字
    ...
    public void tearDown() {
      ...
      @Step("Test Step 2:Get new lan client MAC .")
       ...
       @Step("Test Step 3:Disable QoS and check attached device,the information(MAC address, ip address, device name) of device should be correct;.")
        public void step3() {
