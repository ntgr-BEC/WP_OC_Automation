...
set result1 0
Netgear_log_file "CheckPoint-1 ERROR:" "TCP Expect Result: RxTraffic1Cnt = 0, RxTraffic1Cnt == $RxPort2Cnt,TxTraffic1Cnt == $TxPort1Cnt" "YES"  
}
...
set result3 0
Netgear_log_file "CheckPoint-1 ERROR:" "ICMP Expect Result: RxTraffic1Cnt = TxTraffic1Cnt, RxTraffic1Cnt == $RxPort2Cnt,TxTraffic1Cnt == $TxPort1Cnt" "YES"  
}
