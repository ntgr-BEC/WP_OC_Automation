package businessrouter.BusinessRouterFunction.Firewall.BR_T655;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    String tmpStr;
    final static Logger logger = Logger.getLogger("BR_T655");
    public String sTestStr = "BR_T655";
    ...
    @Story("BR_T655") // 对应testrunkey
    @Description("101-TrafficRules-LAN to WAN-Accept the traffic match protocol TCP") // 对应用例名字
    @TmsLink("1461331") // 对应用例详情页的URL最后几位数字
  ...
  @Step("Test Step 1: Open Device")
    ...
    @Step("Test Step 2:Config LAN to WAN rule1:\r\n" + 
            "--Protocol:TCP,source:lan any devices,des:wan source any,action:accept")
    public void step2() {
    ...
    public void step4() {
        ...
        if (TMSUDPResult == false && TMSTCPResult== true && PingResult == false) {
            micResult =  true;
