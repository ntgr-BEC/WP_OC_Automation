package businessrouter.BusinessRouterFunction.Firewall.BR_T656;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    String tmpStr;
    final static Logger logger = Logger.getLogger("BR_T656");
    public String sTestStr = "BR_T656";
    ...
    @Story("BR_T656") // 对应testrunkey
    @Description("102-TrafficRules-LAN to WAN-Accept the traffic match protocol UDP") // 对应用例名字
    @TmsLink("1461332") // 对应用例详情页的URL最后几位数字
  ...
  @Step("Test Step 1: Open Device")
   ...
   @Step("Config LAN to WAN rule1:\r\n" + 
            "--Protocol:UDP,source:lan any devices,des:wan source any,action:accept")
    public void step2() {
    ...
    @Step("Test Step 3: Config LAN to WAN rule2 to block all traffic from lan to wan")
    public void step3() {
    ...
    public void step4() {
        ...
        if (TMSUDPResult == true && TMSTCPResult== false && PingResult == false) {
            micResult =  true;
