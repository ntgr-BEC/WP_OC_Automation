package businessrouter.BusinessRouterFunction.Firewall.BR_T664;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    String tmpStr;
    final static Logger logger = Logger.getLogger("BR_T664");
    public String sTestStr = "BR_T664";
    ...
    @Story("BR_T664") // 对应testrunkey
    @Description("110-TrafficRules-LAN to WAN-Accept the traffic match single destination ip address") // 对应用例名字
    @TmsLink("1461340") // 对应用例详情页的URL最后几位数字
  ...
  @Step("Test Step 1: Open Device")
   ...
   @Step("Step 2:Config LAN to WAN rule1:\r\n" + 
           "--Protocol:all,des ip address set to 10.1.1.100,action:accept,other use default value")
    public void step2() {
