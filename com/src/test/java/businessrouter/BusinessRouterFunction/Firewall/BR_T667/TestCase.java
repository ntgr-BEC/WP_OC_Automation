...
public class TestCase extends TestCaseBase implements Config {
    ...
    String tmpStr;
    final static Logger logger = Logger.getLogger("BR_T667");
    public String sTestStr = "BR_T667";
    ...
    @Story("BR_T667") // 对应testrunkey
    @Description("113-TrafficRules-LAN to WAN-Accept the traffic match multiple destination port") // 对应用例名字
    @TmsLink("1461343") // 对应用例详情页的URL最后几位数字
  ...
  @Step("Test Step 1: Open Device")
   ...
   @Step("Step 3:Config LAN to WAN rule2 to block all traffic from lan to wan.")
    ...
    public void step5() {
        boolean TMSTCPResult = false;
        TmsUDPCommands.replace("WAN port", "1020");
        TMSTCPResult =  Brtmspage.UdpTcpTrafficPassOrFailed(TmsUDPCommands);
        Brtmspage.BackTMSConfigPafe();
