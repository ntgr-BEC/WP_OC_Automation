...
public interface Config {
    public static Map<String, String> Firewallrule1 = new HashMap<String, String>() {
        {
            ...
            put("Protocol", "TCP");
            put("Source Zone", "LAN");
            put("Source MAC address", "00:0C:29:C6:AD:E4");
    ...
    public static Map<String, String> Firewallrule11 = new HashMap<String, String>() {
        {
          
            put("Rule Name", "test1");
            put("Protocol", "TCP");
            //put("Source Zone", "LAN");
            put("Source MAC address", "00:0C:29:C6:AD:56");
           // put("Destination Zone", "WAN"); 
            //put("Destnation Address", WebportalParam.brwanclientip);           
            put("Action", "ACCEPT");
