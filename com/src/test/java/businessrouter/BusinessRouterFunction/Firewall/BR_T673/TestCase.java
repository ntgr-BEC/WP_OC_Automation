package businessrouter.BusinessRouterFunction.Firewall.BR_T673;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    String tmpStr;
    final static Logger logger = Logger.getLogger("BR_T673");
    public String sTestStr = "BR_T673";
    ...
    @Story("BR_T673") // 对应testrunkey
    @Description("119-TrafficRules-LAN to WAN-Drop the traffic match protocol ICMP") // 对应用例名字
    @TmsLink("1461349") // 对应用例详情页的URL最后几位数字
  ...
  @Step("Test Step 1: Open Device")
   ...
   @Step("Config LAN to WAN rule1:\r\n" + 
           "--Protocol:ICMP,source:lan any devices,des:wan source any,action:Drop")
    public void step2() {
    ...
    @Step("Test Step 3: Send ICMP traffic from lan side to wan side")
    public void step4() {
        ...
        if (TMSUDPResult == true && TMSTCPResult== true && PingResult == false) {
            micResult =  true;
