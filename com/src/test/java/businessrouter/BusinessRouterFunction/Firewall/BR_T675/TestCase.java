package businessrouter.BusinessRouterFunction.Firewall.BR_T675;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    String tmpStr;
    final static Logger logger = Logger.getLogger("BR_T675");
    public String sTestStr = "BR_T675";
    ...
    @Story("BR_T675") // 对应testrunkey
    @Description("121-TrafficRules-LAN to WAN-Drop the traffic match the single source mac address") // 对应用例名字
    @TmsLink("1461351") // 对应用例详情页的URL最后几位数字
  ...
  public void step2() {
   ...
   @Step("Test Step 3:Config LAN to WAN rule1:\r\n" + 
           "--Protocol:All,config single mac address: xx:xx….xx,action:Drop,other use default value")
    public void step3() {
