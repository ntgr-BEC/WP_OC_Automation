...
public class TestCase extends TestCaseBase implements Config {
    ...
    String tmpStr;
    final static Logger logger = Logger.getLogger("BR_T683");
    public String sTestStr = "BR_T683";
    ...
    @Story("BR_T683") // 对应testrunkey
    @Description("129-TrafficRules-LAN to WAN-Drop the traffic match single destination port") // 对应用例名字
    @TmsLink("1461359") // 对应用例详情页的URL最后几位数字
  ...
  @Step("Test Step 1: Open Device")
   ...
   @Step("Test Step 2:Config LAN to WAN rule1:\r\n" + 
           "--Protocol:all,des port to:1000,action:Drop,other use default value")
    public void step2() {
