...
public class TestCase extends TestCaseBase implements Config {
    ...
    String tmpStr;
    final static Logger logger = Logger.getLogger("BR_T741");
    public String sTestStr = "BR_T741";
    ...
    @Story("BR_T741") // 对应testrunkey
    @Description("181-TrafficRules-Delete multiple rules at same time") // 对应用例名字
    @TmsLink("1471685") // 对应用例详情页的URL最后几位数字
  ...
  @Step("Test Step 1: Open Device")
   ...
   @Step("Test Step 2:Add firewall rule1.")
    public void step2() {
