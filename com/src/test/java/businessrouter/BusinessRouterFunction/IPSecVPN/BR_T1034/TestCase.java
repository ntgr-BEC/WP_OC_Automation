...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1034";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1034") // 对应testrunkey
    @Description("003-Establish gateway to gateway VPN tunnel in IKE policy with 8 char pre-shared key") // 对应用例名字
    @TmsLink("1514017") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy and the Pre-shared key: 8 Char")
    public void step2() {
