package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1035;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1035";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1035") // 对应testrunkey
    @Description("004-Establish gateway to gateway VPN tunnel in IKE policy with 128 chars pre-shared key") // 对应用例名字
    @TmsLink("1514018") // 对应用例详情页的URL最后几位数字
