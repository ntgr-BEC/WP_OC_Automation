package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1036;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1036";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1036") // 对应testrunkey
    @Description("013-Establish gateway to gateway VPN tunnel in IKE policy with 1 char policy name") // 对应用例名字
    @TmsLink("1514019") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy with 1 char policy name")
    public void step2() {
