package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1039;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1039";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1039") // 对应testrunkey
    @Description("006-Delete multi vpn Policy") // 对应用例名字
    @TmsLink("1514022") // 对应用例详情页的URL最后几位数字
    ...
    public void step3() {
        boolean Result1 = false; 
        bripsecvpnpage.DeleteOneVpnPolicyRules(DUTIPSecPolicy.get("Policy Name"));
        ...
        bripsecvpnpage.DeleteOneVpnPolicyRules(DUTIPSecPolicy2.get("Policy Name"));
        Result1 = bripsecvpnpage.VpnPolicyRulesExistOrNot(DUTIPSecPolicy2.get("Policy Name"));
        if (Result1 == false) {
            micResult =  true;
            assertTrue(micResult, "Pass: Delete the IPsec VPN Policy successfully!"  );             
        } else {
