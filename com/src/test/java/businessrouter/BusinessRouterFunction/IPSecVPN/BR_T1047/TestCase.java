package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1047;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1047";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1047") // 对应testrunkey
    @Description("028-Establish IPSec VPN gateway to gateway tunnel: Traffic Selection: local Subnet to remote Subnet") // 对应用例名字
    @TmsLink("1514030") // 对应用例详情页的URL最后几位数字
    ...
    public void step5() {
       ...
       //     micResult =  true;
       //     assertTrue(micResult,"Pass:Can't access internet when vpn tunnel is up!"  );             
        //} else {
       //     micResult =  false;
        //    assertTrue(micResult,"Failed:Can access internet when vpn tunnel is up!!"  );
       // }
     }
