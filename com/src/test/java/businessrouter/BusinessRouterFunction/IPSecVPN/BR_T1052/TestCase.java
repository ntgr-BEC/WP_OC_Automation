package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1052;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1052";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1052") // 对应testrunkey
    @Description("033-Establish IPSec VPN gateway to gateway tunnel: pre-shared key not match") // 对应用例名字
    @TmsLink("1514035") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 3: Add DUT2 IPsec VPN Policy, but pre-shared key not match ")
    public void step3() {
        boolean Result1 = false; 
    ...
    @Step("Test Step 4: Check that VPN tunnel is down ")
    public void step4() {
        boolean Result1 = false; 
        handle.sleepi(20);
        bripsecvpnpage.OpenIPSecVPNPage();
