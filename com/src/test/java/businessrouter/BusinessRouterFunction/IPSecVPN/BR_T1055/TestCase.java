package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1055;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1055";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1055") // 对应testrunkey
    @Description("036-Edit VPN Policy, change local/remote subnet") // 对应用例名字
    @TmsLink("1514038") // 对应用例详情页的URL最后几位数字
    ...
    public void step1() {
      // MyCommonAPIs.sleepi(30);
       ...
       // Result1 = bripsecvpnpage.EditIPSecVPNPolicy(DUT1EditIPSecPolicy);
    }
    @Step("Test Step 2: Edit VPN policy:pre-shared key edit to !@#$%^&* ")
    public void step2() {
        boolean Result1 = false; 
        ...
        if (Result1 == true) {
            micResult =  true;
            assertTrue(micResult, "Pass:Edit DUT1 IPsec VPN Policy successfully!"  );             
        } else {
            micResult =  false;
            assertTrue(micResult, "Failed:Edit DUT1 IPsec VPN Policy unsuccessfully!!"  );
        }
        brlogin.BrLogout();
