package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1056;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1056";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1056") // 对应testrunkey
    @Description("045-Disable one VPN Policy") // 对应用例名字
    @TmsLink("1514039") // 对应用例详情页的URL最后几位数字
    ...
    public void step2() {
        ...
        //bripsecvpnpage.DisableOrEnableIPSecVPNPolicy(DUT1IPSecPolicy.get("Policy Name"));
        bripsecvpnpage.EditIPSecVPNPolicy(DUTEditIPSecPolicy);
        brlogin.BrLogout();
    ...
    public void step4() {
        ...
        if (Result1 == false) {
            ...
            micResult =  false;
            assertTrue(micResult, "Failed:VPN tunnel status is on!"  );
        }
        //brlogin.BrLogout();     
     }
