package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1072;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1072";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1072") // 对应testrunkey
    @Description("061-IPSec preshared key check after reboot DUT") // 对应用例名字
    @TmsLink("1517416") // 对应用例详情页的URL最后几位数字
