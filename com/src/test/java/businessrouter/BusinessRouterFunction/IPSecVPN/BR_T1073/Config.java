package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1073;
    ...
    public static Map<String, String> DUT1IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put ("proposal1","sha1-aes256-dh5");
            put ("proposal2","md5-aes128-dh1");
            put ("proposal3","md5-aes128-dh2");
            put ("proposal4","md5-aes128-dh5");
    ...
    public static Map<String, String> DUT2IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put("Local Mask", "255.255.255.0");
            put ("proposal1","md5-aes192-dh1");
            put ("proposal2","md5-aes192-dh2");
            put ("proposal3","md5-aes192-dh5");
            put ("proposal4","sha1-aes256-dh5");
            put("PreShared Key", "12345678");
