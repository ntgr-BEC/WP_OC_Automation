package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1074;
    ...
    public static Map<String, String> DUT1IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put ("proposal1","sha1-aes192-dh1");
            put ("proposal2","sha1-aes192-dh2");
            put ("proposal3","sha1-3des-dh1");
            put ("proposal4","sha1-3des-dh2");
    ...
    public static Map<String, String> DUT2IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put("Local Mask", "255.255.255.0");
            put ("proposal1","md5-aes256-dh1");
            put ("proposal2","md5-aes256-dh2");
            put ("proposal3","sha1-aes192-dh1");
            put ("proposal4","sha1-aes192-dh2");
            put("PreShared Key", "12345678");
