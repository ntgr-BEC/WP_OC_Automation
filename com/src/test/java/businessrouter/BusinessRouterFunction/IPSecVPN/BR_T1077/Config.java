    ...
    public static Map<String, String> DUT1IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put ("proposal1","md5-3des-dh1");
            put ("proposal2","md5-3des-dh2");
            put ("proposal3","md5-3des-dh5");
            put ("proposal4","md5-aes128-dh1");
    ...
    public static Map<String, String> DUT2IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put("Local Mask", "255.255.255.0");
            put ("proposal1","sha1-3des-dh1");
            put ("proposal2","sha1-3des-dh2");
            put ("proposal3","sha1-3des-dh5");
            put ("proposal4","sha1-aes128-dh1");
            put("PreShared Key", "12345678");
