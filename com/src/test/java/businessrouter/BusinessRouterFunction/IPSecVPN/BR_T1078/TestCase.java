package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1078;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1078";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1078") // 对应testrunkey
    @Description("067-Phase-1 Settings:Only config 1 proposal") // 对应用例名字
    @TmsLink("1517422") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy with Only config 1 proposal ")
    public void step2() {
    ...
    @Step("Test Step 3: Add DUT2 IPsec VPN Policy with Only config 1 proposal ")
    public void step3() {
        boolean Result1 = false; 
