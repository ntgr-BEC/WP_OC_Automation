package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1080;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1080";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1080") // 对应testrunkey
    @Description("069-Phase-1 Settings:Establish vpn after edit proposal") // 对应用例名字
    @TmsLink("1517424") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy with 1 proposal")
    public void step2() {
        boolean Result1 = false; 
    ...
    @Step("Test Step 3: Add DUT2 IPsec VPN Policy with 1 proposal")
    public void step3() {
        boolean Result1 = false; 
    ...
    @Step("Test Step 5: edit phase-1 setting on DUT1 and DUT2:\r\n" + 
            "proposal1:md5-3des-dh2 ")
    public void step5() {
        boolean Result1 = false; 
        ...
        if (Result1 == true) {
            micResult =  true;
            assertTrue(micResult, "Pass:edit phase-1 setting on DUT2:\"proposal1:md5-3des-dh2 successfully!"  );             
        } else {
            micResult =  false;
            assertTrue(micResult, "Failed:edit phase-1 setting on DUT2:\\\"proposal1:md5-3des-dh2 unsuccessfully!"  );
        }
        brlogin.BrLogout(); 
        ...
        if (Result1 == true) {
            micResult =  true;
            assertTrue(micResult, "Pass:edit phase-1 setting on DUT1 :\"proposal1:md5-3des-dh2 successfully!"  );             
        } else {
            micResult =  false;
            assertTrue(micResult, "Failed:edit phase-1 setting on DUT1 :\\\"proposal1:md5-3des-dh2 unsuccessfully!"  );
        }
     }
