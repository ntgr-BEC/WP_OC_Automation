package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1083;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1083";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1083") // 对应testrunkey
    @Description("072-Establish VPN tunnel use different IKE policy: In DUT1, Exchange Mode: Aggressive; In DUT2, Exchange Mode: Main;") // 对应用例名字
    @TmsLink("1517427") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy with Exchange Mode \"Main Mode\" ")
    public void step2() {
    ...
    @Step("Test Step 3: Add DUT2 IPsec VPN Policy with Exchange Mode \"Aggressive Mode\"")
    public void step3() {
        boolean Result1 = false; 
