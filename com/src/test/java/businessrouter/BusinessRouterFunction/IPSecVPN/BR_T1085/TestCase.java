package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1085;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1085";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1085") // 对应testrunkey
    @Description("074-Establish gateway to gateway VPn tunnel: nogotiation mode is responder") // 对应用例名字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy with Direction / Type: Responder")
    public void step2() {
