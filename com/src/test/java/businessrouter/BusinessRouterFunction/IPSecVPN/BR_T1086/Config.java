package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1086;
    ...
    public static Map<String, String> DUT1IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put ("ph2proposal2","esp-sha512-3des");
    ...
    public static Map<String, String> DUT2IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put ("ph2proposal2","esp-sha256-des");
            put ("ph2proposal3","esp-sha1-3des");
            put ("ph2proposal4","esp-md5-3des");
            put("PreShared Key", "12345678");
