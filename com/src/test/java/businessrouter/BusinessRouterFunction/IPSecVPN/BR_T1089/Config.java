    ...
    public static Map<String, String> DUT1IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put ("ph2proposal1","esp-sha1-3des");
            put ("ph2proposal2","esp-sha1-aes256");
            put ("ph2proposal3","esp-sha1-aes128");
            put ("ph2proposal4","esp-sha1-aes192");
    ...
    public static Map<String, String> DUT2IPSecPolicy = new HashMap<String, String>() {
        {
            ...
            put("Local Mask", "255.255.255.0");
            put ("ph2proposal1","esp-sha1-aes256");
            put ("ph2proposal2","esp-sha1-aes128");
            put ("ph2proposal3","esp-sha1-aes192");
            put ("ph2proposal4","esp-sha1-3des");
            put("PreShared Key", "12345678");
