package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1089;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1089";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1089") // 对应testrunkey
    @Description("077-Phase-2 Settings:config 4 proposal,4 is same between dut1 and dut2") // 对应用例名字
    @TmsLink("1517433") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy with onfig 4 proposal,4 is same between dut1. ")
    public void step2() {
    ...
    @Step("Test Step 3: Add DUT2 IPsec VPN Policy with onfig 4 proposal,4 is same between dut2. ")
    public void step3() {
        boolean Result1 = false; 
