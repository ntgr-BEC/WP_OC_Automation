package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1092;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1092";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1092") // 对应testrunkey
    @Description("080-Phase-2 Settings:Only config 1 proposal,it is different between 2 devices") // 对应用例名字
    @TmsLink("1517436") // 对应用例详情页的URL最后几位数字
