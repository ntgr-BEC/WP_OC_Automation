package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1101;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1101";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1101") // 对应testrunkey
    @Description("089-PFS is dh1") // 对应用例名字
    @TmsLink("1517445") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy ,PFS is dh1  ")
    public void step2() {
