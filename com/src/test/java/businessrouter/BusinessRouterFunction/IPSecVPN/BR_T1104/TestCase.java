package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1104;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1104";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1104") // 对应testrunkey
    @Description("092-PFS is different between 2 DUT") // 对应用例名字
    @TmsLink("1517448") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 3: Add DUT2 IPsec VPN Policy,PFS is dh1")
    public void step3() {
        boolean Result1 = false; 
    ...
    @Step("Test Step 4: Check VPN tunnel isn't up")
    public void step4() {
        boolean Result1 = false; 
        handle.sleepi(20);
        bripsecvpnpage.OpenIPSecVPNPage();
