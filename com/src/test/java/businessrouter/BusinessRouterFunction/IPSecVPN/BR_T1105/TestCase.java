package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1105;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1105";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1105") // 对应testrunkey
    @Description("094-The IPSec vpn work normally after restore configuration") // 对应用例名字
    @TmsLink("1519753") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Add DUT1 IPsec VPN Policy ,PFS is dh2  ")
    public void step2() {
    ...
    @Step("Test Step 3: Add DUT2 IPsec VPN Policy,PFS is dh2")
    public void step3() {
        boolean Result1 = false; 
    ...
    @Step("Test Step 5:Backup configuration on one device and Delete the vpn policy,then restore the configuration file")
    public void step5() {
    ...
    @Step("Test Step 6: Check VPN tunnel is normally ")
    public void step6() {
        boolean Result1 = false; 
        handle.sleepi(10);
        bripsecvpnpage.OpenIPSecVPNPage();
