package businessrouter.BusinessRouterFunction.IPSecVPN.BR_T1501;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T1051";
    public String sCurrentValue;
    public String sExpectedtValue;
    // public String sOldSW = WebportalParam.sw1IPaddress;

    @Feature("IPSec VPN") // 必须要加，对应目录名
    @Story("BR_T1051") // 对应testrunkey
    @Description("032-Establish IPSec VPN gateway to gateway tunnel:DUT1 enable policy and DUT2 disable") // 对应用例名字
    @TmsLink("1514034") // 对应用例详情页的URL最后几位数字
