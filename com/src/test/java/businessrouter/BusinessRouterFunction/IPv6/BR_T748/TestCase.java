package businessrouter.BusinessRouterFunction.IPv6.BR_T748;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T748";
    ...
    final static Logger logger = Logger.getLogger("BR_T748");
    @Feature("Business Router.IPv6") // 必须要加，对应目录名
    @Story("BR_T748") // 对应testrunkey
    @Description("002-IPv6 - Auto Detect - DHCP") // 对应用例名A字
    @TmsLink("1474875") // 对应用例详情页的URL最后几位数字
