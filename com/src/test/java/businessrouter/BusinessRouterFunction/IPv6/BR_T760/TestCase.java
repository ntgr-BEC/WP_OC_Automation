package businessrouter.BusinessRouterFunction.IPv6.BR_T760;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T760";
    ...
    final static Logger logger = Logger.getLogger("BR_T760");
    @Feature("Business Router.IPv6") // 必须要加，对应目录名
    @Story("BR_T760") // 对应testrunkey
    @Description("014-IPv6-Lan configuration is Auto config") // 对应用例名A字
    @TmsLink("1474887") // 对应用例详情页的URL最后几位数字
