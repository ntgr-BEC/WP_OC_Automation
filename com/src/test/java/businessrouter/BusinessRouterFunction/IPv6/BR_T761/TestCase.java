package businessrouter.BusinessRouterFunction.IPv6.BR_T761;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T761";
    ...
    final static Logger logger = Logger.getLogger("BR_T761");
    @Feature("Business Router.IPv6") // 必须要加，对应目录名
    @Story("BR_T761") // 对应testrunkey
    @Description("015-IPv6-Lan configuration is DHCP") // 对应用例名A字
    @TmsLink("1474888") // 对应用例详情页的URL最后几位数字
