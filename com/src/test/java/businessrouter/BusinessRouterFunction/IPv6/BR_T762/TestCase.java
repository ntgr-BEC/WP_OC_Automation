...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T762";
    ...
    final static Logger logger = Logger.getLogger("BR_T762");
    @Feature("Business Router.IPv6") // 必须要加，对应目录名
    @Story("BR_T762") // 对应testrunkey
    @Description("016-IPv6-Config LAN Use the Interface ID") // 对应用例名A字
    @TmsLink("1474889") // 对应用例详情页的URL最后几位数字
      ...
      @Step("Test Step 2:Enable IPv6 DHCP server for WAN, add prefix delegation for LAN .")
       ...
       @Step("Test Step 3: Set IPv6 connection type to DHCP.")
        public void step3() {
           ...
           bripv6page.OpenAdvancedIPv6Page();
           handle.sleepi(15);
           bripv6page.SetIPv6ConnectionTypeAndInterfaceID(Ipv6Info);
           handle.sleepi(50);
       ...
       public void step4() {
          ...
          if (LanPcIpv6Addr.indexOf("3333::") != -1) {
              micResult =  true;
