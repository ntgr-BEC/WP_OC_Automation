package businessrouter.BusinessRouterFunction.Security_Schedule.BR_T71;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T71";
    public String sCurrentValue;
    public String sExpectedtValue;

    @Feature("Business Router.Security_Schedule") // 必须要加，对应目录名
    @Story("BR_T71") // 对应testrunkey
    @Description("003-Schedule - Every Day") // 对应用例名字
    @TmsLink("1455074") // 对应用例详情页的URL最后几位数字
