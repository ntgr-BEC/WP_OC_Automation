...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T388";
    public String sCurrentValue;
    public String sExpectedtValue;
   // public String sOldSW   = WebportalParam.sw1IPaddress;
    
        @Feature("Business Router.Setup LAN") // 必须要加，对应目录名
        @Story("BR_T388") // 对应testrunkey
        @Description("001-LAN setup - Address Reservation - Add)") // 对应用例名字
        ...
        @Step("Test Step 2: Add a record to the address reservation table")
        public void step2() {
            ...
            if (Result == true ) {
                micResult =  true;
                assertTrue(micResult,"Pass:Add a record to the address reservation table successfully!"  );             
            } else {
                micResult =  false;
                assertTrue(micResult,"Failed:Add a record to the address reservation table unsuccessfully!"  );
            }
         }
