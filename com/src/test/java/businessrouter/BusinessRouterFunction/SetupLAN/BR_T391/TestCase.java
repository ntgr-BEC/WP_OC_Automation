package businessrouter.BusinessRouterFunction.SetupLAN.BR_T391;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T391";
    public String sCurrentValue;
    public String sExpectedtValue;
   // public String sOldSW   = WebportalParam.sw1IPaddress;
    
        @Feature("Business Router.Setup LAN") // 必须要加，对应目录名
        @Story("BR_T391") // 对应testrunkey
        @Description("004-LAN setup - Address Reservation - MAX rules(253 entries for 128MB RAM or more, else 64 entries)") // 对应用例名字
