package businessrouter.BusinessRouterFunction.SetupLAN.BR_T399;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    String                       tmpStr;
    final static Logger logger = Logger.getLogger("BR_T399");
    public String sTestStr = "BR_T399";
    public String sCurrentValue;
    public String sExpectedtValue;
   // public String sOldSW   = WebportalParam.sw1IPaddress;
    
        @Feature("Business Router.Setup LAN") // 必须要加，对应目录名
        @Story("BR_T399") // 对应testrunkey
        @Description("012-LAN setup - Change LAN subnet IP under DHCP") // 对应用例名字
        @TmsLink("1455420") // 对应用例详情页的URL最后几位数字
        ...
        public void step3() {
            ...
            //brlansetuppage.OpenBasicLanSetupPage();
            handle.sleepi(8); 
            String NewLanIp1 = Brtmspage.GetNewIPAddress(WebportalParam.brlanclientip);
            String NewLanIp = Brtmspage.GetNewIPAddress(NewLanIp1);
