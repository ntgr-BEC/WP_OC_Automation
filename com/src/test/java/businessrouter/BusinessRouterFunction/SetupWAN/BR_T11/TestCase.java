package businessrouter.BusinessRouterFunction.SetupWAN.BR_T11;
...
public class TestCase extends TestCaseBase implements Config {
   ...
   // public String sOldSW   = WebportalParam.sw1IPaddress;
        ...
        @Story("BR_T11") // 对应testrunkey
        @Description("007-Config WAN use PPTP Always on") // 对应用例名字
        @TmsLink("1455014") // 对应用例详情页的URL最后几位数字
