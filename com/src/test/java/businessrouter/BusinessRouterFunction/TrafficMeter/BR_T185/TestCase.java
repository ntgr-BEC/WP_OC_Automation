package businessrouter.BusinessRouterFunction.TrafficMeter.BR_T185;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T185";
    public String sCurrentValue;
    public String sExpectedtValue;

    @Feature("Business Router.TrafficMeter") // 必须要加，对应目录名
    @Story("BR_T185") // 对应testrunkey
    @Description("002-Verify the traffic volume conntrol of \"both directions\" can take effect.") // 对应用例名字
    @TmsLink("1455188") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Traffic volume conntrol set to \"both directions\" ,monthly limit set to 50M,warning message set 10M,Check warning message.")
    public void step2() {
        ...
        BrAdvancedTrafficMeterPage.ConfigTrafficVolumeControl("Both directions", "50");
        ...
        if (BrAdvancedTrafficMeterPage.CheckWarningPage()) {
            micResult = true;
            assertTrue(micResult, "Pass:Warning message pop up.");
        } else {
            micResult = false;
