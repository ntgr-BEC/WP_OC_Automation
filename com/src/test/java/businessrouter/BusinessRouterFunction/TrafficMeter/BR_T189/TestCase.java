package businessrouter.BusinessRouterFunction.TrafficMeter.BR_T189;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    public String sTestStr = "BR_T189";
    public String sCurrentValue;
    public String sExpectedtValue;

    @Feature("Business Router.TrafficMeter") // 必须要加，对应目录名
    @Story("BR_T189") // 对应testrunkey
    @Description("006-Traffic Meter - Logs check - Pop up a message before reach monthly limit") // 对应用例名字
    @TmsLink("1455192") // 对应用例详情页的URL最后几位数字
    ...
    @Step("Test Step 2: Traffic volume conntrol set to \"both directions\" ,monthly limit set to 50M,warning message set 10M,Check logs.")
    public void step2() {
        ...
        if (BrAdvancedLogsPage.checkLogoutput("The counter is 10 MBytes before the monthly limit is reached")) {
            micResult = true;
