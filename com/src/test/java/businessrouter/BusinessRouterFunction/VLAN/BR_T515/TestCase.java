package businessrouter.BusinessRouterFunction.VLAN.BR_T515;
...
public class TestCase extends TestCaseBase implements Config {
    ...
    final static Logger logger = Logger.getLogger("BR_T515");
    public String sTestStr = "BR_T515";
    ...
    @Story("BR_T515") // 对应testrunkey
    @Description("028-Delete Address Reservation") // 对应用例名字
    @TmsLink("1458422") // 对应用例详情页的URL最后几位数字
  ...
  public void step4() {
       ...
       handle.sleepi(10);
       if (LanPcNewIP2.length() > 0) {
           System.out.print("dddddddddddd222111");
           Result = true;
       }
       if (Result == true) {
           micResult =  true;
           assertTrue(micResult,"Pass:PC can get any ip address in this lan successfully!"  );             
       } else {
           micResult =  false;
           assertTrue(micResult,"Failed:PC can get any ip address in this lanunsuccessfully!"  );
       }
       Brtmspage.ChangeBrowserHandles(HistroyHandle);
