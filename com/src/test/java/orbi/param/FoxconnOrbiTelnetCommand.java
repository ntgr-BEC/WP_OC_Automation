 ...
 *
 */
public class FoxconnOrbiTelnetCommand {
    //Device details info:
    public final static Map<String, String> FoxconnOrbiTelnetCommandMap = new HashMap<String, String>() {
        /**
         * 
         */
    ...
    public String FoxconnOrbiSetRegion (String region) {
