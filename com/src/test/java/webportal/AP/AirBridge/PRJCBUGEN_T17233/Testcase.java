package webportal.AP.AirBridge.PRJCBUGEN_T17233;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17233") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the default state of the Airbridge mode is enabled") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T17233") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Verify the default state of the Airbridge mode is enabled")
    public void step2() {
        ...
        MyCommonAPIs.waitReady();
        assertTrue(wabg.getAirBridgeMode(), "check aribridge mode is enabled by default");
    }
}
