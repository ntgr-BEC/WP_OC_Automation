package webportal.AP.AirBridge.PRJCBUGEN_T18425;
...
public class Testcase extends TestCaseBase {
    String abGroupName = "grp18425";

    @Feature("AP.AirBridge") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18425") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify validation check for air bridge group name, SSID name while creating air bridge group") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18425") // It's a testcase id/link from Jira Test Case.
