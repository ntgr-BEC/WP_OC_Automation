package webportal.AP.AirBridge.PRJCBUGEN_T19400;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19400") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if the P2P bridge link connection remains established upon changing the air bridge SSID name") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19400") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(wabg.isDeviceConnected(WebportalParam.ap2deveiceName),
                "The bridge link should break and re-establish after changing the SSID name");
    }
}
