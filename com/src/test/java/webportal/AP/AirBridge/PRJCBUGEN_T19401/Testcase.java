package webportal.AP.AirBridge.PRJCBUGEN_T19401;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19401") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if the P2P bridge link connection remains established upon changing the air bridge SSID password") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19401") // It's a testcase id/link from Jira Test Case.
