package webportal.AP.AirBridge.PRJCBUGEN_T19402;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19402") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if the P2P bridge link connection remains established upon changing the air bridge group channel number") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19402") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: 10. Change the air bridge channel number")
    public void step2() {
        WirelessAirBridgeGroupsPage wabg = new WirelessAirBridgeGroupsPage();
        wabg.gotoPage();
        wabg.abGroupData.name = null;
        wabg.abGroupData.channelNumber = null;
        ...
        assertTrue(wabg.isDeviceConnected(WebportalParam.ap2deveiceName),
                "The bridge link should break and re-establish after changing the channel number");
    }
}
