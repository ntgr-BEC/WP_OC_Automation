package webportal.AP.InstantWifi.PRJCBUGEN_T12068;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T12068") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify AP trigger Instant WiFi. is working or not when channel width is non default such as (20,40,80 MHz )") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T12068") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp12068");
    }
