package webportal.AP.InstantWifi.PRJCBUGEN_T18181;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "Switzerland";
    ...
    @Description("verify in instant Wifi by click on optimize  now button for Switzerland with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
