package webportal.AP.InstantWifi.PRJCBUGEN_T18183;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "United States of America";
    ...
    @Story("PRJCBUGEN_T18183") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify in instant Wifi by click on optimize  now button for US with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18183") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to United States of America")
    public void step2() {
