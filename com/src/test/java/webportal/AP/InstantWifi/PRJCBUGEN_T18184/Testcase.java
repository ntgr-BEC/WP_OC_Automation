package webportal.AP.InstantWifi.PRJCBUGEN_T18184;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18184") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify in instant Wifi by click on optimize  now button for UK with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18184") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to Uk")
    public void step2() {
