package webportal.AP.InstantWifi.PRJCBUGEN_T18190;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "New Zealand";
    ...
    @Description("verify in instant Wifi by click on optimize  now button for New Zealand with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to New Zealand")
    public void step2() {
