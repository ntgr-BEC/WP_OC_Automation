package webportal.AP.InstantWifi.PRJCBUGEN_T18191;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "Luxembourg";
    ...
    @Description("verify in instant Wifi by click on optimize  now button for Luxembourg with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to Luxembourg")
    public void step2() {
