package webportal.AP.InstantWifi.PRJCBUGEN_T18194;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify in instant Wifi by click on optimize  now button for Finland with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to Finland")
    public void step2() {
