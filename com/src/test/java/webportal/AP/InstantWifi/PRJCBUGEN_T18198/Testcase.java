package webportal.AP.InstantWifi.PRJCBUGEN_T18198;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "Lithuania";
    ...
    @Description("verify in instant Wifi by click on optimize  now button for Lithuania with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to Lithuania")
    public void step2() {
