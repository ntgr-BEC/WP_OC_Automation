package webportal.AP.InstantWifi.PRJCBUGEN_T18199;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "Netherlands";
    ...
    @Description("verify in instant Wifi by click on optimize  now button for Netherlands with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to Netherlands")
    public void step2() {
