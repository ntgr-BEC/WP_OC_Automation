package webportal.AP.InstantWifi.PRJCBUGEN_T18200;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify in instant Wifi by click on optimize  now button for Poland with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to Poland")
    public void step2() {
