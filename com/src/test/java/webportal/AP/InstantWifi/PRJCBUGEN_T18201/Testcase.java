package webportal.AP.InstantWifi.PRJCBUGEN_T18201;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "Portugal";
    ...
    @Description("verify in instant Wifi by click on optimize  now button for Portugal with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to Portugal")
    public void step2() {
