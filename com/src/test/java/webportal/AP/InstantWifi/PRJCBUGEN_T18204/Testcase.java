package webportal.AP.InstantWifi.PRJCBUGEN_T18204;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "South Africa";
    ...
    @Description("verify in instant Wifi by click on optimize  now button for South Africa with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to South Africa")
    public void step2() {
