package webportal.AP.InstantWifi.PRJCBUGEN_T18205;
...
public class Testcase extends TestCaseBase {
    String              WirelessRegion = "Singapore";
    ...
    @Description("verify in instant Wifi by click on optimize  now button for Singapore with non default channel width in  all radio (cloned)") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Set wireless region to Singapore")
    public void step2() {
