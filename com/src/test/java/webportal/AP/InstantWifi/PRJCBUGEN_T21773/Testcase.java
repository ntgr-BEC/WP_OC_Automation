package webportal.AP.InstantWifi.PRJCBUGEN_T21773;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21773") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify optimize now is working or not when channel width for 2.4 Ghz is changed to 20 MHZ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21773") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21773");
    }
