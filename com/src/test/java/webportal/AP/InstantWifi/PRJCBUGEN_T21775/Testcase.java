package webportal.AP.InstantWifi.PRJCBUGEN_T21775;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21775") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify optimize now is working or not when channel width for 5 Ghz high is changed to 40 MHZ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21775") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21775");
    }
    ...
    public void step2() {
        ...
        ssidInfo.put("SSID", "apwp21775");
        ssidInfo.put("Security", "WPA/WPA2-PSK");
        ssidInfo.put("Password", "123456798");
        new WirelessQuickViewPage().addSsid(ssidInfo);

        new DevicesDashPage().enterDevice(WebportalParam.ap1serialNo);
        channelInfo.put("5GHz high channel width", "40MHz");
        new DevicesApRadioAndChannelsPage().configRadioAndChannel(channelInfo);
