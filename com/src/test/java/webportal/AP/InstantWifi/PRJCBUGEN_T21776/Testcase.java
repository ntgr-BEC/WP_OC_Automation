package webportal.AP.InstantWifi.PRJCBUGEN_T21776;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21776") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify optimize now is working or not when channel width for 5 Ghz is changed to 20 MHZ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21776") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21776");
    }
    ...
    public void step2() {
        ...
        ssidInfo.put("SSID", "apwp21776");
        ssidInfo.put("Security", "WPA/WPA2-PSK");
        ssidInfo.put("Password", "123456798");
        new WirelessQuickViewPage().addSsid(ssidInfo);

        new DevicesDashPage().enterDevice(WebportalParam.ap1serialNo);
        channelInfo.put("5GHz channel width", "20MHz");
        new DevicesApRadioAndChannelsPage().configRadioAndChannel(channelInfo);
