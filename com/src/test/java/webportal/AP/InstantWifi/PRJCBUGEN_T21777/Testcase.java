package webportal.AP.InstantWifi.PRJCBUGEN_T21777;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21777") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify optimize now is working or not when channel width for 5 Ghz is changed to 40 MHZ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21777") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21777");
    }
