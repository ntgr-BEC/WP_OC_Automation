package webportal.AP.InstantWifi.PRJCBUGEN_T21780;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21780") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T21780") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21780");
    }
    ...
    public void step2() {
        ...
        ssidInfo.put("SSID", "apwp21780");
        ssidInfo.put("Security", "WPA/WPA2-PSK");
        ssidInfo.put("Password", "123456798");
        new WirelessQuickViewPage().addSsid(ssidInfo);

        new DevicesDashPage().enterDevice(WebportalParam.ap1serialNo);
        channelInfo.put("5GHz high channel width", "80MHz");
        new DevicesApRadioAndChannelsPage().configRadioAndChannel(channelInfo);
