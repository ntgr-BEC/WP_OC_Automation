package webportal.AP.SsidOnOrOffBySchedule.PRJCBUGEN_T15988;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15988") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if the user can check details of created schedule in WiFi Schedules page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15988") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteWifiSchedulesYes("scheduled15988");
    }
    ...
    public void step2() {
        ...
        scheduleInfo.put("Schedule Name", "scheduled15988");
