...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16062") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that WiFi scheduler option is available for Read only User") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16062") // It's a testcase id/link from Jira Test Case.
