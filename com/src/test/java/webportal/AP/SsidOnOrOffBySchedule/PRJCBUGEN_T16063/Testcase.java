package webportal.AP.SsidOnOrOffBySchedule.PRJCBUGEN_T16063;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16063") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether WiFi Scheduler option is available to Read & Write Manager account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16063") // It's a testcase id/link from Jira Test Case.
