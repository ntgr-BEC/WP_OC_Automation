package webportal.AP.SsidOnOrOffBySchedule.PRJCBUGEN_T22239;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22239") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user can create maximum 3 slots per day") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22239") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteWifiSchedulesYes("scheduled22239");
    }
...
//        new DevicesDashPage().checkDeviceInAdminAccount();
    ...
    public void step2() {
        ...
        scheduleInfo.put("Schedule Name", "scheduled22239");
        ...
        new WirelessQuickViewPage(false).plusSlot.click();
        new WirelessQuickViewPage(false).strtpickbtn2.click();
        new WirelessQuickViewPage(false).upbtn.click();
        new WirelessQuickViewPage(false).upbtn.click();
        new WirelessQuickViewPage(false).okbtn1.click();
        new WirelessQuickViewPage(false).endpickbtn2.click();
        new WirelessQuickViewPage(false).upbtn.click();
        new WirelessQuickViewPage(false).upbtn.click();
        new WirelessQuickViewPage(false).upbtn.click();
        new WirelessQuickViewPage(false).okbtn1.click();
        ...
        boolean result = !new WirelessQuickViewPage(false).plusSlot.exists();

        new WirelessQuickViewPage(false).editschedulesave.click();
        MyCommonAPIs.waitReady();
        MyCommonAPIs.sleepi(5);
        assertTrue($x("//h6[text()='" + scheduleInfo.get("Schedule Name") + "']").isDisplayed()
                && $x("//*[text()='3 slot(s) in 1 day(s)']").exists() && result, "Wifi schedules option error.");
    }
