package webportal.AP.SsidOnOrOffBySchedule.PRJCBUGEN_T22242;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22242") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user can edit the created SSID schedule slots") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22242") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteWifiSchedulesYes("scheduled22242");
    }
    ...
    public void step2() {
        ...
        scheduleInfo.put("Schedule Name", "scheduled22242");
        ...
        if ($x("//h6[text()='" + scheduleInfo.get("Schedule Name") + "']").isDisplayed() && $x("//*[text()='1 slot(s) in 1 day(s)']").exists()) {
            ...
            assertTrue(
                    $x("//h6[text()='" + scheduleInfo.get("Schedule Name") + "']").exists() && $x("//*[text()='2 slot(s) in 1 day(s)']").exists(),
