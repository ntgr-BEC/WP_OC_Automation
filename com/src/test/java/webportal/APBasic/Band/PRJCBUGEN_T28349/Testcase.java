package webportal.APBasic.Band.PRJCBUGEN_T28349;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28349") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Open Security for ALL Band") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T28349") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp28349");
...
//            if (new Javasocket()
//                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp28349")
//                    .indexOf("true") != -1) {
//                break;
//            } else if (sum > 30) {
...
//        if (!new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFopenconnect apwp28349")
//                .equals("true")) {
//            result1 = false;
//            if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFopenconnect apwp28349")
//                    .equals("true")) {
