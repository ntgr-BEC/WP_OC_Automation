package webportal.APBasic.Band.PRJCBUGEN_T28350;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28350") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify WPA3 Personal Security for ALL Band") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T28350") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp28350");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp28350");
...
//            if (new Javasocket()
//                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp28350")
//                    .indexOf("true") != -1) {
//                break;
//            } else if (sum > 30) {
...
//        if (!new Javasocket()
//                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp28350 123456798 WPA3SAE aes")
//                .equals("true")) {
//            result1 = false;
//            if (new Javasocket()
//                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp28350 123456798 WPA3SAE aes")
