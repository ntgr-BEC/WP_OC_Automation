package webportal.APBasic.Band.PRJCBUGEN_T28352;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28352") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Open Security for 6Ghz Band") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T28352") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp28352");
...
//        new DevicesDashPage().checkDeviceInNormalAccount("admin"); //must input admin or manager
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp28352");
        locationInfo.put("Security", "Open");
        locationInfo.put("Band", "check only 6ghz");
...
//            if (new Javasocket()
//                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp28352")
//                    .indexOf("true") != -1) {
//                break;
//            } else if (sum > 30) {
...
//        if (!new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFopenconnect apwp28352")
//                .equals("true")) {
//            result1 = false;
//            if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFopenconnect apwp28352")
//                    .equals("true")) {
