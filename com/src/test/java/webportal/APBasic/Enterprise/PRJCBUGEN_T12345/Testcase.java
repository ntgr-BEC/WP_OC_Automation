package webportal.APBasic.Enterprise.PRJCBUGEN_T12345;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify WPA2 Enterprise Security as non-pro admin") // It's a testcase title from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp123459");
...
//        new DevicesDashPage().checkDeviceInNormalAccount("admin"); //must input admin or manager
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp123459");
        ...
        new WirelessQuickViewPage().addSsid1(locationInfo);
         ...
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo nmcli device wifi list | grep -F \"apwp123459\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli c add type wifi con-name \"apwp123459\" ifname wlp4s0 ssid \"apwp123459\"");      
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection modify \"apwp123459\" wifi-sec.key-mgmt wpa-eap 802-1x.eap peap 802-1x.phase2-auth mschapv2 802-1x.identity \"teju\" 802-1x.password \"teju\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection up \"apwp123459\"");
