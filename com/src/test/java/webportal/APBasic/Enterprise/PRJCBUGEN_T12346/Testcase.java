package webportal.APBasic.Enterprise.PRJCBUGEN_T12346;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("ENT Windows") // It's a folder/component name to make test suite more readable from Jira Test Case.
...
//        new WirelessQuickViewPage().addSsid1(locationInfo);
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFradiusconnect apwp14270 teju teju WPA2 AES")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFradiusconnect apwp14270 teju teju WPA2 AES")
