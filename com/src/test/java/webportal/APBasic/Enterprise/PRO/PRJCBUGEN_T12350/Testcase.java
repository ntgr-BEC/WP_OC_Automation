package webportal.APBasic.Enterprise.PRO.PRJCBUGEN_T12350;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify both Band and CI with WPA2 Enterprise Security as pro admin") // It's a testcase title from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp12350");
...
//        new DevicesDashPage().checkDeviceInNormalAccount("admin"); //must input admin or manager
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp12350");
        ...
        assertTrue(new WirelessQuickViewPage().AddDomainisenabled(locationInfo.get("SSID")), "add button is not disabled");
         ...
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo nmcli device wifi list | grep -F \"apwp12350\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli c add type wifi con-name \"apwp12350\" ifname wlp4s0 ssid \"apwp12350\"");      
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection modify \"apwp12350\" wifi-sec.key-mgmt wpa-eap 802-1x.eap peap 802-1x.phase2-auth mschapv2 802-1x.identity \"teju\" 802-1x.password \"teju\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection up \"apwp12350\"");
