package webportal.APBasic.Enterprise.PRO.PRJCBUGEN_T12354;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T12354") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify both Band and Fast roaming with WPA3 Enterprise Security as pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T12354") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp12354");
...
//        new DevicesDashPage().checkDeviceInNormalAccount("admin"); //must input admin or manager
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp12354");
      ...
      //Test Step 3: enable 802.11kvr
        new WirelessQuickViewPage().enable80211(locationInfo.get("SSID"));
         ...
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo nmcli device wifi list | grep -F \"apwp12354\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli c add type wifi con-name \"apwp12354\" ifname wlp4s0 ssid \"apwp12354\"");      
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection modify \"apwp12354\" wifi-sec.key-mgmt wpa-eap 802-1x.eap peap 802-1x.phase2-auth mschapv2 802-1x.identity \"teju\" 802-1x.password \"teju\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection up \"apwp12354\"");
