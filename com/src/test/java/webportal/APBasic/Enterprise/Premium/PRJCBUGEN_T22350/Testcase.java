package webportal.APBasic.Enterprise.Premium.PRJCBUGEN_T22350;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify both Band and CI with WPA2 Enterprise Security as premium user") // It's a testcase title from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp22350");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp22350");
        ...
        assertTrue(new WirelessQuickViewPage().AddDomainisenabled(locationInfo.get("SSID")), "add button is not disabled");
         ...
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo nmcli device wifi list | grep -F \"apwp22350\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli c add type wifi con-name \"apwp22350\" ifname wlp4s0 ssid \"apwp22350\"");      
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection modify \"apwp22350\" wifi-sec.key-mgmt wpa-eap 802-1x.eap peap 802-1x.phase2-auth mschapv2 802-1x.identity \"teju\" 802-1x.password \"teju\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection up \"apwp22350\"");
