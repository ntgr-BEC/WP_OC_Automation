package webportal.APBasic.Enterprise.Premium.PRJCBUGEN_T22356;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22356") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify both Band and CI with WPA3 Enterprise Security as premium user") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T22356") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp22356");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp22356");
        ...
        assertTrue(new WirelessQuickViewPage().AddDomainisenabled(locationInfo.get("SSID")), "add button is not disabled");
         ...
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo nmcli device wifi list | grep -F \"apwp22356\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli c add type wifi con-name \"apwp22356\" ifname wlp4s0 ssid \"apwp22356\"");      
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection modify \"apwp22356\" wifi-sec.key-mgmt wpa-eap 802-1x.eap peap 802-1x.phase2-auth mschapv2 802-1x.identity \"teju\" 802-1x.password \"teju\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection up \"apwp22356\"");
