package webportal.APBasic.Enterprise.Premium.PRJCBUGEN_T22357;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22357") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify All Band and WPA3 Enterprise Security as pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T22357") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp22357");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp22357");
        ...
        new WirelessQuickViewPage().addSsid1(locationInfo);
         ...
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo nmcli device wifi list | grep -F \"apwp22357\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli c add type wifi con-name \"apwp22357\" ifname wlp4s0 ssid \"apwp22357\"");      
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection modify \"apwp22357\" wifi-sec.key-mgmt wpa-eap 802-1x.eap peap 802-1x.phase2-auth mschapv2 802-1x.identity \"teju\" 802-1x.password \"teju\"");
         MyCommonAPIs.sleepi(20);
         new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection up \"apwp22357\"");
