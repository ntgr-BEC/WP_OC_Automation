package webportal.APBasic.StaticAndDynamicIP.Pro.PRJCBUGEN_T40269;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40269") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("On Insight pro account Change IP to static then remove AP from account and onboard again") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40269") // It's a testcase id/link from Jira Test Case.
