package webportal.APBasic.WirelessSecurity.Location.Premium.Ghz6.PRJCBUGEN_T35778;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35778") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ssid with band 6 Ghz and WPA3 security for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35778") // It's a testcase id/link from Jira Test Case.
