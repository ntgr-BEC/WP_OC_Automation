package webportal.APBasic.WirelessSecurity.Location.Premium.Ghz6.PRJCBUGEN_T35799;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35799") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ssid with band 6 Ghz and WPA3 Mixed security for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35799") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35799");
