package webportal.APBasic.WirelessSecurity.Location.Premium.ICP.PRJCBUGEN_T35743;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35743") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ICP ssid With Register ssid With Fast Roaming enabled for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35743") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35743");
    ...
    @Step("Test Step 2: Add WIFI ssid and connect a clinet")
    public void step2() {
