package webportal.APBasic.WirelessSecurity.Location.Premium.ICP.PRJCBUGEN_T35748;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35748") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ICP ssid With LinkedIn as Authentication method and  Client Isolation enabled for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35748") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35748");
