package webportal.APBasic.WirelessSecurity.Location.Premium.ICP.PRJCBUGEN_T35749;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35749") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ICP ssid With Twitter and Fast Roaming enabled for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35749") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35749");
    ...
    @Step("Test Step 2: Add WIFI ssid and connect to a client ")
    public void step2() {
