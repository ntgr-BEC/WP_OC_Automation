package webportal.APBasic.WirelessSecurity.Location.Premium.PRJCBUGEN_T35753;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35753") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ssid with band 2.4 Ghz and 6 GHZ with  WPA3 Personal mix security for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35753") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35753");
    ...
    public void step2() {
        ...
        ssidInfo.put("SSID", "apwp35753");
        ssidInfo.put("Security", "WPA3 Personal Mixed (WPA2 + WPA3)");
        ssidInfo.put("Password", "123456798");
        ssidInfo.put("Band", "check 2gz and 6ghz");
