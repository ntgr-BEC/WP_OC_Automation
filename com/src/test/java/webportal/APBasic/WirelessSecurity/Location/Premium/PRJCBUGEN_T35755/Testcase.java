package webportal.APBasic.WirelessSecurity.Location.Premium.PRJCBUGEN_T35755;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35755") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ssid with band 2.4 and 5 Ghz and WPA3 mixed security for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35755") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35755");
