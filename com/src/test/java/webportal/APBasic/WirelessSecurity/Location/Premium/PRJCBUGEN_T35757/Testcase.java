package webportal.APBasic.WirelessSecurity.Location.Premium.PRJCBUGEN_T35757;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35757") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ssid with band 5 and 6 Ghz and WPA3 Personal security for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35757") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35757");
