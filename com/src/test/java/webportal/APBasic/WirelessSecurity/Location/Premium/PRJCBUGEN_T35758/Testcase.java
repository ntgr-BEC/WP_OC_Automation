package webportal.APBasic.WirelessSecurity.Location.Premium.PRJCBUGEN_T35758;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35758") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ssid with band 5 and 6 Ghz and WPA3 Personal mix security for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35758") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35758");
    ...
    public void step2() {
        ...
        ssidInfo.put("SSID", "apwp35758");
        ssidInfo.put("Security", "WPA3 Personal Mixed (WPA2 + WPA3)");
        ssidInfo.put("Password", "123456798");
        ssidInfo.put("Band", "check 5ghz and 6ghz");
