package webportal.APBasic.WirelessSecurity.Location.Premium.PRJCBUGEN_T35770;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35770") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ssid with band 5 Ghz and 2.4 GHz with WPA2 Personal mixed security for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35770") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35770");
