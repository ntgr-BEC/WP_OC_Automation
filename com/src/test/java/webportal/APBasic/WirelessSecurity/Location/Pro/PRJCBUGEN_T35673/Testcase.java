package webportal.APBasic.WirelessSecurity.Location.Pro.PRJCBUGEN_T35673;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35673") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ICP ssid With Register ssid With Client Isolation enabled for pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35673") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35673");
