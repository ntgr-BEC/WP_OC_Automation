package webportal.APBasic.WirelessSecurity.Location.Pro.PRJCBUGEN_T35674;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35674") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add ECP ssid With CI enabled pro admin user and client connectivity") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35674") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35674");
...
//        new DevicesDashPage().checkDeviceInNormalAccount("admin"); //must input admin or manager
    ...
    public void step2() {
        ...
        @Step("Test Step 3: add ECP with Client iolation and connect Client")
        public void step3() {
