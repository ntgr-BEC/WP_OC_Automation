package webportal.APBasic.WirelessSecurity.Location.Pro.PRJCBUGEN_T35677;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35677") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T35677") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35677");
