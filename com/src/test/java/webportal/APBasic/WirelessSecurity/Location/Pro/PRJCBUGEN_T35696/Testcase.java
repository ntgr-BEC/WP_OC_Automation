package webportal.APBasic.WirelessSecurity.Location.Pro.PRJCBUGEN_T35696;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35696") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T35696") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp35696");
