package webportal.APBasic.non_pro_admin.PRJCBUGEN_T14271;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify delete Ap functionally as non-pro admin") // It's a testcase title from Jira Test Case.
