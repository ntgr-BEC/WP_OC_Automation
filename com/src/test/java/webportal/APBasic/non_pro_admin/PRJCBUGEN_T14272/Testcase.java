package webportal.APBasic.non_pro_admin.PRJCBUGEN_T14272;
...
public class Testcase extends TestCaseBase {
    ...
    public void step2() {
        ...
        while (count < 5) {
            ...
            if (new APUtils(WebportalParam.ap1IPaddress).getSsidStatus("apwp14272", WebportalParam.ap1Model).indexOf("vapProfileStatus 1") != -1) {
                result = true;
                break;
            }
            count += 1;
