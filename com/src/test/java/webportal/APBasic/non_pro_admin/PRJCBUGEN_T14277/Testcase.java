package webportal.APBasic.non_pro_admin.PRJCBUGEN_T14277;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14277") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify reset functionally as non-pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14277") // It's a testcase id/link from Jira Test Case.
