package webportal.APBasic.non_pro_admin.PRJCBUGEN_T14278;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14278") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify share diagnostics functionally as non-pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14278") // It's a testcase id/link from Jira Test Case.
