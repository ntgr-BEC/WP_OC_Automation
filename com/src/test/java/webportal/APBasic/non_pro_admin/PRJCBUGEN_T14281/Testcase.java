package webportal.APBasic.non_pro_admin.PRJCBUGEN_T14281;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14281") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify wpa2-psk security as non-pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14281") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp14281");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp14281");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14281")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14281 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14281 123456798 WPA2PSK aes")
