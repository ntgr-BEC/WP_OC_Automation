package webportal.APBasic.non_pro_admin.PRJCBUGEN_TCLIENTCONNECTDISCONNECT;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_TCLIENTCONNECTDISCONNECT") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify WPA/WPA2-PSK Security as non-pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_TCLIENTCONNECTDISCONNECT") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwpClientConnect");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwpClientConnect");
        ...
        for (int j = 0; j<=99; j++) {
            ...
            while (true) {
                ...
                if (new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwpClientConnect")
                        .indexOf("true") != -1) {
                    break;
                } else if (sum > 30) {
            ...
            if (!new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwpClientConnect 123456798 WPA2PSK aes")
                    .equals("true")) {
                result1 = false;
                if (new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwpClientConnect 123456798 WPA2PSK aes")
            ...
            logger.info("Iteration - \"+count+\": Completed.");
        }
