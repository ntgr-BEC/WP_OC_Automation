package webportal.APBasic.pro_admin.PRJCBUGEN_T14177;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14177") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify reboot functionally for pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14177") // It's a testcase id/link from Jira Test Case.
