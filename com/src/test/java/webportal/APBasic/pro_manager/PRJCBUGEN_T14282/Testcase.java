package webportal.APBasic.pro_manager.PRJCBUGEN_T14282;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14282") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify WPA/WPA2-PSK Security-->pro manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14282") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp14282");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp14282");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14282")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14282 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14282 123456798 WPA2PSK aes")
