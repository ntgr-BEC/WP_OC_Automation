package webportal.APBasic.pro_manager.PRJCBUGEN_T14283;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14283") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify delete Ap functionally for pro -manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14283") // It's a testcase id/link from Jira Test Case.
