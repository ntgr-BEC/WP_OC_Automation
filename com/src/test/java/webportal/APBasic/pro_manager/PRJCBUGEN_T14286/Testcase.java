package webportal.APBasic.pro_manager.PRJCBUGEN_T14286;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14286") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify edit ssid functionally for pro manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14286") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp14286");
    ...
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14286")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 20) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14286 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14286 123456798 WPA2PSK aes")
