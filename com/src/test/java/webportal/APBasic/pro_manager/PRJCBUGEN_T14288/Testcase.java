package webportal.APBasic.pro_manager.PRJCBUGEN_T14288;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14288") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify reboot functionally for pro manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14288") // It's a testcase id/link from Jira Test Case.
