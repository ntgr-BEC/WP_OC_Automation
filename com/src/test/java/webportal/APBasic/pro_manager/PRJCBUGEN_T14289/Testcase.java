package webportal.APBasic.pro_manager.PRJCBUGEN_T14289;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14289") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify reset functionally- manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14289") // It's a testcase id/link from Jira Test Case.
