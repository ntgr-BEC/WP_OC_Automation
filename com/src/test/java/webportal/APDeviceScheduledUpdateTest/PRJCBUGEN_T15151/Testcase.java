package webportal.APDeviceScheduledUpdateTest.PRJCBUGEN_T15151;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15151") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether user is able to schedule a upgrade for a network location with recurrence as \"Daily\" keeping ends as \"Never\"")
    @TmsLink("PRJCBUGEN-T15151") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(fmp.waitForUpdateAvailable(), "Devices are not in old firmware");
