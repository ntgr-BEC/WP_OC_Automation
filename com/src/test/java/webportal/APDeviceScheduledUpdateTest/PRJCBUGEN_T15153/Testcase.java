package webportal.APDeviceScheduledUpdateTest.PRJCBUGEN_T15153;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15153") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether user is able to schedule a upgrade for a network location with recurrence as Daily setting Ends as \"Specific Date\"")
    @TmsLink("PRJCBUGEN-T15153") // It's a testcase id/link from Jira Test Case.
