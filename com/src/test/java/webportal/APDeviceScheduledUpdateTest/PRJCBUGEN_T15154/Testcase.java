package webportal.APDeviceScheduledUpdateTest.PRJCBUGEN_T15154;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15154") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether user is able to schedule a upgrade for a network location with recurrence as Daily setting the no of recurrence times")
    @TmsLink("PRJCBUGEN-T15154") // It's a testcase id/link from Jira Test Case.
