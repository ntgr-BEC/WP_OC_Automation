package webportal.APDeviceScheduledUpdateTest.PRJCBUGEN_T15157;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15157") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether user is able to schedule a upgrade for a network location with recurrence as Weekly setting the no of times of recurrence")
    @TmsLink("PRJCBUGEN-T15157") // It's a testcase id/link from Jira Test Case.
