package webportal.APDeviceScheduledUpdateTest.PRJCBUGEN_T15158;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15158") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether user is able to schedule a upgrade for a network location with recurrence as \"Monthly\" with ends set as \"Never\"")
    @TmsLink("PRJCBUGEN-T15158") // It's a testcase id/link from Jira Test Case.
