package webportal.APDeviceScheduledUpdateTest.PRJCBUGEN_T15160;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15160") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether user is able to schedule a upgrade for a network location with recurrence as \"Monthly\" Ends set as specific no of recurrences")
    @TmsLink("PRJCBUGEN-T15160") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(fmp.waitForUpdateAvailable(), "Device are not in old firmware");
