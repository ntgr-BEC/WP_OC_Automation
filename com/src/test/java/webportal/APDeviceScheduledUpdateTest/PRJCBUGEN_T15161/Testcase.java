package webportal.APDeviceScheduledUpdateTest.PRJCBUGEN_T15161;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15161") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the location time zone matches the scheduler time zone")
    @TmsLink("PRJCBUGEN-T15161") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Set user network time zone GMT-4")
    public void step3() {
        new AccountPage().enterEditNetworkPage().setTimeZone(false);
    }

    @Step("Test Step 4: Set a one-time firmware schedule policy")
    public void step4() {
        fmpp.gotoPage();
        fmpp.addSchedule(true, false, true);
    }

    @Step("Test Step 5: Now the upgrade should get triggered as per the configured policy")
    public void step5() {
        fmp.gotoFirmwarePage();
