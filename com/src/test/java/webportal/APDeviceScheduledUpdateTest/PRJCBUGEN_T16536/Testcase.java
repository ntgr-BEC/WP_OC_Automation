package webportal.APDeviceScheduledUpdateTest.PRJCBUGEN_T16536;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16536") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether both AP and Orbi (In Router Mode) devices goes for successful upgrade  using Update All")
    @TmsLink("PRJCBUGEN-T16536") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Downgrade firmware for an AP and ORBI")
    public void step1() {
    ...
    public void step2() {
        ...
        assertTrue(fmp.waitForUpdateAvailable(), "AP/Orbi is not in old firmware");
