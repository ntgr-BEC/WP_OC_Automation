package webportal.AdvanceAPFunctionally.non_pro_admin.PRJCBUGEN_T14477;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14477") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify captive portal functionally as non pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14477") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14477");
    ...
    @Step("Test Step 2: Add WIFI ssid and enable Captive Portal;")
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14477")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14477 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
