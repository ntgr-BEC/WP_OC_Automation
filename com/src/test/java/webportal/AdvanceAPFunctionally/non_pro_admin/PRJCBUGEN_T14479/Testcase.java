package webportal.AdvanceAPFunctionally.non_pro_admin.PRJCBUGEN_T14479;
 ...
 *
 * @author dallas
 *         Edited by vivek Speed test step's logic only
 *
 */
public class Testcase extends TestCaseBase {
    ...
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14479")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
