package webportal.AdvanceAPFunctionally.non_pro_admin.PRJCBUGEN_T14665;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14665") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Schedule instant wifi as mild functionally non pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14665") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14665");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp14665");
