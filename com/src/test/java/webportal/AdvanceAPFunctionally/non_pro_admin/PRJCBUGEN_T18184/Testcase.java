package webportal.AdvanceAPFunctionally.non_pro_admin.PRJCBUGEN_T18184;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify instant wifi functionally as non pro user for country UK") // It's a testcase title from Jira Test Case.
    ...
    public void step2() {
        ...
        locationInfo.put("Wireless Region", "UK");
        new AccountPage().editLocation(WebportalParam.location1, locationInfo);
        new DevicesDashPage().waitDevicesReConnected(WebportalParam.ap1serialNo);

        Map<String, String> ssidInfo = new HashMap<String, String>();
        ssidInfo.put("SSID", "apwp18184");
