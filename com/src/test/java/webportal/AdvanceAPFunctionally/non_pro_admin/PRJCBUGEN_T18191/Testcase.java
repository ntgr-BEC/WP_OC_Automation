package webportal.AdvanceAPFunctionally.non_pro_admin.PRJCBUGEN_T18191;
...
public class Testcase extends TestCaseBase {
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp18191");
    ...
    @Step("Test Step 2: Change location wireless region to Luxemourg and click optimize now button, then check ap log;")
    public void step2() {
        region = new AccountPage().getWirelessRegion(WebportalParam.location1);
        locationInfo.put("Wireless Region", "Luxemourg");
        new AccountPage().editLocation(WebportalParam.location1, locationInfo);
        new DevicesDashPage().waitDevicesReConnected(WebportalParam.ap1serialNo);

        Map<String, String> ssidInfo = new HashMap<String, String>();
        ssidInfo.put("SSID", "apwp18191");
