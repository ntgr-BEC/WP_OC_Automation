package webportal.AdvanceAPFunctionally.non_pro_admin.PRJCBUGEN_T18201;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18201") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify instant wifi functionally as non pro user for country Portugal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18201") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp18201");
    ...
    @Step("Test Step 2: Change location wireless region to Portugal and click optimize now button, then check ap log;")
    public void step2() {
        region = new AccountPage().getWirelessRegion(WebportalParam.location1);
        locationInfo.put("Wireless Region", "Portugal");
        new AccountPage().editLocation(WebportalParam.location1, locationInfo);
        new DevicesDashPage().waitDevicesReConnected(WebportalParam.ap1serialNo);

        Map<String, String> ssidInfo = new HashMap<String, String>();
        ssidInfo.put("SSID", "apwp18201");
