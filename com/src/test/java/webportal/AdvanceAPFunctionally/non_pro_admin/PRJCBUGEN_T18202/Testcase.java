package webportal.AdvanceAPFunctionally.non_pro_admin.PRJCBUGEN_T18202;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18202") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify instant wifi functionally as non pro user for country Romania") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18202") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp18202");
    ...
    public void step2() {
        ...
        locationInfo.put("Wireless Region", "Romania");
        new AccountPage().editLocation(WebportalParam.location1, locationInfo);
        new DevicesDashPage().waitDevicesReConnected(WebportalParam.ap1serialNo);

        Map<String, String> ssidInfo = new HashMap<String, String>();
        ssidInfo.put("SSID", "apwp18202");
