package webportal.AdvanceAPFunctionally.non_pro_admin.PRJCBUGEN_T18205;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18205") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify instant wifi functionally as non pro user for country Singapore") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18205") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp18205");
    ...
    @Step("Test Step 2: Change location wireless region to Singapore and click optimize now button, then check ap log;")
    public void step2() {
        region = new AccountPage().getWirelessRegion(WebportalParam.location1);
        locationInfo.put("Wireless Region", "Singapore");
        new AccountPage().editLocation(WebportalParam.location1, locationInfo);
        new DevicesDashPage().waitDevicesReConnected(WebportalParam.ap1serialNo);

        Map<String, String> ssidInfo = new HashMap<String, String>();
        ssidInfo.put("SSID", "apwp18205");
