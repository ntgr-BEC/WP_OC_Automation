package webportal.AdvanceAPFunctionally.pro_admin.PRJCBUGEN_T14406;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14406") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify whether error message is shown or not when user set 11 url in url filter") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14406") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14406");
