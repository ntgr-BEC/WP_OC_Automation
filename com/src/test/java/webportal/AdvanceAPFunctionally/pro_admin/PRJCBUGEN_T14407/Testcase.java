package webportal.AdvanceAPFunctionally.pro_admin.PRJCBUGEN_T14407;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14407") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify whether user able to remove added url from Url filter list") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14407") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14407");
