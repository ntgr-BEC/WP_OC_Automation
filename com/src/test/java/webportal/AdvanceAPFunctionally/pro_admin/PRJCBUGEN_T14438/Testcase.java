package webportal.AdvanceAPFunctionally.pro_admin.PRJCBUGEN_T14438;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14438") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify captive portal functionally") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14438") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14438");
