package webportal.AdvanceAPFunctionally.pro_admin.PRJCBUGEN_T14459;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14459") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify MAC ACL functionally") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14459") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp14459");
