package webportal.AdvanceAPFunctionally.pro_admin.PRJCBUGEN_T14461;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14461") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify user is able to on boarding AP on different countries") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14461") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14461");
    ...
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14461")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFopenconnect apwp14461")
                .equals("true")) {
            result1 = false;
            if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFopenconnect apwp14461")
                    .equals("true")) {
            ...
            for (int i = 2; i < 107; i++) {
                ...
                while (true) {
                    ...
                    if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                            "WAFfindSSID apwp14461").indexOf("true") != -1) {
                        break;
                    } else if (sum > 30) {
                        assertTrue(false, "Client cannot connected.");
                        break;
