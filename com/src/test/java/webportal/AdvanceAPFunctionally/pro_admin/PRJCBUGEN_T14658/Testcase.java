package webportal.AdvanceAPFunctionally.pro_admin.PRJCBUGEN_T14658;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14658") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Schedule instant wifi as aggressive functionally") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14658") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14658");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp14658");
