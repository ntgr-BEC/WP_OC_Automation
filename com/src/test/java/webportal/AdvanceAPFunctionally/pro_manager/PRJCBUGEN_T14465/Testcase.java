package webportal.AdvanceAPFunctionally.pro_manager.PRJCBUGEN_T14465;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify Fast Roaming enable as manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14465") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp14465");
