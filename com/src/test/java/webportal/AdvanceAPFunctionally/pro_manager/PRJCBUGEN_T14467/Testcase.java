package webportal.AdvanceAPFunctionally.pro_manager.PRJCBUGEN_T14467;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14467") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify captive portal functionally as manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14467") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14467");
