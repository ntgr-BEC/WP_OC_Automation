package webportal.AdvanceAPFunctionally.pro_manager.PRJCBUGEN_T14471;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14471") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify user is able to on boarding AP on different countries as manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14471") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14471");
