package webportal.AdvanceAPFunctionally.pro_manager.PRJCBUGEN_T14612;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14612") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify instant wifi functionally as manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14612") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14612");
