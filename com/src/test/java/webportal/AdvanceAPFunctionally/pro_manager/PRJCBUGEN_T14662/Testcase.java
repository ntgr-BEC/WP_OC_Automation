package webportal.AdvanceAPFunctionally.pro_manager.PRJCBUGEN_T14662;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14662") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Schedule instant wifi as mild functionally as as manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14662") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14662");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp14662");
