package webportal.AdvanceAPFunctionally.pro_manager.PRJCBUGEN_T14663;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14663") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Schedule instant wifi as moderate functionally as manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14663") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp14663");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp14663");
