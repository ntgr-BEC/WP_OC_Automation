package webportal.AdvanceICP10Device1Year.PRJCBUGEN_T24069;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24069") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 1 year Spain") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24069") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24069");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24069");
