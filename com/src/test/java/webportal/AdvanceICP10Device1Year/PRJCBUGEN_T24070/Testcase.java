package webportal.AdvanceICP10Device1Year.PRJCBUGEN_T24070;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24070") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 1 year Finland") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24070") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24070");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24070");
