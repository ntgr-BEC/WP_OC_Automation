package webportal.AdvanceICP10Device1Year.PRJCBUGEN_T24091;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24091") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 1 year US") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24091") // It's a testcase id/link from Jira Test Case.
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24091");
