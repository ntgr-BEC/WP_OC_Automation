package webportal.AdvanceICP10Device1Year.PRJCBUGEN_T30481;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30481") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 1 year Malta") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30481") // It's a testcase id/link from Jira Test Case.
