package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24124;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24124") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Finland") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24124") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24124");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24124");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Porthaninkatu");
            CaptivePortalPaymentInfo.put("City", "Kotka");
            CaptivePortalPaymentInfo.put("Zip", "48200");
            CaptivePortalPaymentInfo.put("Country", "Finland");
            CaptivePortalPaymentInfo.put("State", "Kotka");
