package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24126;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24126") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year UK") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24126") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24126");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24126");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Saltash");
            CaptivePortalPaymentInfo.put("City", "England");
            CaptivePortalPaymentInfo.put("Zip", "PL12");
            CaptivePortalPaymentInfo.put("Country", "UK");
            CaptivePortalPaymentInfo.put("State", "England");
