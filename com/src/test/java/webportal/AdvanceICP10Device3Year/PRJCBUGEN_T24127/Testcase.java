package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24127;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24127") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Greece") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24127") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24127");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "30300");
        locationInfo.put("Country", "Greece");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24127");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Psani Beach");
            CaptivePortalPaymentInfo.put("City", "Nafpaktos");
            CaptivePortalPaymentInfo.put("Zip", "30300");
            CaptivePortalPaymentInfo.put("Country", "Greece");
            CaptivePortalPaymentInfo.put("State", "Nafpaktos ");
