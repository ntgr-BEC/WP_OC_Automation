package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24130;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24130") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Italy") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24130") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24130");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24130");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Via Bari");
            CaptivePortalPaymentInfo.put("City", "Palermo");
            CaptivePortalPaymentInfo.put("Zip", "90133");
            CaptivePortalPaymentInfo.put("Country", "Italy");
            CaptivePortalPaymentInfo.put("State", "Palermo");
