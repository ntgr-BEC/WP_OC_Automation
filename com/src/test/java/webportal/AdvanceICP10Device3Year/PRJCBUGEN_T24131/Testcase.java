package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24131;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24131") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Lithuania") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24131") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24131");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "LT-44293");
        locationInfo.put("Country", "Lithuania");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24131");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "street");
            CaptivePortalPaymentInfo.put("City", "Kaunas");
            CaptivePortalPaymentInfo.put("Zip", "44293");
            CaptivePortalPaymentInfo.put("Country", "Lithuania");
            CaptivePortalPaymentInfo.put("State", "Kaunas");
