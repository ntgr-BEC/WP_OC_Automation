package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24133;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("AdvanceICP10Device3Year") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24133") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Netherlands") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24133") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24133");
        accountInfo.put("Email Address", mailname + "@mailinator.com");
        accountInfo.put("Confirm Email", mailname + "@mailinator.com");
        accountInfo.put("Password", "Netgear#123");
        accountInfo.put("Confirm Password", "Netgear#123");
        accountInfo.put("Country", "Netherlands");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "1054 ES");
        locationInfo.put("Country", "Netherlands");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24133");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Stadhouderskade");
            CaptivePortalPaymentInfo.put("City", "Amsterdam");
            CaptivePortalPaymentInfo.put("Zip", "1054");
            CaptivePortalPaymentInfo.put("Country", "Netherlands");
            CaptivePortalPaymentInfo.put("State", "Amsterdam");
