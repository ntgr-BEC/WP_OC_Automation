package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24134;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24134") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Norway") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24134") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24134");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24134");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Storgaten ");
            CaptivePortalPaymentInfo.put("City", "Tromso");
            CaptivePortalPaymentInfo.put("Zip", "9008");
            CaptivePortalPaymentInfo.put("Country", "Norway");
            CaptivePortalPaymentInfo.put("State", "Tromso");
