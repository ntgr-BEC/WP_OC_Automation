package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24135;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24135") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Poland") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24135") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24135");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "31-579");
        locationInfo.put("Country", "Poland");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24135");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Dolna");
            CaptivePortalPaymentInfo.put("City", "Krakow");
            CaptivePortalPaymentInfo.put("Zip", "31579");
            CaptivePortalPaymentInfo.put("Country", "Poland");
            CaptivePortalPaymentInfo.put("State", "Krakow");
