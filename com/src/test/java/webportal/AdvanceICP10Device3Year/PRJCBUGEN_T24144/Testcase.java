package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T24144;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24144") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Singapore") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24144") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24144");
