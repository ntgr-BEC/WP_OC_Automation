package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30435;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30435") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Austria") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30435") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Country", "Austria");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "A1070");
        locationInfo.put("Country", "Austria");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Vienna");
            CaptivePortalPaymentInfo.put("City", "Vienna ");
            CaptivePortalPaymentInfo.put("Zip", "A1070");
            CaptivePortalPaymentInfo.put("Country", "Austria");
            CaptivePortalPaymentInfo.put("State", "Vienna");
