package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30493;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30493") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Belgium") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30493") // It's a testcase id/link from Jira Test Case.
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Bodenbroekstraat");
            CaptivePortalPaymentInfo.put("City", "Bodenbroekstraat ");
            CaptivePortalPaymentInfo.put("Zip", "B1000");
            CaptivePortalPaymentInfo.put("Country", "Belgium");
            CaptivePortalPaymentInfo.put("State", "Brussels");
