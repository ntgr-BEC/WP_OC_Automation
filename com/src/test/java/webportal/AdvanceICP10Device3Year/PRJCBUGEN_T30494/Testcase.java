package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30494;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30494") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Bulgaria") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30494") // It's a testcase id/link from Jira Test Case.
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Burgas");
            CaptivePortalPaymentInfo.put("City", "Burgas");
            CaptivePortalPaymentInfo.put("Zip", "8000");
            CaptivePortalPaymentInfo.put("Country", "Bulgaria");
            CaptivePortalPaymentInfo.put("State", "Burgas");
