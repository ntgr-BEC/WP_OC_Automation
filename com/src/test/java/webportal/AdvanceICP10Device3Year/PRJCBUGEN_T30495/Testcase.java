package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30495;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30495") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Cyprus") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30495") // It's a testcase id/link from Jira Test Case.
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Poseidonos Avenue");
            CaptivePortalPaymentInfo.put("City", "Paphos");
            CaptivePortalPaymentInfo.put("Zip", "8125");
            CaptivePortalPaymentInfo.put("Country", "Cyprus");
            CaptivePortalPaymentInfo.put("State", "Paphos");
