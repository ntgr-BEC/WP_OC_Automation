package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30496;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30496") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Czech Republic") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30496") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24145");
        accountInfo.put("Email Address", mailname + "@mailinator.com");
        accountInfo.put("Confirm Email", mailname + "@mailinator.com");
        accountInfo.put("Password", "Netgear#123");
        accountInfo.put("Confirm Password", "Netgear#123");
        accountInfo.put("Country", "Czech Republic");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "15000");
        locationInfo.put("Country", "Czech Republic");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24145");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Prague");
            CaptivePortalPaymentInfo.put("City", "Prague");
            CaptivePortalPaymentInfo.put("Zip", "15000");
            CaptivePortalPaymentInfo.put("Country", "Czech Republic");
            CaptivePortalPaymentInfo.put("State", "Prague");
