package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30497;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30497") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Croatia") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30497") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Country", "Croatia");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Cavtat");
            CaptivePortalPaymentInfo.put("City", "Cavtat");
            CaptivePortalPaymentInfo.put("Zip", "20210");
            CaptivePortalPaymentInfo.put("Country", "Croatia");
            CaptivePortalPaymentInfo.put("State", "Cavtat");
