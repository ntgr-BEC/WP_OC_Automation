package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30498;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30498") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Latvia") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30498") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Country", "Latvia");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "LV1010");
        locationInfo.put("Country", "Latvia");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Centra rajons");
            CaptivePortalPaymentInfo.put("City", "Riga");
            CaptivePortalPaymentInfo.put("Zip", "LV1010");
            CaptivePortalPaymentInfo.put("Country", "Latvia");
            CaptivePortalPaymentInfo.put("State", "Riga");
