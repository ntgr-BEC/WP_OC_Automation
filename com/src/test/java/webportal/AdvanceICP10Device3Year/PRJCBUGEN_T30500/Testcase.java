package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30500;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30500") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Slovenia") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30500") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Country", "Slovenia");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "6320");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Portorose"); 
            CaptivePortalPaymentInfo.put("City", "Portorose");
            CaptivePortalPaymentInfo.put("Zip", "6320");
            CaptivePortalPaymentInfo.put("Country", "Slovenia");
            CaptivePortalPaymentInfo.put("State", "Portorose");
