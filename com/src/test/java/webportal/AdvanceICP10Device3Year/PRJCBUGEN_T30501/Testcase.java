package webportal.AdvanceICP10Device3Year.PRJCBUGEN_T30501;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30501") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 10 device for 3 year Slovakia") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30501") // It's a testcase id/link from Jira Test Case.
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Bratislava"); 
            CaptivePortalPaymentInfo.put("City", "Bratislava");
            CaptivePortalPaymentInfo.put("Zip", "81109");
            CaptivePortalPaymentInfo.put("Country", "Slovakia");
            CaptivePortalPaymentInfo.put("State", "Bratislava");
