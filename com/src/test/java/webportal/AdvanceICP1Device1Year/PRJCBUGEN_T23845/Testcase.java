package webportal.AdvanceICP1Device1Year.PRJCBUGEN_T23845;
...
//    Map<String, String> CaptivePortalPaymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Feature("AdvanceICP1Device1Year") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T23845") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 1 device for 1 year France") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23845") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T23845");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T23845");
            CaptivePortalPaymentInfo.put("Email", mailname + "@mailinator.com");
            CaptivePortalPaymentInfo.put("Quantity", "1"); // can input 1 , 3 , 10 , 40
            CaptivePortalPaymentInfo.put("Duration", "1"); // can input 1 , 
            CaptivePortalPaymentInfo.put("Street Address", "ARQUIZAN");
            CaptivePortalPaymentInfo.put("City", "Montreal");
            CaptivePortalPaymentInfo.put("Zip", "32250");
            CaptivePortalPaymentInfo.put("Country", "France");
            CaptivePortalPaymentInfo.put("State", "Montreal");
