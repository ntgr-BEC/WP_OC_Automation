package webportal.AdvanceICP1Device1Year.PRJCBUGEN_T23852;
...
//    Map<String, String> CaptivePortalPaymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Story("PRJCBUGEN_T23852") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 1 device for 1 year Luxembourg") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23852") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T23852");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T23852");
