package webportal.AdvanceICP1Device1Year.PRJCBUGEN_T30396;
...
//    Map<String, String> CaptivePortalPaymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Story("PRJCBUGEN_T30396") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 1 device for 1 year Czech Republic") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30396") // It's a testcase id/link from Jira Test Case.
