package webportal.AdvanceICP1Device1Year.PRJCBUGEN_T30401;
...
//    Map<String, String> CaptivePortalPaymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Story("PRJCBUGEN_T30401") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 1 device for 1 year Slovakia") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30401") // It's a testcase id/link from Jira Test Case.
