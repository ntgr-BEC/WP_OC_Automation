package webportal.AdvanceICP1Device3Year.PRJCBUGEN_T23913;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23913") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 1 device for 3 year South Africa") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23913") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T23913");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T23913");
