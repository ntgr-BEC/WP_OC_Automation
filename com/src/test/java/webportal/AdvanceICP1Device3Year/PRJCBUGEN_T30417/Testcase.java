package webportal.AdvanceICP1Device3Year.PRJCBUGEN_T30417;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30417") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 1 device for 3 year Malta") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30417") // It's a testcase id/link from Jira Test Case.
