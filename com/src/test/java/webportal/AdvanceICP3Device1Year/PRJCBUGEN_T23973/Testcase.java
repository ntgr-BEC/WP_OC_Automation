package webportal.AdvanceICP3Device1Year.PRJCBUGEN_T23973;
...
//    Map<String, String> CaptivePortalPaymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Story("PRJCBUGEN_T23973") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 3 device for 1 year US") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23973") // It's a testcase id/link from Jira Test Case.
