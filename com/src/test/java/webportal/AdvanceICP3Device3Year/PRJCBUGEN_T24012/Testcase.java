package webportal.AdvanceICP3Device3Year.PRJCBUGEN_T24012;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24012") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 3 device for 3 year Italy") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24012") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24012");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24012");
