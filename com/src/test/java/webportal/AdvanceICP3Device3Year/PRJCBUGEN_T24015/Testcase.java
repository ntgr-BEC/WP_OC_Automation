package webportal.AdvanceICP3Device3Year.PRJCBUGEN_T24015;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("AdvanceICP3Device3Year") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24015") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 3 device for 3 year Netherlands") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24015") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24015");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24015");
