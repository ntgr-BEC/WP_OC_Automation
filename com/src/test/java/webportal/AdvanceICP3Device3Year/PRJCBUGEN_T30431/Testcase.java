package webportal.AdvanceICP3Device3Year.PRJCBUGEN_T30431;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30431") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 3 device for 3 year Austria") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30431") // It's a testcase id/link from Jira Test Case.
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Main Road");
