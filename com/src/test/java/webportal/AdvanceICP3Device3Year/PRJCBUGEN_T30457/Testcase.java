package webportal.AdvanceICP3Device3Year.PRJCBUGEN_T30457;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30457") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 3 device for 3 year Belgium") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30457") // It's a testcase id/link from Jira Test Case.
