package webportal.AdvanceICP40Device1Year.PRJCBUGEN_T24177;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24177") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 1 year Spain") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24177") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24177");
   ...
   Map<String, String> firststdevInfo = new HashMap<String, String>();
    ...
    public void step4() {
        ...
        CaptivePortalPaymentInfo = new CommonDataType().CARD_INFO;
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24177");
