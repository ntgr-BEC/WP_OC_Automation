package webportal.AdvanceICP40Device1Year.PRJCBUGEN_T24183;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24183") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 1 year Ireland") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24183") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24183");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "Y34 KR62");
        locationInfo.put("Country", "Ireland");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24183");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "New Ross");
            CaptivePortalPaymentInfo.put("City", "Wexford");
            CaptivePortalPaymentInfo.put("Zip", "KR62");
            CaptivePortalPaymentInfo.put("Country", "Ireland");
            CaptivePortalPaymentInfo.put("State", "Wexford");
...
//        }
    ...
    @Step("Test Step 3: Cancel ICP subscription;")
    public void step3() {
