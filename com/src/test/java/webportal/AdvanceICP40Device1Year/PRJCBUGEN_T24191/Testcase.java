package webportal.AdvanceICP40Device1Year.PRJCBUGEN_T24191;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24191") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 1 year Romania") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24191") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24191");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "300553");
        locationInfo.put("Country", "Romania");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24191");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Strada Miorita");
            CaptivePortalPaymentInfo.put("City", "Timisoara");
            CaptivePortalPaymentInfo.put("Zip", "300553");
            CaptivePortalPaymentInfo.put("Country", "Romania");
            CaptivePortalPaymentInfo.put("State", "Timisoara");
