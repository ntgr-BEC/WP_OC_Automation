package webportal.AdvanceICP40Device1Year.PRJCBUGEN_T30519;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30519") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 1 year Malta") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30519") // It's a testcase id/link from Jira Test Case.
