package webportal.AdvanceICP40Device3Year.PRJCBUGEN_T24240;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24240") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 3 year Luxembourg") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24240") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24240");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24240");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Rue Jean Engling");
            CaptivePortalPaymentInfo.put("City", "Luxembourg");
            CaptivePortalPaymentInfo.put("Zip", "1466");
            CaptivePortalPaymentInfo.put("Country", "Luxembourg");
            CaptivePortalPaymentInfo.put("State", "Luxembourg");
