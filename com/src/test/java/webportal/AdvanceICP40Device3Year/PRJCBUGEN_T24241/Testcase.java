package webportal.AdvanceICP40Device3Year.PRJCBUGEN_T24241;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("AdvanceICP40Device3Year") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24241") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 3 year Netherlands") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24241") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24241");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24241");
