package webportal.AdvanceICP40Device3Year.PRJCBUGEN_T24247;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24247") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 3 year South Africa") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24247") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24247");
 ...
 Map<String, String> firststdevInfo = new HashMap<String, String>();
     ...
     public void step4() {
        ...
        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24247");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Keerom Street");
            CaptivePortalPaymentInfo.put("City", "Western Cape");
            CaptivePortalPaymentInfo.put("Zip", "8005");
            CaptivePortalPaymentInfo.put("Country", "South Africa");
            CaptivePortalPaymentInfo.put("State", "Western Cape");
