package webportal.AdvanceICP40Device3Year.PRJCBUGEN_T24249;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24249") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 3 year Hong Kong") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24249") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24249");
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        locationInfo.put("Zip Code", "999077");
        locationInfo.put("Country", "Hong Kong");
...
//        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T24249");
            ...
            CaptivePortalPaymentInfo.put("Street Address", "Mong Kok");
            CaptivePortalPaymentInfo.put("City", "Causeway Bay");
            CaptivePortalPaymentInfo.put("Zip", "999077");
            CaptivePortalPaymentInfo.put("Country", "Hong Kong");
            CaptivePortalPaymentInfo.put("State", "Causeway Bay");
