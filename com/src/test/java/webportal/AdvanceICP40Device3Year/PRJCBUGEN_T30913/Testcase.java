package webportal.AdvanceICP40Device3Year.PRJCBUGEN_T30913;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30913") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 3 year Slovakia") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30913") // It's a testcase id/link from Jira Test Case.
