package webportal.AdvanceICP40Device3Year.PRJCBUGEN_T30919;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30919") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 3 year Czech Republic") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30919") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T24253");
