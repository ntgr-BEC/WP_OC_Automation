package webportal.AdvanceRateSelction.Premium.PRJCBUGEN_T22739;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22739") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Density Level as 1") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22739") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp22739");
        ...
        assertTrue(msg.contains("vapSettingTable:wlan0:vap7:densityLevel 1"),"default  value for 2.4 Ghz is not right");
    }
