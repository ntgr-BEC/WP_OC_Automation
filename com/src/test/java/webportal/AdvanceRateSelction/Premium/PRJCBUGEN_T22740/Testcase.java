package webportal.AdvanceRateSelction.Premium.PRJCBUGEN_T22740;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22740") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Density Level as 2") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22740") // It's a testcase id/link from Jira Test Case.
...
//        new DevicesDashPage().checkDeviceInAdminAccount();
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp22740");
        ...
        assertTrue(msg.contains("vapSettingTable:wlan0:vap7:densityLevel 2"),"default  value for 2.4 Ghz is not right");  
    }
