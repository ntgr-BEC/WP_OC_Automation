package webportal.AdvanceRateSelction.Premium.PRJCBUGEN_T22746;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22746") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Density Level as 3 in 5 ghz") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22746") // It's a testcase id/link from Jira Test Case.
...
//        new DevicesDashPage().checkDeviceInAdminAccount();
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp22746");
        ...
        assertTrue(msg.contains("vapSettingTable:wlan1:vap7:densityLevel 3"),"default  value for 2.4 Ghz is not right");
