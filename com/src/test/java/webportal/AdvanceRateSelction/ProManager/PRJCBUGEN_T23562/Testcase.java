package webportal.AdvanceRateSelction.ProManager.PRJCBUGEN_T23562;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23562") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Advanced Rate Selection option  in new SSID  in vlan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23562") // It's a testcase id/link from Jira Test Case.
