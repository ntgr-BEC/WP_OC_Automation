...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36489") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase History All Details after purchase the ICP One AP for Three Year") // It's a test case title from Jira
                                                                                                             // Test Case.
    @TmsLink("PRJCBUGEN-T36489") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T36489");
    ...
    @Step("Test Step 4: Buy 1 ICP Device for 3 Years;")
    public void step4() {
        ...
        CaptivePortalPaymentInfo.put("Quantity", "1");
...
//        assertTrue(result, "<2> Captive portal services credits is incorrect.");
    ...
    @Step("Test Step 7: Verify ICP 3 Year subscription Text are present there")
    public void step7() {
        assertTrue(new HamburgerMenuPage(false).VerifyTheICPforThreeYearSubsText(), "ICP 3 year subs Texts are not present");
