package webportal.AdvancedPurchaseHistory.DontRunICPVPN.PRJCBUGEN_T36552;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36552") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase History All Details after purchase the ICP 10 AP for Three Years") // It's a test case title from Jira
                                                                                                             // Test Case.
    @TmsLink("PRJCBUGEN-T36552") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T36552");
    ...
    public void step4() {
        ...
        CaptivePortalPaymentInfo.put("Quantity", "10");
    ...
    @Step("Test Step 7: Verify ICP 10 AP, 3 Year subscription Text are present there")
    public void step7() {
        assertTrue(new HamburgerMenuPage(false).VerifyTheICPforTenAPThreeYearSubsText(), "ICP 3 years 10 AP subs Texts are not present");
