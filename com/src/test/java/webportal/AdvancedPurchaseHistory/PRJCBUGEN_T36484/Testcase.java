package webportal.AdvancedPurchaseHistory.PRJCBUGEN_T36484;
...
public class Testcase extends TestCaseBase {
    ...
    String              locationName = "PurchaseHistory";

    @Feature("IM-7.2 AdvancedPurchaseHistory") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T36484") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase History All Details Without On boarded any AP") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T36484") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T36484");
