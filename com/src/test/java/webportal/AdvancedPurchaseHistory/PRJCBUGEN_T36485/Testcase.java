package webportal.AdvancedPurchaseHistory.PRJCBUGEN_T36485;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36485") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase History All Details after On boarded 1 AP") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T36485") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T36485");
    ...
    @Step("Test Step 4: Open Purchase History Page and expand insigt HBB div Credits Section")
    public void step4() {
