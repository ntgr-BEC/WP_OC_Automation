package webportal.AdvancedPurchaseHistory.PRJCBUGEN_T36499;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36499") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase History All Details after purchasing the Premium Trial to Premium Monthly For 1 Device") // It's a test case title from Jira
    // Test Case.
    @TmsLink("PRJCBUGEN-T36499") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T36499");
    ...
    @Step("Test Step 7: Verify Premium Trial to Premium Monthly subscription Text are present there")
    public void step7() {
        assertTrue(new HamburgerMenuPage(false).VerifyThePreTrialToPreMonthlySubsText(), "Premium Trial to Premium Monthly subscription Text are not present");
