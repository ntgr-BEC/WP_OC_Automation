package webportal.AdvancedPurchaseHistory.PRJCBUGEN_T36520;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36520") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase History All Details after purchasing the Multi Pack For 5 Devices with 3 years") // It's a test
                                                                                                                          // case title from
                                                                                                                          // Jira
    // Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T36520");
    ...
    @Step("Test Step 7: Verify Multi Pack 5 device for 3 years subscription Text are present there")
    public void step7() {
        assertTrue(new HamburgerMenuPage(false).VerifyMultiPackforFiveDivThreeYearsSubsText(),
                "Multi pack 5 device with 3 yeara subscription Text are not present");
