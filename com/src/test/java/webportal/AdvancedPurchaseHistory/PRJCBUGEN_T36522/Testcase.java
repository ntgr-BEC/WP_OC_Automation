package webportal.AdvancedPurchaseHistory.PRJCBUGEN_T36522;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36522") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase History All Details after purchasing the Multi Pack For 10 Devices with 1 year") // It's a test
                                                                                                                           // case title from
                                                                                                                           // Jira
    // Test Case.
    @TmsLink("PRJCBUGEN-T36522") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T36522");
    ...
    @Step("Test Step 7: Verify Multi Pack 10 device for 1 year subscription Text are present there")
    public void step7() {
        assertTrue(new HamburgerMenuPage(false).VerifyMultiPackforTenDivOneYearsSubsText(),
                "Multi pack 10 device with 1 yeara subscription Text are not present");
    ...
    public void step9() {
        assertTrue(new HamburgerMenuPage(false).VerifyTheInsightPreSubsActivationAndExpiryDatesMultiPack(1), "Activation Date is not equal to Today's Date");
