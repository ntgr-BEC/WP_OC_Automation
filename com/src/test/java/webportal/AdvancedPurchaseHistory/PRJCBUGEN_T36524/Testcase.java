package webportal.AdvancedPurchaseHistory.PRJCBUGEN_T36524;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36524") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase History All Details after purchasing the Multi Pack For 10 Devices with 5 years") // It's a test
                                                                                                                           // case title from
                                                                                                                           // Jira
    // Test Case.
    @TmsLink("PRJCBUGEN-T36524") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T36524");
    ...
    @Step("Test Step 7: Verify Multi Pack 10 device for 5 years subscription Text are present there")
    public void step7() {
        assertTrue(new HamburgerMenuPage(false).VerifyMultiPackforTenDivFiveYearsSubsText(),
                "Multi pack 10 device with 5 years subscription Text are not present");
