...
public class Api_GetDefaultNatSsids extends TestCaseBaseApi{
    ...
    @Feature("Api_GetDefaultNatSsids") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test gets default NAT data from the particular API") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        Response getResponse = ApiRequest.sendGetRequest(endPointUrl.get("DefaultNatSsids_Sanity"), headers, pathParams, null); 
