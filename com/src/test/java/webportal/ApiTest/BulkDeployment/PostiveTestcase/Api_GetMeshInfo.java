...
public class Api_GetMeshInfo extends TestCaseBaseApi{

    Map<String, String> endPointUrl = new HashMap<String,String>();
    Map<String, String> headers = new HashMap<String, String>();

    
    @Feature("Api_GetMeshInfo") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T002") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Retrieves all the details related to Mesh") // It's a testcase title from Jira Test Case.
    ...
    {        
        ...
        String requestBody="{\"deviceInfo\":[{\"networkId\":\""+WebportalParam.networkId+"\",\"serialNo\":\""+WebportalParam.ap2serialNo+"\"}]}";
