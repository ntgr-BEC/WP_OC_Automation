package webportal.ApiTest.Clients.NegativeTestcases;
...
public class ClientsInfoWithEmptyIsConnectedPPValue_Api extends TestCaseBaseApi{
    ...
    @Feature("ClientsInfoWithEmptyIsConnectedPPValue_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Clients Information with empty Isconnected pathparam value") // It's a testcase title from Jira Test Case.
