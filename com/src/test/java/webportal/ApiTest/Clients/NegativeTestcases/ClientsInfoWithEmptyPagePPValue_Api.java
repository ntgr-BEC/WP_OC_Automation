...
public class ClientsInfoWithEmptyPagePPValue_Api extends TestCaseBaseApi{
    ...
    @Feature("ClientsInfoWithEmptyPagePPValue_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Clients Information with emtpy page Path param value Body.") // It's a testcase title from Jira Test Case.
