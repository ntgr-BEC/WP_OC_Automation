...
public class Api_ClientsInfo extends TestCaseBaseApi{
    ...
    @Feature("Api_ClientsInfo") // It's a folder/component name to make test suite more readable from Jira Test Case.
    ...
    public void step1()
    {
        ...
        ssidInfo.put("SSID", "SSID_CLIENT_INFO");
