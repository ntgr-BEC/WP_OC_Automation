 ...
 *
 */
public class CreateSSID_ClientConnect extends TestCaseBaseApi {

    @Feature("CreateSSID_ClientConnect") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T14270") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("API -- Create SSID and connect client") // It's a testcase title from Jira Test Case.
