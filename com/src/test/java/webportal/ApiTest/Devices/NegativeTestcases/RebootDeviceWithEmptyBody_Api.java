...
public class RebootDeviceWithEmptyBody_Api extends TestCaseBaseApi{
    WebportalParam webportalParam = new WebportalParam();
    
    @Feature("RebootDeviceWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This API REBOOTS THE DEVICE with empty body") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        getResponse.then().body("status", equalTo(false))
                          .body("message", equalTo("Invalid command"));
