...
public class SetDeviceIPSettingsWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    {      
        ...
        Response getResponse = ApiRequest.sendPostRequest(endPointUrl.get("IP_Statistics"), requestBody, headers, pathParams, null,400); 
        getResponse.then().body("response.status", equalTo(false))
        .body("response.message", equalTo("Some error occured while configuring device , Please try after some time"));
    }
