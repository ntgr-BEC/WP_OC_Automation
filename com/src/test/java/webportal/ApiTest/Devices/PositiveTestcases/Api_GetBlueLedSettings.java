...
public class Api_GetBlueLedSettings extends TestCaseBaseApi{
    ...
    { 
        Response add = new Api_SetBlueLedSettings().step1();       //set the blue LED [LOCATE DEVICE]
    }
    
    @AfterMethod(alwaysRun=true)
    public void teardown1()
    { 
        MyCommonAPIs.sleepi(300);                                   //wait till the locate device ends its timer of 5 mins
        ...
        .body("details.ledStatus", equalTo("0"));       // VERIFYING THE LOCATE DEVICE TIMER ENDs
    ...
    {      
        ...
        getResponse.then().body("response.status", equalTo(true));
        getResponse.then().body("response.message", equalTo("Blue LED settings info fetched successfully"))
        .body("details.ledStatus", equalTo("1"));       // VERIFYING THE LOCATE DEVICE IS SET
