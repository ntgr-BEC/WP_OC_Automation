...
public class Api_GetLedSettings extends TestCaseBaseApi{
    ...
    @Feature("VLAN Api_GetLedSettings") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test gets led settings of a device the Netgear APIs based on specific Network ID") // It's a testcase title from Jira Test Case.
