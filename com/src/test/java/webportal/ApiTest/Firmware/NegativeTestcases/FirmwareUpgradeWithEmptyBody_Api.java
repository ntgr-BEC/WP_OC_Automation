...
public class FirmwareUpgradeWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("FirmwareUpgradeWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T008") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("UPDATE Device Firmware with EMPTY Json") // It's a testcase title from Jira Test Case.
    ...
    public void step1()
    {
        ...
        .body("response.message", equalTo("Invalid command"));
}
}
