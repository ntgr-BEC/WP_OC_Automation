...
public class FirmwareUpgradeWithInvalidBody_Api extends TestCaseBaseApi{
    ...
    @Description("UPDATE Device Firmware with Invalid Json") // It's a testcase title from Jira Test Case.
    ...
    public void step1()
    {
        ...
        String requestBody="{\"fwInfo\":{\"fwUpgrade\":\"firmwareUpgrade\",\"serialNo\":\"6676dfds76f6r67r7tr6\"}}";
        ...
        .body("response.message", equalTo("Device not found."));
}
}
