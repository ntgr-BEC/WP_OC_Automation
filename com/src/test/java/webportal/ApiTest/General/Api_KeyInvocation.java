...
public class Api_KeyInvocation extends TestCaseBaseApi{

    Map<String, String> endPointUrl = new HashMap<String, String>();
    Map<String, String> headers = new HashMap<String, String>();

    @Feature("Api_KeyInvocation") // It's a folder/component name to make test suite more readable from Jira Test Case.
    ...
    { 
        ...
        String message = getResponse.jsonPath().getString("response.message");
        
        if ( message.equals("success")) {     
            System.out.println("Count of execution pass = " + i);
        }else {
         System.out.println("Count of execution fail " + i);
    }
        }
