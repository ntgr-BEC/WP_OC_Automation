...
public class Api_LocationNameSanity_b extends TestCaseBaseApi{
    ...
    @Feature("Location name more than 23") // It's a folder/component name to make test suite more readable from Jira Test Case.
    ...
    {        
        ...
        String requestBody="{\"networkInfo\":[{\"name\":\"NeasfgSKUGfasdfgskufgWSUFg\",\"adminPassword\":\"Netgear1@\",\"timeSettings\":{\"timeZone\":\"262\"},\"street\":\"\",\"city\":\"\",\"state\":\"\",\"postCode\":\"\",\"isoCountry\":\"US\"}]}";       
