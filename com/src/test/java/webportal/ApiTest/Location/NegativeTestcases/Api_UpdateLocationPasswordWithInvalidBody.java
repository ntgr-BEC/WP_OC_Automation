...
public class Api_UpdateLocationPasswordWithInvalidBody extends TestCaseBaseApi{
    ...
    @Feature("Api_UpdateLocationPasswordWithInvalidBody") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T007") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Updating the locations password with invalid Body") // It's a testcase title from Jira Test Case.
    ...
    public void step1()
    {
        ...
        String requestBody="{\"adminCred\":{\"adminUser\":\"admin\",\"password\":\"Pass\"}}";
        ...
        getResponse.then().body("response.message", equalTo("Invalid password. Password must be 8-20 characters, with at least one uppercase and one lowercase letter, and one numeral. Allowed special characters are: !@#$%^&()*"))
