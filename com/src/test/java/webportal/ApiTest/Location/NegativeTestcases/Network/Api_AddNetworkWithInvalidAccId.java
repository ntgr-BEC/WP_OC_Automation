...
public class Api_AddNetworkWithInvalidAccId extends TestCaseBaseApi{

    Map<String, String> endPointUrl = new HashMap<String, String>();
    Map<String, String> headers = new HashMap<String, String>();
    String networkId;
    
    @Feature("invalid acc_id") // It's a folder/component name to make test suite more readable from Jira Test Case.
    ...
    { 
            ...
            pathParams.put("accountId","66f3bcMe1ad78f467b7fad8b");
            ...
            Response getResponse = ApiRequest.sendPostRequest(endPointUrl.get("Add_Network"), requestBody1, headers, pathParams, null,400); 
