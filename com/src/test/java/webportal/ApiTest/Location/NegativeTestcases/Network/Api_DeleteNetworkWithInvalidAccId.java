...
public class Api_DeleteNetworkWithInvalidAccId extends TestCaseBaseApi{
    ...
    { 
            ...
            wrongHeaders.put("accountId","66f3bcMe1ad78f467b7fad8b");        
            wrongHeaders.put("networkId",networkId);
       
            
            //TO PERFORM ANY REQUEST
            Response getResponse2 = ApiRequest.sendDeleteRequest(endPointUrl.get("Network_Sanity"), wrongHeaders, pathParams, null); 
