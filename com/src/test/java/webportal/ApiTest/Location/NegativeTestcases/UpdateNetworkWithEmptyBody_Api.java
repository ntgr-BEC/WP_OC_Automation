...
public class UpdateNetworkWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("UpdateNetworkWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test retrieves updte netwok with empty body the Netgear APIs based on specific Network ID") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        Response getResponse2 = ApiRequest.sendPutRequest(endPointUrl.get("Network_Sanity"), requestBody2, headers, pathParamsupdate, null,400); 
