...
public class Api_DeleteNetwork extends TestCaseBaseApi{
    ...
    @Feature("Api_DeleteNetwork") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T006") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Deletes the network") // It's a testcase title from Jira Test Case.
