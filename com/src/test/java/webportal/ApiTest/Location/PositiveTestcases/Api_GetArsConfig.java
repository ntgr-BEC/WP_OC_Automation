...
public class Api_GetArsConfig extends TestCaseBaseApi{
    ...
    @Feature("Api_GetArsConfig") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test gets ARS config from the particular network ID") // It's a testcase title from Jira Test Case.
