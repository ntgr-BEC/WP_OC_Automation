...
public class Api_GetSNMPConfig extends TestCaseBaseApi{
    ...
    @Feature("Api_GetSNMPConfig") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test gets SNMP configuration from the particular API") // It's a testcase title from Jira Test Case.
...
//        headers.put("accountId",WebportalParam.accountId);
        ...
        Response getResponse = ApiRequest.sendGetRequest(endPointUrl.get("SNMP_Sanity"), headers, pathParams, null); 
