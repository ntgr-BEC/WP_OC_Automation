...
public class Api_GetSyslogSettings extends TestCaseBaseApi{
    ...
    @Feature("Api_GetSyslogSettings") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test gets syslog settings config from the particular network ID") // It's a testcase title from Jira Test Case.
