...
public class Api_GetSystemHealthDetails extends TestCaseBaseApi{
    ...
    @Feature("Api_GetSystemHealthDetails") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test gets system health details configuration from the particular API") // It's a testcase title from Jira Test Case.
