...
public class Api_UpdateLocationPassword extends TestCaseBaseApi{
    ...
    @Description("Updating the locations password") // It's a testcase title from Jira Test Case.
    ...
    {     Response add = new Api_AddNetwork().step1();
        ...
        String requestBody="{\"adminCred\":{\"adminUser\":\"admin\",\"password\":\"Pass@1232222\"}}";
