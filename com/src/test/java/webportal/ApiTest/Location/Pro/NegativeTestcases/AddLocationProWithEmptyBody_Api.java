...
public class AddLocationProWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("AddLocationProWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add network from pro account with empty body") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        Response getResponse = ApiRequest.sendPostRequest(endPointUrl.get("Add_Network_Pro"), requestBody, headers, pathParams, queryParams,400); 
