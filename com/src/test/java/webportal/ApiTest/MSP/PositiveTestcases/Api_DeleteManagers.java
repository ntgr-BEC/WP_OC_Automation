...
public class Api_DeleteManagers extends TestCaseBaseApi{
    ...
    @Feature("Api_DeleteManagers") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test deletes managers to a pro account") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        Response getResponse = ApiRequest.sendDeleteRequest(endPointUrl.get("Manager_Sanity"),headers, pathParams, null); 
