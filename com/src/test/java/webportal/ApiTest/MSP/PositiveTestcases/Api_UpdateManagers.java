...
public class Api_UpdateManagers extends TestCaseBaseApi{
    ...
    @Feature("Api_UpdateManagers") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test updates the manager account details to a pro account") // It's a testcase title from Jira Test Case.
