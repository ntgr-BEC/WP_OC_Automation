...
public class Api_AddNetworkWithInvalidAcctoken extends TestCaseBaseApi{
    ...
    { 
            ...
            headers.put("token","eyJraWQiOiJvc2FqOVNyemR1SWgrUTFRa3NqcTZpZU9EU25PYXFyQnY5ekFVV3pkT2lNPSI");
            ...
            Response getResponse1 = ApiRequest.sendPostRequest(endPointUrl.get("Add_Network"), requestBody1, headers, pathParamsadd, null, 200); 
