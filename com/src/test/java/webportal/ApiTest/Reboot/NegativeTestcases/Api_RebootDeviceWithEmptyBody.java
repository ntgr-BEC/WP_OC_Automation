...
public class Api_RebootDeviceWithEmptyBody extends TestCaseBaseApi{
    ...
    @Feature("Api_RebootDeviceWithEmptyBody") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T002") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Api_RebootDeviceWithEmptyBody") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        String requestBody="[{\"serialNo\":\"\",\"deviceType\":\"AP\"}]";
