...
public class Api_RebootDeviceWithEmptytoken extends TestCaseBaseApi{
    ...
    @Description("Api_RebootDeviceWithEmptytoken") // It's a testcase title from Jira Test Case.
