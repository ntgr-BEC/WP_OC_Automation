...
public class Api_DNSLookupTest extends TestCaseBaseApi{
    ...
    @Feature("Api_DNSLookupResults") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test  will troubleshoot the device with DNS lookup from the particular account") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        Response getResponse = ApiRequest.sendPostRequest(endPointUrl.get("DNSLookUp"), requestBody, headers, pathParams, null); 
