...
public class Api_PingTest extends TestCaseBaseApi{
    ...
    @Feature("Api_PingTest") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test will troubleshoot the device with ping test from the particular account") // It's a testcase title from Jira Test Case.
