...
public class CreateVlanWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("CreateVlanWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test creates VLAN with Empty Body") // It's a testcase title from Jira Test Case.
