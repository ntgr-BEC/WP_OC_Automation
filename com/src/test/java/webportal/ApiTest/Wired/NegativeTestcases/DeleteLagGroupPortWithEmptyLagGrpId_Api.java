...
public class DeleteLagGroupPortWithEmptyLagGrpId_Api extends TestCaseBaseApi{
    String networkId;
    String lagGroupId;
    String deviceId;
    ...
    @Feature("DeleteLagGroupPortWithEmptyLagGrpId_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Deletes the lag group by port with empty lag group ID ") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        pathParams.put("lagGroupId"," ");     //Empty lagGrp ID 
        ...
        getResponse.then().body("response.status", equalTo(false))
                          .body("response.message", equalTo("SwitchConfigLagGroup Info not found on network."));
