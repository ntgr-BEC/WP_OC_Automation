...
import webportal.ApiTest.Wired.PositiveTestcases.Api_SetStaticRoute;
...
public class DeleteStaticRouteWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("DeleteStaticRouteWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test deletes static route using Netgear APIs") // It's a testcase title from Jira Test Case.
