...
public class DeleteVlanIpAclSettingsWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("DeleteVlanIpAclSettingsWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test deletes Vlan IP ACL with empty jSon setting of the network") // It's a testcase title from Jira Test Case.
    ...
    public List<Response> step1()
    {
        ...
        .body("response.message", equalTo("Invalid action"));
        return response;
