...
public class GetLagGroupByIdWithEmptyLagGrpIdPPValue_Api extends TestCaseBaseApi{
    String networkId;
    String lagGroupId;
    String deviceId;
    ...
    @Feature("GetLagGroupByIdWithEmptyLagGrpIdPPValue_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Retrieves Data by laggroup Id with empty lag grp id path param value") // It's a testcase title from Jira Test Case.
