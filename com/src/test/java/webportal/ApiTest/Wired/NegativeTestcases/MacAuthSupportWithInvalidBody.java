...
public class MacAuthSupportWithInvalidBody extends TestCaseBaseApi{
    ...
    @Feature("MacAuthSupportWithInvalidBody") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test tries to creates enavles MAC Acl settings support with Invalid Json") // It's a testcase title from Jira Test Case.
...
//  not working
    ...
    public void step1()
    {
        ...
        String body="{\"macAuthenticationInfo\":{\"mode\":\"10\"}}";
