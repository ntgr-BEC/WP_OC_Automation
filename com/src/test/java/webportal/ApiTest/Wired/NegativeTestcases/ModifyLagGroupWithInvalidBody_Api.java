...
public class ModifyLagGroupWithInvalidBody_Api extends TestCaseBaseApi{
    ...
    @Feature("ModifyLagGroupWithInvalidBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Modifies_Lagport with Invalid"
            + " Json") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        String requestBody = "{\"lagConfig\":{\"lagObjectId\":\"1241224jhef23423rt23332\",\"adminMode\":1,\"lagMembers\":[{\"deviceId\":\"6732eb73901da5a5428853c4734073\",\"lagId\":\"0\",\"ports\":[6]}],\"name\":\"Lag001Test\",\"pvid\":1,\"type\":1}}";
        ...
        getResponse1.then().body("response.status", equalTo(false))
                          .body("response.message", equalTo("Invalid deviceId6732eb73901da5a5428853c4734073"));
