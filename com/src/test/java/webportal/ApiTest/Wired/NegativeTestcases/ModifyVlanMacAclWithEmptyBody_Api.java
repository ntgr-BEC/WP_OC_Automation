...
public class ModifyVlanMacAclWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Description("This test Modifies VLAN Mac Acl with empty body") // It's a testcase title from Jira Test Case.
