...
public class ModifyVlanMacAclWithInvalidBody_Api extends TestCaseBaseApi{
    ...
    @Feature("ModifyVlanMacAclWithInvalidBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test Modifies VLAN Mac Acl with invalid body") // It's a testcase title from Jira Test Case.
    ...
    public Response step1()
    {
        ...
        //Invalid srcmac and destmac
        String body="{\"macAclList\":{\"mode\":\"0\",\"action\":\"0\",\"macAclRule\":{\"custom\":[{\"aclName\":\"m11221122111111271145113150\",\"sequenceNo\":3,\"srcDeviceName\":\"Test033\",\"srcMac\":\"11:22::11:22:11:11\",\"srcMacMask\":\"00-00-00-00-00-00\",\"destDeviceName\":\"Test0044\",\"destMac\":\"11:2725:11:45:11:31\",\"destMacMask\":\"00-00-00-00-00-00\"}]}}}";
        ...
        getResponse.then().body("response.status", equalTo(false))
                          .body("response.message", equalTo("Failed to validate macAddress and macMaskAddress"));
