...
import webportal.ApiTest.Wired.PositiveTestcases.Api_SetVlanMembers;
...
public class ModifyVlanMembersWithInvalidBody_Api extends TestCaseBaseApi{
    ...
    @Feature("ModifyVlanMembersWithInvalidJson") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test Modifies VlanMembers with Invalid Json") // It's a testcase title from Jira Test Case.
   ...
   public void step1() throws Exception
   {
       ...
       String requestBody = "{\"vlanMembers\":{\"memberWirelessNetwork\":[],\"apPortMembers\":[],\"portMembers\":[{\"deviceId\":\"agfd65865hjg76587jh87876876\",\"taggedPorts\":[],\"untaggedPorts\":[\"15\",\"18\"]}],\"lanPortMembers\":[],\"wanPortMembers\":[],\"publicMembers\":[],\"employeeMembers\":[],\"guestMembers\":[],\"isMdnsEnabled\":false,\"lagMembers\":{\"tagged\":[],\"untagged\":[],\"portGrp\":[]},\"oldVlanId\":\""+vlanId+"\",\"nameChanged\":\"0\",\"bandChanged\":\"0\",\"vlanChanged\":\"0\"}}";

       Response getResponse = ApiRequest.sendPutRequest(endPointUrl.get("Modify_VlanMembers"), requestBody, headers, pathParams, null,400); 
