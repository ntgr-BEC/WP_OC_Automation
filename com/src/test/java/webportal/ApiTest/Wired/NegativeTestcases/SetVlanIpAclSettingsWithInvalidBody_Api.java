...
public class SetVlanIpAclSettingsWithInvalidBody_Api extends TestCaseBaseApi{
    ...
    @Feature("SetVlanIpAclSettingsWithInvalidBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test creates sets Vlan IP ACL setting with invalid Body of the network") // It's a testcase title from Jira Test Case.
