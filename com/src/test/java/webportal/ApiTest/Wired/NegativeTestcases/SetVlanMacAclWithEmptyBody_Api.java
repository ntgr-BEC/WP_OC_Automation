...
public class SetVlanMacAclWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Description("This test Sets VLAN Mac Acl with empty body") // It's a testcase title from Jira Test Case.
