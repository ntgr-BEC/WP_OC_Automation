...
public class SetVlanMembersWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("SetVlanMembersWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
