...
public class Api_AddLagPort extends TestCaseBaseApi{
    ...
    { 
        ...
        Response getResponse2 = ApiRequest.sendGetRequest(endPointUrl.get("LagGroup_Sanity"), headers, pathParams, null); 
        getResponse2.then().body("response.status", equalTo(true))
                          .body("response.message", equalTo("Success"));
        
        lagGroupId = getResponse2.jsonPath().getString("lagSettings[0].id");
