...
public class Api_DeleteStaticRoute extends TestCaseBaseApi{
    ...
    @Feature("Api_DeleteStaticRoute") // It's a folder/component name to make test suite more readable from Jira Test Case.
