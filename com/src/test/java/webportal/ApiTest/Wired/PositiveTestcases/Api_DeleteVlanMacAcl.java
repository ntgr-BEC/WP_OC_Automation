...
public class Api_DeleteVlanMacAcl extends TestCaseBaseApi{
    ...
    @Feature("Api_DeleteVlanMacAcl") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test deletes VLAN Mac Acl") // It's a testcase title from Jira Test Case.
    ...
    public List<Response> step1()
    {
        ...
        String body="{\"mode\":\"0\",\"action\":\"0\",\"manualAclNames\":[],\"customAclNames\":[\"m112211221111112711451131250\"]}";
