...
public class Api_GetIpAclSettings extends TestCaseBaseApi{
    ...
    @Feature("Api_GetIpAclSettings") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test creates retrieves IP ACL setting of the network") // It's a testcase title from Jira Test Case.
    ...
    public Response step1()
    {
        ...
        Response getResponse = ApiRequest.sendGetRequest(endPointUrl.get("Get_iPAcl"), headers, pathParams, null); 
