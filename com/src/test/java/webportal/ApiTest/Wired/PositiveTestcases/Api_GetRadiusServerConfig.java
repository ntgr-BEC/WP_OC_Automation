...
public class Api_GetRadiusServerConfig extends TestCaseBaseApi{
    ...
    @Description("This test retrieves Radius Server Config info from the Netgear APIs based on specific Network ID") // It's a testcase title from Jira Test Case.
    ...
    public void step1()
    {
        ...
        Response getResponse1 = ApiRequest.sendGetRequest(endPointUrl.get("RadiusServer_Sanity"), headers, null, null); 
        getResponse1.then().body("response.status", equalTo(true))
