...
public class Api_SetSpanningTree extends TestCaseBaseApi{
    ...
    @Feature("Api_SetSpanningTree") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test Sets Spanning tree") // It's a testcase title from Jira Test Case.
    ...
    {  
        //Enabling the spanning tree [default]
    ...
    public void step2() {
        ...
        Response add = new Api_GetSpanningTree().step1();     
    }
