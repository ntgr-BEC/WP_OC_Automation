...
public class Api_SetWiredRadiusPortConfig extends TestCaseBaseApi{
    ...
    @Feature("Api_SetWiredRadiusPortConfig") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("This test Set-Wired-RadiusPort-Config") // It's a testcase title from Jira Test Case.
    ...
    public void step1()
    {
        ...
        Response getResponse = ApiRequest.sendPutRequest(endPointUrl.get("Set_WiredRadius"), requestBody, headers, pathParams, null); 
