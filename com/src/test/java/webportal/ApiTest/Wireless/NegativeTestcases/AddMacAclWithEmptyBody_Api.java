...
public class AddMacAclWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Description("This test Adds MAC ACL config with Empty JSON") // It's a testcase title from Jira Test Case.
