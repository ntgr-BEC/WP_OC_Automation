...
public class UpdateSsidWithEmptyBody_Api extends TestCaseBaseApi{
    Map<String, String> headers = new HashMap<String, String>();
    Map<String, String> endPointUrl = new HashMap<String, String>();
    String networkId;
    
    @Feature("UpdateSsidWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Modifies the existing SSID with EmptyJSON") // It's a testcase title from Jira Test Case.
