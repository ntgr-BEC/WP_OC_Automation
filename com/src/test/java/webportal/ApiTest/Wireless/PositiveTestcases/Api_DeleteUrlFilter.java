...
public class Api_DeleteUrlFilter extends TestCaseBaseApi{
    ...
    @Feature("Api_DeleteUrlFilter") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T005") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Removes the URL filter") // It's a testcase title from Jira Test Case.
