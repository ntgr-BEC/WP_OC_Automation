...
public class Api_UpdateSsid extends TestCaseBaseApi{
    ...
    @Feature("Api_UpdateSsid") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T001") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Modifies the existing SSID") // It's a testcase title from Jira Test Case.
