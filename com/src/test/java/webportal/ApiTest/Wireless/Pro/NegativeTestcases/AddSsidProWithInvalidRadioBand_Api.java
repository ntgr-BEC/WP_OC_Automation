...
public class AddSsidProWithInvalidRadioBand_Api extends TestCaseBaseApi{
    ...
    @Feature("AddSsidProWithInvalidRadioBand_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    ...
    { 
        ...
        .body("response.message", equalTo("One of the request param is invalid"));
