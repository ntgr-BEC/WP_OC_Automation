...
public class ModifySsidProWithEmtyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("ModifySsidProWithEmtyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T004") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Modify ssid of pro account with empty json") // It's a testcase title from Jira Test Case.
