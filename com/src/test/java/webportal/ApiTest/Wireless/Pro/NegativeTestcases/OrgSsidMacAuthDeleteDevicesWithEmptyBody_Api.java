...
public class OrgSsidMacAuthDeleteDevicesWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("OrgSsidMacAuthDeleteDevicesWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T004") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Organization SSID MAC authentication delete devices with empty body.") // It's a testcase title from Jira Test Case.
