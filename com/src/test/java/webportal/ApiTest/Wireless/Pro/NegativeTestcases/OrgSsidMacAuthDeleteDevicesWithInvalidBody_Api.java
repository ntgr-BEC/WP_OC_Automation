...
import webportal.ApiTest.Wireless.Pro.PositiveTestcases.Api_OrgSsidMacAuthAddDevices;
...
public class OrgSsidMacAuthDeleteDevicesWithInvalidBody_Api extends TestCaseBaseApi{
    ...
    @Feature("OrgSsidMacAuthDeleteDevicesWithInvalidBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T004") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Organization SSID MAC authentication delete devices with Invalid body.") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        String requestBody="{\"deleteMacAclConfigInfo\":{\"macAuth\":\"0\",\"type\":\"0\",\"policy\":\"0\",\"macList\":[\"11-34--12-1233-44-66\"]}}";
        //TO PERFORM ANY REQUEST
    
        Response getResponse = ApiRequest.sendDeleteRequest(endPointUrl.get("OrgSsid_MacAuth"), requestBody, headers, pathParams, null); 
        getResponse.then().body("response.status", equalTo(false));
//        .body("orgNwInfo[0].message", equalTo("Successfully deleted in Database"))
