...
public class OrgSsidMacAuthUpdateDevicesWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Description("Organization SSID MAC authentication update devices with empty body.") // It's a testcase title from Jira Test Case.
