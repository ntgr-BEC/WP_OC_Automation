...
public class OrgSsidMacAuthUpdateDevicesWithInvalidBody_Api extends TestCaseBaseApi{
    ...
    @Feature("OrgSsidMacAuthUpdateDevicesWithInvalidBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T004") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Organization SSID MAC authentication update devices with Invalid Body.") // It's a testcase title from Jira Test Case.
...
//        getResponse.then().body("response.status", equalTo(true));
    ...
    { 
        ...
        String requestBody="{\"updateMacAclConfigInfo\":{\"macAuth\":\"0\",\"type\":\"0\",\"policy\":\"0\",\"macList\":[{\"deviceName\":\"Laptop2\",\"mac\":\"22:23:24:25:26:27\",\"previousMac\":\"11-34-1200-33--44-66\"}]}}";
