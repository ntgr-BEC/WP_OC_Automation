...
public class SetTrafficPoliciesLocSsidWithEmptyBody_Api extends TestCaseBaseApi{
    ...
    @Feature("SetTrafficPoliciesLocSsidWithEmptyBody_Api") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T004") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Get traffic policies (DHCP offer as unicast) from Location SSSID with EmptyJSON.") // It's a testcase title from Jira Test Case.
