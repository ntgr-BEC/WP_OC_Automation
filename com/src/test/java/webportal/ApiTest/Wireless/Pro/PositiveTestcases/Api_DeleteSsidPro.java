...
public class Api_DeleteSsidPro extends TestCaseBaseApi{
    ...
    @Feature("Api_DeleteSsidPro") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T004") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Deletes of ssid to pro account") // It's a testcase title from Jira Test Case.
