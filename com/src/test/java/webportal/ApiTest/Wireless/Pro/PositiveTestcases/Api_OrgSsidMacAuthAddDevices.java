...
public class Api_OrgSsidMacAuthAddDevices extends TestCaseBaseApi{
    ...
    @Feature("Api_OrgSsidMacAuthAddDevices") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T004") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Organization SSID MAC authentication add devices.") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        String requestBody="{\"macAclConfigInfo\":{\"macAuth\":\"1\",\"type\":\"0\",\"policy\":\"0\",\"macList\":[{\"deviceName\":\"Laptop1\",\"mac\":\"11:34:12:33:44:66\"}]}} or {\"macAuthInfo\":{\"macAuth\":\"1\",\"type\":\"0\",\"policy\":\"0\"}}";
