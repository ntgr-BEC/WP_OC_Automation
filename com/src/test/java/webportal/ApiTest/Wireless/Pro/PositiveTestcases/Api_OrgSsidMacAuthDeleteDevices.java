...
public class Api_OrgSsidMacAuthDeleteDevices extends TestCaseBaseApi{
    ...
    @Description("Organization SSID MAC authentication delete devices.") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        String requestBody="{\"deleteMacAclConfigInfo\":{\"macAuth\":\"0\",\"type\":\"0\",\"policy\":\"0\",\"macList\":[\"11-34-12-33-44-66\"]}}";
