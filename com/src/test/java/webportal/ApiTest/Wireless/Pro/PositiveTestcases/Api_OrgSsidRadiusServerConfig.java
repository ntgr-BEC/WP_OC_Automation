...
public class Api_OrgSsidRadiusServerConfig extends TestCaseBaseApi{
    ...
    @Description("Get organization SSID radius server configuration.") // It's a testcase title from Jira Test Case.
    ...
    { 
        ...
        Response getResponse = ApiRequest.sendGetRequest(endPointUrl.get("OrgSsid_RadiusServerConfig"), headers, pathParams, null); 
        getResponse.then().body("response.status", equalTo(true))
        .body("details.radiusConfigInfo.authenticationStatus802_1x", equalTo("1"));
