package webportal.AutoRRMSanity.PRJCBUGEN_T24287Belgium;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24287Belgium") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify instant wifi functionally as non pro user for country Belgium") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24287Belgium") // It's a testcase id/link from Jira Test Case.
...
//        new DevicesDashPage().checkDeviceInAdminAccount();
    ...
    public void step2() {
        ...
        locationInfo.put("Wireless Region", "Belgium");
