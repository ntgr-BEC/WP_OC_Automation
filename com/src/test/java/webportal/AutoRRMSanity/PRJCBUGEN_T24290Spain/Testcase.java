package webportal.AutoRRMSanity.PRJCBUGEN_T24290Spain;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24290Spain") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify instant wifi functionally as non pro user for country Spain") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24290Spain") // It's a testcase id/link from Jira Test Case.
