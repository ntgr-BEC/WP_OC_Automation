package webportal.AutoRRMSanity.PRJCBUGEN_T24292UK;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24292UK") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify instant wifi functionally as non pro user for country UK") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T24292UK") // It's a testcase id/link from Jira Test Case.
