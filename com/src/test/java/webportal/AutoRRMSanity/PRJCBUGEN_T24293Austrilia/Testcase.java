package webportal.AutoRRMSanity.PRJCBUGEN_T24293Austrilia;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24293Austrilia") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify instant wifi functionally as non pro user for country Austrilia") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T24293Austrilia") // It's a testcase id/link from Jira Test Case.
