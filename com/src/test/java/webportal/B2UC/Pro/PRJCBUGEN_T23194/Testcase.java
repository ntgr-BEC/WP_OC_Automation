package webportal.B2UC.Pro.PRJCBUGEN_T23194;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23194") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature Broadcast to unicast can be enabled ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23194") // It's a testcase id/link from Jira Test Case.
