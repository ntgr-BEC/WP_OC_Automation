package webportal.B2UC.ProManager.AllModel.PRJCBUGEN_T23217;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23217") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature B2UC gets configured across all the 505 AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23217") // It's a testcase id/link from Jira Test Case.
