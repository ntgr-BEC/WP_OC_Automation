package webportal.B2UC.ProManager.PRJCBUGEN_T23198;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23198") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T23198") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Delete device and enable B2UC")
    public void step2() {
