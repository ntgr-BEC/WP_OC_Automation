package webportal.B2UC.ProManager.PRJCBUGEN_T23200;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23200") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature Broadcast to unicast can be disabled ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T23200") // It's a testcase id/link from Jira Test Case.
