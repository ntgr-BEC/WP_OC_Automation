package webportal.B2UC.ProManager.PRJCBUGEN_T23205;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23205") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify the default state of the feature Broadcast to unicast ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T23205") // It's a testcase id/link from Jira Test Case.
