package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13633;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13633") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("001-Add a VPN policy with remote gateway IP address ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13633") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: verify all data on device side")
    public void step4() {
        ...
        assertTrue(tocheck.Dump().contains(bripsvp.testData.remoteGw), "verify remote_host: " + bripsvp.testData.remoteGw);
