package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13634;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13634") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("002-Establish gateway to gateway VPN tunnel with FQDN") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13634") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        bripsvp.gotoPage();
        bripsvp.testData.remoteGw = "test.domain.com";
        bripsvp.testData.phase1Proposal1 = "sha1-aes128-dh2";
        bripsvp.testData.phase2Proposal1 = "esp-sha1-aes128";
        bripsvp.addPolicy();
    }
    ...
    @Step("Test Step 4: On webportal and DUT,the remote gateway display correctly")
    public void step4() {
