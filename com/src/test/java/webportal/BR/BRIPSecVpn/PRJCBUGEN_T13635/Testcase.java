package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13635;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13635") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("004-Establish vpn with 128 chars pre-shared key") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13635") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: IN DUT1, config IKE policy,remote gateway input DUT2's DNS name")
    public void step2() {
        bripsvp.testData.policyName = bripsvp.testData.policyName + testcaseId;
        bripsvp.gotoPage();
        bripsvp.testData.preShardkey = "Netgear1@1" + RandomStringUtils.randomAlphanumeric(54);
        bripsvp.testData.phase1Proposal1 = "sha256-aes192-dh5";
    ...
    @Step("Test Step 4: On webportal and DUT,the pre-shared key display correctly")
    public void step4() {
