package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13651;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13651") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("035-Edit VPN Policy,change pre-shared key") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13651") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Edit VPN policy:pre-shared key edit to !@#$%^&* after created")
    public void step2() {
        ...
        bripsvp.testData.preShardkey = "Netgear1@1" + "!@#$%^&*";
        bripsvp.addPolicy();
    }
