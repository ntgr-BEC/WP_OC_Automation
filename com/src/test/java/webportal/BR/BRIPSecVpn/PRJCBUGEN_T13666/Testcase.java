package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13666;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13666") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("062-Phase-1 Settings:config 4 proposal,only 1 is same between dut1 and dut2") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13666") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: On DUT1 config phase-1 setting")
    public void step2() {
        bripsvp.testData.policyName = bripsvp.testData.policyName + testcaseId;
        bripsvp.gotoPage();
        bripsvp.testData.phase1Proposal1 = "sha256-aes192-dh5";
        bripsvp.testData.phase1Proposal2 = "md5-aes128-dh1";
        bripsvp.testData.phase1Proposal3 = "md5-aes128-dh2";
        bripsvp.testData.phase1Proposal4 = "md5-aes128-dh5";
        bripsvp.addPolicy();
    }
