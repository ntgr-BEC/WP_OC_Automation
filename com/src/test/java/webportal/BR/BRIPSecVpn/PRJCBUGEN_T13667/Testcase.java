package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13667;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13667") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("063-Phase-1 Settings:config 4 proposal,2 is same between dut1 and dut2") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13667") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        bripsvp.gotoPage();
        bripsvp.testData.phase1Proposal1 = "sha1-aes192-dh18";
        bripsvp.testData.phase1Proposal2 = "sha1-aes192-dh19";
        bripsvp.testData.phase1Proposal3 = "sha1-3des-dh1";
        bripsvp.testData.phase1Proposal4 = "sha1-3des-dh2";
        bripsvp.addPolicy();
    }
