package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13668;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13668") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("064-Phase-1 Settings:config 4 proposal,3 is same between dut1 and dut2") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13668") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        bripsvp.gotoPage();
        bripsvp.testData.phase1Proposal1 = "md5-aes256-dh20";
        bripsvp.testData.phase1Proposal2 = "md5-aes256-dh21";
        bripsvp.testData.phase1Proposal3 = "md5-aes256-dh22";
        bripsvp.testData.phase1Proposal4 = "sha1-3des-dh1";
        bripsvp.addPolicy();
    }
