package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13672;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13672") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("068-Phase-1 Settings:Only config 1 proposal,it is different between 2 devices") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13672") // It's a testcase id/link from Jira Test Case.
