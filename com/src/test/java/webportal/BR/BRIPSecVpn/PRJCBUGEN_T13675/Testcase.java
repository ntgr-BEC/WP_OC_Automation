package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13675;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13675") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("071-Establish vpn with Exchange Mode \"Aggressive Mode\"") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13675") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        bripsvp.gotoPage();
        bripsvp.testData.exchangeMode = 1;
        bripsvp.addPolicy();
    }
    ...
    public void step5() {
        ...
        assertTrue(tocheck.Dump().contains("aggressive"), "verify to aggressive from main");
    }
}
