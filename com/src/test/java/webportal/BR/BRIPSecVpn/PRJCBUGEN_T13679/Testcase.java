package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13679;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13679") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("076-Phase-2 Settings:config 4 proposal,2 is same between dut1 and dut2") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13679") // It's a testcase id/link from Jira Test Case.
