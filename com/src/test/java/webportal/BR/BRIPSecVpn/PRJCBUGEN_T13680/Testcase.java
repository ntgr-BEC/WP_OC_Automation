package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13680;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13680") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("093-Phase-2 Settings:config 4 proposal,3 is same between dut1 and dut2") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13680") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        bripsvp.testData.phase2Proposal2 = "esp-md5-aes256";
