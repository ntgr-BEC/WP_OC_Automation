package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13681;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13681") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("077-Phase-2 Settings:config 4 proposal,4 is same between dut1 and dut2") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13681") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        bripsvp.gotoPage();
        bripsvp.testData.phase2Proposal1 = "esp-sha256-3des";
        bripsvp.testData.phase2Proposal2 = "esp-sha256-aes256";
        bripsvp.testData.phase2Proposal3 = "esp-sha256-aes128";
        bripsvp.testData.phase2Proposal4 = "esp-sha256-aes192";
        bripsvp.addPolicy();
    }
