package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13682;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13682") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("078-Phase-2 Settings:config 4 proposa,all proposal is different") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13682") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        bripsvp.gotoPage();
        bripsvp.testData.phase2Proposal1 = "esp-sha384-3des";
        bripsvp.testData.phase2Proposal2 = "esp-sha384-aes256";
        bripsvp.testData.phase2Proposal3 = "esp-sha384-aes128";
        bripsvp.testData.phase2Proposal4 = "esp-sha384-aes192";
        bripsvp.addPolicy();
    }
