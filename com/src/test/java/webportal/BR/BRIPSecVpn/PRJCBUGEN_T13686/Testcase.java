package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13686;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13686") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("084-Phase-2 settings:SA-Lifetime input check (600-604800)") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13686") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        bripsvp.openAdv();
        bripsvp.txtph2SaLifetime.setValue("0");
        bripsvp.btnSave.click();
        assertTrue(handle.getPageErrorMsg().length() > 10, "check msg on 0 value");

        bripsvp.txtph2SaLifetime.setValue("999999");
        bripsvp.btnSave.click();
        assertTrue(handle.getPageErrorMsg().length() > 10, "check msg on 999999 value");
    }

    @Step("Test Step 3: SA-Lifetime (sec): 600")
    public void step3() {
        bripsvp.txtph2SaLifetime.setValue("600");
        bripsvp.btnSave.click();
    }
    ...
    public void step4() {
        bripsvp.openPolicy(bripsvp.testData.policyName);
        bripsvp.openAdv();
        bripsvp.txtph2SaLifetime.setValue("604800");
        bripsvp.btnSave.click();
    }
