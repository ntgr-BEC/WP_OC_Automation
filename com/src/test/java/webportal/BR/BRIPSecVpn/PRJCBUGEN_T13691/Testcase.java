package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13691;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13691") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("089-PFS change from dh1 to dh15") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13691") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: webportal create a vpn policy,PFS is df1")
    public void step2() {
        bripsvp.testData.phase2PFS = tomatch;
        bripsvp.gotoPage();
        bripsvp.addPolicy();
    }
    ...
    public void step3() {
        ...
        assertTrue(tocheck.Dump().contains(tomatch), "verify new pfs is: " + tomatch);
    }

    @Step("Test Step 4: webportal edit vpn policy,PFS change to dh15")
    public void step4() {
        tomatch = "dh15";
