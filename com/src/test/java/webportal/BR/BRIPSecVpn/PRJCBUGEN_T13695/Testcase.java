package webportal.BR.BRIPSecVpn.PRJCBUGEN_T13695;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13695") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("096-Establish vpn with IKE2,phase1 proposal use sha384-aes256-dh14,phase2 proposal use esp-sha512-aes256") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13695") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Establish vpn with IKE2,phase1 proposal use sha384-aes256-dh14,phase2 proposal use esp-sha512-aes256")
    public void step2() {
