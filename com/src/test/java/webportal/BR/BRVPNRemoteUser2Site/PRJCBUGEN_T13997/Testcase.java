package webportal.BR.BRVPNRemoteUser2Site.PRJCBUGEN_T13997;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13997") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("018-The year for copyright should be correct") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13997") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Click About,check insight vpn client Copyright")
    public void step4() {
        assertTrue(new VPNClient().checkCopyright(sUser, WebportalParam.loginPassword), "check copyright in about");
    }
}
