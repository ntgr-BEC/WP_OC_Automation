package webportal.BR.BRVPNRemoteUser2Site.PRJCBUGEN_T13998;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13998") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("019-Diggonosis Tool work fine") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13998") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Diagnosis Tool can work,list correct for Test")
    public void step4() {
        assertTrue(new VPNClient(sUser).callStumb("checkDiagnosisTool"));
    }
}
