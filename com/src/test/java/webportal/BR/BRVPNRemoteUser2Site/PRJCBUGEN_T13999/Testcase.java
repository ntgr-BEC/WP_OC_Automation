package webportal.BR.BRVPNRemoteUser2Site.PRJCBUGEN_T13999;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13999") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("020-Remember password can work") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13999") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Login vpn insight client,select \"Remember Password\"")
    public void step4() {
        assertTrue(new VPNClient(sUser).callStumb("checkRemember"));
    }
}
