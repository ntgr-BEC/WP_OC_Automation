package webportal.BR.BRVPNRemoteUser2Site.PRJCBUGEN_T14003;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14003") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("022-Login insight vpn client use wrong account or password") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14003") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Login insight vpn client use wrong SSO account")
    public void step4() {
        assertTrue(new VPNClient(sUser).callStumb("checkLoginWithWrongAccount"));
    }
}
