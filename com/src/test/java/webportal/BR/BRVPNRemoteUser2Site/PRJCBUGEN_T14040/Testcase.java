package webportal.BR.BRVPNRemoteUser2Site.PRJCBUGEN_T14040;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14040") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("030-Select all vpn group to favorite") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14040") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        assertTrue(new VPNClient(sUser).callStumb("checkFavorite"));
    }
}
