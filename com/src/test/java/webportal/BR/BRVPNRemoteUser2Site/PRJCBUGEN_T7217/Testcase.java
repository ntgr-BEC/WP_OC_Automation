package webportal.BR.BRVPNRemoteUser2Site.PRJCBUGEN_T7217;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7217") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("004-Login/out VPN client with Netgear SSO account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7217") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Login VPN client with Netgear SSO;")
    public void step4() {
        assertTrue(new VPNClient().LoginOut(sUser, WebportalParam.loginPassword), sUser + " cannot be login or logout");
    }
}
