package webportal.BR.BRVPNRemoteUser2Site.PRJCBUGEN_T7224;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7224") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("011-VPN client is latest version,update it online") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7224") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: 2.Set all groups to favorite vpn group")
    public void step4() {
        assertTrue(new VPNClient(sUser).callStumb("VPNClientCheckUpdate"));
    }
}
