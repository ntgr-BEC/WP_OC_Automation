package webportal.BR.BRVPNRemoteUser2Site.PRJCBUGEN_T7226;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7226") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("002-Notify to user when add account by Insight") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7226") // It's a testcase id/link from Jira Test Case.
