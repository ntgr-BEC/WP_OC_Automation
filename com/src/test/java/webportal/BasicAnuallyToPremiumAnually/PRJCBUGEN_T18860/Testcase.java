package webportal.BasicAnuallyToPremiumAnually.PRJCBUGEN_T18860;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18860") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Basic Anually to premium yearly Subscription for  Lithuania country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18860") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Check buy  basic  subscription in Country Lithuania;")
    public void step2() {
