package webportal.BasicAnuallyToPremiumAnually.PRJCBUGEN_T18870;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18870") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Basic Anually to premium yearly Subscription for  Hungary country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18870") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18870");
