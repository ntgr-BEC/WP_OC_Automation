package webportal.BasicAnuallyToPremiumAnually.PRJCBUGEN_T18875;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18875") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Basic Anually to premium yearly Subscription for  Romania country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18875") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Check buy  basic  subscription in Country Romania;")
    public void step2() {
    ...
    @Step("Test Step 8: cancel Subscription")
    public void step8() {
