package webportal.BasicAnuallyToPremiumTrail.PRJCBUGEN_T18800;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18800") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Basic Anually to premium trail Subscription for  Canada country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18800") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Check buy  basic subscription in Country Canada;")
    public void step2() {
...
//        paymentInfo.put("Email", mailname + "@mailinator.com");
    ...
    @Step("Test Step 5: Add device and check whether it throws error while adding fourth device;")
    public void step5() {
