package webportal.BasicToBasicAnnually.PRJCBUGEN_T18539;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18539") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Basic paid Subscription for Australia country (one device)") // It's a testcase title
    // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18539") // It's a testcase id/link from Jira Test Case.
