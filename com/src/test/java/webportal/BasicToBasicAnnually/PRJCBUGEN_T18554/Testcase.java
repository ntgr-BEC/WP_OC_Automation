package webportal.BasicToBasicAnnually.PRJCBUGEN_T18554;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18554") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Basic paid Subscription for Finland country (one device)") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18554") // It's a testcase id/link from Jira Test Case.
