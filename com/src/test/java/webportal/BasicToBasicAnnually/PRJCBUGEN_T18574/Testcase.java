package webportal.BasicToBasicAnnually.PRJCBUGEN_T18574;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18574") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Basic paid Subscription for Denmark country (one device)") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18574") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18574");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18574");
