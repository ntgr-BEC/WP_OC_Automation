package webportal.BasicToBasicAnnually.PRJCBUGEN_T18576;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18576") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Basic paid Subscription for Switzerland country (one device)") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18576") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18576");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18576");
