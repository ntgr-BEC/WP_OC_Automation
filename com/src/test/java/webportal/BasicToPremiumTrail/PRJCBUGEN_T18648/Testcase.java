package webportal.BasicToPremiumTrail.PRJCBUGEN_T18648;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18648") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail Subscription for Spain country") // It's a testcase title
    // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18648") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18648");
