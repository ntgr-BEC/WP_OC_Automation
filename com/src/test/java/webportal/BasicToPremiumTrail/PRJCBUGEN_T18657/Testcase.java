package webportal.BasicToPremiumTrail.PRJCBUGEN_T18657;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18657") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail Subscription for Luxembourg country") // It's a testcase title
    // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18657") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18657");
