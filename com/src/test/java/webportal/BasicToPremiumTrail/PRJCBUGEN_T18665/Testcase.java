package webportal.BasicToPremiumTrail.PRJCBUGEN_T18665;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18665") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail Subscription for Hong Kong country") // It's a testcase title
    // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18665") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18665");
