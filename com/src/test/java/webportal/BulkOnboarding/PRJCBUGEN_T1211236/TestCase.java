package webportal.BulkOnboarding.PRJCBUGEN_T1211236;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T1211236";
    ...
    @Story("PRJCBUGEN_T1211236") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is able to add 50   devicesfrom device screens.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T1211236") // It's a testcase id/link from Jira Test Case.
...
//        DeviceBulkOnboardingPage.GoToSummaryPage(locationName);
        ...
        filePath = filePath + "PRJCBUGEN_T1211236\\Bulkonbord.csv";
