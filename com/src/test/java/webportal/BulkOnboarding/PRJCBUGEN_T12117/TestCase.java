package webportal.BulkOnboarding.PRJCBUGEN_T12117;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T12117";
    String locationName     = "change";
    ...
    @Story("PRJCBUGEN_T12117") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is able to add bulk devices from Router screens.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T12117") // It's a testcase id/link from Jira Test Case.
...
//        hamburgearMenuPage.configCreditAllocation(organizationName, 3, 0, 0);
        ...
        filePath = filePath + "PRJCBUGEN_T12117\\Bulkonbord.csv";
        System.out.println(filePath);
        
        new DeviceBulkOnboardingPage().ImportCvsFileRouterscreen(filePath);
        assertTrue(new DevicesDashPage(false).checkNumberOfDevicesOrganization().equals("Threedevice"), "More device exits");
        
////        Result = DeviceBulkOnboardingPage.addMultiDeviceButtonExistOrNOT();
//        System.out.print(Result);
//        if (Result == true) {
//            micResult =  true;
//            assertTrue(micResult,"Pass:\"Add Multi Device\" button exist !");  
//        }else {
//            micResult =  false;
//            assertTrue(micResult,"Failed:\"Add Multi Device\" button not existS !"); 
//        } 
    }
