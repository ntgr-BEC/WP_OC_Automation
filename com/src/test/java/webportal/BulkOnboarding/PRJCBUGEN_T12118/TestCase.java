package webportal.BulkOnboarding.PRJCBUGEN_T12118;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T12118";
    ...
    @Story("PRJCBUGEN_T12118") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is able to add bulk devices from Mobile screens.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T12118") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T12118\\Bulkonbord.csv";
        System.out.println(filePath);
        
        new DeviceBulkOnboardingPage().ImportCvsFileMobilescreen(filePath);
