package webportal.BulkOnboarding.PRJCBUGEN_T12119;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T12119";
    ...
    @Story("PRJCBUGEN_T12119") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is able to add bulk devices from wireless screens.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T12119") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T12119\\Bulkonbord.csv";
