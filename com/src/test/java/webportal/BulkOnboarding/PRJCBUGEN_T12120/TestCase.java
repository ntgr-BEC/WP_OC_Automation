package webportal.BulkOnboarding.PRJCBUGEN_T12120;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T12120";
    ...
    @Story("PRJCBUGEN_T12120") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is able to add bulk devices from Wired screens.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T12120") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T12120\\Bulkonbord.csv";
        System.out.println(filePath);
        
        new DeviceBulkOnboardingPage().ImportCvsFileWiredscreen(filePath);
