package webportal.BulkOnboarding.PRJCBUGEN_T15088;
...
public class TestCase extends TestCaseBase  {
    String organizationName = "PRJCBUGEN_T15088";
    String locationName     = "BulkOnboarding";
    String warning   = "2 errors found. The following devices were not added due to errors. If you want to add these devices, check the name, serial number, or location of each device, and then try again, or you can continue without these devices at this time.";
    ...
    @Story("PRJCBUGEN_T15088") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify what happens if user clicks on \"Skip\" button in the  \"Add Multiple Device\" page where for few devices \"location not found \" and  for few devices \" Device name is invalid \" error message is shown") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T15088") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3 () throws IOException  {
        ...
        filePath = filePath + "PRJCBUGEN_T15088\\Device.csv";
        
        System.out.println(filePath);
        String warningForWrongFormat = DeviceBulkOnboardingPage.ImportCvsFileWithmultierrors(filePath);
