package webportal.BusinessVPNPayment.EmployeeHome.PRJCBUGEN_T27560;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27560") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Employee Home - Canada ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27560") // It's a testcase id/link from Jira Test Case.
