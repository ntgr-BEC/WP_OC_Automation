package webportal.BusinessVPNPayment.EmployeeHome.PRJCBUGEN_T27565;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Employee Home - US ") // It's a testcase title from Jira Test Case.
