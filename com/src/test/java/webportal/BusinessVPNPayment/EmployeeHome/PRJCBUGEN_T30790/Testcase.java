package webportal.BusinessVPNPayment.EmployeeHome.PRJCBUGEN_T30790;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Employee Home - Cyprus ") // It's a testcase title from Jira Test Case.
