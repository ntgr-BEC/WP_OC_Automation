package webportal.BusinessVPNPayment.EmployeeHome.PRJCBUGEN_T30791;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Business VPN Payment and Subscription Employee Home") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T27565") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Employee Home - Czech Republic ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27565") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Subscription Type", "Employee Home Site");
