package webportal.BusinessVPNPayment.EmployeeHome.PRJCBUGEN_T30792;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Employee Home - Croatia ") // It's a testcase title from Jira Test Case.
