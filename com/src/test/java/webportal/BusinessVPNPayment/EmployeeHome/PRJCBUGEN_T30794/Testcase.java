package webportal.BusinessVPNPayment.EmployeeHome.PRJCBUGEN_T30794;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Employee Home - Malta ") // It's a testcase title from Jira Test Case.
