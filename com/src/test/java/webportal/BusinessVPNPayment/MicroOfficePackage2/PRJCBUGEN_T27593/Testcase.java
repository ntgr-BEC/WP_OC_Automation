package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T27593;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Business VPN Payment and Subscription MicroOfficePackage2") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T27593") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Australia ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27593") // It's a testcase id/link from Jira Test Case.
