package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T27601;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27601") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Hungary ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27601") // It's a testcase id/link from Jira Test Case.
