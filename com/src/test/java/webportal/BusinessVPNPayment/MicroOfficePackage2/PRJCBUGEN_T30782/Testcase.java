package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T30782;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Austria ") // It's a testcase title from Jira Test Case.
  ...
  Map<String, String> firststdevInfo = new HashMap<String, String>();
    ...
    public void step4() {
        ...
        paymentInfo.put("Street Address", "Vienna");
        paymentInfo.put("City", "Vienna ");
        paymentInfo.put("Zip", "A1070");
        paymentInfo.put("Country", "Austria");
        paymentInfo.put("State", "Vienna");
