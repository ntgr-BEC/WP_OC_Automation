package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T30855;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Cyprus ") // It's a testcase title from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Street Address", "Poseidonos Avenue");
        paymentInfo.put("City", "Paphos");
        paymentInfo.put("Zip", "8125");
        paymentInfo.put("Country", "Cyprus");
        paymentInfo.put("State", "Paphos");
