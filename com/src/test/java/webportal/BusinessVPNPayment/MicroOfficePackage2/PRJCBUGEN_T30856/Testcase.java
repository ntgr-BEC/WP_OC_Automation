package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T30856;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27619") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Czech Republic ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27619") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Street Address", "Prague");
        paymentInfo.put("City", "Prague");
        paymentInfo.put("Zip", "15000");
        paymentInfo.put("Country", "Czech Republic");
        paymentInfo.put("State", "Prague");
