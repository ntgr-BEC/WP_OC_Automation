package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T30857;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Croatia ") // It's a testcase title from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Street Address", "Cavtat");
        paymentInfo.put("City", "Cavtat");
        paymentInfo.put("Zip", "20210");
        paymentInfo.put("Country", "Croatia");
        paymentInfo.put("State", "Cavtat");
