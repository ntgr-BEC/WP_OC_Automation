package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T30858;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Latvia ") // It's a testcase title from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Street Address", "Centra rajons");
        paymentInfo.put("City", "Riga");
        paymentInfo.put("Zip", "LV1010");
        paymentInfo.put("Country", "Latvia");
        paymentInfo.put("State", "Riga");
