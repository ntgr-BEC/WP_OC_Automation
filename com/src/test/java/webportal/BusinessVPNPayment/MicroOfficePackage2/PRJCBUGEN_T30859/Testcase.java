package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T30859;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Malta ") // It's a testcase title from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Street Address", "Julians");
        paymentInfo.put("City", "Julians");
        paymentInfo.put("Zip", "STJ3310");
        paymentInfo.put("Country", "Malta");
        paymentInfo.put("State", "Julians");
