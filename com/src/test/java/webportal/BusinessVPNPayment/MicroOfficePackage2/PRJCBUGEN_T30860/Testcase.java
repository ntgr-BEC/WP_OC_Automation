package webportal.BusinessVPNPayment.MicroOfficePackage2.PRJCBUGEN_T30860;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Micro Office - 15 User - Slovenia ") // It's a testcase title from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Street Address", "Portorose"); 
        paymentInfo.put("City", "Portorose");
        paymentInfo.put("Zip", "6320");
        paymentInfo.put("Country", "Slovenia");
        paymentInfo.put("State", "Portorose");
