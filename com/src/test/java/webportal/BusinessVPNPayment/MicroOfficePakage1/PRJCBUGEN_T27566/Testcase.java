package webportal.BusinessVPNPayment.MicroOfficePakage1.PRJCBUGEN_T27566;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Business VPN Payment and Subscription MicroOfficePakage1") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T27566") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Micro Office - 9 User - US ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27566") // It's a testcase id/link from Jira Test Case.
