package webportal.BusinessVPNPayment.MicroOfficePakage1.PRJCBUGEN_T27573;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27573") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Micro Office - 9 User - Greece ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27573") // It's a testcase id/link from Jira Test Case.
