package webportal.BusinessVPNPayment.MicroOfficePakage1.PRJCBUGEN_T27580;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27580") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Micro Office - 9 User - Luxembourg ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27580") // It's a testcase id/link from Jira Test Case.
