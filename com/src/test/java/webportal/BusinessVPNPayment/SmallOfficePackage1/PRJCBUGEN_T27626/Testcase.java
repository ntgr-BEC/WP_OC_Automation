package webportal.BusinessVPNPayment.SmallOfficePackage1.PRJCBUGEN_T27626;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27626") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Small Office - 25 User - Greece ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27626") // It's a testcase id/link from Jira Test Case.
