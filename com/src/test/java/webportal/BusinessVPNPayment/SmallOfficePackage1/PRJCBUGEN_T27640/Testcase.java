package webportal.BusinessVPNPayment.SmallOfficePackage1.PRJCBUGEN_T27640;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27640") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Small Office - 25 User - Singapore ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27640") // It's a testcase id/link from Jira Test Case.
