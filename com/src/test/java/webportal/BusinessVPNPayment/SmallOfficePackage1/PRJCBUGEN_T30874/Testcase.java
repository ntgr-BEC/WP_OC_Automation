package webportal.BusinessVPNPayment.SmallOfficePackage1.PRJCBUGEN_T30874;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Business VPN Payment and Subscription Small Office - 25 User") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T27646") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Small Office - 25 User - Czech Republic ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27646") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Subscription Type", "Small Office - 25 User");
