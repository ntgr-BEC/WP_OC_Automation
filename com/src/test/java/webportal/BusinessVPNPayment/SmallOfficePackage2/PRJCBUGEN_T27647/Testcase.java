package webportal.BusinessVPNPayment.SmallOfficePackage2.PRJCBUGEN_T27647;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Business VPN Payment and Subscription SmallOfficePackage2") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T27647") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Small Office - 50 User - Australia ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27647") // It's a testcase id/link from Jira Test Case.
