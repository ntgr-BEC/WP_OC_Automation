package webportal.BusinessVPNPayment.SmallOfficePackage2.PRJCBUGEN_T27663;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27663") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy Business VPN license for Small Office - 50 User - Norway ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27663") // It's a testcase id/link from Jira Test Case.
