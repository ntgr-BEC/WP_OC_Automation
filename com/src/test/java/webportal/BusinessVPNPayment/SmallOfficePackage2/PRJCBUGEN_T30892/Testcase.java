package webportal.BusinessVPNPayment.SmallOfficePackage2.PRJCBUGEN_T30892;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Small Office - 50 User - Czech Republic ") // It's a testcase title from Jira Test Case.
