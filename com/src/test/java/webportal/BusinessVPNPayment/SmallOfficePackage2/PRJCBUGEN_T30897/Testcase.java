package webportal.BusinessVPNPayment.SmallOfficePackage2.PRJCBUGEN_T30897;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy Business VPN license for Small Office - 50 User - Slovakia ") // It's a testcase title from Jira Test Case.
