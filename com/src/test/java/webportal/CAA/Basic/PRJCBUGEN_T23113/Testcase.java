package webportal.CAA.Basic.PRJCBUGEN_T23113;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23113") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country Sweden shows the purchase currency symbol in sek") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23113") // It's a testcase id/link from Jira Test Case.
...
//        webportalLoginPage.loginByUserPassword("apwptest9645108@mailinator.com", "Netgear#123");
    ...
    public void step2() {
        ...
        paymentInfo.put("Country", "Sweden");
