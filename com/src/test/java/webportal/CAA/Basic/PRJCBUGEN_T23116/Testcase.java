package webportal.CAA.Basic.PRJCBUGEN_T23116;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23116") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country New Zealand shows the purchase currency symbol in  nzd") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23116") // It's a testcase id/link from Jira Test Case.
...
//        webportalLoginPage.loginByUserPassword("apwptest9645108@mailinator.com", "Netgear#123");
    ...
    @Step("Test Step 2: Check buy  basic  subscription in Country New Zealand;")
    public void step2() {
