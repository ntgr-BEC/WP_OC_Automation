package webportal.CAA.Basic.PRJCBUGEN_T23118;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23118") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country czech Republic shows the purchase currency symbol in  czk") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23118") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Create IM WP account in czech Republic success;")
    public void step1() {
...
//        webportalLoginPage.loginByUserPassword("apwptest7692277@mailinator.com", "Netgear#123");
    ...
    public void step2() {
        ...
        paymentInfo.put("Street Address", "Czech Republic");
        paymentInfo.put("City", "city");
        paymentInfo.put("Zip", "4567");
    ...
    public void step4() {
        ...
        locationInfo.put("Zip Code", "4567");
