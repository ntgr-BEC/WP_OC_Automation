package webportal.CAA.Basic.PRJCBUGEN_T23119;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23119") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country Hungary shows the purchase currency symbol in  huf") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23119") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Create IM WP account in Hungary success;")
    public void step1() {
...
//        webportalLoginPage.loginByUserPassword("apwptest9645108@mailinator.com", "Netgear#123");
    ...
    @Step("Test Step 2: Check buy  basic  subscription in Country Hungary;")
    public void step2() {
    ...
    public void step4() {
        ...
        locationInfo.put("Zip Code", "1056");
        locationInfo.put("Country", "Hungary");
    ...
    public void step5() {
        ...
        CaptivePortalPaymentInfo.put("Last Name", "T24128");
        ...
        CaptivePortalPaymentInfo.put("Street Address", "Vaci Utca");
        CaptivePortalPaymentInfo.put("City", "Budapest");
        CaptivePortalPaymentInfo.put("Zip", "1056");
        CaptivePortalPaymentInfo.put("Country", "Hungary");
        CaptivePortalPaymentInfo.put("State", "Budapest  ");
