package webportal.CAA.Basic.PRJCBUGEN_T23120;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23120") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country Denmark shows the purchase currency symbol in  dkk") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23120") // It's a testcase id/link from Jira Test Case.
