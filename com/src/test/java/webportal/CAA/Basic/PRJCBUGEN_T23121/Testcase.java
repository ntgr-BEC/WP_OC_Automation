package webportal.CAA.Basic.PRJCBUGEN_T23121;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23121") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country Switzerland shows the purchase currency symbol in  chf") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23121") // It's a testcase id/link from Jira Test Case.
