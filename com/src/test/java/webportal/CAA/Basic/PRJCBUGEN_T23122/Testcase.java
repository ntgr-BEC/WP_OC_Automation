package webportal.CAA.Basic.PRJCBUGEN_T23122;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23122") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country South Korea shows the purchase currency symbol in  kr") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23122") // It's a testcase id/link from Jira Test Case.
...
//        webportalLoginPage.loginByUserPassword("apwptest9645108@mailinator.com", "Netgear#123");
        ...
        accountInfo.put("Country", "South Korea");

        new HamburgerMenuPage(false).createAccount(accountInfo);
    }

    @Step("Test Step 2: Check buy  basic  subscription in Country Sweden;")
    public void step2() {
        Map<String, String> paymentInfo = new HashMap<String, String>();
        paymentInfo.put("Number of Device Credits", "1");
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T23113");
        paymentInfo.put("Email", mailname + "@mailinator.com");
        paymentInfo.put("Street Address", "Strandgatan");
        paymentInfo.put("City", "Visby");
        paymentInfo.put("Zip", "62156");
        paymentInfo.put("Country", "South Korea");
    ...
    public void step4() {
        ...
        locationInfo.put("Zip Code", "62156");
        locationInfo.put("Country", "Sweden");
    ...
    public void step5() {
        ...
        CaptivePortalPaymentInfo.put("Last Name", "T23858");
        ...
        CaptivePortalPaymentInfo.put("Street Address", "Strandgatan");
        CaptivePortalPaymentInfo.put("City", "Visby");
        CaptivePortalPaymentInfo.put("Zip", "62156");
        CaptivePortalPaymentInfo.put("Country", "Sweden");
        CaptivePortalPaymentInfo.put("State", "Visby");
