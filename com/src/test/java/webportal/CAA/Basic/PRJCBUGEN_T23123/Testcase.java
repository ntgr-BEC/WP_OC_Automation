package webportal.CAA.Basic.PRJCBUGEN_T23123;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23123") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country Norway shows the purchase currency symbol in  nok") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23123") // It's a testcase id/link from Jira Test Case.
