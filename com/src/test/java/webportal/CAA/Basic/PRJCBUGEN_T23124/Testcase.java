package webportal.CAA.Basic.PRJCBUGEN_T23124;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23124") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether account created with country Poland shows the purchase currency symbol in  pln") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23124") // It's a testcase id/link from Jira Test Case.
