package webportal.CAA.Basic.PRJCBUGEN_T24562;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24562") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Premium trail works for the local currency countries Czech Republic") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24562") // It's a testcase id/link from Jira Test Case.
