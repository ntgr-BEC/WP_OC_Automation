package webportal.CAA.PRJCBUGEN_T23125;
...
public class Testcase extends TestCaseBase {
    ...
    String Currency = "ZAR";
    String MonthlyAmount = "17"; 
    String YearlyAmount = "166"; 

    @Feature("CAA") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T23125") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Device subscription cost for the local currency account is proper (South Africa )") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23125") // It's a testcase id/link from Jira Test Case.
