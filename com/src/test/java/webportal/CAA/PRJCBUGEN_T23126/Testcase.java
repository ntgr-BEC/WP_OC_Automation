package webportal.CAA.PRJCBUGEN_T23126;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23126") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Premium trail works for the local currency countries South Korea ") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23126") // It's a testcase id/link from Jira Test Case.
