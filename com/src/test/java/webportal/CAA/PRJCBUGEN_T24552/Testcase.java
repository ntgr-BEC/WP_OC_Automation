package webportal.CAA.PRJCBUGEN_T24552;
...
public class Testcase extends TestCaseBase {
    ...
    String Currency = "SEK";
    String MonthlyAmount = "9"; 
    String YearlyAmount = "89"; 

    @Feature("CAA") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24552") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Device subscription cost for the local currency account is proper (Sweden)") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24552") // It's a testcase id/link from Jira Test Case.
