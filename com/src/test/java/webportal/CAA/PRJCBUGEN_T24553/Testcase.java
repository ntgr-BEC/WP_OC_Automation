package webportal.CAA.PRJCBUGEN_T24553;
...
public class Testcase extends TestCaseBase {
    ...
    String Currency = "DKK";
    String MonthlyAmount = "7"; 
    String YearlyAmount = "64"; 

    @Feature("CAA") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24553") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Device subscription cost for the local currency account is proper (Denmark)") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24553") // It's a testcase id/link from Jira Test Case.
