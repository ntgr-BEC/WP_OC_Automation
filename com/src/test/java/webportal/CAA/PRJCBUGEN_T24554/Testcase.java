package webportal.CAA.PRJCBUGEN_T24554;
...
public class Testcase extends TestCaseBase {
    ...
    String Currency = "PL";
    String MonthlyAmount = "4"; 
    String YearlyAmount = "39"; 

    @Feature("CAA") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24554") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Device subscription cost for the local currency account is proper (Poland)") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24554") // It's a testcase id/link from Jira Test Case.
