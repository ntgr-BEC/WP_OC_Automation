package webportal.CAA.PRJCBUGEN_T24557;
...
public class Testcase extends TestCaseBase {
    ...
    String Currency = "HK";
    String MonthlyAmount = "8"; 
    String YearlyAmount = "78"; 

    @Feature("CAA") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24557") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Device subscription cost for the local currency account is proper (Hong Kong)") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24557") // It's a testcase id/link from Jira Test Case.
