package webportal.CAA.PRJCBUGEN_T24559;
...
public class Testcase extends TestCaseBase {
    ...
    String Currency = "KR";
    String MonthlyAmount = "1147"; 
    String YearlyAmount = "11572"; 

    @Feature("CAA") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24559") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Device subscription cost for the local currency account is proper (South Korea)") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24559") // It's a testcase id/link from Jira Test Case.
