package webportal.CAA.PRJCBUGEN_T24560;
...
public class Testcase extends TestCaseBase {
    ...
    String Currency = "CZ";
    String MonthlyAmount = "23"; 
    String YearlyAmount = "230"; 

    @Feature("CAA") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24560") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether Device subscription cost for the local currency account is proper (Czech Republic)") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24560") // It's a testcase id/link from Jira Test Case.
