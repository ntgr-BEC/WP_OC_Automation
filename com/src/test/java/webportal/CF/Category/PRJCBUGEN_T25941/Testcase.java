package webportal.CF.Category.PRJCBUGEN_T25941;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25941") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Alcohol category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25941") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
      ...
      String output1 = new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                "nslookup dice.com");
     ...
     assertTrue(finalresult1, "domain is not blocked");
