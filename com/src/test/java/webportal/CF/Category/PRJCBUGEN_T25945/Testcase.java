package webportal.CF.Category.PRJCBUGEN_T25945;
...
public class Testcase extends TestCaseBase {
    ...
    String URL = "Cars/Transportation";
    ...
    @Story("PRJCBUGEN_T25945") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Car/Transportation category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25945") // It's a testcase id/link from Jira Test Case.
