package webportal.CF.Category.PRJCBUGEN_T25949;
...
public class Testcase extends TestCaseBase {
    ...
    String URL = "Criminal Skills/Hacking";
    ...
    @Story("PRJCBUGEN_T25949") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Criminal Skills/Hacking category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25949") // It's a testcase id/link from Jira Test Case.
