package webportal.CF.Category.PRJCBUGEN_T25962;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25962") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Illegal Drugs category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25962") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        MyCommonAPIs.sleepi(80);  
         ...
         String output = new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                   "nslookup webmd.com/mental-health/addiction/street-drugs-risks");
