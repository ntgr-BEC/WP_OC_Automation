package webportal.CF.Category.PRJCBUGEN_T25972;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25972") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Pharmacy category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25972") // It's a testcase id/link from Jira Test Case.
