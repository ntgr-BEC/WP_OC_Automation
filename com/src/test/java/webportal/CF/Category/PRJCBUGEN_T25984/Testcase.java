package webportal.CF.Category.PRJCBUGEN_T25984;
...
public class Testcase extends TestCaseBase {
    ...
    String URL = "Sports and Recreation";
    ...
    @Story("PRJCBUGEN_T25984") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Sports and Recreation category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25984") // It's a testcase id/link from Jira Test Case.
