package webportal.CF.Category.PRJCBUGEN_T25985;
...
public class Testcase extends TestCaseBase {
    ...
    String URL = "Spyware and Malicious Sites";
    ...
    @Story("PRJCBUGEN_T25985") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Spyware and Malicious Sites category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25985") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        MyCommonAPIs.sleepi(80);  
         ...
         String output = new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                   "nslookup maliciouswebsitetest.com");
