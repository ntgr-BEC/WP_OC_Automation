package webportal.CF.Category.PRJCBUGEN_T25991;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25991") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Web-based Email category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25991") // It's a testcase id/link from Jira Test Case.
