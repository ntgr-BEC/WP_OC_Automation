package webportal.CF.Category.PRJCBUGEN_T26127;
...
public class Testcase extends TestCaseBase {
    ...
    String URL = "Computers and Technology";
    ...
    @Story("PRJCBUGEN_T26127") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Computers and Technology category blocking URL.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26127") // It's a testcase id/link from Jira Test Case.
