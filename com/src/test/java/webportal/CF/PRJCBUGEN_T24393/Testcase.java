package webportal.CF.PRJCBUGEN_T24393;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24393") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should be able to select one category and allow/block that particular category and then all domains and subdomains should be allowed/blocked for that category") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24393") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T14480.py www.facebook.com test test").indexOf("finalresult: 1") != -1,
