package webportal.CF.PRJCBUGEN_T24394;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24394") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that the user should be able to allow/block from the domains for particular category.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24394") // It's a testcase id/link from Jira Test Case.
