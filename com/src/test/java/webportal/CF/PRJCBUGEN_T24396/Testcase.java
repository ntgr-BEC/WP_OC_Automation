package webportal.CF.PRJCBUGEN_T24396;
...
public class Testcase extends TestCaseBase {
    ...
    String URL = "Entertainment and Videos";
    String URL1 = "Job";
    ...
    @Story("PRJCBUGEN_T24396") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user should be allowed to Resume/Pause the multiple domains at a time.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24396") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T14480.py www.mtv.com test test").indexOf("finalresult: 1") != -1,
                "Captive portal not take effect.");
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T14480.py www.naukri.com test test").indexOf("finalresult: 1") != -1,
                "Captive portal not take effect.");
