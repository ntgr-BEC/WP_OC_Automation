package webportal.CF.PRJCBUGEN_T24402;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24402") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that the content filtering subscription should have a 30 days free trial") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24402") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 6: Try to enable Cf;")
    public void step6() {
