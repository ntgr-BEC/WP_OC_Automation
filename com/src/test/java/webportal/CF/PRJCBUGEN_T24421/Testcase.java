package webportal.CF.PRJCBUGEN_T24421;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24421") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the addition of domains in allow list") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24421") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T14480.py www.telegram.org test test").indexOf("finalresult: 1") != -1,
                "Captive portal not take effect.");
        
    }
    
    
    @Step("Test Step 5: Check whether whatsapp is opening;")
    public void step5() {
        MyCommonAPIs.sleepi(20);
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T14481.py www.whatsapp.com test test").indexOf("finalresult: 1") != -1,
                "Captive portal not take effect.");
