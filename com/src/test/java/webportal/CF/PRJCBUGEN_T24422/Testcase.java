package webportal.CF.PRJCBUGEN_T24422;
...
public class Testcase extends TestCaseBase {
    ...
    //String URL = "Chat/IM";
    String Domain = "cardekho.com";
    String Description = "people should not use cardekho";
    ...
    @Story("PRJCBUGEN_T24422") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the addition of domains in block list") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24422") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        new ContentFilteringPage().AddBlocklist(Domain, Description);
    ...
    public void step4() {
        ...
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T14480.py www.cardekho.com test test").indexOf("finalresult: 1") != -1,
