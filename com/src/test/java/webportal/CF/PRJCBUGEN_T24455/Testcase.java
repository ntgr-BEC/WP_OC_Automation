package webportal.CF.PRJCBUGEN_T24455;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24455") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T24455") // It's a testcase id/link from Jira Test Case.
    ...
    public void step8() {
        ...
        HashMap<String, String> locationInfo = new HashMap<String, String>();
        locationInfo.put("Location Name", "OnBoardingTest1");
        locationInfo.put("Device Admin Password", WebportalParam.loginDevicePassword);
        locationInfo.put("Zip Code", "32003");
        locationInfo.put("Country", "United States of America");
        new AccountPage().addNetwork(locationInfo);
    ...
    @Step("Test Step 9: Add orbi to your account;")
    public void step9() {
        WebCheck.checkHrefIcon(URLParam.hrefDevices);
    ...
    @Step("Test Step 10: Try to enable Cf;")
    public void step10() {
