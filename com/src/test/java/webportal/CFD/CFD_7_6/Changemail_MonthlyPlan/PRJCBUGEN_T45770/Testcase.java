package webportal.CFD.CFD_7_6.Changemail_MonthlyPlan.PRJCBUGEN_T45770;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45770") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buy monthly subscription ,the change mail id_Australia") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T45770") // It's a testcase id/link from Jira Test Case.
    ...
    public void step6() {
        ...
        new MyCommonAPIs().open(URLParam.hrefPaymentSubscription, true);
        Map<String, String> paymentInfonew = new HashMap<String, String>();
        paymentInfonew.put("Subscription Time", "Yearly");
        paymentInfonew.put("Number of Device Credits", "6");
        paymentInfonew.put("First Name", mailnew);
        paymentInfonew.put("Last Name", "T15592");
        paymentInfonew.put("Email", mailnew + "@yopmail.com");
        paymentInfonew.put("Street Address", "street Pork street");
        paymentInfonew.put("City", "Sydney");
        paymentInfonew.put("Zip", "2000");
        paymentInfonew.put("Country", "Australia");
        paymentInfonew.put("State", "New South Wales"); 
        paymentInfonew.put("Card Number", "4112344112344113");
        paymentInfonew.put("CVV Number", "123");
        paymentInfonew.put("Expiration Month", "May");
        paymentInfonew.put("Expiration Year", "2030");
        new HamburgerMenuPage().buyDeviceCredits(paymentInfonew);
        assertTrue(new HamburgerMenuPage(false).checkMonthlySubscriptionScreen(
                String.valueOf(Integer.valueOf(paymentInfonew.get("Number of Device Credits")) + 2)), "Buy basic subscription unsuccessful.");
