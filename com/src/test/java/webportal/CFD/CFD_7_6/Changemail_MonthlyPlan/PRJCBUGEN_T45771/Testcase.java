package webportal.CFD.CFD_7_6.Changemail_MonthlyPlan.PRJCBUGEN_T45771;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Buy monthly subscription ,the change mail id_Canada") // It's a test case title from Jira Test Case.
    ...
    public void step6() {
        ...
        paymentInfonew.put("Street Address", "Whitehorse");
        paymentInfonew.put("City", "Ontario");
        paymentInfonew.put("Zip", "L6A");
        paymentInfonew.put("Country", "Canada");
        paymentInfonew.put("State", "Ontario");
