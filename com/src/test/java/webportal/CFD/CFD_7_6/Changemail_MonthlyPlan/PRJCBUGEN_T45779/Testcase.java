package webportal.CFD.CFD_7_6.Changemail_MonthlyPlan.PRJCBUGEN_T45779;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45779") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buy monthly subscription ,the change mail id_Denmark") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T45779") // It's a testcase id/link from Jira Test Case.
    ...
    public void step6() {
        ...
        paymentInfonew.put("Street Address", "Ostre Stationsvej");
        paymentInfonew.put("City", "Odense");
        paymentInfonew.put("Zip", "5000");
        paymentInfonew.put("Country", "Denmark");
        paymentInfonew.put("State", "Odense");
