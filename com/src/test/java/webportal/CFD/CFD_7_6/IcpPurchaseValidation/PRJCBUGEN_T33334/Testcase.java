package webportal.CFD.CFD_7_6.IcpPurchaseValidation.PRJCBUGEN_T33334;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33334") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 1 device for 1 year Australia") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33334") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        CaptivePortalPaymentInfo = new CommonDataType().CARD_INFO;
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T23809");
            ...
            assertTrue(result, " Captive portal services credits is incorrect.");
    }
