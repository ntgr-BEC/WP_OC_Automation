package webportal.CFD.CFD_7_6.Licence_DC.PRJCBUGEN_T30933;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("CFD_AddingLicenceNewProDC") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30933") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add Pro LICENSE Account level immadiate pro account") 
    @TmsLink("PRJCBUGEN_T30933") // It's a testcase id/link from Jira Test Case.
