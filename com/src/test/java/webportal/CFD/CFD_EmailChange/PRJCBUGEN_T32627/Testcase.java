package webportal.CFD.CFD_EmailChange.PRJCBUGEN_T32627;
...
public class Testcase extends TestCaseBase {
    ...
    String newEmailAddress = "readwritemanager@mailcatch.com";
    ...
    @Story("PRJCBUGEN_T32627") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the pro admin user changed the email address using the read-write manager email address.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T32627") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Change admin email with Read Write Manager;")
    public void step3() {
