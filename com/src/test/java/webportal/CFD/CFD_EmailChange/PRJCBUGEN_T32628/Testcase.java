package webportal.CFD.CFD_EmailChange.PRJCBUGEN_T32628;
...
public class Testcase extends TestCaseBase {
    ...
    String Name     = "PRJCBUGEN_T32628";
    
    @Feature("InsightPro.InvitingReadManager") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T32628") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the pro admin user changed the email address using the secondary admin email address.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T32628") // It's a testcase id/link from Jira Test Case.
