package webportal.CFD.CFD_Pro.AP.PRJCBUGEN_T29199;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T29199";
    ...
    @Story("PRJCBUGEN_T29199") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("ICP functionally in 2.4ghz for WAX630E") 
    @TmsLink("PRJCBUGEN-T29199") // It's a testcase id/link from Jira Test Case.
...
//        OrganizationPage.openOrg(organizationName);
    ...
    public void step4() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwpT29199")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwpT29199 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
