package webportal.CFD.CFD_Pro.AP.PRJCBUGEN_T29201;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T29201";
    ...
    @Story("PRJCBUGEN_T29201") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("ICP functionally in 5ghz for WAX630E") 
    @TmsLink("PRJCBUGEN-T29201") // It's a testcase id/link from Jira Test Case.
...
//        OrganizationPage.openOrg(organizationName);
    ...
    public void step4() {
        ...
        ssidInfo.put("SSID", "apwp29201");
        ssidInfo.put("Security", "WPA2 Personal");
        ssidInfo.put("Password", "12345678");
        ssidInfo.put("Band", "check only 5ghz");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp29201")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp29201 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
