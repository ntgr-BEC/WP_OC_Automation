package webportal.CFD.CFD_Pro.AP.PRJCBUGEN_T31051;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T31051";
    ...
    @Story("PRJCBUGEN_T31051") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("ICP credits valdation after disable and enable ICP") 
    @TmsLink("PRJCBUGEN-T31051s") // It's a testcase id/link from Jira Test Case.
...
//        OrganizationPage.openOrg(organizationName);
    ...
    public void step4() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwpT31051")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwpT31051 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
...
//    }
    ...
    @Step("Test Step 6: Disbale ICP and enable it agagin ;")
    public void step6() {
    ...
    @Step("Test Step 7: connect to client again ;")
    public void step7() {
        int sum = 0;
        while (true) {
            MyCommonAPIs.sleepi(10);
