package webportal.CFD.CFD_Testcases.PRJCBUGEN_T28304;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "Organization11";
    ...
    @Story("PRJCBUGEN_T28304") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create 300 location in admin accout;)") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T28304") // It's a testcase id/link from Jira Test Case.
