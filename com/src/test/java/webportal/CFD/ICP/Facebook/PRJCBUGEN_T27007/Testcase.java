package webportal.CFD.ICP.Facebook.PRJCBUGEN_T27007;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27007") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify existing FBCP functionally after enable rate limitation")
    @TmsLink("PRJCBUGEN-T27007") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27007")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27007 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
