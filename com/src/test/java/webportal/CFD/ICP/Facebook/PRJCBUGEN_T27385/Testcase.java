package webportal.CFD.ICP.Facebook.PRJCBUGEN_T27385;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27385") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to configure the FB wifi on the SSID on which ICP was configured before.")
    @TmsLink("PRJCBUGEN-T270385") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T27385");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27385")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27385 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
    ...
    @Step("Test Step 4: Check whether FB page is shown or not;")
    public void step4() {
        
        new WirelessQuickViewPage().disablecp(ssidInfo.get("SSID"));
