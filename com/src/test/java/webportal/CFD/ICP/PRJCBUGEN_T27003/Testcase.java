package webportal.CFD.ICP.PRJCBUGEN_T27003;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27003") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify existing ICP functionally after enable rate limitation")
    @TmsLink("PRJCBUGEN-T27003") // It's a testcase id/link from Jira Test Case.
