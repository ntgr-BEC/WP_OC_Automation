package webportal.CFD.ICP.PRJCBUGEN_T27006;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27006") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify new ICP functionally after disable rate limitation")
    @TmsLink("PRJCBUGEN-T27006") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        while (true) {
            MyCommonAPIs.sleepi(10);
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27006")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27006 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
