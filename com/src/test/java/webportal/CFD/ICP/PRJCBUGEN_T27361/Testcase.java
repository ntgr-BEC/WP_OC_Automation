package webportal.CFD.ICP.PRJCBUGEN_T27361;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27361") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify after switching from basic CP to ICP the client is getting ICP splash screen and able to connect with SSID.")
    @TmsLink("PRJCBUGEN-T27361") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27003")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27003 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
    ...
    @Step("Test Step 4: Check whether captive portal page is shown or not;")
    public void step4() {
