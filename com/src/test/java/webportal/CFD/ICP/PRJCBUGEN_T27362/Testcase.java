package webportal.CFD.ICP.PRJCBUGEN_T27362;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27362") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify after switching from ICP to basic CP the client is able to connect with SSID.")
    @TmsLink("PRJCBUGEN-T27362") // It's a testcase id/link from Jira Test Case.
