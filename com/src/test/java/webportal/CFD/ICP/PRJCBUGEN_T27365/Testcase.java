package webportal.CFD.ICP.PRJCBUGEN_T27365;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("ICP") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T27365") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T27365") // It's a testcase id/link from Jira Test Case.
...
//        webportalLoginPage.loginByUserPassword("apwptest7751980@mailinator.com", "Netgear#123");
        ...
        accountInfo.put("Last Name", "T27365");
    ...
    public void step4() {
        ...
        paymentInfo.put("Last Name", "T27065");
    ...
    public void step5() {
        ...
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T27065");
    ...
    @Step("Test Step 7: create New ssid with ICP enabled and connect to client ")
    public void step7() {
        ...
        while (true) {
            MyCommonAPIs.sleepi(10);
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27365a")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27365a 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
