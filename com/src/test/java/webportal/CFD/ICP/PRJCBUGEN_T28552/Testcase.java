package webportal.CFD.ICP.PRJCBUGEN_T28552;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28552") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Icp functionally when same ICP ssid ( same name ssid) is adding and deleting in location")
    @TmsLink("PRJCBUGEN-T28552") // It's a testcase id/link from Jira Test Case.
