package webportal.CFD.ICP.PRJCBUGEN_T28565;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28565") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Icp functionally when different ICP ssid ( different name ssid) is adding and deleting in location")
    @TmsLink("PRJCBUGEN-T28565") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID New88")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect New88 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
    ...
    public void step4() {
        ...
        while (true) {
            MyCommonAPIs.sleepi(10);
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID New99")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
                assertTrue(false, "Client cannot connected.");
        ...
        boolean result1 = true;
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect New99 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            MyCommonAPIs.sleepi(20);
            if (new Javasocket()
