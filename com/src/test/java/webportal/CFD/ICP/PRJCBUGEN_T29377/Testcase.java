package webportal.CFD.ICP.PRJCBUGEN_T29377;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T29377") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("ICP functionally when AP is reboot with in session time")
    @TmsLink("PRJCBUGEN-T29377") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        icpInfo.put("Session Duration", "30 min");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp29378")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp29378 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
