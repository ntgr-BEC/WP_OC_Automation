package webportal.CFD.ICP.PRJCBUGEN_T29378;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T29378") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("ICP functionally when AP is reboot after session time end")
    @TmsLink("PRJCBUGEN-T29378") // It's a testcase id/link from Jira Test Case.
