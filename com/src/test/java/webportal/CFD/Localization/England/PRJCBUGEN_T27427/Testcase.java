package webportal.CFD.Localization.England.PRJCBUGEN_T27427;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27427") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("English language -->create   ICP with register") 
    @TmsLink("PRJCBUGEN-T27427") // It's a testcase id/link from Jira Test Case.
