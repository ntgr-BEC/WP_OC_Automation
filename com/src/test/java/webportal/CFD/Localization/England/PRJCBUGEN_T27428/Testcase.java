package webportal.CFD.Localization.England.PRJCBUGEN_T27428;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27428") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("French language -->create   ICP with register  --> with  Customize  ( Non default value )") 
    @TmsLink("PRJCBUGEN-T27428") // It's a testcase id/link from Jira Test Case.
