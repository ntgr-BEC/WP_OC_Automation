package webportal.CFD.Localization.England.PRJCBUGEN_T27429;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27429") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("English  language -->create   ICP with register  --> with  Customize  (default value )") 
    @TmsLink("PRJCBUGEN-T27429") // It's a testcase id/link from Jira Test Case.
...
//        }
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp27429")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp27429 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
