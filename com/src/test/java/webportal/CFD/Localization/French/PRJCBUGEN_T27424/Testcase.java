package webportal.CFD.Localization.French.PRJCBUGEN_T27424;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27424") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("French language -->create   ICP with register") // It's
    @TmsLink("PRJCBUGEN-T27424") // It's a testcase id/link from Jira Test Case.
