package webportal.CFD.Localization.French.PRJCBUGEN_T27425;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27425") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("French language -->create   ICP with register  --> with  Customize  (default value )") // It's
    @TmsLink("PRJCBUGEN-T27425") // It's a testcase id/link from Jira Test Case.
