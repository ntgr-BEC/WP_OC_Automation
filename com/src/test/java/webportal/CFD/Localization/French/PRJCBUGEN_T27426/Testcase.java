package webportal.CFD.Localization.French.PRJCBUGEN_T27426;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("CFD_Localization") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T27426") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("French language -->create   ICP with register  --> with  Customize  ( Non default value )") // It's
    @TmsLink("PRJCBUGEN-T27426") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYesLoc(ssidInfo.get("SSID"));
    ...
    public void step1() {
//        new  TestCaseBase().setBrowser("de");
    ...
    public void step2() {
        ...
        ssidInfo.put("Security", "WPA2 personnel");
        ssidInfo.put("Password", "12345678");
        new WirelessQuickViewPage().addSsidLoc(ssidInfo);
        ...
        icpInfo.put("Step Type", "Méthode d'authentification");
        icpInfo.put("Login Modes", "Register.");
        icpInfo.put("Customize", "Yes.");
        new WirelessQuickViewPage().enableCaptivePortalTypeLoc(ssidInfo.get("SSID"), icpInfo);
    ...
    public void step3() {
        ...
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T16637a.py www.rediff.com test test").indexOf("finalresult: 1") != -1,
