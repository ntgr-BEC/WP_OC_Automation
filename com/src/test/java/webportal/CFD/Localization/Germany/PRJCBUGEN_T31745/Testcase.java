package webportal.CFD.Localization.Germany.PRJCBUGEN_T31745;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31745") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Germany language -->create   ICP with register --> with Customize (default value)") // It's
    @TmsLink("PRJCBUGEN-T31745") // It's a testcase id/link from Jira Test Case.
