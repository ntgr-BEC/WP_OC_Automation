package webportal.CFD.Localization.Germany.PRJCBUGEN_T31746;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31746") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Germany  language -->create   ICP with register") // It's
    @TmsLink("PRJCBUGEN-T31746") // It's a testcase id/link from Jira Test Case.
