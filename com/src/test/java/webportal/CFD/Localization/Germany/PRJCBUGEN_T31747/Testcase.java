package webportal.CFD.Localization.Germany.PRJCBUGEN_T31747;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31747") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Germany language -->create   ICP with register --> with Customize (Non default value)") // It's
    @TmsLink("PRJCBUGEN-T31747") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        icpInfo.put("Step Type", "Authentifizierungsmethode");
