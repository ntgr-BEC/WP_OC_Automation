package webportal.CFD.Localization.Japan.PRJCBUGEN_T31751;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31751") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Japanese language -->create   ICP with register") // It's
    @TmsLink("PRJCBUGEN-T31751") // It's a testcase id/link from Jira Test Case.
