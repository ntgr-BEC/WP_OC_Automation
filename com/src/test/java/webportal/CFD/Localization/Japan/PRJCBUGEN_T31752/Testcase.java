package webportal.CFD.Localization.Japan.PRJCBUGEN_T31752;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31752") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Japanese language -->create   ICP with register --> with Customize (Non default value)") // It's
    @TmsLink("PRJCBUGEN-T31752") // It's a testcase id/link from Jira Test Case.
...
//        new  TestCaseBase().setBrowser("de");
    ...
    public void step2() {
        ...
        ssidInfo.put("Security", "WPA2 パーソナル");
