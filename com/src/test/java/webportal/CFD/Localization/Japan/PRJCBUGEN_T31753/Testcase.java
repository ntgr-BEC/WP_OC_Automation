package webportal.CFD.Localization.Japan.PRJCBUGEN_T31753;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31753") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Japanese language -->create   ICP with register --> with Customize (default value)") // It's
    @TmsLink("PRJCBUGEN-T31753") // It's a testcase id/link from Jira Test Case.
