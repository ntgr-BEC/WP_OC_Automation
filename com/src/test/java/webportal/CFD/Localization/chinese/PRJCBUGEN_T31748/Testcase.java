package webportal.CFD.Localization.chinese.PRJCBUGEN_T31748;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31748") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Chinese language -->create   ICP with register") // It's
    @TmsLink("PRJCBUGEN-T31748") // It's a testcase id/link from Jira Test Case.
