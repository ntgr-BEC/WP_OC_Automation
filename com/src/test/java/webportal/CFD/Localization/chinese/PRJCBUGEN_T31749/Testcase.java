package webportal.CFD.Localization.chinese.PRJCBUGEN_T31749;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31749") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Chinese language -->create   ICP with register --> with Customize (Non default value)") // It's
    @TmsLink("PRJCBUGEN-T31749") // It's a testcase id/link from Jira Test Case.
