package webportal.CFD.Migration_Pro.Canada.PRJCBUGEN_T27037;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T27037";
    ...
    @Story("PRJCBUGEN_T27037") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("converting premiun to pro account funcationally") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T27037") // It's a testcase id/link from Jira Test Case.
...
//        webportalLoginPage.loginByUserPassword("apwptest5993851@mailinator.com","Netgear#123");
        ...
        accountInfo.put("Last Name", "T27037");
...
//            icpInfo.put("Desktop Background Image", "DEFAULT_BG");
            ...
            while (true) {
                ...
                if (new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27037")
                        .indexOf("true") != -1) {
                    break;
                } else if (sum > 30) {
            ...
            if (!new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27037 12345678 WPA2PSK aes")
                    .equals("true")) {
                result1 = false;
    ...
    @Step("Test Step 6: cpnnect to client in Pro Account")
    public void step6() {
