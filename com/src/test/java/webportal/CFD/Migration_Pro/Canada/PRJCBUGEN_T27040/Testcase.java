package webportal.CFD.Migration_Pro.Canada.PRJCBUGEN_T27040;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27040") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("converting  premiun to  pro  account ,logout and  login  before  assigning   the  location  to  an organzation") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T27040") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        public void step4() {
            ...
            CaptivePortalPaymentInfo = new CommonDataType().CARD_INFO;
                ...
                CaptivePortalPaymentInfo.put("Street Address", "Whitehorse");
                CaptivePortalPaymentInfo.put("City", "Ontario");
                CaptivePortalPaymentInfo.put("Zip", "L6A");
                CaptivePortalPaymentInfo.put("Country", "Canada");
                CaptivePortalPaymentInfo.put("State", "Ontario");
            ...
            while (true) {
                ...
                if (new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27040")
                        .indexOf("true") != -1) {
                    break;
                } else if (sum > 30) {
            ...
            if (!new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27040 12345678 WPA2PSK aes")
                    .equals("true")) {
                result1 = false;
...
//        }
    ...
    public void step6() {
           ...
           String sCheck = "[alt=\"User Image\"]";
            ...
            businessInfo.put("Primary Address of Business", "Whitehorse");
            businessInfo.put("City", "Ontario");
            businessInfo.put("State", "Ontario");
