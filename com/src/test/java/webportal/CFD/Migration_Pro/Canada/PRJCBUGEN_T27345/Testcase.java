package webportal.CFD.Migration_Pro.Canada.PRJCBUGEN_T27345;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27345") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T27345") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T27345");
    ...
    public void step6() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27345")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27345 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
