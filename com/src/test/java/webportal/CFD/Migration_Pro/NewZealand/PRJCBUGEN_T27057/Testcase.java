package webportal.CFD.Migration_Pro.NewZealand.PRJCBUGEN_T27057;
...
//       handle.gotoLoction();
//        webportalLoginPage.loginByUserPassword("apwptest6593332@mailinator.com","Netgear#123");
    ...
    public void step3() {
        ...
        public void step4() {
            ...
            while (true) {
                ...
                if (new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27057")
                        .indexOf("true") != -1) {
                    break;
                } else if (sum > 30) {
            ...
            if (!new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27057 12345678 WPA2PSK aes")
                    .equals("true")) {
                result1 = false;
