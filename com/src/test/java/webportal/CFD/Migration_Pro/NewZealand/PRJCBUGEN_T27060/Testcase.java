package webportal.CFD.Migration_Pro.NewZealand.PRJCBUGEN_T27060;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27060") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T27060") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        //webportalLoginPage.loginByUserPassword("apwptest9837158@mailinator.com", "Netgear#123");
    ...
    public void step3() {
        ...
        public void step4() {
            ...
            while (true) {
                ...
                if (new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27060")
                        .indexOf("true") != -1) {
                    break;
                } else if (sum > 30) {
            ...
            if (!new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27060 12345678 WPA2PSK aes")
                    .equals("true")) {
                result1 = false;
