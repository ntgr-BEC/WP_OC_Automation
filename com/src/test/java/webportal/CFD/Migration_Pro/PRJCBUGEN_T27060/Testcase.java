package webportal.CFD.Migration_Pro.PRJCBUGEN_T27060;
    ...
    public void step4() {
        ...
        public void step5() {
            ...
            if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
                ...
                CaptivePortalPaymentInfo.put("Last Name", "T27060");
...
//            icpInfo.put("Desktop Background Image", "DEFAULT_BG");
    ...
    public void step7() {
            ...
            WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);
            webportalLoginPage.loginByUserPassword(Email , "Netgear#123");
