package webportal.CFD.Migration_Pro.US.PRJCBUGEN_T27047;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27047") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("converting premiun to pro account funcationally") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T27047") // It's a testcase id/link from Jira Test Case.
...
//        webportalLoginPage.loginByUserPassword("apwptest5993851@mailinator.com","Netgear#123");
        ...
        accountInfo.put("Last Name", "T27047");
    ...
    public void step3() {
        ...
        public void step4() {
            ...
            while (true) {
                ...
                if (new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27047")
                        .indexOf("true") != -1) {
                    break;
                } else if (sum > 30) {
            ...
            if (!new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27047 12345678 WPA2PSK aes")
                    .equals("true")) {
                result1 = false;
