package webportal.CFD.Migration_Pro.US.PRJCBUGEN_T27050;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27050") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T27050") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        public void step4() {
            ...
            while (true) {
                ...
                if (new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID 1apwp27050")
                        .indexOf("true") != -1) {
                    break;
                } else if (sum > 30) {
            ...
            if (!new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect 1apwp27050 12345678 WPA2PSK aes")
                    .equals("true")) {
                result1 = false;
