package webportal.CFD.New_CFD_cases.PRJCBUGEN_T35145;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T35145") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("Test to verify Connected, Disconnected, wired, wireless, and all client data shown properly.") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN_T35145") // It's a testcase id/link from Jira Test Case.
...
//    Each step is a single test step from Jira Test Case
  ...
  @Step("Test Step 3:check whether the client is getting listed in connected tab or not")
   public void step3() {
      ...
      assertTrue(new WirelessQuickViewPage(false).connectedCheck(),"NOT LISTED IN CLIENT");
  }
  ...
  public void step4() {
     ...
     WebCheck.checkHrefIcon(URLParam.hrefClients);
     MyCommonAPIs.sleepi(5);
     assertTrue(new WirelessQuickViewPage(false).disconnectedCheck(),"NOT LISTED IN CLIENT");
