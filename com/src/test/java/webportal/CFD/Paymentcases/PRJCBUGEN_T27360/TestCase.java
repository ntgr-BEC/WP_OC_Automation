package webportal.CFD.Paymentcases.PRJCBUGEN_T27360;
...
public class TestCase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27360") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify User is able to create Premium trail Accont and can able to naviagte to Subscription without any error.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T27360") // It's a testcase id/link from Jira Test Case.
