package webportal.CFD.Paymentcases.PRJCBUGEN_T32555;
...
public class TestCase extends TestCaseBase {
    String organizationName = "PRJCBUGEN_T32555";
    Random r        = new Random();
    ...
    @Story("PRJCBUGEN_T32555") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user purchased the Monthy Plan and try to cancel within three days.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T32555") // It's a testcase id/link from Jira Test Case.
