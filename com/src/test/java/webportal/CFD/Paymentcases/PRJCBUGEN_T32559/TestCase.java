package webportal.CFD.Paymentcases.PRJCBUGEN_T32559;
...
public class TestCase extends TestCaseBase {
    String organizationName = "PRJCBUGEN_T32559";
    Random r        = new Random();
    ...
    @Story("PRJCBUGEN_T32559") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user purchased the Multipack and try to cancel within three days.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T32559") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Check buy multipack services;")
    public void step4() {
