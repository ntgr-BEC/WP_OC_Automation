package webportal.CFD.Paymentcases.PRJCBUGEN_T33341;
...
public class TestCase extends TestCaseBase {
    String organizationName = "PRJCBUGEN_T33341";
    Random r        = new Random();
    ...
    @Story("PRJCBUGEN_T33341") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user purchased the yearly Plan and try to cancel within three days where no devices were present in the account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33341") // It's a testcase id/link from Jira Test Case.
