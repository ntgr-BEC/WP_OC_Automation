package webportal.CFDPayment.PRJCBUGEN_T21394;
...
public class Testcase extends TestCaseBase {
    ...
    String              locationName = "ntk21394";

    @Feature("CFDPayment") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T21394") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Basic Free --> Premium yearly --> Manage more than 2 devices (Non-Hard Bundle ) --> Cancel within 3 days") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21394") // It's a testcase id/link from Jira Test Case.
...
//        webportalLoginPage.loginByUserPassword("apwptest7616115@mailinator.com","Netgear#123");
        Map<String, String> accountInfo = new HashMap<String, String>();
        accountInfo.put("First Name", mailname);
        accountInfo.put("Last Name", "T21394");
...
//            paymentInfo.put("Email", mailname + "@mailinator.com");
            ...
            assertTrue(new HamburgerMenuPage(false).checkSubscriptionScreenForPremium(), "Premium subscription type incorrect.");
        
    }

    @Step("Test Step 5: Add three devices and check cancel subscription;")
    public void step5() {
