package webportal.CFDPayment.basic.PRJCBUGEN_T21387;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21387") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Basic free --> Basic Paid --> Premium Yearly") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21387") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T21387");
    ...
    public void step2() {
        if (new HamburgerMenuPage(true).checkSubscriptionScreenForBasic()) {
            ...
            paymentInfo.put("Last Name", "T21387");
//            paymentInfo.put("Email", mailname + "@mailinator.com");
    ...
    @Step("Test Step 3: Buy yearly premium subscription;")
    public void step3() {
