package webportal.CFDPayment.basic.PRJCBUGEN_T21397;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21397") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Basic Free --> Basic Paid --> Premium Trail --> Multipack") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21397") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T21397");
    ...
    public void step2() {
        if (new HamburgerMenuPage(true).checkSubscriptionScreenForBasic()) {
            ...
            paymentInfo.put("Last Name", "T21397");
//            paymentInfo.put("Email", mailname + "@mailinator.com");
            ...
            assertTrue(result && new HamburgerMenuPage().checkAccountTryTrial(), "Account try trial unsuccessful.");
        } else {
    ...
    public void step3() {
        ...
        assertTrue(!MyCommonAPIs.getText(ele).contains("Use this table to view all current device credit packs for your Insight Premium account."),
