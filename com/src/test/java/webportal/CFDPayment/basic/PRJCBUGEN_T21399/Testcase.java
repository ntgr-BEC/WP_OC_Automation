package webportal.CFDPayment.basic.PRJCBUGEN_T21399;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21399") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Basic free --> Basic paid --> Premium yearly --> Multipack --> Cancel both Multipack & Premium yearly within 3 days of purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21399") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T21399");
    ...
    public void step2() {
        ...
        if (new HamburgerMenuPage(true).checkSubscriptionScreenForBasic()) {
            ...
            paymentInfo.put("Last Name", "T21399");
//            paymentInfo.put("Email", mailname + "@mailinator.com");
    ...
    public void step3() {
        ...
        if (!MyCommonAPIs.getText(ele).contains("Use this table to view all current device credit packs for your Insight Premium account.")) {
            ...
            assertTrue(!new HamburgerMenuPage(false).checkSubscriptionScreenForPremium() && !ele.exists(), "Cancel subscription failed.");
        } else {
            assertTrue(false, "Subscription type incorrect.");
        }
    }
