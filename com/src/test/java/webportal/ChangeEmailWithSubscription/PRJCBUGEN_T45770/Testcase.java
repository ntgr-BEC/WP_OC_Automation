package webportal.ChangeEmailWithSubscription.PRJCBUGEN_T45770;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify after purchasing the month plan then change the email address login with the change email and try to purchase the device credit for Australia Country") // It's a testcase title from Jira Test Case.
