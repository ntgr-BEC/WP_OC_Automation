package webportal.ChangeEmailWithSubscription.PRJCBUGEN_T45771;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45771") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify after purchasing the month plan then change the email address login with the change email and try to purchase the device credit for Canada Country") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T45771") // It's a testcase id/link from Jira Test Case.
