package webportal.ChangeEmailWithSubscription.PRJCBUGEN_T45774;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45774") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify after purchasing the month plan then change the email address login with the change email and try to purchase the device credit for Japan Country") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T45774") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        locationInfo.put("Zip Code", "8307");
    ...
    public void step3() {
        ...
        paymentInfo.put("Street Address", "Tatsumicho");
        paymentInfo.put("City", "Kyoto");
        paymentInfo.put("Zip", "8307");
        paymentInfo.put("Country", "Japan");
        paymentInfo.put("State", "Kyoto");
