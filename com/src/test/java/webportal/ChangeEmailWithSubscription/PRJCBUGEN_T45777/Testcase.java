package webportal.ChangeEmailWithSubscription.PRJCBUGEN_T45777;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45777") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify after purchasing the month plan then change the email address login with the change email and try to purchase the device credit for France Country") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T45777") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Country", "France");
    ...
    public void step2() {
        ...
        locationInfo.put("Zip Code", "32250");
        locationInfo.put("Country", "France");
    ...
    public void step3() {
        ...
        paymentInfo.put("Street Address", "ARQUIZAN");
        paymentInfo.put("City", "Montreal");
        paymentInfo.put("Zip", "32250");
        paymentInfo.put("Country", "France");
        paymentInfo.put("State", "Montreal");
