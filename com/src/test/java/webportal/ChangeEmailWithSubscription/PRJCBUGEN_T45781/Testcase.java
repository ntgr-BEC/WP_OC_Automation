package webportal.ChangeEmailWithSubscription.PRJCBUGEN_T45781;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45781") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify after purchasing the month plan then change the email address login with the change email and try to purchase the device credit for Finland Country") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T45781") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Country", "Finland");
    ...
    public void step2() {
        ...
        locationInfo.put("Zip Code", "48200");
        locationInfo.put("Country", "Finland");
    ...
    @Step("Test Step 3: chnage premium Trail to Premium Monthly;")
    public void step3() {
        ...
        paymentInfo.put("Street Address", "Porthaninkatu");
        paymentInfo.put("City", "Kotka");
        paymentInfo.put("Zip", "48200");
        paymentInfo.put("Country", "Finland");
        paymentInfo.put("State", "Kotka");
    ...
    @Step("Test Step 4: Change login email account, check the user should be able to login successfully;")
    public void step4() {
    ...
    @Step("Test Step 5: Check buy vpn services;")
    public void step5() {
        ...
        assertTrue(new HamburgerMenuPage(false).checkSubscriptionsPage("Insight Premium", "7"),
