package webportal.ClientIsolationWithDLAN.Enhancement.Pro.PRJCBUGEN_T31787;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31787") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, CI is supported on both premium and pro account types") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31787") // It's a testcase id/link from Jira Test Case.
