package webportal.ClientIsolationWithDLAN.Enhancement.Pro.PRJCBUGEN_T31788;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31788") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, CI is enabled wireless clients cannot reach one anot") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31788") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
     ...
     public void step2() {
        ...
        locationInfo.put("SSID", "apwp14488");
       ...
       while (true) {
           ...
           if (new Javasocket()
                   .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14488")
                   .indexOf("true") != -1) {
               break;
           } else if (sum > 20) {
       ...
       if (!new Javasocket()
               .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14488 12345678 WPA2PSK aes")
               .equals("true")) {
           result1 = false;
           MyCommonAPIs.sleepi(20);
           if (new Javasocket()
