package webportal.ClientIsolationWithDLAN.IncreaseClientIsolationFrom5to16.Pro.PRJCBUGEN_T40706;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40706") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T40706") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp40706");
    ...
    public void step1() {
     ...
     public void step2() {
        ...
        locationInfo.put("SSID", "apwp40706");
     ...
     @Step("Test Step 3: Connect client with this client isolation dlan SSID;")
     public void step3() {
         ...
         while (true) {
             ...
             if (new Javasocket()
                     .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp40706")
                     .indexOf("true") != -1) {
                 break;
             } else if (sum > 20) {
         ...
         if (!new Javasocket()
                 .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp40706 12345678 WPA2PSK aes")
                 .equals("true")) {
             result1 = false;
             MyCommonAPIs.sleepi(20);
             if (new Javasocket()
     ...
     @Step("Test Step 4: Verify client details on orgaziation settings clients tab;")
     public void step4() {
         
         new OrganizationPage(false).openOrg(WebportalParam.Organizations);
         assertTrue(new OrganizationPage(false).goToOrgClientsTab(WebportalParam.Organizations, "apwp40706"),"Client is not listed on clients tab under organization setting page");
