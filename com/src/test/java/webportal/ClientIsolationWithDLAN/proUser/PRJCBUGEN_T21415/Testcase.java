package webportal.ClientIsolationWithDLAN.proUser.PRJCBUGEN_T21415;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21415") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the Client Isolation can be Enabled on an 802.1X / Enterprise SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21415") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21415");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp21415");
