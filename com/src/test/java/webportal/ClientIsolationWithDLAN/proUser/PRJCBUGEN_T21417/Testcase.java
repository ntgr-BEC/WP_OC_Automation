package webportal.ClientIsolationWithDLAN.proUser.PRJCBUGEN_T21417;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21417") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the Allow access is enabled only when the Profile VLAN is same as Mgnt VLAN.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21417") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21417");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp21417");
