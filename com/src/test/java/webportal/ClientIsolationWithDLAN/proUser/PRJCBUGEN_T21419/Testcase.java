package webportal.ClientIsolationWithDLAN.proUser.PRJCBUGEN_T21419;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21419") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Profile VLAN can be changed when the Client Isolation is enabled") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21419") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21419");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp21419");
        ...
        new WirelessQuickViewPage().changeVLANID(locationInfo.get("SSID"));      
