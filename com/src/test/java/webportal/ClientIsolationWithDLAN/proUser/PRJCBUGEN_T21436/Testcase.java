package webportal.ClientIsolationWithDLAN.proUser.PRJCBUGEN_T21436;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21436") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the Client Isolation can be configured across all the WAC5XX & WAX APs") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21436") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21436");
    }
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp21436");
