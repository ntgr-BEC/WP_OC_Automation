package webportal.ClientRoaminghistory.PRJCBUGEN_T21540;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21540") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Second level client information after click on selected disconnected client") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21540") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp21540");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp21540");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp21540")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp21540 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp21540 123456798 WPA2PSK aes")
