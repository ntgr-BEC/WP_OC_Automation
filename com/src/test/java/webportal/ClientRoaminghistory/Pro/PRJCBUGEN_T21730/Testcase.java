package webportal.ClientRoaminghistory.Pro.PRJCBUGEN_T21730;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21730") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Connected and Disconnected client list after we reboot the AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21730") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp21575");
    ...
    @Step("Test Step 3: Check whether connected connect is shown in Wireless page and client page;")
    public void step3() {
    ...
    @Step("Test Step 4: Reboot AP and wait till connected;")
    public void step4() {
    ...
    @Step("Test Step 5: Check whether connected connect is shown in Wireless page and client page;")
    public void step5() {
        assertTrue(new WirelessQuickViewPage().checkClientConnect(WebportalParam.clientwlanmac), "Client cannot connected.");
        assertTrue(new WirelessQuickViewPage(false).checkClientConnectClientPage(WebportalParam.clientwlanmac, Disconnect), "Client cannot connected.");
        assertTrue(new WirelessQuickViewPage().ClientConnect(WebportalParam.clientwlanmac, Disconnect),"client details are not right");
