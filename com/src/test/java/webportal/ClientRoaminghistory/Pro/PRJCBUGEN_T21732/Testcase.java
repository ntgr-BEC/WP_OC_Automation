package webportal.ClientRoaminghistory.Pro.PRJCBUGEN_T21732;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21732") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Connected and Disconnected client list after we reboot the AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21732") // It's a testcase id/link from Jira Test Case.
