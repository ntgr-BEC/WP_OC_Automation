package webportal.ConfigBackupAndRestore.Premium.AP.PRJCBUGEN_T7875;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7875") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Premium user can Edit configure backup at network level from web portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7875") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        BackupInfo.put("Name", "testtwo7875");
        BackupInfo.put("oldName", "test7875");
        BackupInfo.put("Description", "test");
