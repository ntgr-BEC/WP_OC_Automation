package webportal.ConfigBackupAndRestore.Premium.AP.PRJCBUGEN_T7877;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7877") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Premium user can Create a configure backup at network level from web portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7877") // It's a testcase id/link from Jira Test Case.
