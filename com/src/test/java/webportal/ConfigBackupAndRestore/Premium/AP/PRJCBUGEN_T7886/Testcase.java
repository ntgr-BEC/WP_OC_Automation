package webportal.ConfigBackupAndRestore.Premium.AP.PRJCBUGEN_T7886;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7886") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Premium user can restore backup configure checkpoints at network level from web portal") // It's a test case title from
                                                                                                                  // Jira Test Case.
    @TmsLink("PRJCBUGEN-T7886") // It's a testcase id/link from Jira Test Case.
