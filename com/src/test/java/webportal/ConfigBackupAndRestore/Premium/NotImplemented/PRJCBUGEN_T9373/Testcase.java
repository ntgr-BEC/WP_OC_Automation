package webportal.ConfigBackupAndRestore.Premium.NotImplemented.PRJCBUGEN_T9373;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T9373") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Spanning Tree configuration during back up and restore") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T9373") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Add one spanning tree configuration and create second backup;")
    public void step3() {
        handle.gotoLoction();
        ...
        BackupInfoTwo.put("Name", "test9373two");
