package webportal.ConfigBackupAndRestore.Premium.PRJCBUGEN_T15547;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15547") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("User can download backup checkpoint configurations for device level for switch") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15547") // It's a testcase id/link from Jira Test Case.
