package webportal.ConfigBackupAndRestore.Premium.PRJCBUGEN_T15548;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15548") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("User can upload backup checkpoint configuration file only at device level for switch") // It's a test case title from Jira
    // Test Case.
    @TmsLink("PRJCBUGEN-T15548") // It's a testcase id/link from Jira Test Case.
