package webportal.ConfigBackupAndRestore.Premium.PRJCBUGEN_T15549;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15549") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify basic user can configure backup checkpoints from web portal at device level for switch") // It's a test case title from
                                                                                                                  // Jira Test Case.
    @TmsLink("PRJCBUGEN-T15549") // It's a testcase id/link from Jira Test Case.
