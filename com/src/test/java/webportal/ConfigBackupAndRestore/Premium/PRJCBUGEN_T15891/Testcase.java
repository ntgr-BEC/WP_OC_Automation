package webportal.ConfigBackupAndRestore.Premium.PRJCBUGEN_T15891;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15891") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify basic user can configure backup checkpoints from web portal at device level for Orbi") // It's a test case title from Jira
                                                                                                                // Test Case.
    @TmsLink("PRJCBUGEN-T15891") // It's a testcase id/link from Jira Test Case.
...
//        new DevicesDashPage().checkDutInAdminAccount(devInfo.get("Serial Number"), devInfo.get("Device Name"), devInfo.get("Mac Address"));
    ...
    public void step2() {
        ...
        accountInfo.put("Last Name", "T15891");
    ...
    @Step("Test Step 3: Add new location and add one orbi, check create new backup checkpoint;")
    public void step3() {
