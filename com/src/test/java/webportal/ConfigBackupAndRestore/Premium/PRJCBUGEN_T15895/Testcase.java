package webportal.ConfigBackupAndRestore.Premium.PRJCBUGEN_T15895;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15895") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Premium user can edit configure backup checkpoints at Device level from web portal for Orbi") // It's a test case title
                                                                                                                       // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15895") // It's a testcase id/link from Jira Test Case.
