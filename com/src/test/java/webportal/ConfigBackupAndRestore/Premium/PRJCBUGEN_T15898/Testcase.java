package webportal.ConfigBackupAndRestore.Premium.PRJCBUGEN_T15898;
...
public class Testcase extends TestCaseBase {
    ...
    String backupName = "test15898";

    @Feature("ConfigBackupAndRestore.Premium") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T15898") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify user can restore config for switch") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15898") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        if (!new DevicesDashPage().getDeviceName(WebportalParam.sw1serialNo).contains(WebportalParam.sw1deveiceName)) {
//            new DevicesDashPage().editDeviceName(WebportalParam.sw1serialNo, WebportalParam.sw1deveiceName);
            new DevicesDashPage();
...
//        new DevicesDashPage().checkDutInAdminAccount(WebportalParam.sw1serialNo, WebportalParam.sw1deveiceName, WebportalParam.sw1MacAddress);
    ...
    public void step3() {
        new DevicesDashPage();
        new WirelessQuickViewPage(false).editswitchName(WebportalParam.sw1serialNo, backupName);
        handle.gotoLoction();
        ddp.gotoPage();
        ddp.openSW1();
    ...
    public void step4() {
        assertTrue(new DevicesDashPage().getDeviceName(WebportalParam.sw1serialNo).contains(WebportalParam.sw1deveiceName));
    }
