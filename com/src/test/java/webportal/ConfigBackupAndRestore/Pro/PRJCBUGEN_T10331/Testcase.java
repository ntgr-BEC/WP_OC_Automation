package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T10331;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "test10331";

    @Feature("ConfigBackupAndRestore.Pro") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T10331") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Locations automatically created when organization created") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10331") // It's a testcase id/link from Jira Test Case.
