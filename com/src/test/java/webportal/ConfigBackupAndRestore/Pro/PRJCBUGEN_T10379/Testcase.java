package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T10379;
...
public class Testcase extends TestCaseBase {
    ...
    String              organizationName = "test10382";
    String              locationName     = "ntk10382";
    String              ip1              = "11.22.33." + String.format("%02d", ends);
    String              ip2              = "11.22.33.100";

    @Feature("ConfigBackupAndRestore.Pro") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T10382") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the location configuration-Spanning tree configuration getting copied on copy configuration") // It's a test case title
                                                                                                                       // from Jira
    // Test Case.
    @TmsLink("PRJCBUGEN-T10382") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enable radius configuration;")
    public void step2() {
        rdp.gotoPage();
    ...
    public void step4() {
        ...
        new AccountPage(false).editNetwork(locationName);
        WebCheck.checkUrl(URLParam.hrefRadius);
        assertTrue(rdp.checkAuthStatus(ip1), "Copy configuration failed.");
    }
