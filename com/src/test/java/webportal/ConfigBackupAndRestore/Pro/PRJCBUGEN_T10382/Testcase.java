package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T10382;
...
public class Testcase extends TestCaseBase {
    ...
    @Step("Test Step 2: Create new organization and add stp configuration;")
    public void step2() {
    ...
    public void step4() {
        ...
        wstp.gotoPage();
        assertTrue(wstp.getSTPMode() != 0, "Copy configuration failed.");
    }
