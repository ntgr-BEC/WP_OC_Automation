package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T10384;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10384") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the wireless configuration- WiFi getting copied on copy configuration") // It's a test case title from
    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T10384") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        assertTrue(new WirelessQuickViewPage().checkUrlFilterIsExist("www.rediff.com")
                && new WirelessQuickViewPage().checkRateLimitStatus(ssidInfo.get("SSID")), "Copy configuration failed.");
    }
