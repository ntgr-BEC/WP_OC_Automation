package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T10386;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "test10386";
    String locationName     = "ntk10386";
    ...
    @Story("PRJCBUGEN_T10386") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the wireless configuration- Auto RRM configuration getting copied on copy configuration") // It's a test case title
                                                                                                                   // from
    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T10386") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).enableFastRoamingAndGetMobilityid();
    ...
    @Step("Test Step 2: Add ssid and disable Fast Roaming;")
    public void step2() {
        if (new DevicesDashPage().getDeviceName(WebportalParam.ap1serialNo).equals("")) {
            assertTrue(false, "Need add one ap.");
        }

        ssidInfo.put("SSID", "apwp10386");
        ssidInfo.put("Security", "WPA2 Personal");
        ssidInfo.put("Password", "12345678");
        new WirelessQuickViewPage().addSsid(ssidInfo);
        new WirelessQuickViewPage(false).disableFastRoaming();
        MyCommonAPIs.sleepi(20);
    }
    ...
    public void step4() {
        ...
        assertTrue(!new WirelessQuickViewPage().checkFastRoamingStatus(), "Copy configuration failed.");
    }
