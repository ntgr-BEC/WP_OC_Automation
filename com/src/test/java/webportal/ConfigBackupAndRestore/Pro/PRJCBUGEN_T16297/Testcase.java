package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16297;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16297") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("User can upload backup checkpoint configuration file only at device level for BR500") // It's a test case title from Jira Test
                                                                                                        // Case.
    @TmsLink("PRJCBUGEN-T16297") // It's a testcase id/link from Jira Test Case.
