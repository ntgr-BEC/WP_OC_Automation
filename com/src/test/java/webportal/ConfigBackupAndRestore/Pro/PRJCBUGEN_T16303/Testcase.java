package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16303;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16303") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Premium user can Delete configure backup checkpoints at Device level from web portal for Switch") // It's a test case title
                                                                                                                           // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16303") // It's a testcase id/link from Jira Test Case.
