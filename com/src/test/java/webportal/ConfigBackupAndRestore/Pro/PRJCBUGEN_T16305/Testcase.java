package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16305;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16305") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Premium user can configure backup checkpoints from web portal at device level for BR500") // It's a test case title from
                                                                                                                   // Jira Test Case.
    @TmsLink("PRJCBUGEN-T16305") // It's a testcase id/link from Jira Test Case.
