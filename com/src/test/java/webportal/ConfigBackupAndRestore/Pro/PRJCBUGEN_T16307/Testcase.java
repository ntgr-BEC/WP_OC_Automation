package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16307;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16307") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Premium user can configure backup checkpoints from web portal at device level for switch") // It's a test case title from
                                                                                                                    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T16307") // It's a testcase id/link from Jira Test Case.
