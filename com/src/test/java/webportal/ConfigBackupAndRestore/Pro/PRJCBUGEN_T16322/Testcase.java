package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16322;
...
public class Testcase extends TestCaseBase {
    ...
    public void step3() {
        new DevicesDashPage().editDeviceName(WebportalParam.ob1serialNo, backupName);
