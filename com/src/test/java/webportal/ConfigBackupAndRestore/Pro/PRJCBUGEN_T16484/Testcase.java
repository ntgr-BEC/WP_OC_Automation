package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16484;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16484") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Premium user can Create a configure backup at network level from web portal") // It's a test case title from Jira Test
                                                                                                       // Case.
    @TmsLink("PRJCBUGEN-T16484") // It's a testcase id/link from Jira Test Case.
