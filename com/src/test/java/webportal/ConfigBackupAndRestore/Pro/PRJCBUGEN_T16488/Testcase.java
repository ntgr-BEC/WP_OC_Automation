package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16488;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16488") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Facebook Wifi for wireless device at location level") // It's a test case title from
    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T16488") // It's a testcase id/link from Jira Test Case.
