package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16491;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16491") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Spanning Tree configuration during back up and restore") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16491") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        BackupInfoTwo.put("Name", "test16491two");
