package webportal.ConfigBackupAndRestore.Pro.PRJCBUGEN_T16492;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16492") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Wifi config for AP at location level") // It's a test case title from
                                                                    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T16492") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        BackupInfoTwo.put("Name", "test16492two");
