package webportal.CreateMultipleLocation.PRJCBUGEN_T50009;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("AdvanceAPFunctionally.non_premium_admin") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T50009") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add Multiple MAC ACL deny") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T50009") // It's a testcase id/link from Jira Test Case.
