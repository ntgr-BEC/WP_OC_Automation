package webportal.CreateOrganization.PRJCBUGEN_T13877;
...
public class Testcase extends TestCaseBase {
    String organizationName = "PRJCBUGEN_T13877";
    
    @Feature("CreateOrganization") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T13877") // It's a testcase id/link from Jira Test Case but replace - with _.
