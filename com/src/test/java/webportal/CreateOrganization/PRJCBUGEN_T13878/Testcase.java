package webportal.CreateOrganization.PRJCBUGEN_T13878;
...
public class Testcase extends TestCaseBase {
    String organizationName = "PRJCBUGEN_T13878";

    @Feature("CreateOrganization") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T13878") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that the user is able to change organization policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13878") // It's a testcase id/link from Jira Test Case.
