package webportal.CreateOrganization.PRJCBUGEN_T13880;
...
public class Testcase extends TestCaseBase {
    ...
    @Step("Test Step 2:  to change the organization name")
    public void step2() {
        OrganizationPage page = new OrganizationPage();
        page.gotoPage();
        ...
        if (page.checkOrganizationIsExist(organizationName)) {
            ...
            organizationInfo.put("New Name", organizationName);
            page.editOrganization(organizationInfo);
            assertTrue(new OrganizationPage().checkOrganizationIsExist(organizationName), "organization new name is not saved.");
        } else {
