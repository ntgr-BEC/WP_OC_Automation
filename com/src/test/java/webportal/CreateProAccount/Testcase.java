package webportal.CreateProAccount;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14341565") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T14341565") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        for (int i = 1; i <= accountNum; i++) {
            mailname = "auxqapro" + String.valueOf(i) + "@sharklasers.com";
