package webportal.CustomReports.PRJCBUGEN_T9655;
...
public class Testcase extends TestCaseBase {
    ...
    String      reportName = "PRJCBUGEN_T9655";
    MailHandler mh         = new MailHandler();

    @Feature("Custom Reports") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T9655") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if user can create a custom report with 24 hours time, with all the Organizations, Locations & Devices selected.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T9655") // It's a testcase id/link from Jira Test Case.
