package webportal.CustomReports.PRJCBUGEN_T9666;
...
public class Testcase extends TestCaseBase {
    ...
    String      reportName = "PRJCBUGEN_T9666";
    MailHandler mh         = new MailHandler();
    
    @Feature("Custom Reports") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T9666") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the user is able to see the preview of the report based on the selection of the Widgets") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T9666") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(crPage.txtReviewHeader.exists(), "verify preview windows is opened");
