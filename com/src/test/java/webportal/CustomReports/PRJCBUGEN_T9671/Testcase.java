package webportal.CustomReports.PRJCBUGEN_T9671;
...
public class Testcase extends TestCaseBase {
    ...
    String      reportName = "PRJCBUGEN_T9671";
    MailHandler mh         = new MailHandler();

    @Feature("Custom Reports") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T9671") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if all the changes done in the device configurations are captured in the change log reports.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T9671") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(micResult, "check must have configuration changes");
