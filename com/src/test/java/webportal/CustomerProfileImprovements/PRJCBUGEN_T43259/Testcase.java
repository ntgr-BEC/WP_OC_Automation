package webportal.CustomerProfileImprovements.PRJCBUGEN_T43259;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T43259") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether selected customer profile name is pushed to the device - SAVANT") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T43259") // It's a testcase id/link from Jira Test Case.
