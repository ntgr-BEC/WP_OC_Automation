package webportal.CustomerProfileImprovements.PRJCBUGEN_T43265;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T43265") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether whether applied customer profiles get applied to the device properly when we edit an exiting SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T43265") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        assertTrue(new WirelessQuickViewPage().deleteSsidYesConfirm("apwp43265"),"Ssid not deleted successfully");
