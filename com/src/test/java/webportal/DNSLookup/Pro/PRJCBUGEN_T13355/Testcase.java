package webportal.DNSLookup.Pro.PRJCBUGEN_T13355;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13355") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that after completing the test on network level user is navigated to the device list screen on clicking Troubleshoot again") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13355") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        troubleshoot.troubleshootBtn.click();
        MyCommonAPIs.sleepi(5);
        assertTrue($$x("//p[text()='" + WebportalParam.ap1serialNo + "']").size() == 2, "Cannot jump to troubleshoot page.");
    }
