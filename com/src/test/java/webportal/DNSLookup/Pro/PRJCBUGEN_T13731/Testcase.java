package webportal.DNSLookup.Pro.PRJCBUGEN_T13731;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13731") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if the user clicks on DNS Look up tile on troubleshoot screen, then the user is able to enter the domain name") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13731") // It's a testcase id/link from Jira Test Case.
