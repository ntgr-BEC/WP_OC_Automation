package webportal.DNSLookup.Pro.PRJCBUGEN_T13732;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T13732") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify \"test now\" button remains disable until any domain name is entered") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T13732") // It's a testcase id/link from Jira Test Case.
