package webportal.DNSLookup.Pro.PRJCBUGEN_T14451;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14451") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can run DNS lookup for multiple devices at a time") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14451") // It's a testcase id/link from Jira Test Case.
