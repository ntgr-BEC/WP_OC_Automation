package webportal.DNSLookup.Pro.PRJCBUGEN_T14453;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14453") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that IP address associated with the entered domain are displayed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14453") // It's a testcase id/link from Jira Test Case.
