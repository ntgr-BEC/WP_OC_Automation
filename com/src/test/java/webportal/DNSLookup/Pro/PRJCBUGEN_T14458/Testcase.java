package webportal.DNSLookup.Pro.PRJCBUGEN_T14458;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14458") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T14458") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(tmpStr.contains("a valid domain name"), "dns lookup fail reason is: " + tmpStr);
    }
