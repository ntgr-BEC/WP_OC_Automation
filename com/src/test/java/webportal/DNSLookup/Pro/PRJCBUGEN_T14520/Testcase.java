package webportal.DNSLookup.Pro.PRJCBUGEN_T14520;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14520") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the firmware compatibility wrt DNS Lookup") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14520") // It's a testcase id/link from Jira Test Case.
