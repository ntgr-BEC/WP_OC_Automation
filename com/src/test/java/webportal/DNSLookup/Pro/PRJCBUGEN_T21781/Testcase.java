package webportal.DNSLookup.Pro.PRJCBUGEN_T21781;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21781") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify DNS look up for AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21781") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        handle.gotoLoction();
        assertTrue(!new DevicesDashPage().getDeviceName(WebportalParam.ap1serialNo).equals(""), "Not found ap device.");
