package webportal.DNSLookup.Pro.PRJCBUGEN_T21782;
...
public class Testcase extends TestCaseBase {
    String                                domain       = "www.bing21782.com";
    String                                tmpStr;
    ...
    @Story("PRJCBUGEN_T21782") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify a Failure message with appropriate reason is displayed in case of DNS lookup failure") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21782") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue($x("//*[text()='Domain name does not exist. Enter a valid domain name.']").exists(), "Not found failure message.");
        $$("div.in button").last().click();
    }
