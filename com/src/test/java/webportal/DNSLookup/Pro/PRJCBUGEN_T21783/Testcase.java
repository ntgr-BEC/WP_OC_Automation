package webportal.DNSLookup.Pro.PRJCBUGEN_T21783;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21783") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify a text box for entering domain name is present and the user is able to enter the text.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21783") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!troubleshoot.btnRunTest.isEnabled()) {
            ...
            assertTrue(troubleshoot.domainName.getValue().equals(domain), "Cannot input text.");
        } else {
            assertTrue(false, "Test button not enable.");
        }
    }
