package webportal.DNSLookup.Pro.PRJCBUGEN_T21788;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21788") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that after starting the test user can move to another screen") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21788") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!troubleshoot.btnRunTest.isEnabled()) {
            ...
            assertTrue(!troubleshoot.DNSLookup.isDisplayed(), "DNS lookup test failed.");
        } else {
