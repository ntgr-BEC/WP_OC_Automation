package webportal.Deallocation.PRJCBUGEN_T29933;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName1 = "PRJCBUGEN_T29933";
    OrganizationPage page = new OrganizationPage();

    @Feature("Deallocation") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T29933") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should able to see allocated credit for the org on the screen.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T29933") // It's a testcase id/link from Jira Test Case.
