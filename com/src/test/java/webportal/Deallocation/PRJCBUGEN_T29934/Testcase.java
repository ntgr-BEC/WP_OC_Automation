package webportal.Deallocation.PRJCBUGEN_T29934;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName1 = "PRJCBUGEN_T29934";
    OrganizationPage page = new OrganizationPage();

    @Feature("Deallocation") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T29934") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should able to deallocate credits from organisation.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T29934") // It's a testcase id/link from Jira Test Case.
