package webportal.DeviceContract.PRJCBUGEN_T14272;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Purchase device contract for WAC540 Model - UK") // It's a testcase title from Jira Test Case.
    ...
    public void step1() {
        ...
        webportalLoginPage.loginByUserPassword("devicecontractuk@yopmail.com", "Netgear1@");
    ...
    public void step2() {
        ...
        new InsightServicesPage().buyDeviceContract(paymentInfo, WebportalParam.ap6serialNo);
    ...
    public void step3() {
        ...
        assertTrue(new InsightServicesPage(false).DeviceContractVerification(WebportalParam.ap6serialNo),"");
