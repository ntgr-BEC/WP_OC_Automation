package webportal.DeviceContract.PRJCBUGEN_T14273;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Purchase device contract for WAC540 Model - Australia") // It's a testcase title from Jira Test Case.
    ...
    public void step1() {
        ...
        webportalLoginPage.loginByUserPassword("devicecontractaus@yopmail.com", "Netgear1@");
    ...
    public void step2() {
        ...
        paymentInfo.put("State", "Montville");
        ...
        new InsightServicesPage().buyDeviceContract(paymentInfo, WebportalParam.ap7serialNo);
    ...
    public void step3() {
        ...
        assertTrue(new InsightServicesPage(false).DeviceContractVerification(WebportalParam.ap7serialNo),"");
