package webportal.DeviceGroup.CustomGroupNPI.PRJCBUGEN_T32367;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32367") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, CG page list CGs with clounm as Name, Discription and Devices (with subdivision of online | onboarded)") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32367") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        MyCommonAPIs.sleepi(5);
        assertTrue(new DeviceGroupPage().CGclounm(),"clounm as Name, Discription and Devices  did not appear");
