package webportal.DeviceGroup.CustomGroupNPI.PRJCBUGEN_T32369;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32369") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, deleting a CG") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32369") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(!new DeviceGroupPage().checkCGexits("Automation1"),"on deleting CG, warning popup is did not appear");
    }
