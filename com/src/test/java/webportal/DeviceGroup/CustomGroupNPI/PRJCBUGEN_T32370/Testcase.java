package webportal.DeviceGroup.CustomGroupNPI.PRJCBUGEN_T32370;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32370") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, on deleting CG, devices under this Group also gets deleted from insight account") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32370") // It's a testcase id/link from Jira Test Case.
