package webportal.DeviceGroup.CustomGroupNPI.PRJCBUGEN_T32371;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32371") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, device addition to existing CG with SN entry from webportal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32371") // It's a testcase id/link from Jira Test Case.
