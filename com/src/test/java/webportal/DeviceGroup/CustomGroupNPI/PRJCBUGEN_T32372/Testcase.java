package webportal.DeviceGroup.CustomGroupNPI.PRJCBUGEN_T32372;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32372") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, APs can be added to Custom Groups") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32372") // It's a testcase id/link from Jira Test Case.
