package webportal.DeviceGroup.CustomGroupNPI.PRJCBUGEN_T32373;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32373") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify,  Router/Switch and APs can be added to  Custom Groups") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32373") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        devInfo1.put("MAC Address1", WebportalParam.sw1MacAddress);

        new DeviceGroupPage().addNewDevice(devInfo1, "Automation1");
