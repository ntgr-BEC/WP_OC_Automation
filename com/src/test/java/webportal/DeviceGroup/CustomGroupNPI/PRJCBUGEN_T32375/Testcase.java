package webportal.DeviceGroup.CustomGroupNPI.PRJCBUGEN_T32375;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32375") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Deleting device within CG will delete device from account") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32375") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        new DeviceGroupPage().DeleteDeviceDG(WebportalParam.ap1serialNo);
    }
        
    
    @Step("Test Step 4: Click on x on AP under device tab;")
    public void step4() {
