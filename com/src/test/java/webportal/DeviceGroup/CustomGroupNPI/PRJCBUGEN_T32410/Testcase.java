package webportal.DeviceGroup.CustomGroupNPI.PRJCBUGEN_T32410;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32410") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, VLANs creation on CG") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32410") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Go VLANNetworkSetup")
    public void step3() {
        ...
        MyCommonAPIs.sleepi(5);
        new DeviceGroupPage().DGVLANNetworkSetup.click();
        vlanPage.addDataVlanWithPorts("data traffic vlan", "600", null, null, "tag", null, null, null, "true");
    }
