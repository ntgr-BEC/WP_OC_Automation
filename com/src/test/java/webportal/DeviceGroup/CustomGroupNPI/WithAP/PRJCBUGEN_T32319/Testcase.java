package webportal.DeviceGroup.CustomGroupNPI.WithAP.PRJCBUGEN_T32319;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32319") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Connected client per SSID for all Custom Group Name") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32319") // It's a testcase id/link from Jira Test Case.
