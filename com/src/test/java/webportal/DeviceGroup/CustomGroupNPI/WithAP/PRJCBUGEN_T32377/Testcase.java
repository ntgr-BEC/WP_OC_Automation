package webportal.DeviceGroup.CustomGroupNPI.WithAP.PRJCBUGEN_T32377;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32377") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, SSID creation with CG") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32377") // It's a testcase id/link from Jira Test Case.
