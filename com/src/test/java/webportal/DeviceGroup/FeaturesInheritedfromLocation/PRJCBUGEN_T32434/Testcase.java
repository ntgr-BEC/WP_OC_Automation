package webportal.DeviceGroup.FeaturesInheritedfromLocation.PRJCBUGEN_T32434;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32434") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, syslog configuration is pushed on CG devices") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32434") // It's a testcase id/link from Jira Test Case.
