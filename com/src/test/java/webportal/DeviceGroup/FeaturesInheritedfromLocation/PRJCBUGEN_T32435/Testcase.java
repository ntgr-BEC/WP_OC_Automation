package webportal.DeviceGroup.FeaturesInheritedfromLocation.PRJCBUGEN_T32435;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32435") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, syslog configuration is pushed on CG devices") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32435") // It's a testcase id/link from Jira Test Case.
