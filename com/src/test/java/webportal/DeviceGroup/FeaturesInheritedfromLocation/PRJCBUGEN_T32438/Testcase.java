package webportal.DeviceGroup.FeaturesInheritedfromLocation.PRJCBUGEN_T32438;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32438") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, LED settings at location level is applied on CG's device") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32438") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to LED and enable")
    public void step2() {
    ...
    @Step("Test Step 3: check whethe it is pushed to AP;")
    public void step3() {
