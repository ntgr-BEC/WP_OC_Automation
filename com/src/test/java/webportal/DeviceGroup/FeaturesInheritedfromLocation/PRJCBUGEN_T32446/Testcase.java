package webportal.DeviceGroup.FeaturesInheritedfromLocation.PRJCBUGEN_T32446;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32446") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, SNMP is part of first config for CG's devices") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32446") // It's a testcase id/link from Jira Test Case.
