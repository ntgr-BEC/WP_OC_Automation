package webportal.DeviceGroup.FeaturesunderCGs.PRJCBUGEN_T32303;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32303") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, on device on-boarding with SN from device list page a dropdown to select CG step is shown provided CG is existing") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32303") // It's a testcase id/link from Jira Test Case.
