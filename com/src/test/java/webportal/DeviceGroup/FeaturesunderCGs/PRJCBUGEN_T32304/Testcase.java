package webportal.DeviceGroup.FeaturesunderCGs.PRJCBUGEN_T32304;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32304") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, on device on-boarding with SN from org level new pop up to select CG provided CG is existing") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32304") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new DeviceGroupPage().addNewDeviceOrg(devInfo, "Automation1", WebportalParam.location1),"dropdown to select CG step is shown");
