package webportal.DeviceGroup.FeaturesunderCGs.PRJCBUGEN_T32307;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32307") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Device list on CG") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32307") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteDeviceYes(WebportalParam.ap7macaddress);
