package webportal.DeviceGroup.FeaturesunderCGs.PRJCBUGEN_T32308;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32308") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, device list have columns as : device name, model and serial number") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32308") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        devInfo.put("Serial Number", WebportalParam.ap7serialNo);
        devInfo.put("MAC Address1", WebportalParam.ap7macaddress);
    ...
    @Step("Test Step 3: check device tab;")
    public void step3() {
        OrganizationPage.openOrg(WebportalParam.Organizations);
        new DeviceGroupPage().GoToDeviceGroup(WebportalParam.location1);
        MyCommonAPIs.sleepi(5);
        ...
        MyCommonAPIs.sleepi(5);       
        assertTrue(new DeviceGroupPage().DeviceName.isDisplayed()&& new DeviceGroupPage().DeviceSerialNumber.isDisplayed()  , "device list and serial number not displayed");
