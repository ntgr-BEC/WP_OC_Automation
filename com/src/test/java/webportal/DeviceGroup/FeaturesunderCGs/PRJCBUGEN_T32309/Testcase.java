package webportal.DeviceGroup.FeaturesunderCGs.PRJCBUGEN_T32309;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32309") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, at  loc level > device page lists CG's devices") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32309") // It's a testcase id/link from Jira Test Case.
    ...
    assertTrue(new WirelessQuickViewPage().checkApIsExist(WebportalParam.ap7serialNo),"Device delete unsuccessful");
