package webportal.DeviceGroup.FeaturesunderCGs.PRJCBUGEN_T32346;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32346") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, admin can create CG") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32346") // It's a testcase id/link from Jira Test Case.
