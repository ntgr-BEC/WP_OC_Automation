package webportal.DeviceGroup.FeaturesunderCGs.PRJCBUGEN_T32349;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32349") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Read-Write manager can create/edit CGs") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32349") // It's a testcase id/link from Jira Test Case.
