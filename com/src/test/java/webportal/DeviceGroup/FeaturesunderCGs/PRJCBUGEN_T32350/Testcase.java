package webportal.DeviceGroup.FeaturesunderCGs.PRJCBUGEN_T32350;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32350") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, secondary admin can create CG") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32350") // It's a testcase id/link from Jira Test Case.
