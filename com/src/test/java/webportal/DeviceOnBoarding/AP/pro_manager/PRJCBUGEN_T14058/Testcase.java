package webportal.DeviceOnBoarding.AP.pro_manager.PRJCBUGEN_T14058;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14058") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("On-boarding of AP device WAC 510 via serial number") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14058") // It's a testcase id/link from Jira Test Case.
