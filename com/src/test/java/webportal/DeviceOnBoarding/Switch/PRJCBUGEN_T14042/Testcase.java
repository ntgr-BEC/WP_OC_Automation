package webportal.DeviceOnBoarding.Switch.PRJCBUGEN_T14042;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("DeviceOnBoarding.Switch") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T14042") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("On-boarding of Switches via serial number") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14042") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        String newNameDev = switchTelnet.getDeviceName();
        assertTrue(newNameDev.contains(newName), "check device name on device side:" + newNameDev);
    }
