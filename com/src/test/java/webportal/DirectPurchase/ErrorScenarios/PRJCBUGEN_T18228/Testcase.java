package webportal.DirectPurchase.ErrorScenarios.PRJCBUGEN_T18228;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18228") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Basic paid user gets error message when user tries to do Direct Premium / Pro Purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18228") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Create IM WP account success and buy device credits;")
    public void step1() {
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);

        Map<String, String> accountInfo = new HashMap<String, String>();
        accountInfo.put("First Name", mailname);
        accountInfo.put("Last Name", "T18228");
        ...
        paymentInfo.put("Last Name", "T18828");
        ...
        assertTrue(new HamburgerMenuPage().checkDevicesBilling(paymentInfo.get("Number of Device Credits"), "basic", "US"), "Amount is incorrect.");
    }
