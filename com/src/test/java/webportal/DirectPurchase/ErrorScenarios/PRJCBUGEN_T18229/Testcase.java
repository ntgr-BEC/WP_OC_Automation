package webportal.DirectPurchase.ErrorScenarios.PRJCBUGEN_T18229;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18229") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether IM throws error message when an Premium user purchase Pro subscription using Direct Pro Purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18229") // It's a testcase id/link from Jira Test Case.
