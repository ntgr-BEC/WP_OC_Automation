package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18208;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18208") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Existing Premium monthly User able to do Premium direct purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18208") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18208");
