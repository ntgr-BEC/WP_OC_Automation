package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18210;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18210") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Existing Premium User able to do Pro direct purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18210") // It's a testcase id/link from Jira Test Case.
