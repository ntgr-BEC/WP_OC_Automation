package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18214;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18214") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Premium trail user able to do Direct premium Purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18214") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18214");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18214");
