package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18217;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18217") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether User who have purchased Multipack able to do Direct premium purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18217") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18217");
    ...
    public void step2() {
        ...
        assertTrue(new HamburgerMenuPage(false).checkDeviceCredits(paymentInfo.get("Device Credits Pack")), "Subscriptions page display error.");
    }
