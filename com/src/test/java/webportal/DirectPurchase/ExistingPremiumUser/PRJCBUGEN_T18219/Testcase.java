package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18219;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18219") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether user able to cancel the Purchased direct premium credit <= 3 day of purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18219") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18219");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18219");
        ...
        assertTrue(new HamburgerMenuPage(false).checkSubscriptionScreen(
                String.valueOf(Integer.valueOf(paymentInfo.get("Number of Device Credits")))), "Buy premium subscription unsuccessful.");
    }
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        String url = MyCommonAPIs.getCurrentUrl();
        if (url.contains("dashboard")) {
            assertTrue(new HamburgerMenuPage(true).checkDisplayCancelDirectPurchase("premium"), "Not found cancel button.");
        } else {
