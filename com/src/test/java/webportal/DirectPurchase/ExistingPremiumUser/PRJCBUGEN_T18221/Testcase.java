package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18221;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18221") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether user able to purchase the ICP credits when user purchases direct premium credits") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18221") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18221");
    ...
    public void step2() {
        ...
        assertTrue(new HamburgerMenuPage().checkCaptivePortalServicesCredits(), "Buy captive portal service unsuccessful.");
    }
