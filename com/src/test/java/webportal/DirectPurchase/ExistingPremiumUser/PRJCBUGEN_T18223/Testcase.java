package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18223;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18223") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Direct purchased premium credits gets added in the account Total device credits") // It's a testcase title from
                                                                                                                   // Jira Test Case.
    @TmsLink("PRJCBUGEN-T18223") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18223");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18223");
        ...
        assertTrue(
                new HamburgerMenuPage(false).checkSubscriptionScreen(String.valueOf(Integer.valueOf(paymentInfo.get("Number of Device Credits")))),
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        if (url.contains("dashboard")) {
            assertTrue(
                    new HamburgerMenuPage(true)
                            .checkSubscriptionScreen(String.valueOf(Integer.valueOf(paymentInfo.get("Number of Device Credits")) + 1)),
                    "Buy premium subscription unsuccessful.");
        } else {
