package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18224;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18224") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Direct purchased premium credits are displayed under \"Current Subscription \" page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18224") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18224");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18224");
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        String url = MyCommonAPIs.getCurrentUrl();
        if (url.contains("dashboard")) {
            assertTrue(new HamburgerMenuPage(true).checkDirectPurchaseTableInfo(), "Buy premium subscription unsuccessful.");
        } else {
