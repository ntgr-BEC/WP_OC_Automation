package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18225;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18225") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether user able add more than the purchased device credit") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18225") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        } else if (url.contains("/devices/dash")) {
            new AccountPage().deleteLocation(locationName);
        }
    }
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18225");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18225");
    ...
    @Step("Test Step 3: Buy premium subscription and check add devices;")
    public void step3() {
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        if (url.contains("dashboard")) {
            ...
            assertTrue(!new DevicesDashPage().checkAddDevice(devInfo), "Add device error.");
        } else {
