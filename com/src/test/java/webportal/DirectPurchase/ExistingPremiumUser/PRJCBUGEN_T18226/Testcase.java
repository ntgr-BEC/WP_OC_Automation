package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T18226;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18226") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether the status of the account changes from \"Premium trail \" to \"Premium \" account when user does an direct premium purchase") // It's
                                                                                                                                                               // a
                                                                                                                                                               // testcase
                                                                                                                                                               // title
                                                                                                                                                               // from
                                                                                                                                                               ...
                                                                                                                                                               // Test
                                                                                                                                                               // Case.
    @TmsLink("PRJCBUGEN-T18226") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18226");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18226");
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        String url = MyCommonAPIs.getCurrentUrl();
        if (url.contains("dashboard")) {
            assertTrue(!new HamburgerMenuPage(true).checkCancelSubscription() && new HamburgerMenuPage(false).checkDirectPurchase(),
