package webportal.DirectPurchase.ExistingPremiumUser.PRJCBUGEN_T19920;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19920") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Cancel functionality with respect to Direct purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19920") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T19920");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T19920");
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        if (url.contains("dashboard")) {
            assertTrue(
                    new HamburgerMenuPage(true).checkDisplayCancelDirectPurchase("premium")
                            && MyCommonAPIs.getText(new HamburgerMenuPage(false).directPurchaseTdOne)
                                    .contains("Use this table to view all current subscriptions for your Insight Premium account"),
