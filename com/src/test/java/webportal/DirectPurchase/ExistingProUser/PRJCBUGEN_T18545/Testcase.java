package webportal.DirectPurchase.ExistingProUser.PRJCBUGEN_T18545;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18545") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Direct purchased Pro credits are displayed under \"Current Subscription \" page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18545") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        paymentInfo.put("Last Name", "T18545");
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("pro");
        ...
        if (url.contains("dashboard")) {
            assertTrue(new HamburgerMenuPage(true).proSubscriptionTdOne.exists(), "Buy pro subscription unsuccessful.");
        } else {
