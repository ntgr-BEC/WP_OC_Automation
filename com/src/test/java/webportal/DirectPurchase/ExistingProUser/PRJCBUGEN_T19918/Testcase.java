package webportal.DirectPurchase.ExistingProUser.PRJCBUGEN_T19918;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19918") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to purchase more than 1 device credit using direct purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19918") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        if (url.contains("subScriptionsPro")) {
            ...
            new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("pro");
        } else {
            Selenide.close();
            startBrowser();
    ...
    public void step1() {
        ...
        paymentInfo.put("Last Name", "T19918");
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("pro");
        ...
        if (url.contains("dashboard")) {
            assertTrue(new HamburgerMenuPage(true).getTotalDevicesCredits().equals(String.valueOf(Integer.valueOf(devNum) + 2)),
