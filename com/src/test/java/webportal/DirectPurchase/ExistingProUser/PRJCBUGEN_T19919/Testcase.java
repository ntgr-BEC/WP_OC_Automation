package webportal.DirectPurchase.ExistingProUser.PRJCBUGEN_T19919;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19919") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Cancel functionality with respect to Direct purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19919") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Buy pro subscription and cancel this subscription;")
    public void step1() {
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T19919");
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("pro");
        ...
        if (url.contains("dashboard")) {
            assertTrue(new HamburgerMenuPage(true).checkDisplayCancelDirectPurchase("pro"), "Cancel subscription failed.");
        } else {
