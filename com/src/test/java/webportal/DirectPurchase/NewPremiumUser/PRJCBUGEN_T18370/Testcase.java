package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18370;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18370") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify \"Create Account\" page, validate field on clicking \"Continue button\"") // It's a testcase title from Jira Test
                                                                                                           // Case.
    @TmsLink("PRJCBUGEN-T18370") // It's a testcase id/link from Jira Test Case.
