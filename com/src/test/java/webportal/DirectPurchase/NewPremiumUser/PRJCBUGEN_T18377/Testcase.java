package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18377;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18377") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T18377") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18377");
