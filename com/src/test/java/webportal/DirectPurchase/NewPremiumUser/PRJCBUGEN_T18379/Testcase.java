package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18379;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18379") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify \"Payment page\", at Billing information tab, able to fill all mandatory fields") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18379") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18379");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18379");
