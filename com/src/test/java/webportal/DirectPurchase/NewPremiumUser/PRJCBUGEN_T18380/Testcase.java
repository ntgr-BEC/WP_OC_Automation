package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18380;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18380") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify \"Payment page\", at Payment information tab, able to fill all mandatory fields") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18380") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18380");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18380");
...
//        boolean result = !new InsightServicesPage(false).savebutton.isEnabled();
        new InsightServicesPage(false).inputPaymentInfo(paymentInfo);
//        assertTrue(result && new InsightServicesPage(false).savebutton.isEnabled(), "Billing page display incorrect.");
    }
