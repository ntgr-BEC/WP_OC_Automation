package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18381;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18381") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify \"Payment page\", at Payment information tab validate all fields") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18381") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18381");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18381");
        ...
        paymentInfo.put("Card Number", "411234411234411");
        paymentInfo.put("CVV Number", "12");
        paymentInfo.put("Expiration Month", "Select Month");
        paymentInfo.put("Expiration Year", "Select Year");
        new InsightServicesPage(false).inputBillingInfo(paymentInfo);
//        new InsightServicesPage(false).savebutton.click();
        MyCommonAPIs.sleepi(30);
        new InsightServicesPage(false).inputPaymentInfo(paymentInfo);
        assertTrue(new InsightServicesPage(false).checkPaymentInfoError(), "Billing page display incorrect.");
    }
