package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18382;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18382") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Order Summary tab Total Price is sum for single device price and Tax") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18382") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18382");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18382");
...
//        new InsightServicesPage(false).savebutton.click();
        ...
        MyCommonAPIs.sleepi(5);
        assertTrue(new InsightServicesPage(false).checkTotalPrice(), "Billing page display incorrect.");
    }
