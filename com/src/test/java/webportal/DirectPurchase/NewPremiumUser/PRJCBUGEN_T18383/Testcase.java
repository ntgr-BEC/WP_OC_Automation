package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18383;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18383") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Place your order button at \"Order Summary\" tab clickable once all field of Subscription Plan, Billing information, Payment Information are filled") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18383") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18383");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18383");
...
//        new InsightServicesPage(false).clickSaveButton();
        ...
        assertTrue(!new HamburgerMenuPage(false).orderSummaryTab.exists(), "Place order failed.");
    }
