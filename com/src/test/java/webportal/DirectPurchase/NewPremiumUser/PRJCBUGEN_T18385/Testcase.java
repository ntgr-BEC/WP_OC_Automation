package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18385;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18385") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify clicking \"Go to Dashboard\" button allow to Proceed on further Process of Premium User") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18385") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18385");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18385");
