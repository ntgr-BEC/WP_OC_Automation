package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18388;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18388") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if Payment fails than not able to start process using same details") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18388") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18388");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18388");
...
//        new InsightServicesPage(false).clickSaveButton();
        ...
        assertTrue(new InsightServicesPage(false).cardError.exists(), "Place order failed.");

        Selenide.close();
        startBrowser();
    }

    @Step("Test Step 3: Repeat step2;")
    public void step3() {
        num = r.nextInt(10000000);
        mailname = "apwptest" + String.valueOf(num);
        accountInfo.put("Email Address", mailname + "@mailinator.com");
        accountInfo.put("Confirm Email", mailname + "@mailinator.com");
...
//        new InsightServicesPage(false).clickSaveButton();
        ...
        new InsightServicesPage(false).clickPlaceOrderButton();
        MyCommonAPIs.sleepi(3);
        if (new InsightServicesPage(false).cardError.exists()) {
            WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);

            MyCommonAPIs.sleepsync();
            assertTrue(new HamburgerMenuPage(true).checkSubscriptionScreenForBasic(), "Place order failed.");
        } else {
