package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18390;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18390") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T18390") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18390");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18390");
        ...
        assertTrue(new HamburgerMenuPage(false).dropDownPremiunDirectPurchase.exists(), "Purchase order history incorrect.");
    }
