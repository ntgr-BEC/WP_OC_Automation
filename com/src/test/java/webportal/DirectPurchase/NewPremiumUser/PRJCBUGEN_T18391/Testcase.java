package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18391;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18391") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if Direct Purchase tab is present at Purchase Order History") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18391") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18391");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18391");
