package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18393;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18393") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Direct Purchase at Purchase Order History, Activated On date is purchase date of device") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18393") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18393");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18393");
