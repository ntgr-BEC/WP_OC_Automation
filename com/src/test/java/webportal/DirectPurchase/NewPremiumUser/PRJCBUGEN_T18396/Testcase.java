package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18396;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18396") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if Direct Purchase tab is present at Subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18396") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18396");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18396");
        ...
        MyCommonAPIs.sleepsync();
        assertTrue(new HamburgerMenuPage(true).checkDirectPurchase(), "Subscription page incorrect.");
    }
