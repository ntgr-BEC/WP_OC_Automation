package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18401;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18401") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Direct Purchase at Subscription, Quantity is one") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18401") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18401");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18401");
        ...
        MyCommonAPIs.sleepsync();
        boolean result = new HamburgerMenuPage().checkPremiunDirectPurchaseCorrect();
        new HamburgerMenuPage(false).subscriptions.click();
        MyCommonAPIs.waitElement(new HamburgerMenuPage(false).subDiv);
        assertTrue(result && new HamburgerMenuPage(false).checkDirectPurchaseTableInfo(), "Subscription page incorrect.");
    }
