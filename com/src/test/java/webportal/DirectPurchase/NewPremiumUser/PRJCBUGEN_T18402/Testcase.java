package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18402;
...
public class Testcase extends TestCaseBase {
    ...
    String              locationName = "ntk18402";

    @Feature("DirectPurchase.NewPremiumUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18402") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to add device to location where device credit added") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18402") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18402");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18402");
    ...
    @Step("Test Step 3: Add one device;")
    public void step3() {
        ...
        assertTrue(new DevicesDashPage().devicesName(devInfo.get("Serial Number")).exists(), "Not found added device.");
    }
