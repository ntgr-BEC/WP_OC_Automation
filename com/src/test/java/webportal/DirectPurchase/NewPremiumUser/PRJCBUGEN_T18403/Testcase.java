package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18403;
...
public class Testcase extends TestCaseBase {
    ...
    String              locationName = "ntk18403";

    @Feature("DirectPurchase.NewPremiumUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18403") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Direct Purchase option has Cancel subscription Option") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18403") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18403");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18403");
    ...
    public void step3() {
        assertTrue(new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("premium"), "Not found cancel button.");
    }
