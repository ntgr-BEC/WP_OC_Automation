package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18404;
...
public class Testcase extends TestCaseBase {
    ...
    String              locationName = "ntk18404";

    @Feature("DirectPurchase.NewPremiumUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18404") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify User able to cancel Premium pack within 3 days of subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18404") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18404");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18404");
    ...
    public void step3() {
        if (new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("premium")) {
            assertTrue(!new HamburgerMenuPage(false).directPurchaseTable.exists(), "Cancel subscription failed.");
        } else {
