package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18405;
...
public class Testcase extends TestCaseBase {
    ...
    String              locationName = "ntk18405";

    @Feature("DirectPurchase.NewPremiumUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18405") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify When User cancel Premium pack within 3 days of subscription than user account auto change to Basic account") // It's
                                                                                                                                              // a
                                                                                                                                              // testcase
                                                                                                                                              // title
                                                                                                                                              // from
                                                                                                                                              ...
                                                                                                                                              // Test
                                                                                                                                              // Case.
    @TmsLink("PRJCBUGEN-T18405") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18405");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18405");
    ...
    @Step("Test Step 3: Check cancel direct purchase button;")
    public void step3() {
        if (new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("premium")) {
            MyCommonAPIs.sleepi(10);
            assertTrue(new HamburgerMenuPage(false).checkSubscriptionScreenForBasic(), "Cancel subscription failed.");
        } else {
