package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18406;
...
public class Testcase extends TestCaseBase {
    ...
    String              locationName = "ntk18406";

    @Feature("DirectPurchase.NewPremiumUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18406") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify when User cancel Premium pack within 3 days of subscription, Device credit is auto deallocate") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18406") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18406");
    ...
    public void step3() {
        if (new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("premium")) {
            ...
            String url = MyCommonAPIs.getCurrentUrl();
            assertTrue(url.contains("/locked"), "Cancel subscription failed.");
        } else {
