package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T18408;
...
public class Testcase extends TestCaseBase {
    ...
    String              locationName = "ntk18408";

    @Feature("DirectPurchase.NewPremiumUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18408") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify when User cancel Premium pack within 3 days of subscription than banner display upgraed account and buy device credit") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18408") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("premium");
        ...
        accountInfo.put("Last Name", "T18408");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18408");
    ...
    @Step("Test Step 3: Check subscription page;")
    public void step3() {
        if (new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("premium")) {
            MyCommonAPIs.sleepi(10);
            assertTrue(new HamburgerMenuPage(false).subscriptionupgrade.exists() && new HamburgerMenuPage(false).buydevicecredits.exists(),
