package webportal.DirectPurchase.NewPremiumUser.PRJCBUGEN_T19897;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19897") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Direct Purchase at Purchase Order History, Credit Column has 1 count") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19897") // It's a testcase id/link from Jira Test Case.
...
//        new HamburgerMenuPage(false).clickLoginAndSubscribe("pro");
        ...
        accountInfo.put("Last Name", "T19897");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T19897");
