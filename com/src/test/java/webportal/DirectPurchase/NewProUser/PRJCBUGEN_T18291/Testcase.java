package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18291;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18291") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify new user has \"Create account\" option") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18291") // It's a testcase id/link from Jira Test Case.
