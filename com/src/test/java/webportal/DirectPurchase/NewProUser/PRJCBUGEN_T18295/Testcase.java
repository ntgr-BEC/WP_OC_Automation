package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18295;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18295") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T18295") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);
        assertTrue(webportalLoginPage.checkLoginErrorMsg("18295" + WebportalParam.loginName, WebportalParam.loginPassword), "Login incorrect account failed.");
    }
