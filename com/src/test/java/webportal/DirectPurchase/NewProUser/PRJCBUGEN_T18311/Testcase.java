package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18311;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18311") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Payment Process done successfully") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18311") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18311");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18311");
