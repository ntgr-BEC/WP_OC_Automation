package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18312;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18312") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify clicking \"Go to Dashboard\" button allow to proceed on further process of Pro User") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18312") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18312");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18312");
        ...
        assertTrue(url.contains("businessDetails"), "Place order failed.");
    }
