package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18316;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18316") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify \"Done\" button is Present") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18316") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18316");
    ...
    @Step("Test Step 2: Finish subscription and check business information page button;")
    public void step2() {
        Map<String, String> paymentInfo = new HashMap<String, String>();
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T18316");
        ...
        assertTrue(new HamburgerMenuPage(false).businessDone.exists(), "Done button displayed incorrect.");
    }
