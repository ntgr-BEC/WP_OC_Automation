package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18317;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18317") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to sign up successfully as pro user") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18317") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18317");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18317");
