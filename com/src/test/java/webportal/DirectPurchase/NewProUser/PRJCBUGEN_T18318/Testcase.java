package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18318;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18318") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Payment process Fails than error message occure") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18318") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18318");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18318");
