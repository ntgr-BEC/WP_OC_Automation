package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18323;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18323") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify when user not fill business sign up details and close browser than user login and redirect business sign upand able to fill again") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18323") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18323");
    ...
    @Step("Test Step 2: Check pro subscription and check business information;")
    public void step2() {
        Map<String, String> paymentInfo = new HashMap<String, String>();
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T18323");
        ...
        if (url.contains("businessDetails")) {
            Selenide.close();
            startBrowser();
            WebportalLoginPage webportallogin = new WebportalLoginPage(true);
            webportallogin.inputLogin(accountInfo.get("Email Address"), accountInfo.get("Password"));
            MyCommonAPIs.sleepi(30);
            new HamburgerMenuPage(false).clickBusinessDetailsToComplete();
            ...
            assertTrue(url.contains("organization/dashboard"), "Business information incorrect.");
        } else {
