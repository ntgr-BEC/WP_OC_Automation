package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18325;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18325") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Purchase Order History has drop down list have Direct Purchase") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18325") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18325");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18325");
        ...
        MyCommonAPIs.waitElement(new HamburgerMenuPage(false).iconsearch);
        MyCommonAPIs.sleepi(5);
        new HamburgerMenuPage(false).dropDownProDirectPurchase.click();

        assertTrue(new HamburgerMenuPage(false).directPurchaseProHistoryTdOne.isDisplayed(), "Purchase order history incorrect.");
    }
