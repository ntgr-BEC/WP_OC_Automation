package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18326;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18326") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T18326") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18326");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18326");
        ...
        assertTrue(new HamburgerMenuPage().checkdropDownProDirectPurchase(), "Purchase order history incorrect.");
    }
