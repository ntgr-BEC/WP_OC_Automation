package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18331;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18331") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if Direct Purchase credit is present at Activation Subscription key tab of Subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18331") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18331");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18331");
        ...
        assertTrue(new HamburgerMenuPage(true).checkProAccountSubscriptionExist(), "Subscription incorrect.");
    }
