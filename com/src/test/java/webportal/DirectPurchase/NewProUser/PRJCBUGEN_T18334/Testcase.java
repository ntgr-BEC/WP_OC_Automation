package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18334;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18334") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Direct Purchase at Subscription, Expire On date is one year future date of purchase date of device") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18334") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18334");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18334");
        ...
        assertTrue(new HamburgerMenuPage(true).checkProAccountSubscriptionInfo(), "Subscription incorrect.");
    }
