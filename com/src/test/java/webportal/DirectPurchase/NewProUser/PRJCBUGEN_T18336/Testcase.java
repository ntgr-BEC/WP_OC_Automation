package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18336;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18336") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Check Direct Purchase at Purchase History details are same as Direct Purchase at Subscriptions (Activation, Expiration, Credits)") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18336") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18335");
