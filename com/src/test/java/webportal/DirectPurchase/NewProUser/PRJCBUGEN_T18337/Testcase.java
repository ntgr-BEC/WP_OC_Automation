package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18337;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18335") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Direct Purchase at Subscription, Quantity is one") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18335") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18337");
        ...
        assertTrue(new HamburgerMenuPage(false).getTotalDevicesCredits().equals("1"), "Subscription incorrect.");
    }
