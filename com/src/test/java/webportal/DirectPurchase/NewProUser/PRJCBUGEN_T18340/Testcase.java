package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18340;
...
public class Testcase extends TestCaseBase {
    ...
    String              organizationName = "test18340";
    String              locationName     = "ntk18340";

    @Feature("DirectPurchase.NewProUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18340") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to add device to location in Organization where device credit added") // It's a testcase title from Jira
                                                                                                                 // Test Case.
    @TmsLink("PRJCBUGEN-T18340") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18340");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18340");
        ...
        if (creditsInfo.get("Total Devices Credits").equals("1") && creditsInfo.get("Used Devices Credits").equals("0")
            ...
            assertTrue(!new DevicesDashPage().getDeviceName(devInfo.get("Serial Number")).equals(""), "Cannot add device.");
        } else {
