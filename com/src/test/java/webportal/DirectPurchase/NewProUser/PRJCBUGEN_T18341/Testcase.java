package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18341;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18341") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T18341") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18341");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18341");
        ...
        if (new HamburgerMenuPage(true).checkProAccountSubscriptionInfo()) {
            assertTrue(new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("pro"), "Not found cancel button.");
        } else {
