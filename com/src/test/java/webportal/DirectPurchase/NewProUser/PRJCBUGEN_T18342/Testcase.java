package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18342;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18342") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify User able to cancel Pro pack within 3 days of subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18342") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18342");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18342");
        ...
        if (new HamburgerMenuPage(true).checkProAccountSubscriptionInfo()) {
            if (new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("pro")) {
                assertTrue(MyCommonAPIs.getText($x(new HamburgerMenuPage(false).proSubscriptionTable)).contains("No key available"),
