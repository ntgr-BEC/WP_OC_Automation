package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18343;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18343") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify when User cancel Pro pack within 3 days of subscription, user account is pro user") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18343") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18343");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18343");
        ...
        if (new HamburgerMenuPage(true).checkProAccountSubscriptionInfo()) {
            if (new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("pro")) {
                assertTrue(new HamburgerMenuPage(true).checkProAccountCurrentSubscription(), "Subscription page display error.");
            } else {
