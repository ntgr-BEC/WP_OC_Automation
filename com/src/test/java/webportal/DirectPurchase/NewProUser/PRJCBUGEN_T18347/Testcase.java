package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18347;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18347") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify when User cancel Pro pack within 3 days of subscription than banner display") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18347") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18347");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18347");
        ...
        if (new HamburgerMenuPage(true).checkProAccountSubscriptionInfo()) {
            if (new HamburgerMenuPage(false).checkDisplayCancelDirectPurchase("pro")) {
                assertTrue(new HamburgerMenuPage(false).checkCancelBanner(), "Subscription incorrect.");
            } else {
