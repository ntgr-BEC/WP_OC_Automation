package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18446;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18446") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if user able to to login with changed password") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18446") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18446");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18346");
