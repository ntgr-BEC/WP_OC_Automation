package webportal.DirectPurchase.NewProUser.PRJCBUGEN_T18448;
...
public class Testcase extends TestCaseBase {
    ...
    String              organizationName = "test18448";
    String              locationName     = "ntk18448";

    @Feature("DirectPurchase.NewProUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T18448") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if user able to use that device credit which added") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18448") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18448");
    ...
    @Step("Test Step 2: Buy pro subscription and add one device;")
    public void step2() {
        Map<String, String> paymentInfo = new HashMap<String, String>();
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T18448");
