package webportal.DirectPurchaseAccountCreation.PRJCBUGEN_T27335;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27335") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Buy option for \"Premium Subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27335") // It's a testcase id/link from Jira Test Case.
