package webportal.DirectPurchaseProAccountCreation.PRJCBUGEN_T27289;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27289") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Buy option for \"Pro Subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27289") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        businessInfo.put("Zip Code", "70184");
        businessInfo.put("Country", "Germany");
