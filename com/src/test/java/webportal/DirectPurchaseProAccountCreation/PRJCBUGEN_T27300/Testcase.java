package webportal.DirectPurchaseProAccountCreation.PRJCBUGEN_T27300;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27300") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Buy option for \"Pro Subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27300") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        businessInfo.put("Zip Code", "1466");
        businessInfo.put("Country", "Luxembourg");
