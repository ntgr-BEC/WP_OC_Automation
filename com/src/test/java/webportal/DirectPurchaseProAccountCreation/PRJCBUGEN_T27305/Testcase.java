package webportal.DirectPurchaseProAccountCreation.PRJCBUGEN_T27305;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27305") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Buy option for \"Pro Subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27305") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T18336");
        ...
        businessInfo.put("Zip Code", "300553");
        businessInfo.put("Country", "Romania");
        businessInfo.put("Business Phone Number", "1234567890");
        new HamburgerMenuPage(false).inputBusinessInfoDirectPurchase(businessInfo);
        new HamburgerMenuPage(false).clickBusinessInfoPageButton();
        MyCommonAPIs.sleepsync();

        assertTrue(new HamburgerMenuPage(true).checkProAccountSubscriptionInfo() && new HamburgerMenuPage().checkPremiunDirectPurchaseCorrect(),
