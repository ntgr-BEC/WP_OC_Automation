package webportal.DisconnectedTime.Dontrun.PRJCBUGEN_T28397;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28397") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("* icon  for  Last known information is  shown in router  tab  for  pro account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T28397") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Verify last known information on Routers/VPN page; ")
    public void step3() {
        ...
        devInfo.put("MAC Address", WebportalParam.ob1deveiceMac);
        
        new DevicesDashPage(false).addNewDevice(devInfo);
        new DevicesDashPage().waitDevicesReConnected(WebportalParam.ob1serialNo);
        new RoutersPage().gotoPage();
        assertTrue(new RoutersPage().lastknowninfoverify(),"Device last known information is not verified.");
    }
}
