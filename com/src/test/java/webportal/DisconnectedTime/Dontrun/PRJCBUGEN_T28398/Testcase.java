package webportal.DisconnectedTime.Dontrun.PRJCBUGEN_T28398;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28398") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("* icon  for  Last known information is  shown in wired  tab  for  pro account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T28398") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Verify last known information on wired page; ")
    public void step3() {
        ...
        devInfo.put("MAC Address", WebportalParam.sw1MacAddress);
        
        new DevicesDashPage(false).addNewDevice(devInfo);
        new DevicesDashPage().waitDevicesReConnected(WebportalParam.sw1serialNo);
        assertTrue(new WiredQuickViewPage().lastknowninfoverify(),"Device last known information is not verified.");
    }
}
