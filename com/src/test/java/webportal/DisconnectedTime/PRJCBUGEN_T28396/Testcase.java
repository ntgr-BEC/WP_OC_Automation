package webportal.DisconnectedTime.PRJCBUGEN_T28396;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28396") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("* icon  for  Last known information is  shown in device  tab  for  pro account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T28396") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Verify last known information on device dashboard page; ")
    public void step3() {
        ...
        assertTrue(new DevicesDashPage().lastknowninfoverify(),"Device last known information is not verified.");
    }
}
