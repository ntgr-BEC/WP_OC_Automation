package webportal.ECP.PRO.PRJCBUGEN_T33437;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33435") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify ECP with Web Auth at ssid page.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33435") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).deleteOrgSsid("apwp33437");
