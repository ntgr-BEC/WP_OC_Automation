package webportal.ECP.PRO.PRJCBUGEN_T33442;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33441") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify allow HTTPS option with web auth at Org-ssid") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33441") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).deleteOrgSsid("apwp33442");
