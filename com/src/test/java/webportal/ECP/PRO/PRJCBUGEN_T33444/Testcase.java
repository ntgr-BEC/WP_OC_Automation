package webportal.ECP.PRO.PRJCBUGEN_T33444;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33444") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify failsafe option with radius at Org-ssid") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T334434") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).deleteOrgSsid("apwp33444");
