package webportal.ECP.PRO.PRJCBUGEN_T33446;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33446") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify allow HTTPS option with radius at Org-ssid") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33446") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).deleteOrgSsid("apwp33446");
