package webportal.ECP.PRO.PRJCBUGEN_T33448;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33448") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify adding Walled Garden with web  Auth  at org  ssid level") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33448") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).deleteOrgSsid("apwp33438");
