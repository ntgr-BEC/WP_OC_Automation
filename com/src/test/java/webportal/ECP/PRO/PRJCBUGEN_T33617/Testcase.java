package webportal.ECP.PRO.PRJCBUGEN_T33617;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33617") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Editing Org-wide SSID:  ECP parameter are saved and pushed to APs") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33617") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteOrgSsid("apwp33617");
    ...
    public void step4() {
        ...
        new WirelessQuickViewPage(false).editmodeECP(ssidInfo.get("SSID"), ECPInfo);
        MyCommonAPIs.sleepi(60);
