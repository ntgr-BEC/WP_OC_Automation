package webportal.ECP.Premium.PRJCBUGEN_T33439;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33439") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify failsafe option with web auth at ssid.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33439") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33439");
