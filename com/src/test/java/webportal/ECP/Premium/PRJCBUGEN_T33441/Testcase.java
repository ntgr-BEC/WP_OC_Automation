package webportal.ECP.Premium.PRJCBUGEN_T33441;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify allow HTTPS option with web auth at ssid.") // It's a testcase title from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33441");
