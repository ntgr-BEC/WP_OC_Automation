package webportal.ECP.Premium.PRJCBUGEN_T33445;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33445") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify allow HTTPS option with radius at ssid.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33445") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33445");
