package webportal.ECP.Premium.PRJCBUGEN_T33447;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33447") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify adding Walled Garden with web Auth at ssid level") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33447") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33447");
