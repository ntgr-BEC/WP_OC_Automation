package webportal.ECP.Premium.PRJCBUGEN_T33449;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33449") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify adding Walled Garden with radius at org ssid level") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33449") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33449");
