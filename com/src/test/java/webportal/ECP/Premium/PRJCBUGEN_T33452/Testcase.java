package webportal.ECP.Premium.PRJCBUGEN_T33452;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33452") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("validation of Wall Garden Url") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33452") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33452");
