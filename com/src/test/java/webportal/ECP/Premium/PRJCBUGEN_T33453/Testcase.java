package webportal.ECP.Premium.PRJCBUGEN_T33453;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33453") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T33453") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33453");
        new WirelessQuickViewPage().deleteSsidYes("apwp33453a");
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "apwp33453");
    ...
    public void step3() {
        Map<String, String> locationInfo = new HashMap<String, String>();
        locationInfo.put("SSID", "apwp33453a");
