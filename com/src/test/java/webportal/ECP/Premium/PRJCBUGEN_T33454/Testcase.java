package webportal.ECP.Premium.PRJCBUGEN_T33454;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33454") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T33454") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new WirelessQuickViewPage().editECP(locationInfo.get("SSID"), EcpInfo), "ECP did ot through error ");
