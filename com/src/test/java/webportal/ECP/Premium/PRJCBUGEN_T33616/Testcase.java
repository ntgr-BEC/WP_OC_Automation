package webportal.ECP.Premium.PRJCBUGEN_T33616;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33616") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, ECP config is a part of first config") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33616") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33616");
    ...
    @Step("Test Step 5: add Ap and check ECP;")
    public void step5() {
