package webportal.ECP.Premium.PRJCBUGEN_T33897a;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33897a") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, ssid with differently type of securities along with ECP with radius type enabled-open") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33897a") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33897a");
