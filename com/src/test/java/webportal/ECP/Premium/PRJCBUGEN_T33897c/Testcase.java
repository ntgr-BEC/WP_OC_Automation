package webportal.ECP.Premium.PRJCBUGEN_T33897c;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33897c") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T33897c") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33897c");
