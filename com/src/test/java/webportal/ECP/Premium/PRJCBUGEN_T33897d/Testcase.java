package webportal.ECP.Premium.PRJCBUGEN_T33897d;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33897d") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T33897d") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp33897d");
