package webportal.ECP_GoZone.Premium.PRJCBUGEN_T40805;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40805") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify ECP with radius at ssid page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40805") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp40805");
    ...
    @Step("Test Step 2: Add WIFI ssid  and enable ECP;")
    public void step2() {
        new WirelessQuickViewPage().deleteALLSSID();
        ssidInfo.put("SSID", "apwp40805");
    ...
    @Step("Test Step 3: Validate Config Push")
    public void step3() {
        ...
        assertTrue( Result2.contains(ECPInfo.get("Primary Address"))  && Result2.contains("1812"), "Primary Authentication port not pushed");
        ...
        assertTrue( Result3.contains(ECPInfo.get("Secondary Address"))  && Result3.contains("1812"), "Secondary Authentication port not pushed");
        
        String CMD4 = "wlan0:vap7 | grep -i exCpPriRadAcntServer" ;
        String Result4 = new APUtils(WebportalParam.ap1IPaddress).getECPWalledGarden(WebportalParam.ap1Model,  CMD4);
        System.out.println(Result4);
        assertTrue( Result4.contains(ECPInfo.get("Primary Address"))  && Result4.contains("1813"), "Primary Accounting port not pushed");
        
        String CMD5 = "wlan0:vap7 | grep -i exCpSecRadAcntServer" ;
        String Result5 = new APUtils(WebportalParam.ap1IPaddress).getECPWalledGarden(WebportalParam.ap1Model,  CMD5);
        System.out.println(Result5);
        assertTrue( Result5.contains(ECPInfo.get("Secondary Address"))  && Result5.contains("1813"), "Secondary Accounting port not pushed");
    }
