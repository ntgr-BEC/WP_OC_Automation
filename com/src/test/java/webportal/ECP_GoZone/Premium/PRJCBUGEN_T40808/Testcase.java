package webportal.ECP_GoZone.Premium.PRJCBUGEN_T40808;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40808") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify failsafe option with radius at ssid.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40808") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Add WIFI ssid with WPA2 Pers and enable ECP;")
    public void step2() {

        ssidInfo.put("SSID", "apwp40808");
    ...
    @Step("Test Step 3: Validate the Configuration;")
    public void step3() {
        ...
        assertTrue( Result2.contains(ECPInfo.get("Secondary Address"))  && Result2.contains("1813"), "Secondary Address not pushed");
