package webportal.ECP_GoZone.Premium.PRJCBUGEN_T40812;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40812") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T40812") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        new WirelessQuickViewPage().deleteALLSSID();
        locationInfo.put("SSID", "apwp40812");
