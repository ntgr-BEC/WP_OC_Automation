package webportal.EU_SKU_WAX605.PRJCBUGEN_T46831;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("EU_SKU_WAX605") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T46831") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify the channel list in 2.4Ghz and 5Ghz for United Kingdom") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T46831") // It's a testcase id/link from Jira Test Case.
...
//        locationInfo.put("Zip Code", "4560");
    ...
    @Step("Test Step 4: Check 2.4 Ghz band channels are same as showing on tera term;")
    public void step4() {
    ...
    @Step("Test Step 5: Check 5 Ghz band channels are same as showing on tera term;")
    public void step5() {
