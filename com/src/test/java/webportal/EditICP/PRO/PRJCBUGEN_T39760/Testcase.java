package webportal.EditICP.PRO.PRJCBUGEN_T39760;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN-T39760") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal funcationally when user select tier type as \"social login\" with only Facebook selected as login mode") // It's
                                                                                                                                                      ...
                                                                                                                                                      // Test
                                                                                                                                                         // Case.
    @TmsLink("PRJCBUGEN-T39760") // It's a testcase id/link from Jira Test Case.
