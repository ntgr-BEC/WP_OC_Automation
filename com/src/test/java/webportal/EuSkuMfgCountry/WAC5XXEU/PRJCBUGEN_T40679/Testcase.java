...
package webportal.EuSkuMfgCountry.WAC5XXEU.PRJCBUGEN_T40679;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40679") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX5XX in Austria Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40679") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp40679");
