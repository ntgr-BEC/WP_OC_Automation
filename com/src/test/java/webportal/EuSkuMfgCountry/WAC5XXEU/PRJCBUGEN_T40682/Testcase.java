...
package webportal.EuSkuMfgCountry.WAC5XXEU.PRJCBUGEN_T40682;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40682") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX5XX in Croatia Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40682") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp40682");
