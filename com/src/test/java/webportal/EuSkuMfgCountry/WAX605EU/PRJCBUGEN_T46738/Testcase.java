...
package webportal.EuSkuMfgCountry.WAX605EU.PRJCBUGEN_T46738;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("EuSkuMfgCountry.WAX605EU") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T46738") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX605 in Czech Republic Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T46738") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp46738");
