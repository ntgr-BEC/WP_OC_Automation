...
package webportal.EuSkuMfgCountry.WAX605EU.PRJCBUGEN_T46752;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46752") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX605 in Spain Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T46752") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp46752");
