...
package webportal.EuSkuMfgCountry.WAX605EU.PRJCBUGEN_T46756;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46756") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX605 in Belgium Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T46756") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp46756");
