...
package webportal.EuSkuMfgCountry.WAX6XXEU.PRJCBUGEN_T40645;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("EuSkuMfgCountry.WAX6XXEU") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T40645") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX6XX in Czech Republic Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40645") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp40645");
