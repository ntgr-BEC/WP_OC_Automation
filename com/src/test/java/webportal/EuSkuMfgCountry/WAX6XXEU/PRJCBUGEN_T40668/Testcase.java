...
package webportal.EuSkuMfgCountry.WAX6XXEU.PRJCBUGEN_T40668;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40668") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX6XX in Ireland Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40668") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp40668");
