...
package webportal.EuSkuMfgCountry.WAX6XXEU.PRJCBUGEN_T40672;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40672") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX6XX in Malta Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40672") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp40672");
