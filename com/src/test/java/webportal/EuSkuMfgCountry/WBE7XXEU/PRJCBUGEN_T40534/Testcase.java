...
package webportal.EuSkuMfgCountry.WBE7XXEU.PRJCBUGEN_T40534;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40534") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add AP WAX7XX in Slovenia Location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40534") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        locationInfo.put("SSID", "apwp40534");
