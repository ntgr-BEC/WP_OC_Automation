package webportal.FeatureWPA3.Premium.PRJCBUGEN_T21998;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21998") 
    @Description("verify  check end to end flow   when default  authentication method is WPA2-psk or not  and 802.11w(PMF) is optional") 
    @TmsLink("PRJCBUGEN-T21998") 
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp21998");
    ...
    public void step2(){
        ...
        locationInfo.put("SSID", "apwp21998");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp21998")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect  apwp21998 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp21998 123456798 WPA2PSK aes")
