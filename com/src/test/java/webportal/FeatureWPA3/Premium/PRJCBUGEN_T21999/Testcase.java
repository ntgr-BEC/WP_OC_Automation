package webportal.FeatureWPA3.Premium.PRJCBUGEN_T21999;
...
//        new DevicesDashPage().checkDeviceInAdminAccount();
    ...
    public void step2(){
        ...
        locationInfo.put("SSID", "apwp21999");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp21999")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp21999 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp21999 123456798 WPA2PSK aes")
