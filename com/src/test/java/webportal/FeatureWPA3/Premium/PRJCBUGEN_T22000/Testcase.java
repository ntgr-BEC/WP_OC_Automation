package webportal.FeatureWPA3.Premium.PRJCBUGEN_T22000;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22000") 
    @Description("verify  whether default  authentication method is WPA2-psk or not  and 802.11w(PMF) is disable  and  check end to end funcationally") 
    @TmsLink("PRJCBUGEN-T22000") 
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp22000");
    ...
    public void step2(){
        ...
        locationInfo.put("SSID", "apwp22000");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp22000")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22000 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22000 123456798 WPA2PSK aes")
