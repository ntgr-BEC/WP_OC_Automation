package webportal.FeatureWPA3.Premium.PRJCBUGEN_T22011;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22011") 
    @Description("verify end to end flow when authentication method is WPA2-psk  Mixed   and 802.11w(PMF) is Optional from vlan setting") 
    @TmsLink("PRJCBUGEN_T22011") 
    ...
    public void step2(){
        ...
        locationInfo.put("SSID", "apwp22011");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp22011")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22011 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22011 123456798 WPA2PSK aes")
