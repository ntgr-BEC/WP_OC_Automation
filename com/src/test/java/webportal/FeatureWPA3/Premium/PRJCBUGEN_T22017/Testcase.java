package webportal.FeatureWPA3.Premium.PRJCBUGEN_T22017;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22017") 
    @Description("verify end to end flow when authentication method is WPA3 Personal Mixed (WPA2 + WPA3)  and 802.11w(PMF) is Mandatory from  vlan setting ") 
    @TmsLink("PRJCBUGEN-T22017") 
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp22017");
    ...
    public void step2(){
        ...
        locationInfo.put("SSID", "apwp22017");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp22017")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22017 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22017 123456798 WPA2PSK aes")
