package webportal.FeatureWPA3.Premium.PRJCBUGEN_T22018;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22018") 
    @Description("verify end to end flow when authentication method is WPA3 Personal Mixed (WPA2 + WPA3)  and 802.11w(PMF) is Optional") 
    @TmsLink("PRJCBUGEN-T22018") 
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp22018");
    ...
    public void step2(){
        ...
        locationInfo.put("SSID", "apwp22018");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp22018")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22018 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22018 123456798 WPA2PSK aes")
