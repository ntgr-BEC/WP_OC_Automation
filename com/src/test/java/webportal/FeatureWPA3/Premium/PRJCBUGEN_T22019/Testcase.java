package webportal.FeatureWPA3.Premium.PRJCBUGEN_T22019;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22019") 
    @Description("verify end to end flow when authentication method is WPA3 Personal Mixed (WPA2 + WPA3)  and 802.11w(PMF) is Optional from vlan setting ") 
    @TmsLink("PRJCBUGEN_T22019") 
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp22019");
    ...
    public void step2(){
        ...
        locationInfo.put("SSID", "apwp22019");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp22019")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22019 123456798 WPA3SAE aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22019 123456798 WPA3SAE aes")
