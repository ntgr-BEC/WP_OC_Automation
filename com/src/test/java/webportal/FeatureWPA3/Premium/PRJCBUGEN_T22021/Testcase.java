package webportal.FeatureWPA3.Premium.PRJCBUGEN_T22021;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22021") 
    @Description("verify end to end flow when authentication method is WPA3-psk   and 802.11w(PMF) is Mandatory in vlan setting ") 
    @TmsLink("PRJCBUGEN_T22021") 
    ...
    public void tearDown() {
        new WirelessQuickViewPage().deleteSsidYes("apwp22021");
    ...
    public void step2(){
        ...
        locationInfo.put("SSID", "apwp22021");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp22021")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22021 123456798 WPA3SAE aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp22021 123456798 WPA3SAE aes")
