package webportal.FeaturesfromLocation.PRJCBUGEN_T32434;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify, syslog configuration is pushed on devices") // It's a testcase title from Jira Test Case.
