package webportal.FeaturesfromLocation.PRJCBUGEN_T32438;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify, LED settings at location level is applied on device") // It's a testcase title from Jira Test Case.
