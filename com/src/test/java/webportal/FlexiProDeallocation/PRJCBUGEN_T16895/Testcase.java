package webportal.FlexiProDeallocation.PRJCBUGEN_T16895;
...
public class Testcase extends TestCaseBase {
    ...
    String              organizationName    = "test16895";
    ...
    @Story("PRJCBUGEN_T16895") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T16895") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(creditsInfo.get("Deallocate DevNum").equals(String.valueOf(devNumNew + devNum))
                && creditsInfo.get("Deallocate IcpNum").equals(""), "Allocate credits error.");
    }
