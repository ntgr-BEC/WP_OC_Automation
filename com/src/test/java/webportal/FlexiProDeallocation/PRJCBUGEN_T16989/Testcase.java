package webportal.FlexiProDeallocation.PRJCBUGEN_T16989;
...
public class Testcase extends TestCaseBase {
    ...
    String              organizationName    = "test16989";
    ...
    @Story("PRJCBUGEN_T16989") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    public void step2() {
        ...
        new HamburgerMenuPage().configCreditAllocation(organizationInfoNew.get("Name"), 3, 0, 1);
        new HamburgerMenuPage().configCreditAllocation(organizationName, 2, 0, 2);
    ...
    public void step3() {
        new HamburgerMenuPage().deallocateCredit(organizationName, String.valueOf(devNum), "0");
        ...
        assertTrue(creditsInfo.get("Used Devices Credits").equals("0") && creditsInfo.get("Unused Devices Credits").equals("0")
                && creditsInfo.get("Used ICP Credits").equals("0") && creditsInfo.get("Unused ICP Credits").equals(String.valueOf(icpNum))
                && creditsInfoNew.get("Used Devices Credits").equals("0")
                && creditsInfoNew.get("Unused Devices Credits").equals(String.valueOf(devNumNew))
