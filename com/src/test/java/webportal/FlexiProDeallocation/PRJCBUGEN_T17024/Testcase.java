package webportal.FlexiProDeallocation.PRJCBUGEN_T17024;
...
public class Testcase extends TestCaseBase {
    ...
    String              organizationName    = "test17024";
    ...
    @Story("PRJCBUGEN_T17024") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify user able to do partial deallocation") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T17024") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        new HamburgerMenuPage().deallocateCredit(organizationName, "0", String.valueOf("icpNum"));
        new HamburgerMenuPage().deallocateCredit(organizationInfoNew.get("Name"), String.valueOf(devNumNew), "0");
        ...
        assertTrue(creditsInfo.get("Used Devices Credits").equals("0") && creditsInfo.get("Unused Devices Credits").equals(String.valueOf(devNum))
                && creditsInfo.get("Used ICP Credits").equals("0") && creditsInfo.get("Unused ICP Credits").equals("0")
                && creditsInfoNew.get("Used Devices Credits").equals("0") && creditsInfoNew.get("Unused Devices Credits").equals("0")
                && creditsInfoNew.get("Used ICP Credits").equals("0") && creditsInfoNew.get("Unused ICP Credits").equals(String.valueOf(icpNumNew)),
