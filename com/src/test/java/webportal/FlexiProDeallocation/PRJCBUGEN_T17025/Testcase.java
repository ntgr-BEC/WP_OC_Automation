package webportal.FlexiProDeallocation.PRJCBUGEN_T17025;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17025") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Read & Write Manager of two organisation can do Deallocation") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T17025") // It's a testcase id/link from Jira Test Case.
