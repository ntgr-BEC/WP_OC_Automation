package webportal.FlexibleProSubscription.PRJCBUGEN_T16013;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16013") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    public void step2() {
        ...
        assertTrue(creditsInfo.get("Devices Credits").equals("2") && creditsInfo.get("ICP Credits").equals("2"), "Allocate credits error.");
    }
