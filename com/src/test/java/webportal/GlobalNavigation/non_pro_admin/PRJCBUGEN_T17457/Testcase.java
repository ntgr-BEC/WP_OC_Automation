package webportal.GlobalNavigation.non_pro_admin.PRJCBUGEN_T17457;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17457") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T17457") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new GlobalNotificationPage().checkDeviceEnterDashBoardPage(WebportalParam.ob1deveiceName), "Did not enter Orbi dash board");
