package webportal.GlobalNavigation.non_pro_admin.PRJCBUGEN_T17479;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17479") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify whether user is redirected to APdashboard when user click on device configuration beside device name in instant wifi page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T17479") // It's a testcase id/link from Jira Test Case.
