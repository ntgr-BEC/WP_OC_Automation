package webportal.HardBundle.Basic.PRJCBUGEN_T21471;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21471") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[Verify if a user is able to add hard bundle devices to a basic free account without buying any extra credit") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21471") // It's a testcase id/link from Jira Test Case.
