package webportal.HardBundle.Basic.PRJCBUGEN_T21500;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21500") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the behavior for a hard bundle device subscription if a basic free user migrates to a PRO account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21500") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new HardBundlePage().CheckOneHBadded(WebportalParam.ap1serialNo), "Hardbundle to not listed in subscription");
    ...
    @Step("Test Step 5: Check Pro Account for the device list.")
    public void step5() {
        
         new  HardBundlePage().gotoOneYearInsightIncludedwithHardwarePRO();
        
         assertTrue(new HardBundlePage().CheckOneHBadded(WebportalParam.getDeviceSerialNoCSV("ap1")), "Hardbundle to not listed in subscription");
