package webportal.HardBundle.Basic.PRJCBUGEN_T21501;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21501") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the behavior for a hard bundle device subscription if a basic paid user migrates to a PRO account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21501") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        assertTrue(new HardBundlePage().CheckOneHBadded(WebportalParam.sw1serialNo), "Hardbundle to not listed in subscription");
    }
    ...
    public void step6() {
         ...
         assertTrue(new HardBundlePage().CheckOneHBadded(WebportalParam.getDeviceSerialNoCSV("sw1")), "Hardbundle to not listed in subscription");
