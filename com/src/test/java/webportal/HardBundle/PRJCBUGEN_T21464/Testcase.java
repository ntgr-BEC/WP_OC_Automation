package webportal.HardBundle.PRJCBUGEN_T21464;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21464") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Pro Admin(IM 5.9) Test to Verify the user should be able to add hard bundle devices to the organization and the allocated credits should not be utilized.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21464") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        firststdevInfo.put("Serial Number1", WebportalParam.getDeviceSerialNoCSV("sw1"));
        firststdevInfo.put("MAC Address1", WebportalParam.getDeviceMacCSV("SW1"));
