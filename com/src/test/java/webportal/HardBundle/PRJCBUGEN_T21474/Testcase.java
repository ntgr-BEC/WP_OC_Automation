package webportal.HardBundle.PRJCBUGEN_T21474;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21474") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the user is able to add hard bundle devices to a premium annual account  and verify that device credits are not consumed by hard bundle devices") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21474") // It's a testcase id/link from Jira Test Case.
