package webportal.HardBundle.PRJCBUGEN_T21475;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21475") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if user is able to add hard bundle devices to a trial account without buying any extra credit, till the trial period expires") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21475") // It's a testcase id/link from Jira Test Case.
