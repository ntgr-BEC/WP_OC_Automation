package webportal.HardBundle.PRJCBUGEN_T21502;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21502") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the behavior for a hard bundle device subscription if a premium trial  user migrates to a PRO account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21502") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        firststdevInfo.put("Serial Number1", WebportalParam.getDeviceSerialNoCSV("br1"));
        firststdevInfo.put("MAC Address1", WebportalParam.getDeviceMacCSV("br1"));
                
        new DevicesDashPage(false).addNewdummyDevice(firststdevInfo);
        new  HardBundlePage().gotoOneYearInsightIncludedwithHardwarePRO();
        
        assertTrue(new HardBundlePage().CheckOneHBadded(WebportalParam.getDeviceSerialNoCSV("br1")), "Hardbundle to not listed in subscription");
