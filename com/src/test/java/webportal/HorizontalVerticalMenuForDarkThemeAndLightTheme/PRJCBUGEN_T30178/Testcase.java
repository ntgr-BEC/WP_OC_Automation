package webportal.HorizontalVerticalMenuForDarkThemeAndLightTheme.PRJCBUGEN_T30178;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30178") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should able to navigate on setting screen to enable Vertical menu to toggle button.") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T30178") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new  SummaryPage().verifyVerticalMenuToggleSwitch()," Vertical Menu toggle switch is not ENABLED ");   
