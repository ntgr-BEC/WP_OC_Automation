package webportal.HorizontalVerticalMenuForDarkThemeAndLightTheme.PRJCBUGEN_T30179;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30179") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that Vertical menu (tray) should be displayed vertically.") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T30179") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new  SummaryPage().verifyArrrowOnLeft(),"After Vertical Menu enabled Arrow on left is not dispalyed ");  
