package webportal.HorizontalVerticalMenuForDarkThemeAndLightTheme.PRJCBUGEN_T30182;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30182") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that content should be reflected on dashboard of inner screen..") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T30182") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new  DeviceScreenNavigationPage().verifVerticalInnerDashboard(),"The menu is switched to vertical but tabs are not displayed properly ");
