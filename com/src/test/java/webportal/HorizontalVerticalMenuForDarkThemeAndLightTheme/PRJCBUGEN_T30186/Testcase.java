package webportal.HorizontalVerticalMenuForDarkThemeAndLightTheme.PRJCBUGEN_T30186;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30186") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that \"Setting\" button's link will move on left menu at top level as \"Summary\".") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T30186") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new  DeviceScreenNavigationPage().verifySettingsQuickview(),"Quick view button has not replaced by Summary on vertical menu ");
