package webportal.HorizontalVerticalMenuForDarkThemeAndLightTheme.PRJCBUGEN_T30187;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30187") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that 'Quick View' button's all link show to left menu under 'Summary' ") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T30187") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        handle.gotoLoction();
        assertTrue(new  DeviceScreenNavigationPage().verifySummaryInLoc(),"Quick view button has not replaced by Summary on vertical menu ");
