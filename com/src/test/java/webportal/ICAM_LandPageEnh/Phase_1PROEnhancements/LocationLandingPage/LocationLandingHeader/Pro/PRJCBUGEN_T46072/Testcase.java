package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.LocationLandingPage.LocationLandingHeader.Pro.PRJCBUGEN_T46072;
...
public class Testcase extends TestCaseBase {
    ...
    @Step("Test Step 2: Verify User Name edited successfully")
    public void step2() {

        assertTrue(new OrganizationPage(false).verifyEditUserName(), "User Name is not edited successfully");
