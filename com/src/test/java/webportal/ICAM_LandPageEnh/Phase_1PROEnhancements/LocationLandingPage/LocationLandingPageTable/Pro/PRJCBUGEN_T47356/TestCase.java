package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.LocationLandingPage.LocationLandingPageTable.Pro.PRJCBUGEN_T47356;
...
public class TestCase extends TestCaseBase {
    String organizationName = "PRJCBUGEN_T47356";
    ...
    @Story("PRJCBUGEN_T47356") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test by Creating 50 locations and verify if any location goes missing") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T47356") // It's a testcase id/link from Jira Test Case.
