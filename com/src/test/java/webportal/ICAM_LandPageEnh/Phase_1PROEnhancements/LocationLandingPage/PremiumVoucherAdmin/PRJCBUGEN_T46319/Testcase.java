package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.LocationLandingPage.PremiumVoucherAdmin.PRJCBUGEN_T46319;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46319") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that create voucher admin")
    @TmsLink("PRJCBUGEN_T46319") // It's a testcase id/link from Jira Test Case.
