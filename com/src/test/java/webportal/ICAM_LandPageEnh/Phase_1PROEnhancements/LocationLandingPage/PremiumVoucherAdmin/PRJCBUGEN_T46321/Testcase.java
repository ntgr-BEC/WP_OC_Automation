package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.LocationLandingPage.PremiumVoucherAdmin.PRJCBUGEN_T46321;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46321") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that on (yopmail.com) and able to continue with the same")
    @TmsLink("PRJCBUGEN_T46321") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 5: Login and verify active status for VC Admin;")
    public void step5() {

        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);
        webportalLoginPage.defaultLogin();
        assertTrue(new OrganizationPage(false).verifyActiveStatusofVCAdmin(managerInfo.get("Email Address")), "VC Admin is not activated");
        userManage.logout();
