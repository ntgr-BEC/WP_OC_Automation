package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.ProOrganizationLandingPage.OrgLandingPageFilter.PRJCBUGEN_T46131;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46131") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Functionality of the \"Device\" Filter.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T46131") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
      ...
      @Step("Test Step 3: Verify On Organization dashboard Filter Devices options")
      public void step3() {
          
          new OrganizationPage(false).gotoPage();
          MyCommonAPIs.sleepi(5);
          assertTrue(new OrganizationPage(false).verifyFilterOptionDevicesfororganizationHeader("Netgear","Netgear1"),"On Organization dashboard Filter devices options are not working");
