package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.ProOrganizationLandingPage.OrgLandingPageFilter.PRJCBUGEN_T46135;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46135") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Clear ALL Filter Functionality.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T46135") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
      ...
      @Step("Test Step 3: Verify On Organization dashboard Clear Filter option ")
      public void step3() {
          
          new OrganizationPage(false).gotoPage();
          MyCommonAPIs.sleepi(5);
          assertTrue(new OrganizationPage(false).verifyClearFilterOptionorganizationHeader("Netgear","Netgear1"),"On Organization dashboard Clear Filter option is not working");
