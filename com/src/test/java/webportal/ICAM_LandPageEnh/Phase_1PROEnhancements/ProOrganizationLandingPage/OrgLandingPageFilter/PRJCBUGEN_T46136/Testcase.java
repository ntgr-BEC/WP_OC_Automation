package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.ProOrganizationLandingPage.OrgLandingPageFilter.PRJCBUGEN_T46136;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46136") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Functionality of \"Cancel\" and \"Apply\" Buttons") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T46136") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
      ...
      @Step("Test Step 3: Verify On Organization dashboard filter dropdown verify Apply and Cancel button functionality ")
      public void step3() {
          
          new OrganizationPage(false).gotoPage();
          MyCommonAPIs.sleepi(5);
          assertTrue(new OrganizationPage(false).verifyCancelButtonOnFilterOptionorganizationHeader("Netgear","Netgear1"),"Cancel Button on filter dropdown is not visible");
          assertTrue(new OrganizationPage(false).verifyFilterOptionDevicesfororganizationHeader("Netgear","Netgear1"),"Apply Button on filter dropdown is not visible");
