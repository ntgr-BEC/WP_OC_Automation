package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.ProOrganizationLandingPage.OrganizationCreditDeallocate.PRJCBUGEN_T46125;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("OrganizationCreditDeallocate") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T46125") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify System Behavior After De-Allocation.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T46125") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
      ...
      @Step("Test Step 3: verify deallocate functionality")
      public void step3() {
          
          new OrganizationPage(false).gotoPage();
          MyCommonAPIs.sleepi(5);
          assertTrue(new OrganizationPage(false).verifyDeallocateCredits("Netgear1", "5"),"Deallocate Device Credits is not working");

      }
      
      @Step("Test Step 4: Unmanage one device and verify deallocate functionality")
      public void step4() {
          ...
          new OrganizationPage(false).gotoPage();
          MyCommonAPIs.sleepi(5);
          assertTrue(new OrganizationPage(false).verifyDeallocateCredits("Netgear1", "1"),"Deallocate Device Credits is not working");
