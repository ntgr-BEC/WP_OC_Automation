package webportal.ICAM_LandPageEnh.Phase_1PROEnhancements.ProOrganizationLandingPage.RouteRedirecting.PRJCBUGEN_T46137;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46137") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Navigation to Device Table on Clicking \"Total Devices\".") // It's // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T46137") // It's a testcase id/link from Jira Test Case.
