package webportal.ICP.Premium.PRJCBUGEN_T16637;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16637") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal funcationally when user select tier type as \"social login\" with only Register selected as login mode") // It's
                                                                                                                                                         ...
                                                                                                                                                         // Test
                                                                                                                                                         // Case.
    @TmsLink("PRJCBUGEN-T16637") // It's a testcase id/link from Jira Test Case.
