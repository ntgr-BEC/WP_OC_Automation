package webportal.ICP.admin.PRJCBUGEN_T12141;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify whether following are present in instant captive portal under account management") // It's a test case title from Jira TestCase.
    ...
    public void step2() {
        assertTrue(new HamburgerMenuPage().checkProUserIcpCreditsAndTable(), "Captive portal services credits is incorrect.");
    }
