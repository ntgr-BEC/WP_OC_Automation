package webportal.ICP.admin.PRJCBUGEN_T15084;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15084") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Pro account Manager is able to see the Instant Captive Portal License details under Account Management but not able to add the ICP License") // It's a test case title from Jira TestCase.
    @TmsLink("PRJCBUGEN-T15084") // It's a testcase id/link from Jira Test Case.
