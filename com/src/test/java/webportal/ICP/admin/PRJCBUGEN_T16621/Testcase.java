package webportal.ICP.admin.PRJCBUGEN_T16621;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16621") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal funcationally when user select tier type as \"social login\" with only Facebook selected as login mode") // It's
                                                                                                                                                     ...
                                                                                                                                                     // Test
                                                                                                                                                         // Case.
    @TmsLink("PRJCBUGEN-T16621") // It's a testcase id/link from Jira Test Case.
...
//        }
        ...
        icpInfo.put("Welcome Headline", "Welcome to Netgear");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp16621")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp16621 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
