package webportal.ICP.admin.PRJCBUGEN_T16653;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify instant captive portal funcationally when user select tier type as \"voucher \"") // It's a test case title from Jira Test
                                                                                                           // Case.
    @TmsLink("PRJCBUGEN-T16653") // It's a testcase id/link from Jira Test Case.
...
//        }
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp16653")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp16653 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
