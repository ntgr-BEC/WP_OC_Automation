package webportal.ICP.manager.PRJCBUGEN_T16632;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16632") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal funcationally when user select tier type as \"play video \"") // It's a test case title from Jira
                                                                                                              // Test Case.
    @TmsLink("PRJCBUGEN-T16632") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp16632")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp16632 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
