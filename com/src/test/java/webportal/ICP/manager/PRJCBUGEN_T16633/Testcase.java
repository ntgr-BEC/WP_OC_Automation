package webportal.ICP.manager.PRJCBUGEN_T16633;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16633") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal funcationally when user select tier type as \"showdisplay Ad \"") // It's a test case title from
                                                                                                                  // Jira Test Case.
    @TmsLink("PRJCBUGEN-T16633") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp16633")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp16633 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
