package webportal.ICP.user.PRJCBUGEN_T14009;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14009") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify whether user is able to selected instant captive portal in captive portal page") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14009") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14009");
