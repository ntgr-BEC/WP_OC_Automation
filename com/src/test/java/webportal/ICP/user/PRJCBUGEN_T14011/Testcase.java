package webportal.ICP.user.PRJCBUGEN_T14011;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14011") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify whether user is able to selected Facebook WiFi in captive portal page") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14011") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14011");
        ...
        MyCommonAPIs.sleepi(3);
        new WirelessQuickViewPage(false).selectfacebookwifi.click();
        MyCommonAPIs.sleepi(3);
        assertTrue(new WirelessQuickViewPage(false).checkFbWifiSelected.isSelected(), "Captive portal page display error.");
    }
