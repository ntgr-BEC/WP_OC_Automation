package webportal.ICP.user.PRJCBUGEN_T14112;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14112") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal functionally with wpa2-psk") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14112") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14112");
