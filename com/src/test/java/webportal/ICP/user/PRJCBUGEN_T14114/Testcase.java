package webportal.ICP.user.PRJCBUGEN_T14114;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14114") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal functionally with wpa/wpa2-psk") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14114") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Check icp status;")
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14114");
        ...
        assertTrue(new WirelessQuickViewPage().checkIcpEnable(ssidInfo.get("SSID")), "Instant captive portal cannot enable.");
    }
