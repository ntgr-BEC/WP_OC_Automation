package webportal.ICP.user.PRJCBUGEN_T14540;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14540") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify whether Landing page title on connected client is same as the tilte set in instant captive portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14540") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14540");
