package webportal.ICP.user.PRJCBUGEN_T14541;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14541") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify whether Landing page Message on connected client is same as theMessage set in instant captive portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14541") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14541");
        ...
        ssidInfo.put("SSID", "apwp14541");
        ssidInfo.put("Security", "WPA2 Personal");
        ssidInfo.put("Password", "12345678");
        new WirelessQuickViewPage().addSsid(ssidInfo);

        icpInfo.put("Portal Name", "test14541");
        icpInfo.put("Welcome Headline", "test");
        icpInfo.put("Welcome Message", "test14541");
        ...
        while (true) {
            ...
            if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14541")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14541 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
        ...
        assertTrue(
                new Javasocket()
                        .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                                "WAFruncaptive PRJCBUGEN-T14541.py www.rediff.com " + icpInfo.get("Welcome Message") + " test")
