package webportal.ICP.user.PRJCBUGEN_T14543;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14543") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify user is able to add new Captive Portal Logo in instant captive portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14543") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14543");
        ...
        icpInfo.put("Captive Portal Logo", "test14543");
        ...
        assertTrue($x("//option[text()='" + icpInfo.get("Captive Portal Logo") + "']").exists(), "Upload logo image failed.");
    }
