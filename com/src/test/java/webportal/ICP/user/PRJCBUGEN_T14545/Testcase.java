package webportal.ICP.user.PRJCBUGEN_T14545;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14545") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify user is able to Add Mobile Background Image in instant captive portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14545") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14545");
        ...
        assertTrue($x("//option[text()='" + icpInfo.get("Mobile Background Image") + "']").exists(), "Upload logo image failed.");
    }
