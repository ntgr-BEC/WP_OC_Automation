package webportal.ICP.user.PRJCBUGEN_T14551;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14551") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify preview in desktop functionally") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14551") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14551");
        ...
        new WirelessQuickViewPage(false).desktopPreview.click();
        MyCommonAPIs.sleepi(5);
        Selenide.switchTo().frame(0);
        assertTrue(new WirelessQuickViewPage(false).previewAcceptBtn.isDisplayed(), "Preview window display error.");
        Selenide.switchTo().parentFrame();
        new WirelessQuickViewPage(false).previewCloseBtn.click();
    }
