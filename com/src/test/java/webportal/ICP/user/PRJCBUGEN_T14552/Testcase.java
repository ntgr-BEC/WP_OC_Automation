package webportal.ICP.user.PRJCBUGEN_T14552;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14552") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify preview in Mobile functionally") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14552") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14552");
        ...
        new WirelessQuickViewPage(false).mobilePreview.click();
