package webportal.ICP.user.PRJCBUGEN_T14553;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14553") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify whether Tier Name on connected client is same as the Tier Name set in instant captive portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14553") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14553");
        ...
        ssidInfo.put("SSID", "apwp14553");
        ssidInfo.put("Security", "WPA2 Personal");
        ssidInfo.put("Password", "12345678");
        new WirelessQuickViewPage().addSsid(ssidInfo);

        icpInfo.put("Portal Name", "test14553");
        icpInfo.put("Welcome Headline", "test14553");
        ...
        while (true) {
            ...
            if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14553")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14553 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
    ...
    public void step3() {
        ...
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T14553.py www.rediff.com test test").indexOf("finalresult: 1") != -1,
