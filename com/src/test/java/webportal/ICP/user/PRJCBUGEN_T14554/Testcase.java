package webportal.ICP.user.PRJCBUGEN_T14554;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14554") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify user is able to land on the same page which is set on instant captive portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14554") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14554");
        ...
        ssidInfo.put("SSID", "apwp14554");
        ssidInfo.put("Security", "WPA2 Personal");
        ssidInfo.put("Password", "12345678");
        new WirelessQuickViewPage().addSsid(ssidInfo);

        icpInfo.put("Portal Name", "test14554");
        icpInfo.put("Welcome Headline", "test14554");
        ...
        while (true) {
            ...
            if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp14554")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp14554 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
