package webportal.ICP.user.PRJCBUGEN_T14556;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14556") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify vaildation on value set for Portal Name") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14556") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14556");
