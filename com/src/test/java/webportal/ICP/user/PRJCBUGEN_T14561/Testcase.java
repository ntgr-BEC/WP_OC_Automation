package webportal.ICP.user.PRJCBUGEN_T14561;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14561") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify Session Validity functionally") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14561") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14561");
