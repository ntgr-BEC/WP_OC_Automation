package webportal.ICP.user.PRJCBUGEN_T14562;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14562") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify \"+\" on tier tab is working or not") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14562") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T14562");
        ...
        assertTrue(new WirelessQuickViewPage(false).selectsteptype.isDisplayed(), "Configure icp failed.");
    }
