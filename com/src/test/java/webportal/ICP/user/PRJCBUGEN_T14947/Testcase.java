package webportal.ICP.user.PRJCBUGEN_T14947;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14947") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that can user buy Instant Captive Portal Subscription being in premium trial.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14947") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T14947");
    ...
    @Step("Test Step 4: Use account trial and buy captive portal service;")
    public void step4() {
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T14947");
//        paymentInfo.put("Email", account);
        ...
        boolean result = new HamburgerMenuPage().checkAccountTryTrial();
        new InsightServicesPage().buyCaptivePortalProducts(paymentInfo);

        assertTrue(result && new HamburgerMenuPage().checkCaptivePortalServicesCredits(), "Buy captive portal service unsuccessful.");
    }
