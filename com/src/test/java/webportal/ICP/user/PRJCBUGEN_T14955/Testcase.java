package webportal.ICP.user.PRJCBUGEN_T14955;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14955") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that a confirmation pop up is displayed while canceling the subscription") // It's a test case title from Jira TestCase.
    @TmsLink("PRJCBUGEN-T14955") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        CaptivePortalPaymentInfo.put("Last Name", "T14955");
        ...
        if (new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            assertTrue(new HamburgerMenuPage().checkCancelICPServicesWindwow(), "Cancel ICP services failed.");
        } else {
