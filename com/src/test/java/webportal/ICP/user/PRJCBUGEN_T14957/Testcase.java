package webportal.ICP.user.PRJCBUGEN_T14957;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14957") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy multiple subscription for same duration") // It's a test case title from Jira TestCase.
    @TmsLink("PRJCBUGEN-T14957") // It's a testcase id/link from Jira Test Case.
 ...
 //       webportalLoginPage.loginByUserPassword(WebportalParam.loginName, WebportalParam.loginPassword);
    ...
    public void step4() {
        ...
        CaptivePortalPaymentInfo.put("Last Name", "T14957");
        ...
        assertTrue(new HamburgerMenuPage().getIcpCreditsNum().equals("14"), "Captive portal services credits is incorrect.");
    }
