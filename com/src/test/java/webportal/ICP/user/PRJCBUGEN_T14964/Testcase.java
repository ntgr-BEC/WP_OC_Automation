 package webportal.ICP.user.PRJCBUGEN_T14964;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14964") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that time stamp for Instant Captive Portal Subscription is present") // It's a test case title from Jira TestCase.
    ...
    public void step2() {
        ...
        assertTrue(new HamburgerMenuPage().checkIcpCreditsDate(), "Icp credits date error.");
    }
