package webportal.ICP.user.PRJCBUGEN_T14969;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14969") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy multiple subscription with different time lengths") // It's a test case title from Jira TestCase.
    @TmsLink("PRJCBUGEN-T14969") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        CaptivePortalPaymentInfo.put("Last Name", "T14969");
        ...
        assertTrue(new HamburgerMenuPage().getIcpCreditsNum().equals("6"), "Captive portal services credits is incorrect.");
    }
