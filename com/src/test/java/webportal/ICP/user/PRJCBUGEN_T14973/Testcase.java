package webportal.ICP.user.PRJCBUGEN_T14973;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14973") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that information regarding all available/expired credits is displayed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14973") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T14973");
    ...
    public void step4() {
        ...
        paymentInfo.put("Last Name", "T14973");
        ...
        paymentInfo.put("Quantity", "10"); // can input 1 , 3 , 10 , 40
        paymentInfo.put("Duration", "1"); // can input 1 , 3
        new InsightServicesPage().buyCaptivePortalProducts(paymentInfo);
        ...
        boolean result = new HamburgerMenuPage(false).expiredIcpTdOne.exists()
                && MyCommonAPIs.getText(new HamburgerMenuPage(false).expiredIcpTdFour).equals("3");
        
        System.out.println(result);
        
        assertTrue(result && new HamburgerMenuPage().checkIcpCreditsDate(), "Captive portal services credits is incorrect.");
    }
