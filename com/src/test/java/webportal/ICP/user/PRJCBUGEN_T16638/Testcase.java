package webportal.ICP.user.PRJCBUGEN_T16638;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16638") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal funcationally when user select tier type as \"social login\" with onlyTwitter selected as login mode") // It's
                                                                                                                                                       ...
                                                                                                                                                       // Test
                                                                                                                                                       // Case.
    @TmsLink("PRJCBUGEN-T16638") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        if (!new HamburgerMenuPage().checkCaptivePortalServicesCredits()) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T16638");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp16638")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp16638 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
