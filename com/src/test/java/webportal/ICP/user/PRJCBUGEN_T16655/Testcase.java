package webportal.ICP.user.PRJCBUGEN_T16655;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16655") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant captive portal funcationally when user select tier type as \"voucher \"") // It's a test case title from Jira Test
                                                                                                           // Case.
    @TmsLink("PRJCBUGEN-T16655") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        } else if (url.contains("voucherManagement")) {
        ...
        new ManagerPage().deleteVoucherAdmin(managerEmail);
        handle.gotoLoction();
    ...
    public void step2() {
        ...
        icpInfo.put("Welcome Headline", "Welcome to Automation testing");
        ...
        if (new HamburgerMenuPage(false).checkEmailMessage(vadminInfo.get("Email Address"))) {
            ...
            managerAccountInfo.put("Password", WebportalParam.loginPassword);
            managerAccountInfo.put("Confirm Password", WebportalParam.loginPassword);
        ...
        new AccountPage().enterVoucherLocation(WebportalParam.Organizations, WebportalParam.location1);
        accessCode = new WirelessQuickViewPage(false).getAccessCode();
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID apwp16655")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect apwp16655 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
    ...
    public void step3() {
        ...
        assertTrue(
                new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport,
                        "WAFruncaptive PRJCBUGEN-T16655.py www.rediff.com " + accessCode + " test").indexOf("finalresult: 1") != -1,
