package webportal.ICP.user.PRJCBUGEN_T17776;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17776") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 3 device for 1 year") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T17776") // It's a testcase id/link from Jira Test Case.
