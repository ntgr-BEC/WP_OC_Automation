package webportal.ICP.user.PRJCBUGEN_T17780;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17780") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify ICP Supports to buy 40 device for 1 year") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T17780") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        if (new WirelessQuickViewPage().checkICPInsufficientCreditsDisplayed(ssidInfo.get("SSID"))) {
            ...
            CaptivePortalPaymentInfo.put("Last Name", "T17780");
