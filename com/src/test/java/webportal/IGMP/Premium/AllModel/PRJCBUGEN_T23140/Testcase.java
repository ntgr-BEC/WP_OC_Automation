package webportal.IGMP.Premium.AllModel.PRJCBUGEN_T23140;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23140") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP gets configured across all the 540 AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23140") // It's a testcase id/link from Jira Test Case.
