package webportal.IGMP.Premium.PRJCBUGEN_T23100;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23100") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP has help text defination") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23100") // It's a testcase id/link from Jira Test Case.
