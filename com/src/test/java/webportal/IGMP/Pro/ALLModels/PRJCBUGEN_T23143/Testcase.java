package webportal.IGMP.Pro.ALLModels.PRJCBUGEN_T23143;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23143") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP gets configured across all the 505 AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23143") // It's a testcase id/link from Jira Test Case.
