package webportal.IGMP.Pro.PRJCBUGEN_T23131;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23131") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the IGMP gets pushed as a part of first config") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23131") // It's a testcase id/link from Jira Test Case.
