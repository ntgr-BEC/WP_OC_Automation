package webportal.IGMP.Pro.PRJCBUGEN_T23136;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23136") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP is a part of backup and restore list ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23136") // It's a testcase id/link from Jira Test Case.
