package webportal.IGMP.ProManager.ALLModels.PRJCBUGEN_T23326;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23326") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP gets configured across all the 540 AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23326") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        assertTrue((WebportalParam.ap8Model.equals("WAC540")),"test case should be tested only for WAC510 AP");
        handle.gotoLoction();
