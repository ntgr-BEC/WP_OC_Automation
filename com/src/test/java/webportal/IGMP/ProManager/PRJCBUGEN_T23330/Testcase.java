package webportal.IGMP.ProManager.PRJCBUGEN_T23330;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23330") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP can be enabled") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23330") // It's a testcase id/link from Jira Test Case.
