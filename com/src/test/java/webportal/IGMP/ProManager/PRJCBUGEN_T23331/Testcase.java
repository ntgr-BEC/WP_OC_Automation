package webportal.IGMP.ProManager.PRJCBUGEN_T23331;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23331") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP gets copied when cloning of the configuration is done") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23331") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new WirelessQuickViewPage().Isenabled(),"it is not enabled");
