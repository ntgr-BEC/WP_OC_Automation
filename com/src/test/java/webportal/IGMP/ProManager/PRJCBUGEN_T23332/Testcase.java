package webportal.IGMP.ProManager.PRJCBUGEN_T23332;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23332") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP has help text defination") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23332") // It's a testcase id/link from Jira Test Case.
