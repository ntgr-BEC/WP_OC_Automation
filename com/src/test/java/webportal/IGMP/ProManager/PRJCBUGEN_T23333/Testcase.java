package webportal.IGMP.ProManager.PRJCBUGEN_T23333;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23333") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the feature IGMP is a part of backup and restore list ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23333") // It's a testcase id/link from Jira Test Case.
