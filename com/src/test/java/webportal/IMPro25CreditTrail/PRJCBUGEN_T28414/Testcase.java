package webportal.IMPro25CreditTrail.PRJCBUGEN_T28414;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28414") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether  Newly created Pro account gets Insight pro 25 device credit for  3-Month free Trial  period") 
    @TmsLink("PRJCBUGEN-T28414") // It's a testcase id/link from Jira Test Case.
