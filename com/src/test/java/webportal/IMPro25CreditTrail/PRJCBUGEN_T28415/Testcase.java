package webportal.IMPro25CreditTrail.PRJCBUGEN_T28415;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28415") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Insight Pro Free Trail Icon is shown and can get activated for Pro accounts which contains only Insight Included with Hardware subscription") 
    @TmsLink("PRJCBUGEN-T28415") // It's a testcase id/link from Jira Test Case.
...
//            businessInfo.put("Licence Key", new HamburgerMenuPage(false).readLicenceKeyByTxt("Write"));
            ...
            new HamburgerMenuPage(false).HardBundleSignin(businessInfo);
