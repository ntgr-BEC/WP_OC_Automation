package webportal.IMPro25CreditTrail.PRJCBUGEN_T28418;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28418") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Insight Pro trial license Key get listed in Purchase Order History and Subscription page") 
    @TmsLink("PRJCBUGEN-T28418") // It's a testcase id/link from Jira Test Case.
