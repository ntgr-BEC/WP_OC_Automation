package webportal.IMPro25CreditTrail.PRJCBUGEN_T28434;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28434") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Insight Pro Free Trail activation  message is displayed in Organisation page , when user activates the Free Trail") 
    @TmsLink("PRJCBUGEN-T28434") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new HamburgerMenuPage(false).CheckFreeTrailmessage(), "Not received verify email.");
    }
