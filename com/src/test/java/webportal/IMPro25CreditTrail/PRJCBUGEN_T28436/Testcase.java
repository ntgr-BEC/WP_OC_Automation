package webportal.IMPro25CreditTrail.PRJCBUGEN_T28436;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28436") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether user can add Other services Keys to the account when user has activated only Insight Pro Free Trail") 
    @TmsLink("PRJCBUGEN-T28436") // It's a testcase id/link from Jira Test Case.
