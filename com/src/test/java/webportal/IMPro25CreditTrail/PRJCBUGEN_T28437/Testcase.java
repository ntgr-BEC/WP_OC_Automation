package webportal.IMPro25CreditTrail.PRJCBUGEN_T28437;
...
public class Testcase extends TestCaseBase {
    ...
    String SerialNo = "4XT1" + String.valueOf(Serial);
    
    
    @Feature("IMPro25CreditTrail") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T28437") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether user able to add one year free License Device to the Insight Pro free Trail activated account") 
    @TmsLink("PRJCBUGEN-T28437") // It's a testcase id/link from Jira Test Case.
...
//            businessInfo.put("Licence Key", new HamburgerMenuPage(false).readLicenceKeyByTxt("Write"));
    ...
    public void step4() {
       ...
       String Mac = new WirelessQuickViewPage().getRandomMacAddress();
        ...
        firststdevInfo.put("Serial Number1", SerialNo);
        ...
        assertTrue(new DevicesDashPage(true).checkNumberOfDevicesOrganization().equals("Onedevice"), "More device exits");
