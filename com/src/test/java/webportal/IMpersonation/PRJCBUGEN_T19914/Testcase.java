package webportal.IMpersonation.PRJCBUGEN_T19914;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19914") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that a black banner is displayed at the bottom of the customer account when they enabled technical support mode.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19914") // It's a testcase id/link from Jira Test Case.
