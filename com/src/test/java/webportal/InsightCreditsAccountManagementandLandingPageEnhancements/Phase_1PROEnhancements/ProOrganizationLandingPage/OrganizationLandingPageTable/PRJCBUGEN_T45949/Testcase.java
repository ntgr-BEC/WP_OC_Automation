package webportal.InsightCreditsAccountManagementandLandingPageEnhancements.Phase_1PROEnhancements.ProOrganizationLandingPage.OrganizationLandingPageTable.PRJCBUGEN_T45949;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45949") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Sorting and Filtering.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T45949") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
      ...
      @Step("Test Step 3: Verify On Organization dashboard Filter and sort Functionality options")
      public void step3() {
          
          new OrganizationPage(false).gotoPage();
          MyCommonAPIs.sleepi(5);
          assertTrue(new OrganizationPage(false).verifyFilterOptionfororganizationHeader("Netgear","Netgear1"),"On Organization dashboard Filter Options are not working");
          MyCommonAPIs.sleepi(5);
          assertTrue(new OrganizationPage(false).verifyOrgHeaderSortOptions("Netgear","Netgear1"),"On Organization dashboard Sort Options are not working");
