package webportal.InsightCreditsAccountManagementandLandingPageEnhancements.Phase_1PROEnhancements.ProOrganizationLandingPage.OrganizationsLandingHeader.PRJCBUGEN_T45934;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45934") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description(" Verify tooltip display on \"Offline Devices\" hover-over") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T45934") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      @Step("Test Step 2: Verify On Organization dashboard Offline Devices count")
      public void step2() {
          ...
          assertTrue(new OrganizationPage(false).verifyOnlineDevicesTooltipOnOrgDashboardPage("Offline Devices"), "Online Devices count is not visible");
