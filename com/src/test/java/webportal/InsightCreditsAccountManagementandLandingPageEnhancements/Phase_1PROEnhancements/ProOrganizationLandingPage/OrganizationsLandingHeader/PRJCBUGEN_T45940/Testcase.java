package webportal.InsightCreditsAccountManagementandLandingPageEnhancements.Phase_1PROEnhancements.ProOrganizationLandingPage.OrganizationsLandingHeader.PRJCBUGEN_T45940;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45940") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Filter Application for \"Offline Devices\" Text") 
    @TmsLink("PRJCBUGEN_T45940") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Now go to org dashboard click on Offline Devices count and verify all devices page")
    public void step3() {

        MyCommonAPIs.sleepi(5);
        assertTrue(new OrganizationPage(false).verifyAlldevicesarePresntOnDevicesPageFromOneOrgWithSearchOptions("Offline Devices"),
                "All Offline Devices are not visible on devices page");
