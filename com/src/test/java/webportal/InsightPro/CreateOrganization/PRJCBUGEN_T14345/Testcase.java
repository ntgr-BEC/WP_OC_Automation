package webportal.InsightPro.CreateOrganization.PRJCBUGEN_T14345;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "TEST14345";

    @Feature("InsightPro.CreateOrganization") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T14345") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Edit Owner details.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14345") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        if (OrganizationPage.checkOrganizationIsExist(organizationName) && OrganizationPage.checkOrganizationOwner(organizationInfo)) {
            organizationInfo.put("Email Address", mailname + "22@mailcatch.com");
