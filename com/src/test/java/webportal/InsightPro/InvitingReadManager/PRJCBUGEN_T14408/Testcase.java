package webportal.InsightPro.InvitingReadManager.PRJCBUGEN_T14408;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14408") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the Invite read-write Manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14408") // It's a testcase id/link from Jira Test Case.
