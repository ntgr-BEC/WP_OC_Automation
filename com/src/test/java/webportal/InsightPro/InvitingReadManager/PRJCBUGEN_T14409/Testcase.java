package webportal.InsightPro.InvitingReadManager.PRJCBUGEN_T14409;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14409") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create the accout read-only manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14409") // It's a testcase id/link from Jira Test Case.
