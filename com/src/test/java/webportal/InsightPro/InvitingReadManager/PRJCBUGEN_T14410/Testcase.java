package webportal.InsightPro.InvitingReadManager.PRJCBUGEN_T14410;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14410") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Edit the account read-only manager") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14410") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        if (new ManagerPage(false).checkEditResult(managerInfo.get("Email Address"), managerInfo.get("Access Policy"), "1")) {
            ...
            assertTrue(new ManagerPage(false).checkEditResult(editManagerInfo.get("Old Email Address"), editManagerInfo.get("Access Policy"), "1"),
