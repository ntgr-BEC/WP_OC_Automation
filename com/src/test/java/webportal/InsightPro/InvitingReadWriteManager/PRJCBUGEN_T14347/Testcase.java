package webportal.InsightPro.InvitingReadWriteManager.PRJCBUGEN_T14347;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14347") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the Invite read-write Manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14347") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new ManagerPage(false).checkSuccessDialog() && new ManagerPage(false).checkManagerIsExist(managerInfo.get("Email Address")),
