package webportal.InsightPro.InvitingReadWriteManager.PRJCBUGEN_T14348;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify the edit the read-write manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14348") // It's a testcase id/link from Jira Test Case.
