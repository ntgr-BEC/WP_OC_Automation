package webportal.InsightPro.InvitingReadWriteManager.PRJCBUGEN_T14349;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14349") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the given Id getting the invitation for a read-write manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14349") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Invite manager and check invite email;")
    public void step2() {
        ...
        managerInfo.put("Name", "test14349");
        ...
        if (new ManagerPage(false).checkSuccessDialog() && new ManagerPage(false).checkManagerIsExist(managerInfo.get("Email Address"))) {
            ...
            assertTrue(new HamburgerMenuPage(false).checkEmailMessage(managerInfo.get("Email Address")), "Not received invite manager email.");
        } else {
