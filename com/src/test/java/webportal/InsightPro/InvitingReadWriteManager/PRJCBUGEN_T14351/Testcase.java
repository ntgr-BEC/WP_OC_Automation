package webportal.InsightPro.InvitingReadWriteManager.PRJCBUGEN_T14351;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14351") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the able to sign up the read-write manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14351") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        userManage.logout();
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);
        webportalLoginPage.loginByUserPassword(writeMan, WebportalParam.adminPassword);
        userManage.logout();
    }
