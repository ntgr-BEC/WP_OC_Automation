package webportal.InsightPro.ProAccountCreation.PRJCBUGEN_T14338;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14338") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify able to enter all information as required for signup and click on next button.") // It's a testcase title from Jira
                                                                                                                  // Test
    // Case.
    @TmsLink("PRJCBUGEN-T14338") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname + "@mailcatch.com")) {
            ...
            assertTrue(new HamburgerMenuPage(false).checkCreateProAccountPage("checkKey"), "Not finish input pro account information.");
        } else {
            assertTrue(false, "Input email address failed.");
        }
    }
