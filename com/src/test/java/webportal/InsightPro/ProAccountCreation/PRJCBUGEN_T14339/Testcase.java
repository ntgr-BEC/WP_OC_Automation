package webportal.InsightPro.ProAccountCreation.PRJCBUGEN_T14339;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14339") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify able to enter the Licence key and able to click on the next button.") // It's a testcase title from Jira
                                                                                                       // Test
    // Case.
    @TmsLink("PRJCBUGEN-T14339") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Check Business Information page")
    public void step1() {
        if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname + "@mailcatch.com")) {
            ...
            assertTrue(new HamburgerMenuPage(false).checkProaccountInfPage(new HamburgerMenuPage(false).readLicenceKeyByTxt("Read")),
                    "Business Information page wasn't displayed.");
        }
