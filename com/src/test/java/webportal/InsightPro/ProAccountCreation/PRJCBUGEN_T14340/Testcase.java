package webportal.InsightPro.ProAccountCreation.PRJCBUGEN_T14340;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14340") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Business Information screen and able to enter all information.") // It's a testcase title from Jira
                                                                                                  // Test
    // Case.
    @TmsLink("PRJCBUGEN-T14340") // It's a testcase id/link from Jira Test Case.
