package webportal.InsightProKeyAllocationtoOrg.PRJCBUGEN_T28564;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28564") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the \"Add purchase confirmation key\" option to allocate LMS key credits directly to Organization.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T28564") // It's a testcase id/link from Jira Test Case.
