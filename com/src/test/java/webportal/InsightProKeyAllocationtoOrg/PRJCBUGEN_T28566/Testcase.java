package webportal.InsightProKeyAllocationtoOrg.PRJCBUGEN_T28566;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName1 = "PRJCBUGEN_T28566";
    ...
    @Story("PRJCBUGEN_T28566") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify allocate LMS credits key directly to a selected Organization.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T28566") // It's a testcase id/link from Jira Test Case.
