package webportal.InsightProKeyAllocationtoOrg.PRJCBUGEN_T28567;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28567") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the \"Credit Allocation\" tab → Select Organization-->\"Allocate\".") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T28567") // It's a testcase id/link from Jira Test Case.
