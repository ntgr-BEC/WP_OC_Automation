package webportal.InsightProKeyAllocationtoOrg.PRJCBUGEN_T28571;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName1 = "PRJCBUGEN_T28571";
    ...
    @Story("PRJCBUGEN_T28571") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if the user selects the LMS credit key from the \"Allocate Additional credit from keys\" option then the \"Allocate additional credits from account. \"option should be disabled.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T285671") // It's a testcase id/link from Jira Test Case.
