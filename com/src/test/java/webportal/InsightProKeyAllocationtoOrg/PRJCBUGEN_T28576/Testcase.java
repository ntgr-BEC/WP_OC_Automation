package webportal.InsightProKeyAllocationtoOrg.PRJCBUGEN_T28576;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName1 = "PRJCBUGEN_T28576";
    
    String organizationName2 = "PRJCBUGEN_T28576a";
    ...
    @Story("PRJCBUGEN_T28576") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to select either \"Allocate Additional Credits from Account\" or \"Allocate Additional Credits from Keys\".") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T285676") // It's a testcase id/link from Jira Test Case.
