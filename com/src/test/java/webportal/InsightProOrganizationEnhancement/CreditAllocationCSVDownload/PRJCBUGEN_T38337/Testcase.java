package webportal.InsightProOrganizationEnhancement.CreditAllocationCSVDownload.PRJCBUGEN_T38337;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38337") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user gets the CSV download option in the credit allocation tab.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T38337") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step2() throws InterruptedException {
          ...
          assertTrue(new HamburgerMenuPage().verifYCSVFileDownload(),"CSV File is not downloaded properly");
