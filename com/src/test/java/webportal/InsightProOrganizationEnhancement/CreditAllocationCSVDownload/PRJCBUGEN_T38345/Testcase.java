package webportal.InsightProOrganizationEnhancement.CreditAllocationCSVDownload.PRJCBUGEN_T38345;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38345") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the read-write manager gets the CSV download option.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T38345") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step2() throws InterruptedException {
          ...
          assertTrue(new HamburgerMenuPage().verifYCSVFileDownload1(),"CSV File is not downloaded properly");
