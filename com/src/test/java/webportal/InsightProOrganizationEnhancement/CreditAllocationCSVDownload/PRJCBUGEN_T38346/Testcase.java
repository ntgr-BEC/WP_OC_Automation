package webportal.InsightProOrganizationEnhancement.CreditAllocationCSVDownload.PRJCBUGEN_T38346;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38346") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the read manager gets the CSV download option.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T38346") // It's a testcase id/link from Jira Test Case.
