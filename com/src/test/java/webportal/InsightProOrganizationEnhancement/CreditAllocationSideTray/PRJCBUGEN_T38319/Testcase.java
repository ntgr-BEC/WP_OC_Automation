package webportal.InsightProOrganizationEnhancement.CreditAllocationSideTray.PRJCBUGEN_T38319
;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38319") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether Credit allocation-->Allocated Device Credits column device count is reacting as a hyperlink and the user clicks on the count then opens the side tray.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T38319") // It's a testcase id/link from Jira Test Case.
