package webportal.InsightProOrganizationEnhancement.CreditAllocationSideTray.PRJCBUGEN_T38323
;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38323") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether the side tray has the License Key List with the number of license keys.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T38323") // It's a testcase id/link from Jira Test Case.
