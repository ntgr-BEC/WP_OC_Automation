package webportal.InsightProOrganizationEnhancement.CreditAllocationSideTray.PRJCBUGEN_T38333
;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38333") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the side tray in read/write Manager user.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T38333") // It's a testcase id/link from Jira Test Case.
