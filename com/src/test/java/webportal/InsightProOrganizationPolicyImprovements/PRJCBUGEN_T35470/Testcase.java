package webportal.InsightProOrganizationPolicyImprovements.PRJCBUGEN_T35470;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35470") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify adding secondary admin account.") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T35470") // It's a testcase id/link from Jira Test Case.
