package webportal.InstantMesh.PRJCBUGEN_T14582;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14582") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the learn more launches a wizard for Plan Ahead screens.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14582") // It's a testcase id/link from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14533") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2:  a box after clicked \"Learn More\" link")
    public void step2() {
        ddp.gotoPage();
...
//        ddp.AddNewDevice(aAP);
        ...
        assertTrue($(ddp.txtHowMeshAP).exists(), "text for mesh ap");
    }
