package webportal.InstantMesh.PRJCBUGEN_T14584;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14584") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the view can be switched between List and Map view.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14584") // It's a testcase id/link from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14535") // It's a testcase id/link from Jira Test Case.
