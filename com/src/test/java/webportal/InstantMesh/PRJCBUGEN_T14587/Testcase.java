package webportal.InstantMesh.PRJCBUGEN_T14587;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14587") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Mesh Plot with two APs should be vertically placed.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14587") // It's a testcase id/link from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14538") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: two APs should be vertically placed")
    public void step2() {
        ddp.gotoPage();
        assertTrue(ddp.getDevicesNo("WAC").size() > 1, "Must have at least 2 AP");
        ...
        assertTrue(page.getAPNameGraph().size() > 1, "Check graph for ap graph");
        page.setMeshViewMode(0);
        assertTrue(page.getAPNameList().size() > 1, "Check graph for ap list");
    }
}
