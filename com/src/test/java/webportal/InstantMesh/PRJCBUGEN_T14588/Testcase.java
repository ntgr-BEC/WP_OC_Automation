package webportal.InstantMesh.PRJCBUGEN_T14588;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14588") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify if the Plan ahead screen can be navigated using the next and previous buttons on screen.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14588") // It's a testcase id/link from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14539") // It's a testcase id/link from Jira Test Case.
...
//        ddp.AddNewDevice(aAP);
        ...
        String step1 = $$(ddp.txtHowMeshAP).toString();
        System.out.println(step1);
        ddp.btnHowMeshAPRightArrow.click();
        MyCommonAPIs.sleepi(5);
        String  step2 = $$(ddp.txtHowMeshAP).toString();
        System.out.println(step2);
        ddp.btnHowMeshAPLeftArrow.click();
        MyCommonAPIs.sleepi(5);
        String step3 = $$(ddp.txtHowMeshAP).toString();
        System.out.println(step3);
        assertTrue(step1 != step2, "Next for how to mesh ap on right arrow");
        assertTrue(step2 != step3, "Previous for how to mesh ap on left arrow");
        assertTrue(step1 != step3, "It's first page on how to mesh ap");
