package webportal.InstantMesh.PRJCBUGEN_T15327;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15327") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, Advanced Mesh Configurations Screen") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15327") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        if (new DevicesApMeshTopologyPage().checkMeshStatusAndAdvanceSettings("")) {
            ...
            if (new DevicesApMeshTopologyPage().checkMeshStatusAndAdvanceSettings("extender")) {
            } else {
                result = false;
            }
        } else {
