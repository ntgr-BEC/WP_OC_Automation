package webportal.InstantMesh.PRJCBUGEN_T15346;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15346") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the Mesh AP mode can be set to NO-Mesh from Advanced settings.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15346") // It's a testcase id/link from Jira Test Case.
