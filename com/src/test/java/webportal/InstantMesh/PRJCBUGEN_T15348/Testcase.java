package webportal.InstantMesh.PRJCBUGEN_T15348;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15348") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Mode Change from Auto (Extender) to Extender Only") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15348") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new DevicesApMeshTopologyPage().checkMeshStatusAndAdvanceSettings("extender"), "Mesh ap advance settings is incorrect.");
    }
}
