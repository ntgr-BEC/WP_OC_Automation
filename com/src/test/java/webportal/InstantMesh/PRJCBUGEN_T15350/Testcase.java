package webportal.InstantMesh.PRJCBUGEN_T15350;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15350") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Mode change from Extender Only to Auto") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15350") // It's a testcase id/link from Jira Test Case.
