package webportal.InstantMesh.PRJCBUGEN_T15354;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15354") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the preferred root AP can be configured for an existing Extender AP") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15354") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        meshConfigInfo.put("Primary Preferred Backhaul", "5 GHz low");
        meshConfigInfo.put("Secondary Preferred Root Device", WebportalParam.ap2deveiceName);
        meshConfigInfo.put("Secondary Preferred Backhaul", "2.4 GHz");
        new DevicesApMeshTopologyPage().setRootApSelectionConfiguration(meshConfigInfo);
//        // MyCommonAPIs.sleepi(5 * 60);
        ...
        assertTrue(new DevicesApMeshTopologyPage().checkExtenderApChNumAndRootAp(WebportalParam.ap1deveiceName, "5low"),
