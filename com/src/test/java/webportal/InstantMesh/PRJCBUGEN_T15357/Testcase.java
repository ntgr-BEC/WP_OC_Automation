package webportal.InstantMesh.PRJCBUGEN_T15357;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15357") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the States after the Extender AP Reboot.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15357") // It's a testcase id/link from Jira Test Case.
