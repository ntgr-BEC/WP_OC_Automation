package webportal.InstantWIFI.PRJCBUGEN_T31735;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31735") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Instant Wifi with  default   channel  for  NA SKU  WAX610 ,610Y,620 ,630") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31735") // It's a testcase id/link from Jira Test Case.
