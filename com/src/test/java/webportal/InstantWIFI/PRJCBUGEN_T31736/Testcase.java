package webportal.InstantWIFI.PRJCBUGEN_T31736;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31736") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Instant Wifi with  default   channel  for  NA SKU  WAX615,625 ,630E") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31736") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Create a ssid  and click optimize now button, then check ap log;")
    public void step5() {
