package webportal.InstantWIFI.PRJCBUGEN_T31737;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31737") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Instant Wifi with  default   channel  for  NA SKU  WAX618,628 ,638E") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31737") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Create one SSID and click optimize now button, then check ap log;")
    public void step5() {
