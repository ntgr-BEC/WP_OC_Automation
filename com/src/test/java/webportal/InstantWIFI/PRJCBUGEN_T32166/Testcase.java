package webportal.InstantWIFI.PRJCBUGEN_T32166;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32166") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Instant Wifi with  default   channel  for  WW SKU  WAC510 ,WAC505 ,WAC540(WW) and  WAC564  CA SKU") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32166") // It's a testcase id/link from Jira Test Case.
