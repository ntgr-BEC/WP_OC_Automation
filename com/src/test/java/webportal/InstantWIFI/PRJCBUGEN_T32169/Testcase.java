package webportal.InstantWIFI.PRJCBUGEN_T32169;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32169") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Instant Wifi with  non default   channel  for   CA SKU WAX610 ,630E, WAX615  ,WAX618 ,WAX625 and   WAX628") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32169") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Create new ssid  and click optimize now button, then check ap log;")
    public void step5() {
