package webportal.InstantWiFIImp.PRJCBUGEN_T36387;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify instant WIFI, by changing radio settings") // It's a testcase title from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new WirelessQuickViewPage(false).changechannelPower(WebportalParam.ap1serialNo, WebportalParam.ap1IPaddress, WebportalParam.ap1Model ),"radios did not push");
    }
