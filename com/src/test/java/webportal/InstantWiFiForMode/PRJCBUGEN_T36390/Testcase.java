package webportal.InstantWiFiForMode.PRJCBUGEN_T36390;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36390") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant WIFI, when AP mode is selected in 11AX mode under 2.4 G") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T36390") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        boolean checkApmodel = true;
        String apModel = WebportalParam.ap1Model;
        if (apModel.contains("WAC")) {
            checkApmodel = false;
        }
        ...
        Map<String, String> locationInfo = new HashMap<String, String>();
        locationInfo.put("SSID", "PRJCBUGEN_T36390");
