package webportal.InstantWiFiForMode.PRJCBUGEN_T36392;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36392") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant WIFI, when AP mode is selected in 11NA mode under 5 Ghz") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T36392") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        Map<String, String> locationInfo = new HashMap<String, String>();
        locationInfo.put("SSID", "PRJCBUGEN_T36392");
        locationInfo.put("Security", "WPA2 Personal Mixed");
        locationInfo.put("Password", "123456798");
        new WirelessQuickViewPage().addSsid1(locationInfo);
    }
 
    @Step("Test Step 3: Select 11na radio mode in RADIO AND CHANNEL PAGE")
    public void step3() {
