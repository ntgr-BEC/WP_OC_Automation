package webportal.KVR80211.Premium.PRJCBUGEN_T22554;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22554") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the user is able to Edit SSID and disable 11r.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T22554") // It's a testcase id/link from Jira Test Case.
...
//        new DevicesDashPage().checkDeviceInAdminAccount();
    ...
    public void step4() {
        new WirelessQuickViewPage().disable80211(ssidInfo.get("SSID"));
