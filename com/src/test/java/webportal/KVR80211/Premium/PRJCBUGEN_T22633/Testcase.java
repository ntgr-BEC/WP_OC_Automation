package webportal.KVR80211.Premium.PRJCBUGEN_T22633;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22633") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify enable both Band Steering and Fast Roaming(R) at a time )") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T22633") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        assertTrue(new WirelessQuickViewPage().bandSteering(ssidInfo.get("SSID")),"");
     }
    }
