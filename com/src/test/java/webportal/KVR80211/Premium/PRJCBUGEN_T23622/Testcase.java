package webportal.KVR80211.Premium.PRJCBUGEN_T23622;
...
public class Testcase extends TestCaseBase {
    ...
    String cmd = "cat /var/config | grep -i wlan1:vap7:11rStatus";
    String cmd1 = "cat /sysconfig/config | grep -i wlan1:vap7:11RStatus";
    ...
    public void step4() {
        ...
        new RunCommand().enableSSH4AP(WebportalParam.ap2IPaddress, WebportalParam.loginPassword);
    ...
    public void step5() {
        ...
        assertTrue(WACAP.contains("vapSettings:vapSettingTable:wlan1:vap7:11rStatus 1"),"");
        assertTrue(WAXAP.contains("vapSettings:vapSettingTable:wlan1:vap7:11rStatus 1"),"");
    }
