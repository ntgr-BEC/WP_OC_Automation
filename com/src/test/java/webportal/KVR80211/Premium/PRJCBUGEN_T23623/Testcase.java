package webportal.KVR80211.Premium.PRJCBUGEN_T23623;
...
public class Testcase extends TestCaseBase {
    ...
    String cmd = "cat /var/config | grep -i wlan1:vap7:11r";
    ...
    @Story("PRJCBUGEN_T23623") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify On adding a new AP, creates corresponding 11R MAC address entries in the existing APs") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T23623") // It's a testcase id/link from Jira Test Case.
...
//        assertTrue(WAXAP.contains("11rAPMac1"),"");
//        assertTrue(WAXAP.contains("11rAPMac2"),"");
//        assertTrue(WAXAP.contains("11rAPMac3"),"");
