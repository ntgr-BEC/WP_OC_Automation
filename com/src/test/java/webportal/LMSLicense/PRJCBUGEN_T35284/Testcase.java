package webportal.LMSLicense.PRJCBUGEN_T35284;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35284") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add VPN Pro LICENSE ") 
    @TmsLink("PRJCBUGEN_T35284") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Add VPN license ")
    public void step2() {
        int count= 1;
        for(int i=0; i<50;i++) {
        ...
        new HamburgerMenuPage().AddKeyAndVerifyVPN(Key);
        assertTrue(new HamburgerMenuPage(true).verifyVPN(Key), "Not received verify email.");
