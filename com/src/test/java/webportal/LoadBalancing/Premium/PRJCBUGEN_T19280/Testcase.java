package webportal.LoadBalancing.Premium.PRJCBUGEN_T19280;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T19280") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, the color legends are reflected on the drag button for each channel in all three parameters i.e max clients per radio, client Rx RSSI and channel load") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19280") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp19280");
    ...
    public void step2() {
        ...
        assertTrue(new WirelessQuickViewPage().checkLoadBalancingStatus("Client 5 GHz").equals("Orange"), "<1>Enable load balancing failed");
    }
