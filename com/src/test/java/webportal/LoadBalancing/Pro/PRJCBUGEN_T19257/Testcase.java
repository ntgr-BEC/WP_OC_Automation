package webportal.LoadBalancing.Pro.PRJCBUGEN_T19257;
...
public class Testcase extends TestCaseBase {
    ...
    String              msg              = "";
    String              organizationName = "test19257";
    String              locationName     = "ntk19257";
    ...
    @Story("PRJCBUGEN_T19257") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify if the load balancing configurations get copied when cloning of the configuration is done") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T19257") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new DevicesDashPage(false).enableApSsh();
    ...
    @Step("Test Step 4: Check load balancing configuration;")
    public void step4() {
        OrganizationPage OrganizationPage = new OrganizationPage();
        OrganizationPage.openOrg(organizationName);
        new AccountPage(false).enterLocation(locationName);
