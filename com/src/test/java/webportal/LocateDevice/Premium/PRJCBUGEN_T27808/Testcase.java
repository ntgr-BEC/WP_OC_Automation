package webportal.LocateDevice.Premium.PRJCBUGEN_T27808;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27808") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Locate device button is available at device dashboard") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27808") // It's a testcase id/link from Jira Test Case.
