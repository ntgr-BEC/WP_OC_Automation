package webportal.LocateDevice.Premium.PRJCBUGEN_T27813;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27813") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, When timer count downs to 0 Locate device button is available again") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27813") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new WirelessQuickViewPage(false).locateDeviceCountDown(),"time is not right");
