package webportal.LocateDevice.Premium.PRJCBUGEN_T27814;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27814") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, When locate device is triggered, 'Stop' button and countdown timer is shown") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27814") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new WirelessQuickViewPage(false).stop(),"stop button does not right");
