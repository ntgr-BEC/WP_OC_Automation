package webportal.LocateDevice.Premium.PRJCBUGEN_T27819;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27819") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Help content for locate device") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27819") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new WirelessQuickViewPage(false).HelpText(),"Help text is not right");
