package webportal.LocateDevice.pro.PRJCBUGEN_T27810;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27810") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Locate device functionality available for both pro and premium users") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27810") // It's a testcase id/link from Jira Test Case.
