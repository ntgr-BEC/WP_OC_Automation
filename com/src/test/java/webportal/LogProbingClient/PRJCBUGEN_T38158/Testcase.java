package webportal.LogProbingClient.PRJCBUGEN_T38158;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38158") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T38158") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new WirelessQuickViewPage(false).probeClient.exists(),"Feature missing");
