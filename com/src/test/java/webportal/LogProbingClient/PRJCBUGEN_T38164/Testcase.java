package webportal.LogProbingClient.PRJCBUGEN_T38164;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38164") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that under location syslog configuration should be displayed.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T38164") // It's a testcase id/link from Jira Test Case.
