package webportal.LogProbingClient.PRJCBUGEN_T38172;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38172") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that on syslog server connected with Access point SSID.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T38172") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        new DeviceGroupPage().GoToSysLog(WebportalParam.location1);
        String systemIPAddress = new DeviceGroupPage().getSystemIpAddress();
        System.out.println("Local System IP Address : "+systemIPAddress);
        new DeviceGroupPage().EnableSysLog(systemIPAddress, "514");
