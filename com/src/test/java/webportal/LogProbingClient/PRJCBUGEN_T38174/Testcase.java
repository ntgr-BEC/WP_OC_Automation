package webportal.LogProbingClient.PRJCBUGEN_T38174;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38174") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that for manager read/write and read able config syslog on WP.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T38174") // It's a testcase id/link from Jira Test Case.
