package webportal.LogProbingClient.PRJCBUGEN_T38175;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T38175") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that for secondary admin able config syslog on WP.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T38175") // It's a testcase id/link from Jira Test Case.
