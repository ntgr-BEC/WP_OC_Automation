package webportal.LongRunStability.PRJCBUGEN_T9025;
...
public class Testcase extends TestCaseBase {
    final String    tcName       = "[T9025] Verify the configuration deploy to AP from Insight";
    String          stepInfo     = "";
    String          expectResult = "";
    String          actualResult = "";
    SQLiteStability dbHandle     = null;
    String          devNo        = null;
    String          devName      = "LongRun-AP";
    String          devNewName   = "LR-AP-";
    String          devIp        = null;

    @Feature("LongRunStability") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T9025") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description(tcName) // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T9025") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        stepInfo = "Verify AP device name can be edit on webportal";
        ...
        stepInfo = "Check AP new name is pushed to device: " + devIp;
        handle.sleepsync();
        devicename = new PlinkCmd(devIp).getAPName();
