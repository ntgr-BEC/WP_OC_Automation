package webportal.MDNS.prouser.PRJCBUGEN_T31107;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31107") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify mDNS Policy addition with a Service, VLAN and SSID selection") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31107") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(!after.contains("SSH_Remote_Terminal"), "policy is not added propely");
