package webportal.MDNS.prouser.PRJCBUGEN_T31108;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31108") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if user can delete an mDNS Policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31108") // It's a testcase id/link from Jira Test Case.
