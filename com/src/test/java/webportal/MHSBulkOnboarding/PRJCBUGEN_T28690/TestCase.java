package webportal.MHSBulkOnboarding.PRJCBUGEN_T28690;
...
public class TestCase extends TestCaseBase {
    ...
    */
    ...
    @Story("PRJCBUGEN_T28690") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Onboard 1000 MHS devices at location level with a Valid location and Profile name") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T28690") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T28690\\MHSBulkOnboarding.csv";
