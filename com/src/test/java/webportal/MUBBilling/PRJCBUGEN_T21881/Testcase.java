...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21881") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is able to enable Usage based billing if a Pro account is created using Direct Purchase Pro flow.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21881") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T19896");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T19896");
    ...
    @Step("Test Step 3: Check MUB option;")
    public void step3() {
