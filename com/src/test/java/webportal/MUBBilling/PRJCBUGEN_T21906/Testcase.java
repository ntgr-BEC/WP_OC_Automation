package webportal.MUBBilling.PRJCBUGEN_T21906;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21906") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the Purchase History Reporting for Monthly Usage Billing") // It's a testcase title from
                                                                                                                    // Jira Test Case.
    @TmsLink("PRJCBUGEN_T21906") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new HamburgerMenuPage(false).GooMUBUsageHistoryAndVerify(),"Usage History of MUB not Verified");
