package webportal.MUBBilling.PRJCBUGEN_T21939;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21939") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("User is trying to disable the Monthly Usage Billing before end of the month time. Verify that Monthly Usage Billing will get disable once monthly billiing cycle is over and user should get an Invoice in email for the current month") // It's a testcase title from
                                                                                                                    // Jira Test Case.
    @TmsLink("PRJCBUGEN_T21939") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new HamburgerMenuPage(false).GooMUBandVerifyDisableTextNotifications(),"Disable text notification about MUB not Verified");
    }
