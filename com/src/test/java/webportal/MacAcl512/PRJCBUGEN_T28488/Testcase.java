package webportal.MacAcl512.PRJCBUGEN_T28488;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28488") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add Multiple MAC ACL allow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T28488") // It's a testcase id/link from Jira Test Case.
...
//        new WirelessQuickViewPage().deleteSsidYes("apwp14476");
    ...
    public void step2() {
        ...
        int MaxMacAclNum=513;
        new WirelessQuickViewPage().AddMultipleMacAcl(ssidInfo.get("SSID"), 512,ssidInfo.get("policy"));
