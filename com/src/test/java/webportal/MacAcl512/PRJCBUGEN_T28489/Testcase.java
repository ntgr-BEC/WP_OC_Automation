package webportal.MacAcl512.PRJCBUGEN_T28489;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28489") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add Multiple MAC ACL allow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T28489") // It's a testcase id/link from Jira Test Case.
