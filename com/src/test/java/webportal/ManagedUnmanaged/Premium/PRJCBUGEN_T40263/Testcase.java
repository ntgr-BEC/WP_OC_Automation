package webportal.ManagedUnmanaged.Premium.PRJCBUGEN_T40263;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40263") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[Premium] Test to verify the user can enable the managed toggle button then device credit moves from the available state to the used state in the subscription tab.") // It's a testcase title from Jira Test
                                                                                                          // Case.
    @TmsLink("PRJCBUGEN_T40263") // It's a testcase id/link from Jira Test Case.
