package webportal.ManagedUnmanaged.Premium.PRJCBUGEN_T40381;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40381") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[premium]Test to verify the add one NHB device and verify the toggle button its enabled.")
    @TmsLink("PRJCBUGEN_T40381") // It's a testcase id/link from Jira Test Case.
