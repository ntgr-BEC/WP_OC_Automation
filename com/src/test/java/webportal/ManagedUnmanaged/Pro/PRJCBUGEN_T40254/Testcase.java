package webportal.ManagedUnmanaged.Pro.PRJCBUGEN_T40254;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40254") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[PRO] Test to verify the user can disable the managed toggle button.") // It's a testcase title from Jira Test
                                                                                                          // Case.
    @TmsLink("PRJCBUGEN_T40254") // It's a testcase id/link from Jira Test Case.
