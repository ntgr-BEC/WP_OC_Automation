package webportal.ManagedUnmanaged.Pro.PRJCBUGEN_T40256;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40256") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[PRO] Test to verify the user can disable the managed toggle button, and then the device credit moves to the unused state.") // It's a testcase title from Jira Test
                                                                                                          // Case.
    @TmsLink("PRJCBUGEN_T40256") // It's a testcase id/link from Jira Test Case.
