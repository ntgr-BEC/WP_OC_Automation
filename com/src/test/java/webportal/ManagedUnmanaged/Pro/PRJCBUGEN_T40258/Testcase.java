package webportal.ManagedUnmanaged.Pro.PRJCBUGEN_T40258;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40258") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T40258") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3:Onboard dummy AP and Verify unused credits;")
    public void step3() {
        new OrganizationPage(false).openOrg(WebportalParam.Organizations);
        new MyCommonAPIs().gotoLoction(WebportalParam.location1);
