package webportal.ManagedUnmanaged.Pro.PRJCBUGEN_T40379;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40379") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[PRO]Test to verify the add one HB device and verify the toggle button its enabled.")
    @TmsLink("PRJCBUGEN_T40379") // It's a testcase id/link from Jira Test Case.
