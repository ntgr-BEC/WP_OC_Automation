package webportal.ManagedUnmanaged.Pro.PRJCBUGEN_T40380;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40380") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[PRO]Test to verify the add one HB device and verify the toggle button is disabled.")
    @TmsLink("PRJCBUGEN_T40380") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new DevicesDashPage(false).deleteDevice1(WebportalParam.ap10serialNo);
        MyCommonAPIs.sleepi(5);
    ...
    public void step2() {
        ...
        assertTrue(
                creditsInfo.get("Used Devices Credits").equals("4") && creditsInfo.get("Unused Devices Credits").equals("1"),
                "Allocate credits error.");
        
        new OrganizationPage(false).openOrg(WebportalParam.Organizations);
        new MyCommonAPIs().gotoLoction(WebportalParam.location1);
        assertTrue(new DevicesDashPage().disablemanagedSwitch(WebportalParam.ap10serialNo));
        MyCommonAPIs.sleepi(5);
