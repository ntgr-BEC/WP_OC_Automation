package webportal.MarketPlace.IMPro.PRJCBUGEN_T10478;
...
public class Testcase extends TestCaseBase {
    ...
    String mailname         = "";
    String organizationName = "TEST10478";

    @Feature("MarketPlace.IMPro") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T10478") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that Owner is able to land Market Place web page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10478") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        } else if (url.endsWith("#/insightServices") && url.contains("insight.netgear")) {
    ...
    public void step2() {
        ...
        organizationInfo.put("Owner Name", "test10478");
    ...
    @Step("Test Step 3: Check insight services page;")
    public void step3() {
        assertTrue(new InsightServicesPage().checkMarketPlacePage("owner"), "Insight services page display incorrect.");
    }
