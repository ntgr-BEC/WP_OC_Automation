package webportal.MarketPlace.Premium.PRJCBUGEN_T10218;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10218") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy VPN license subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10218") // It's a testcase id/link from Jira Test Case.
