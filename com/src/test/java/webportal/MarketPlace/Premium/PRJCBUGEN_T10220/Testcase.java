package webportal.MarketPlace.Premium.PRJCBUGEN_T10220;
...
public class Testcase extends TestCaseBase {
    ...
    String vpnGroupName = "test10220";

    @Feature("MarketPlace.Premium") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T10220") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user gets a purchase license pop-up while creating VPN group if subscription is not bought.") // It's
                                                                                                                            // a
                                                                                                                            // testcase
    // title from Jira
    // Test Case.
    @TmsLink("PRJCBUGEN-T10220") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10220");
    ...
    @Step("Test Step 2: Add new location and free vpn group, check user get purchase pop up;")
    public void step2() {
        ...
        assertTrue(new HamburgerMenuPage().checkBuyVpnResult(paymentInfo.get("YearNum"), paymentInfo.get("BuyNum"))
