package webportal.MarketPlace.Premium.PRJCBUGEN_T10221;
...
public class Testcase extends TestCaseBase {
    ...
    String vpnGroupName = "test10221";

    @Feature("MarketPlace.Premium") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T10221") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is navigated to market place page (on the appropriate category )when clicks on purchase licence pop up.") // It's
    // a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T10221") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10221");
    ...
    @Step("Test Step 2: Add new location and free vpn group, check user is navigated to market place page when clicks on purchase licence pop up;")
    public void step2() {
//        new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        assertTrue(brrp.checkVpnGroupNumLimit("normal<<"), "Vpn group credits is incorrect.");
    }
