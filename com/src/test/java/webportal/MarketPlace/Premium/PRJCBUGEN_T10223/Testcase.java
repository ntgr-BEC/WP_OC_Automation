package webportal.MarketPlace.Premium.PRJCBUGEN_T10223;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10223") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is able to cancel supscription within 3 days of buying it") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10223") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10223");
    ...
    @Step("Test Step 2: Buy vpn services, then cancel it;")
    public void step2() {
//        new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T10223");
        paymentInfo.put("Email", mailname + "@mailinator.com");
        ...
        if (new HamburgerMenuPage().checkBuyVpnResult(paymentInfo.get("YearNum"), paymentInfo.get("BuyNum"))
            ...
            assertTrue(new HamburgerMenuPage().checkVpnServicesSubscription("0", "0"), "Cancel vpn services failed.");
        } else {
