package webportal.MarketPlace.Premium.PRJCBUGEN_T10226;
...
public class Testcase extends TestCaseBase {
    ...
    String              vpnGroupName = "test10226";

    @Feature("MarketPlace.Premium") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T10226") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is able to create VPN groups after buying VPN subscription.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10226") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10226");
...
//        new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T10226");
        paymentInfo.put("Email", mailname + "@mailinator.com");
        ...
        if (new HamburgerMenuPage().checkBuyVpnResult(paymentInfo.get("YearNum"), paymentInfo.get("BuyNum"))
            ...
            assertTrue(brrp.checkVpnGroupIsExist(vpnGroupName), "Create vpn group failed.");
        } else {
