package webportal.MarketPlace.Premium.PRJCBUGEN_T10229;
...
public class Testcase extends TestCaseBase {
    ...
    String              groupName   = "test10229";

    @Feature("MarketPlace.Premium") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T10229") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T10229") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10229");
    ...
    @Step("Test Step 2: Buy vpn services and check vpn services page display;")
    public void step2() {
//        new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T10229");
        paymentInfo.put("Email", WebportalParam.loginName);
        paymentInfo.put("YearNum", "3");
        paymentInfo.put("BuyNum", "4");
        new InsightServicesPage().buyVpnProducts(paymentInfo);

        handle.gotoLoction();
        brrp.gotoPage();
        brrp.createVPNGroup(groupName);
        MyCommonAPIs.sleepi(10);
        brrp.createVPNGroup(groupName + "1");

        assertTrue(
                new HamburgerMenuPage().getVpnTotalGroup().equals("2")
