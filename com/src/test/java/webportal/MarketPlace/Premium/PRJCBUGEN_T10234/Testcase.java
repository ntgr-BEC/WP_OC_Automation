package webportal.MarketPlace.Premium.PRJCBUGEN_T10234;
...
public class Testcase extends TestCaseBase {
    ...
    String vpnGroupName = "test10234";

    @Feature("MarketPlace.Premium") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T10234") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user is taken to market place if there are insufficient subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10234") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10234");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T10234");
    ...
    @Step("Test Step 3: Add free vpn group, check user get purchase pop up;")
    public void step3() { 
        brrp.gotoPage();
