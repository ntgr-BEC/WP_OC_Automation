package webportal.MarketPlace.Premium.PRJCBUGEN_T10237;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10237") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that While viewing a VPN Group we can have Buy User packs") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10237") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10237");
