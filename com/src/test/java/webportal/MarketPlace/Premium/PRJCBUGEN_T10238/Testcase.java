package webportal.MarketPlace.Premium.PRJCBUGEN_T10238;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10238") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that Under purchased history following columns are present Date of Purchase, Product name, Price, expiry date") // It's a
                                                                                                                                         // testcase
                                                                                                                                         // title
                                                                                                                                         // from
                                                                                                                                         // Jira
                                                                                                                                         // Test
                                                                                                                                         // Case.
    @TmsLink("PRJCBUGEN-T10238") // It's a testcase id/link from Jira Test Case.
