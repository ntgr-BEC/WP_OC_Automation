package webportal.MarketPlace.Premium.PRJCBUGEN_T10248;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10248") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that can user buy VPN subscription being in premium trial.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10248") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Account try trial, then check buy vpn services;")
    public void step3() {
            ...
            paymentInfo.put("First Name", mailname);
            paymentInfo.put("Last Name", "T10248");
