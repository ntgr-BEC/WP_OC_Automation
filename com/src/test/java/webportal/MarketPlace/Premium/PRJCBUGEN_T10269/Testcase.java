package webportal.MarketPlace.Premium.PRJCBUGEN_T10269;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10269") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that a confirmation pop up is displayed while canceling the subscription") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10269") // It's a testcase id/link from Jira Test Case.
