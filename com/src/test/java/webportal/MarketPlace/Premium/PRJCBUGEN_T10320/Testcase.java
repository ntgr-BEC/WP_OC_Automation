package webportal.MarketPlace.Premium.PRJCBUGEN_T10320;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10320") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify can a user buy multiple subscription for same duration") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10320") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10320");
...
//        new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T10320");
        ...
        String buynumBefore = paymentInfo.get("BuyNum");
        ...
        if (new HamburgerMenuPage().checkBuyVpnResult(paymentInfo.get("YearNum"), paymentInfo.get("BuyNum"))
            ...
            assertTrue(
                    new HamburgerMenuPage().checkVpnServicesSubscription(
                            String.valueOf(Integer.valueOf(paymentInfo.get("BuyNum")) + Integer.valueOf(buynumBefore)),
                            String.valueOf(Integer.valueOf(paymentInfo.get("BuyNum")) + Integer.valueOf(buynumBefore))),
                    "Vpn services page display incorrect.");
        } else {
            assertTrue(false, "Vpn services page display incorrect.");
        }
    }
