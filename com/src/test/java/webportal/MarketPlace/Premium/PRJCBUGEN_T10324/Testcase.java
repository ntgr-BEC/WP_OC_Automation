package webportal.MarketPlace.Premium.PRJCBUGEN_T10324;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10324") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that, are user configs being stored after expiration") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10324") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        if (new HamburgerMenuPage(false).checkSubscriptionScreen(paymentInfo.get("Number of Device Credits"))) {
            ...
            vpnPaymentInfo.put("Last Name", "T10324");
    ...
    public void step3() {
        ...
        brrp.gotoPage();
        assertTrue(brrp.checkExpiredVpnGroupStatus("vpn0") && brrp.checkExpiredVpnGroupStatus("vpn1"), "Vpn group credits is incorrect.");
    }
