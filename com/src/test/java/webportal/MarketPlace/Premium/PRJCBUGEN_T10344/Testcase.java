package webportal.MarketPlace.Premium.PRJCBUGEN_T10344;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10344") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T10344") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10344");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T10344");
        ...
        if (new HamburgerMenuPage(false).checkSubscriptionScreen(paymentInfo.get("Number of Device Credits"))) {
            ...
            vpnPaymentInfo.put("Last Name", "T10344");
    ...
    public void step3() {
        ...
        brrp.gotoPage();
        assertTrue(brrp.checkVpnGroupNumLimit("buy now"), "Vpn group credits is incorrect.");
    }
