package webportal.MarketPlace.Premium.PRJCBUGEN_T10350;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10350") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that only the groups for which subscription has expired will get blocked") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10350") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
       ...
       Map<String, String> firststdevInfo = new HashMap<String, String>();
        ...
        if (new HamburgerMenuPage(false).checkSubscriptionScreen(paymentInfo.get("Number of Device Credits"))) {
            ...
            vpnPaymentInfo.put("Last Name", "T10350");
    ...
    public void step3() {
        ...
        assertTrue(brrp.checkExpiredVpnGroupStatus("vpn0") && brrp.checkExpiredVpnGroupStatus("vpn1") && !brrp.checkExpiredVpnGroupStatus("vpn2"),
                "Vpn group status is correct.");
    }
