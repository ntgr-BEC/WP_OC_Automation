package webportal.MarketPlace.Premium.PRJCBUGEN_T10351;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10351") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that time stamp for VPN subscription is present") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10351") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10351");
...
//        new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T10351");
