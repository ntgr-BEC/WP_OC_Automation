package webportal.MarketPlace.Premium.PRJCBUGEN_T10918;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10918") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify does a group which is in grace period becomes active or not, if another group (whose subscription is active) is deleted.") // It's
                                                                                                                                                    // a
                                                                                                                                                    // testcase
                                                                                                                                                    // title
                                                                                                                                                    // from
                                                                                                                                                    // Jira
                                                                                                                                                    // Test                                                                                                                                                    // Case.
    @TmsLink("PRJCBUGEN-T10918") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10918");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T10918");
        ...
        if (new HamburgerMenuPage(false).checkSubscriptionScreen(paymentInfo.get("Number of Device Credits"))) {
            ...
            vpnPaymentInfo.put("Last Name", "T10918");
            ...
            assertTrue(new HamburgerMenuPage().checkVpnServicesSubscription("2", "2"), "Vpn services page display incorrect.");
        } else {
            assertTrue(false, "Buy premium subscription unsuccess.");
        }
    }

    @Step("Test Step 3: Add three vpn groups and cancel vpn services, check vpn group status.")
    public void step3() {
        ...
        brrp.gotoPage();
        if (brrp.checkExpiredVpnGroupStatus("vpn0")) {
            brrp.deleteGroupNew("vpn1");

            brrp.gotoPage();
            assertTrue(!brrp.checkExpiredVpnGroupStatus("vpn0"), "<2>Vpn group locked.");
        } else {
