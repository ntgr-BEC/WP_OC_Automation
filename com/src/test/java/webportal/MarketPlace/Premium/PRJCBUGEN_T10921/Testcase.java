package webportal.MarketPlace.Premium.PRJCBUGEN_T10921;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10921") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the strings for subscription expiration and grace period.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10921") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10921");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T10921");
        ...
        if (new HamburgerMenuPage(false).checkSubscriptionScreen(paymentInfo.get("Number of Device Credits"))) {
            ...
            vpnPaymentInfo.put("Last Name", "T10921");
    ...
    @Step("Test Step 3: Add two vpn groups and check cancel services, check warning message;")
    public void step3() {
        ...
        boolean result = !brrp.checkVpnExpiredWarningMessage();

        brrp.closeVpnWarningMessage();

        new HamburgerMenuPage().cancelVpnServices();

        brrp.gotoPage();
        assertTrue(result && brrp.checkVpnExpiredWarningMessage(), "Warning message display incorrect.");
    }
