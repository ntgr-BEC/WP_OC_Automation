package webportal.MarketPlace.Premium.PRJCBUGEN_T10982;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T10982") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy multiple subscription with different time lengths") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T10982") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T10982");
...
//        new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
       ...
       Map<String, String> firststdevInfo = new HashMap<String, String>();
        ...
        paymentInfo.put("First Name", mailname);
        paymentInfo.put("Last Name", "T10982");
