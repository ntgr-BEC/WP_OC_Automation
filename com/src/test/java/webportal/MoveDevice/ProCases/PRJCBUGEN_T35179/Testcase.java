package webportal.MoveDevice.ProCases.PRJCBUGEN_T35179;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35179") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify moving the device Organization to another organization.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35179") // It's a testcase id/link from Jira Test Case.
