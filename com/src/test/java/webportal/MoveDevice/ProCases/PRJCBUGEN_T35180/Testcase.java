package webportal.MoveDevice.ProCases.PRJCBUGEN_T35180;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35180") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify moving the device from location to location within the organization.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35180") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      @Step("Test Step 2: Move deice to another location within same organization")
