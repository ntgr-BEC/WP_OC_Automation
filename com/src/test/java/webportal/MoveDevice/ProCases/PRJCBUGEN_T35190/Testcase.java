package webportal.MoveDevice.ProCases.PRJCBUGEN_T35190;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35190") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user moved the device from one location to another location then the device goes on reboot or not.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35190") // It's a testcase id/link from Jira Test Case.
