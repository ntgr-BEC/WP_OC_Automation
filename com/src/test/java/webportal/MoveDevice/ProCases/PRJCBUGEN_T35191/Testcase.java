package webportal.MoveDevice.ProCases.PRJCBUGEN_T35191;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35191") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user moved the device from one location to another location then the device goes on reset or not.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35191") // It's a testcase id/link from Jira Test Case.
