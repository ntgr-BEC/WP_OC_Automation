package webportal.MoveDevice.ProCases.PRJCBUGEN_T35199;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35199") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the read/write manager account behavior when the user moves the device to the pro admin account.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35199") // It's a testcase id/link from Jira Test Case.
