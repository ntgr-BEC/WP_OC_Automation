package webportal.MoveDevice.ProCases.PRJCBUGEN_T35200;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35200") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the secondary admin account behavior when the user moves the device to the pro admin account.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35200") // It's a testcase id/link from Jira Test Case.
