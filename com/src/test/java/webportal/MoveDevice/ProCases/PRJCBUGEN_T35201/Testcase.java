package webportal.MoveDevice.ProCases.PRJCBUGEN_T35201;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35201") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify secondary admin user also moves the device from one location to another location.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35201") // It's a testcase id/link from Jira Test Case.
