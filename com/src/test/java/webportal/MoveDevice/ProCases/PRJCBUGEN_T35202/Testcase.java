package webportal.MoveDevice.ProCases.PRJCBUGEN_T35202;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35202") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify moving the online device from one Location to another Location.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35202") // It's a testcase id/link from Jira Test Case.
