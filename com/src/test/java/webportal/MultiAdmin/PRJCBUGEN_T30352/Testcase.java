package webportal.MultiAdmin.PRJCBUGEN_T30352;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30352") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether User able to get email related Secondary admin invite") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30352") // It's a testcase id/link from Jira Test Case.
