package webportal.MultiAdmin.PRJCBUGEN_T30353;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Check whether user able to activate new secondary admin invite") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30353") // It's a testcase id/link from Jira Test Case.
