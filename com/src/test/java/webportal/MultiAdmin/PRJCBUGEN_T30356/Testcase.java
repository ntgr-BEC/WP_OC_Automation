package webportal.MultiAdmin.PRJCBUGEN_T30356;
...
public class Testcase extends TestCaseBase {
    ...
    String Name     = "PRJCBUGEN_T30356";

    @Feature("MultiAdmin") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30356") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T30356") // It's a testcase id/link from Jira Test Case.
