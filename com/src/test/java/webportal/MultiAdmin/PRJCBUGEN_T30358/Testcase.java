package webportal.MultiAdmin.PRJCBUGEN_T30358;
...
public class Testcase extends TestCaseBase {
    ...
    String Name     = "PRJCBUGEN_T30358";

    @Feature("MultiAdmin") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30358") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check the status of the Secondary admin invite till user accepts the invitation") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30358") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new WirelessQuickViewPage(false).PendingRequest(), "staus is not pending");
