package webportal.MultiAdmin.PRJCBUGEN_T30359;
...
public class Testcase extends TestCaseBase {
    ...
    String Name     = "PRJCBUGEN_T30359";

    @Feature("MultiAdmin") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30359") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify user able to delete the invitation") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30359") // It's a testcase id/link from Jira Test Case.
