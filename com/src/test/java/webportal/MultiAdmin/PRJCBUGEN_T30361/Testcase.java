package webportal.MultiAdmin.PRJCBUGEN_T30361;
...
public class Testcase extends TestCaseBase {
    ...
    String Name     = "PRJCBUGEN_T30361";

    @Feature("MultiAdmin") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30361") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether user able to resend the invite email") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30361") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new WirelessQuickViewPage(false).Resend(mailname), "staus is not pending");
