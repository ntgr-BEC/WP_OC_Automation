package webportal.MultiAdmin.PRJCBUGEN_T30365;
...
public class Testcase extends TestCaseBase {
    ...
    String Name     = "PRJCBUGEN_T30365";

    @Feature("MultiAdmin") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30365") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether insight displays notification with admin name on every operation admin does") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30365") // It's a testcase id/link from Jira Test Case.
