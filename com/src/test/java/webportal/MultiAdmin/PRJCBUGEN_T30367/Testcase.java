package webportal.MultiAdmin.PRJCBUGEN_T30367;
...
public class Testcase extends TestCaseBase {
    ...
    String Name     = "PRJCBUGEN_T30367";

    @Feature("MultiAdmin") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30367") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify primary admin can revoke the access of secondary admins") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30367") // It's a testcase id/link from Jira Test Case.
