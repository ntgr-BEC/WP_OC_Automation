package webportal.MultiAdmin.PRJCBUGEN_T30949;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30949") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether insight able to display role of the Current user logged into insight in the Upper right corner") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30949") // It's a testcase id/link from Jira Test Case.
