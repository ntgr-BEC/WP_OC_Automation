package webportal.Multipack.PRJCBUGEN_T18232;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18232") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user is able to Cancel current Subscription in Webportal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T18232") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Buy insight premium subscriptions and check subscriptions page;")
    public void step4() {
    ...
    public void step5() {
        ...
        assertTrue(!new HamburgerMenuPage(false).checkDeviceCredits(DeviceCreditsInfo.get("Device Credits Pack")));
    }
