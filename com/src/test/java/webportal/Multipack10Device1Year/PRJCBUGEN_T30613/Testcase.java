package webportal.Multipack10Device1Year.PRJCBUGEN_T30613;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30613") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Muktipack 10Device 1Year Cyprus") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30613") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        webportalLoginPage.loginByUserPassword("apwptest3639875@mailinator.com", "Netgear#123");
