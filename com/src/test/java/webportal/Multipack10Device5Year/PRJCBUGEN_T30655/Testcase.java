package webportal.Multipack10Device5Year.PRJCBUGEN_T30655;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Multipack 10Device 5Year") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30655") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Muktipack 10Device 5Year Czech Republic") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30655") // It's a testcase id/link from Jira Test Case.
