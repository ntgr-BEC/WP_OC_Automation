package webportal.Multipack5Device5Year.PRJCBUGEN_T30576;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Multipack 5Device 5Year") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T30576") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Muktipack 5Device 5Year Czech Republic") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30576") // It's a testcase id/link from Jira Test Case.
