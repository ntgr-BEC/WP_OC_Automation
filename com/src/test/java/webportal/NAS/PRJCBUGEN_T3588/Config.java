package webportal.NAS.PRJCBUGEN_T3588;
...
public interface Config {
    ...
    public static String newpassword="Netgear";
    public static String oldpassword="Netgear1";
    public static String connectedstatus="Connected";
    public static String healthstatus="Everything OK.";
    public static String storagevolumeinfo="1";
}
