...
public class T3588 extends TestCaseBase implements Config {
	...
	public void step2(){
		...
		sleep(30000);
		String text = dashboardLocationPage.confirmStoreageVolume();
		boolean exist = text.contains(storagevolumeinfo);
		assertTrue(exist);
	}
	}
