package webportal.NAS.PRJCBUGEN_T3607;
...
public class T3607 extends TestCaseBase implements Config{
	...
	public void step3(){
		...
		devicesNasNetworkSettingsPage.restNetworkSettings();
		String string=devicesNasNetworkSettingsPage.getMtuValue();
		boolean exist = string.contains(mtuvalue);
		assertTrue(exist);
	}
}