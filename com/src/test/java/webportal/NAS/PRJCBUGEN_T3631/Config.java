...
public interface Config {
    ...
    public static String SerialNo = "3C81310E0010B";
    public static String curfwinfo = "Current Version: 6.9.4";
    public static String upfwinfo = "Update Version: NA";
    public static String name = "rongqing516";
    public static String model = "ReadyNAS 628X";
    public static String firmware = "6.9.4";
    ...
    public static String oldpassword="Netgear2";
