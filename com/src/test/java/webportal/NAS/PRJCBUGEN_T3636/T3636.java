package webportal.NAS.PRJCBUGEN_T3636;
...
public class T3636 extends TestCaseBase implements Config {
    ...
    public void step3() {
        ...
        String address = devicesNasIpSettingsPage.getipaddress();
        boolean exist = address.contains(primaryip);
        assertTrue(exist);
