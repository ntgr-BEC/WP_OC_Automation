package webportal.NAS.PRJCBUGEN_T3639;
...
public class T3639 extends TestCaseBase implements Config {
    ...
    public void step3() {
        ...
        String temp = devicesNasSummaryPage.getsystemtemp();
        assertEquals(systemtemp, temp);
    }
}
