package webportal.NAS.PRJCBUGEN_T3640;
...
import webportal.NAS.PRJCBUGEN_T3639.Config;
...
public class T3640 extends TestCaseBase implements Config {
	...
	public void step3(){
		...
		boolean exists = devicesNasSummaryPage.confirmnascapacity();
		assertTrue(exists);	
