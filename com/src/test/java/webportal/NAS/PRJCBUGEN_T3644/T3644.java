package webportal.NAS.PRJCBUGEN_T3644;
...
public class T3644 extends TestCaseBase implements webportal.NAS.PRJCBUGEN_T3644.Config{
...
public void step3(){
	...
	String size = devicesNasSummaryPage.getDiskinfo();
	boolean exist = size.contains(diskinfo);
	assertTrue(exist);
