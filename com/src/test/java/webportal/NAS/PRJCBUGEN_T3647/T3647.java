package webportal.NAS.PRJCBUGEN_T3647;
...
public class T3647 extends TestCaseBase implements Config {
	...
	public void step3(){
		...
		String storage = devicesNasSummaryPage.getstorageused();
		boolean exist = storage.contains(storageused);
		assertTrue(exist);
	}
}