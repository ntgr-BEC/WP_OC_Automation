package webportal.NAS.PRJCBUGEN_T3649;
...
public class T3649 extends TestCaseBase implements Config {
	...
	public void step3(){
		...
		sleep(10*1000);
		String storage = devicesNasSummaryPage.confirmShareInfo();
		boolean exist = storage.contains(sharetest);
		assertTrue(exist);
	}
