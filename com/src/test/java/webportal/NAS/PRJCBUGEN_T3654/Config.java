package webportal.NAS.PRJCBUGEN_T3654;
...
public interface Config {
    ...
    public static String tempaturedisk = WebportalParam.getLocText("Temperature Disk");
    ...
    public static String portnumberstatus	= WebportalParam.getLocText("display: block");
