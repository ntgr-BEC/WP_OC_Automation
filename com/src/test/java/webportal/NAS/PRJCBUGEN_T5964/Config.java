...
public interface Config {
    ...
    public static String disktemp = "Disk Temperature";
    public static String cputempinfo= "CPU Temperature";
    public static String fanspeedinfo = "Fan Speed";
    public static String hostnameurl="https://rongqing628/admin";
    public static String username ="admin";
    public static String password ="1";
    public static String nodeviceinfo="No device available";
    public static String antivirusoff="Disabled";
}
