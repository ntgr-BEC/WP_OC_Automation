package webportal.NatMode.user.Dontrun.PRJCBUGEN_T33927;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33927") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("verify instant captive portal funcationally using bridge ssid") // It's                                                                                                                                                      // a                                                                                                                                                  // Test                                                                                                                                                     // Case.
   @TmsLink("PRJCBUGEN-T33927") // It's a testcase id/link from Jira Test Case.
   ...
   @Step("Test Step 2: Add bridge WIFI ssid and enable instant captive portal, check client connect wifi;")
   public void step2() {
