package webportal.NatMode.user.Dontrun.PRJCBUGEN_T33929;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33929") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("verify whether the basic captive portal ssid is pushed or not") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33929") // It's a testcase id/link from Jira Test Case.
   ...
   @Step("Test Step 2: Create Bridge SSID and connect it to client")
   public void step2() {
