package webportal.NatMode.user.PRO.PRJCBUGEN_T33761;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33761") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("Able to create NAT mode SSID from Organizational level") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33761") // It's a testcase id/link from Jira Test Case.
   ...
   @Step("Test Step 3: Make sure the config are pushed onto the ap and org ssid are pushed to to loc level")
   public void step3() {
       
      
       assertTrue(new WirelessQuickViewPage().checkSsidIsExist("apwp14008"),"ORG SSID IS NOT PRESENT UNDER LOCLEV");
