package webportal.NatMode.user.PRO.PRJCBUGEN_T33779;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33779") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("create ssid with Bridge mode in manager account") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33779") // It's a testcase id/link from Jira Test Case.
