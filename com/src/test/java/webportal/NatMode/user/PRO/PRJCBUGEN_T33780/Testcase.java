package webportal.NatMode.user.PRO.PRJCBUGEN_T33780;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33780") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("creating nat ssid") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33780") // It's a testcase id/link from Jira Test Case.
