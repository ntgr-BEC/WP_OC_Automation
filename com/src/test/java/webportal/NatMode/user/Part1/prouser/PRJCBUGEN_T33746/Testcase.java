package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33746;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33746") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("creating nat ssid") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33746") // It's a testcase id/link from Jira Test Case.
