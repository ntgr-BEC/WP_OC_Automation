package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33747;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33747") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("changing bridge to Nat") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33747") // It's a testcase id/link from Jira Test Case.
   ...
   @Step("Test Step 3:  Change the mode from Bridge to nat and check for config push")
   public void step3() {
       
   
       new WirelessQuickViewPage().bridgeTonat("apwp14008");
       MyCommonAPIs.sleepi(60);
