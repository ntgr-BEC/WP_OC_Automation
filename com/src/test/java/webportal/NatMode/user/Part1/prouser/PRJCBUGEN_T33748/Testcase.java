package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33748;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33748") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("changing Nat to bridge") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33748") // It's a testcase id/link from Jira Test Case.
...
//       assertTrue(new APUtils(WebportalParam.ap1IPaddress).getNatStatus(WebportalParam.ap1Model), "CONFIG FOR NAT NOT PUSHED");
   ...
   @Step("Test Step 3: Change the mode from NAT to Bridge and check for config push")
   public void step3() {
