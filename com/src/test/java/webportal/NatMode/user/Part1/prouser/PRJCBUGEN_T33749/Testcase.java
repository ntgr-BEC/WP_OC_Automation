package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33749;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33749") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("Dynamic VLAN cannot be enabled in NAT Mode SSID.") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33749") // It's a testcase id/link from Jira Test Case.
   ...
   public void step3() {
             ...
             assertTrue(page.dynamicvlan("apwp14008"),"Failed check logs");
