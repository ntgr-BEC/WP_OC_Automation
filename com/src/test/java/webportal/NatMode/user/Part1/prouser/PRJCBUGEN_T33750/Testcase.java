package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33750;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33750") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("NAT can not enable when Dynamic vlan is enable") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33750") // It's a testcase id/link from Jira Test Case.
