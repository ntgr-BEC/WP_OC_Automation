package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33759;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33759") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("NAT IP range we shall be showing to user for each SSID profile") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33759") // It's a testcase id/link from Jira Test Case.
   ...
   public void step3() {
             ...
             System.out.print(page.Natrange.getText());
             assertTrue((page.Natrange.getText()).contains("10.0"),"Range not matching");
