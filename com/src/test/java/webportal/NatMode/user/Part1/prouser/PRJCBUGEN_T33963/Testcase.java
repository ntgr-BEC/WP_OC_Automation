package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33963;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33963") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("Add SSID with Bridge Mode then add AP.") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33963") // It's a testcase id/link from Jira Test Case.
   ...
   @Step("Test Step 3: Create Bridge SSID and add device ")
   public void step3() {
   ...
   @Step("Test Step 5: Add WIFI ssid and connect client to this ssid;")
   public void step5() {
       int sum = 0;
       while (true) {
   ...
   @Step("Test Step 6: Check whether connected connect is shown in client page;")
   public void step6() {
       MyCommonAPIs.sleepi(120);
       new DevicesDashPage().waitDevicesReConnected(WebportalParam.ap1serialNo);
