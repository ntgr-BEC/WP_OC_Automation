package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33964;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33964") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("Add SSID with NAT Mode then add AP.") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33964") // It's a testcase id/link from Jira Test Case.
...
//   {   new DevicesDashPage(true).gotoPage();
   ...
   @Step("Test Step 3: Create NAT SSID and add device ")
   public void step3() {
