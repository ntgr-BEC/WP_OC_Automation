package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33965;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33965") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("Add SSID with Bridge Mode then add AP --> reboot AP.and check configure") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33965") // It's a testcase id/link from Jira Test Case.
   ...
   @Step("Test Step 3: Create Bridge SSID ")
   public void step3() {
