package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33967;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33967") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("verify whether the NAT mode ssid is pushed or not aftert rebooting") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33967") // It's a testcase id/link from Jira Test Case.
   ...
   @Step("Test Step 2: Create NAT SSID and reboot ")
   public void step2() {
