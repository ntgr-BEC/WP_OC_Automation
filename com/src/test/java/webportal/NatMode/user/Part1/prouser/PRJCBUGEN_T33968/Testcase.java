package webportal.NatMode.user.Part1.prouser.PRJCBUGEN_T33968;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33968") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("verify whether the bridge mode ssid is pushed or not after rebooting") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33968") // It's a testcase id/link from Jira Test Case.
