package webportal.NatMode.user.Part2.prouser.PRJCBUGEN_T33922;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33922") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("verify whether schedule wifi is working properly in Natmode") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33922") // It's a testcase id/link from Jira Test Case.
   ...
   public void step2() {
       ...
       ssidInfo.put("Schedule Name", "scheduled15938");
       new WirelessQuickViewPage().scheduleWifiWithNat(ssidInfo);
  ...
  @Step("Test Step 3: Check whether Scheduled ssid is pushed  into ap or not")
   public void step3() {
     ...
     assertTrue(new APUtils(WebportalParam.ap1IPaddress).getScheduleWifiStatus(WebportalParam.ap1Model), "CONFIG FOR SCHEDULEWIFI NOT PUSHED");
