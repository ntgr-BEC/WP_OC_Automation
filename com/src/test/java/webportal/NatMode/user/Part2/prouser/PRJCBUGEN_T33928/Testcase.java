package webportal.NatMode.user.Part2.prouser.PRJCBUGEN_T33928;
...
public class Testcase extends TestCaseBase {
   ...
   @Story("PRJCBUGEN_T33928") // It's a testcase id/link from Jira Test Case but replace - with _.
   @Description("Verify Icp with Natmode Ssid") // It's a test case title from Jira Test Case.
   @TmsLink("PRJCBUGEN-T33928") // It's a testcase id/link from Jira Test Case.
