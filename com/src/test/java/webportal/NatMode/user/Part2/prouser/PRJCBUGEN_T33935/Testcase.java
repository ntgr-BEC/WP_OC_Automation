package webportal.NatMode.user.Part2.prouser.PRJCBUGEN_T33935;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33935") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, RATELIMIT ON SSID WITH Bridge MODE") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33935") // It's a testcase id/link from Jira Test Case.
