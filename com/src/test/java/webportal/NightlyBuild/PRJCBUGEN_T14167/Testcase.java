package webportal.NightlyBuild.PRJCBUGEN_T14167;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify delete and onboard Ap functionally for pro admin") // It's a testcase title from Jira Test Case.
