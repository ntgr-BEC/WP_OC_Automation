...
public class Testcase extends TestCaseBase {
    ...
    @Description("load firmware and onboard to AP ") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 1:Downlaod firmware From JFrog")
    public void step1()  {
       
        new FileHandling().deleteAllExcept("jfrog_fw_download.py", Path);
...
//        }
        ...
        filename = new FileHandling().fetchFileName(Path, WebportalParam.ap1Model);
        System.out.println("file name is "+filename);
      
    }
        
    
    @Step("Test Step 2: Load Firmware to AP")
    public void step2() throws IOException {
//        String fversion = new APUtils(WebportalParam.ap1IPaddress).getVersion(false);
//        System.out.println("fw version is"+fversion);
//        if(filename.contains(fversion)) {
