...
public class Testcase extends TestCaseBase {
    ...
    String              Ssidname    = "apssid" + String.valueOf(num);
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", Ssidname);
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID "+Ssidname)
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect "+Ssidname+" 123456798 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect "+Ssidname+" 123456798 WPA2PSK aes")
