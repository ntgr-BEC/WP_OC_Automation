package webportal.NightlyBuild.PRJCBUGEN_T15500;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify \"change e-mail\" functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15500") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        new HamburgerMenuPage().changeEmail(email, email, accountInfo.get("Confirm Password") );
