package webportal.NightlyBuild.PRJCBUGEN_T23044;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify, PingAndTraceroute traceroute test can be done on device level") // It's a testcase title from Jira Test Case.
