package webportal.NightlyBuild.PRJCBUGEN_T23097;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify if the feature IGMP can be enabled and disabled") // It's a testcase title from Jira Test Case.
