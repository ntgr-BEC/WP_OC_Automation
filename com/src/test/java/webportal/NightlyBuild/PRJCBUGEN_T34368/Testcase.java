package webportal.NightlyBuild.PRJCBUGEN_T34368;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Device Summary page Navigation in the pro account") // It's a testcase title from Jira Test Case.
