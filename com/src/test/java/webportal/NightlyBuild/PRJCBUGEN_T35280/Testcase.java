package webportal.NightlyBuild.PRJCBUGEN_T35280;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35280") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add Pro LICENSE Org level immidiate ") 
    @TmsLink("PRJCBUGEN_T35280") // It's a testcase id/link from Jira Test Case.
