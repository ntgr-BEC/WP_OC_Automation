package webportal.NightlyBuild.PRJCBUGEN_T36177;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36177") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify,RF parameter is pushed to all AP's in that location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T36177") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
      ...
      new WirelessQuickViewPage().GoToWirelessSettings();
        MyCommonAPIs.sleepi(10);
          ...
          @Step("Test Step 3: Chexk for config push;") 
          public void step3()
          {
