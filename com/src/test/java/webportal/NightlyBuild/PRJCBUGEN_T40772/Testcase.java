package webportal.NightlyBuild.PRJCBUGEN_T40772;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40772") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user is able to see the Secondary Admin account as active in the PRO admin Secondary Admin list when the user again invites and login.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40772") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new ManagerPage(false).deleteallSecondaryAdminEmail();
