package webportal.NotificationPreferencesForAllOrganizations.PRJCBUGEN_T34057;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Notification preferences for ALL organizations IM-7.0") // It's a folder/component name to make test suite more readable from Jira
                                                                      // Test Case.
    @Story("PRJCBUGEN_T34057") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the organisation level notification settings only supported for pro account") // It's a testcase title from Jira
                                                                                                               // Test Case.
    @TmsLink("PRJCBUGEN-T34057") // It's a testcase id/link from Jira Test Case.
