package webportal.NotificationPreferencesForAllOrganizations.PRJCBUGEN_T34059;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Notification preferences for ALL organizations IM-7.0") // It's a folder/component name to make test suite more readable from Jira
                                                                      // Test Case.
    @Story("PRJCBUGEN_T34059") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the organisation level notification settings should be supported for only web portal") // It's a testcase title
                                                                                                                        // from Jira
    // Test Case.
    @TmsLink("PRJCBUGEN-T34059") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: verify Organization Settings should be there When we are on Manage Notification Preferencess Page")
    public void step4() {
