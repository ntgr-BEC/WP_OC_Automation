package webportal.NotificationPreferencesForAllOrganizations.PRJCBUGEN_T34062;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("Notification preferences for ALL organizations IM-7.0") // It's a folder/component name to make test suite more readable from Jira
                                                                      // Test Case.
    @Story("PRJCBUGEN_T34062") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the email notification should be received when the device reboot") // It's a testcase title from
                                                                                                    // Jira
                                                                                                    // Test Case.
    @TmsLink("PRJCBUGEN-T34062") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 5: verify Device Reboot Email Notification is Received")
    public void step5() {
