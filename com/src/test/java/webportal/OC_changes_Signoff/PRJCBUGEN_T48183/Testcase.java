package webportal.OC_changes_Signoff.PRJCBUGEN_T48183;
...
public class Testcase extends TestCaseBase {
    ...
    String              urlmaintqa      = "https://accounts-qa.netgear.com/login?redirectUrl=https:%2F%2Fbilling-qa.netgear.com%2Finsight-pro&GotoDashboard=https://maint-qa.insight.netgear.com&category_id=18&clientId=5bk75uhg5v61mcj48368s2qc9f";
    String              urlmaintbeta    = "https://accounts2-stg.netgear.com/login?redirectUrl=https:%2F%2Fbilling-stg.netgear.com%2Finsight-pro&GotoDashboard=https://maint-beta.insight.netgear.com&category_id=18&clientId=les2m0e41u7nr1asu03uk2iot";

    @Feature("OC_changes_Signoff") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T48183") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Direct purchase for pro account - account creation") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T48183") // It's a testcase id/link from Jira Test Case.
