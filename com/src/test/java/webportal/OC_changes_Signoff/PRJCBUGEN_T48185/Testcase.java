package webportal.OC_changes_Signoff.PRJCBUGEN_T48185;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T48185") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create new PRO account adding a 1-Year Insight Included Device") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T48185") // It's a testcase id/link from Jira Test Case.
