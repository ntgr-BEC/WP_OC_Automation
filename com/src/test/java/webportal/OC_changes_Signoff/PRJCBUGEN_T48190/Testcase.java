package webportal.OC_changes_Signoff.PRJCBUGEN_T48190;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T48190") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create a pro account using a Pro Subscription Key") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T48190") // It's a testcase id/link from Jira Test Case.
