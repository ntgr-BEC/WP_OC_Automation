package webportal.OC_changes_Signoff.PRJCBUGEN_T48202;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T48202") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Purchase of Premium subscription plan (premium trial to premium yearly)") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T48202") // It's a testcase id/link from Jira Test Case.
