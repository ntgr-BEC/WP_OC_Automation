package webportal.OC_changes_Signoff.PRJCBUGEN_T48203;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T48203") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Purchase of Premium subscription plan (premium monthly to premium yearly)") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T48203") // It's a testcase id/link from Jira Test Case.
