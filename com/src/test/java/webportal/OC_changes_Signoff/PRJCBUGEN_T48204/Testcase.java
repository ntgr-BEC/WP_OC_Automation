package webportal.OC_changes_Signoff.PRJCBUGEN_T48204;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T48204") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Enable MUB in pro account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T48204") // It's a testcase id/link from Jira Test Case.
