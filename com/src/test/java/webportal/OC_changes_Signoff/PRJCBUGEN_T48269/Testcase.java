package webportal.OC_changes_Signoff.PRJCBUGEN_T48269;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T48269") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Login to pro account") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T48269") // It's a testcase id/link from Jira Test Case.
