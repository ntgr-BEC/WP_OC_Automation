package webportal.OlaTestcases.PRJCBUGEN_T113878;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T113878") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that the user is able to create an ORG wide SSID WPA2 for existing Organization") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T113878") // It's a testcase id/link from Jira Test Case.
