package webportal.OlaTestcases.PRJCBUGEN_T13879;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T113879") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that the user is able to create an ORG wide SSID Open for existing Organization") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T113879") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        locationInfo.put("SSID", "PRJCBUGEN_T113879");
