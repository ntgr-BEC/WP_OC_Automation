package webportal.OlaTestcases.PRJCBUGEN_T13881;
...
public class Testcase extends TestCaseBase {
    String organizationName = "PRJCBUGEN_T13881";
    ...
    @Description("Verify that the user is able to create an ORG wide SSID WPA2 Personal with ECP for existing Organization") // It's a testcase title from Jira Test Case.
