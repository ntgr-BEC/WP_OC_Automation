package webportal.Onboard_recursive.PRJCBUGEN_T14170;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Repeatly do onboard from pro to premium and vice-versa") // It's a testcase title from Jira Test Case.
    ...
    @Step("Repeatly onboard the AP from pro to premium and vice-versa")
    public void step1() {
