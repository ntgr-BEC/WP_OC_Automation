package webportal.Onboard_recursive.PRJCBUGEN_T14173;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T00011") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Onboard AP to pro account location1 and remove it and again onboard same AP to location1") // It's // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T00011") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        System.out.println(count + " Iteration is completed");
    ...
    @Step("Test Step 2: Add and remove device from location1")
    public void step2() {
