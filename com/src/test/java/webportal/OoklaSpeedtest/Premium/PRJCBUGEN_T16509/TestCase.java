package webportal.OoklaSpeedtest.Premium.PRJCBUGEN_T16509;
...
public class TestCase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16509") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether we are getting results for the upload speed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T16509") // It's a testcase id/link from Jira Test Case.
...
//        System.out.println("adsfasdfasdfqe2222222222222222222221");
...
//        devInfo2.put("MAC Address", WebportalParam.ap2macaddress);
...
//        } 
    ...
    @Step("Test Step 3: Now once the device comes online, go to the device dashboard")
    public void step3() {
        boolean Result = false;
        DevicesDashPage DevicesDashPage= new DevicesDashPage();
