package webportal.OoklaSpeedtest.Premium.PRJCBUGEN_T16510;
...
public class TestCase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16510") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether we are getting results for the upload speed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T16510") // It's a testcase id/link from Jira Test Case.
