package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7504;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7504") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify able to give the static IP or not.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7504") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: should able to give the static IP address.")
    public void step3() {
