package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7912;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7912") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[Firmware] Test to verify the functionality of \"upgrade\" button on firmware screen.")
    @TmsLink("PRJCBUGEN-T7912") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Change to ap mode / Get satellite ip")
    public void step2() {
        ddp.openOB2();
