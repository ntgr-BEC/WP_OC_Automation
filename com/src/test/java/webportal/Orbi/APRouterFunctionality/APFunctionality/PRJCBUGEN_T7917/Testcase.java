package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7917;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7917") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[Satellites] Test to verify the user is able to add satellites by clicking on the \"+\" button.") // It's a testcase title
    // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7917") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Click \"+\" button")
    public void step3() {
        DevicesOrbiSatellitesPage page = new DevicesOrbiSatellitesPage();
        page.btnAdd.click();
        assertTrue(page.btnNextforexist.exists(), "No adding pop");
