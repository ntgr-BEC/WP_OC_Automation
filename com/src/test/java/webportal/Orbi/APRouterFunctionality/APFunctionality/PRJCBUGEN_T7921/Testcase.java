package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7921;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7921") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[WAN IP] Test to verify the WAN IP tile is disabled/unresponsive when the orbi is AP mode.")
    @TmsLink("PRJCBUGEN-T7921") // It's a testcase id/link from Jira Test Case.
