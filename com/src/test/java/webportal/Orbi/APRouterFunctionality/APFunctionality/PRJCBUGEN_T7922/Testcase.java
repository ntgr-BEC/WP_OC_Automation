package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7922;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7922") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[Traffic Meter] Test to verify Traffic Meter tile is disabled/unresponsive when the orbi is AP mode.")
    @TmsLink("PRJCBUGEN-T7922") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: verify Traffic Meter tile is disabled/unresponsive when the orbi is AP mode.")
    public void step3() {
