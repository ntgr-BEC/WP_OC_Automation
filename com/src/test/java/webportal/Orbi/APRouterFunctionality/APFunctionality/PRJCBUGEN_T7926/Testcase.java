package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7926;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7926") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user is able to switch mode from \"AP\" to \"Router\"")
    @TmsLink("PRJCBUGEN-T7926") // It's a testcase id/link from Jira Test Case.
