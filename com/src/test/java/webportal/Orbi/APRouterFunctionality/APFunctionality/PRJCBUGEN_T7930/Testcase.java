package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7930;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7930") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the number of Wifi SSIDs are getting updated on the device dashboard.")
    @TmsLink("PRJCBUGEN-T7930") // It's a testcase id/link from Jira Test Case.
