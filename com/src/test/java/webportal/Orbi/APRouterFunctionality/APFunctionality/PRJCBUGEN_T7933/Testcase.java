package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7933;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7933") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the number of added and connected satellites get displayed on the satellite tile on the device dashboard.")
    @TmsLink("PRJCBUGEN-T7933") // It's a testcase id/link from Jira Test Case.
