package webportal.Orbi.APRouterFunctionality.APFunctionality.PRJCBUGEN_T7937;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7937") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the functionality of \"Reboot\" button.")
    @TmsLink("PRJCBUGEN-T7937") // It's a testcase id/link from Jira Test Case.
