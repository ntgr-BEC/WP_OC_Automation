package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T15966;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15966") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Speed test on Insight")
    @TmsLink("PRJCBUGEN-T15966") // It's a testcase id/link from Jira Test Case.
