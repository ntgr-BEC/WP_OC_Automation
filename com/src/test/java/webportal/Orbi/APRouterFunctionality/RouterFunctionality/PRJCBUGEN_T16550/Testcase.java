package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T16550;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16550") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user is able to share logs via entering e-mail address in share diagnostics tile.")
    @TmsLink("PRJCBUGEN-T16550") // It's a testcase id/link from Jira Test Case.
