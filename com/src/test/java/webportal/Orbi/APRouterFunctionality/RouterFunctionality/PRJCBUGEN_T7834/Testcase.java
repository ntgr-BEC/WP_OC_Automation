package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T7834;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7834") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the orbi device gets connected to cloud i.e comes online post assigning static IP in router mode") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7834") // It's a testcase id/link from Jira Test Case.
