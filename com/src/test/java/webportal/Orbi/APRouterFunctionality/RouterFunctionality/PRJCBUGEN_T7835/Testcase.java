package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T7835;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7835") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the IP and MAC is well displayed on the device list screen after assigning the static IP in router mode") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7835") // It's a testcase id/link from Jira Test Case.
