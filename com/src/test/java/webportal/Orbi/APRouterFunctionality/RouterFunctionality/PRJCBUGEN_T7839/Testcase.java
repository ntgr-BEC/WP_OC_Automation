package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T7839;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7839") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the device must not come online if the user has assigned an invalid subnet mask") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7839") // It's a testcase id/link from Jira Test Case.
