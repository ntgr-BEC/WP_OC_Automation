package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T7855;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7855") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user can switch modes from AP to router and router to AP on the [Device Mode] page.")
    @TmsLink("PRJCBUGEN-T7855") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Click \"Device Mode\" Tab, choose \"Router\" mode.")
    public void step4() {
        DevicesOrbiDeviceModePage page = new DevicesOrbiDeviceModePage();
        page.setDeviceMode(false);
        ddp.gotoPage();
