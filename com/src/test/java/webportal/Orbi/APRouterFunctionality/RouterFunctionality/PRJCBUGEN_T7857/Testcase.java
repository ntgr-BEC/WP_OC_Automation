package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T7857;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7857") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[Wifi Networks] Test to verify the SSIDs created are listed on the wifi networks page")
    @TmsLink("PRJCBUGEN-T7857") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Click \"WiFi Networks\" Tab")
    public void step3() {
