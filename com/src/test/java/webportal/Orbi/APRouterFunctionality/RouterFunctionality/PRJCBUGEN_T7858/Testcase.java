package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T7858;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7858") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[LAN IP] Test to verify the toggle functionality the DHCP server button") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7858") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(page.isDHCP(), "check dhcp is on");
        page.setDHCP(false, true);
        assertTrue(!page.isDHCP(), "check dhcp is off");
    }
}
