package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T7861;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7861") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[LAN IP] Test to verify if the user can assign a static\"end IP address\"") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7861") // It's a testcase id/link from Jira Test Case.
