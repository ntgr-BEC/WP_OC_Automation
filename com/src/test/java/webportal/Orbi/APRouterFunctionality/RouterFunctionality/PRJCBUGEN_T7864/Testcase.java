package webportal.Orbi.APRouterFunctionality.RouterFunctionality.PRJCBUGEN_T7864;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7864") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[Satellites] Test to verify the user is able to add satellites by clicking on the \"+\" button")
    @TmsLink("PRJCBUGEN-T7864") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        page.btnAdd.click();
        assertTrue(page.btnNextforexist.exists(), "Check Add is doable");
