package webportal.Orbi.IM68_WPA3.PRJCBUGEN_T30987;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30987") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the security type from WPA2-PSK to WPA3-Personal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30987") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.editSsid(0);
        page.setSsidSecurity(1, "PRJCBUGEN_T30987-aes");
        page.btnSave.click();
...
//        assertTrue(checkpoint,"checkpoint 1 : AES is selected");
    ...
    public void step5() {
        ...
        DevicesOrbiWifiNetworkPage page = new DevicesOrbiWifiNetworkPage();
        page.editSsid(0);
        page.setSsidSecurity(4, "PRJCBUGEN_T30987-sae");
        page.btnSave.click();
        MyCommonAPIs.sleepi(180);
