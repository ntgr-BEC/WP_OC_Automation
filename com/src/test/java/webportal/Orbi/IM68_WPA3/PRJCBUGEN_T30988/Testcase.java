package webportal.Orbi.IM68_WPA3.PRJCBUGEN_T30988;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30988") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the security type from WPA2-PSK to WPA3-Personal mixed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30988") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.editSsid(0);
        page.setSsidSecurity(1, "PRJCBUGEN_T30988-aes");
        page.btnSave.click();
    ...
    public void step3() {
        ...
        assertTrue(sGet.contains("WPA2-PSK"), "check WPA2-PSK is set");
//        boolean checkpoint;
...
//        assertTrue(checkpoint,"checkpoint 1 : AES is selected");
    ...
    public void step5() {
        ...
        DevicesOrbiWifiNetworkPage page = new DevicesOrbiWifiNetworkPage();
        page.editSsid(0);
        page.setSsidSecurity(5, "PRJCBUGEN_T30988-aes-sae");
        page.btnSave.click();
        MyCommonAPIs.sleepi(180);
