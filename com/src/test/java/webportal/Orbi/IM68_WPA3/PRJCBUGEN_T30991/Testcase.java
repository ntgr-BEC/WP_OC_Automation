package webportal.Orbi.IM68_WPA3.PRJCBUGEN_T30991;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30991") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the security type from WPA-PSK/WPA2-PSK to WPA3-Personal mixed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30991") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change SSID1 security to aes-tkip")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(0);
        page.setSsidSecurity(2, "PRJCBUGEN_T30991-aes-tkip");
        page.btnSave.click();
    ...
    public void step3() {
        ...
        assertTrue(sGet.contains("WPA-PSK/WPA2-PSK"), "check AES-TKIP is set");
//        boolean checkpoint;
...
//        assertTrue(checkpoint,"checkpoint 1 : AES-TKIP is selected");
    ...
    @Step("Test Step 5: Enter device page / Change SSID1 security to aes-sae")
    public void step5() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        DevicesOrbiWifiNetworkPage page = new DevicesOrbiWifiNetworkPage();
        page.editSsid(0);
        page.setSsidSecurity(5, "PRJCBUGEN_T30991-aes-sae");
        page.btnSave.click();
        MyCommonAPIs.sleepi(180);
    ...
    public void step6() {
        String sGet = new BRUtils(BRUtils.api_device_wlan_info, 1).getField("encryptionMode");
        assertTrue(sGet.contains("WPA2-PSK/WPA3-SAE"), "check WPA2-PSK/WPA3-SAE is set");
//        boolean checkpoint;
//        OrbiLoginPage orbiLoginPage = new OrbiLoginPage("admin", WebportalParam.loginPassword, WebportalParam.ob2IPaddress);
//        OrbiAllMenueElements BrAllMenueElements = new OrbiAllMenueElements();
//        OrbiBasicWirelessElements BasicWirelessElements = new OrbiBasicWirelessElements();
...
//        BasicWirelessElements.wireless1.click();
//        util.MyCommonAPIs.waitReady();
//        checkpoint = BasicWirelessElements.wireless1wpa2wpa3.isSelected();
//        assertTrue(checkpoint,"checkpoint 1 : AES-SAE is selected");
    }
