package webportal.Orbi.IM68_WPA3.PRJCBUGEN_T30992;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30992") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the security type from WPA-PSK/WPA2-PSK to WPA3-Enterprise") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30992") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.editSsid(0);
        page.setSsidSecurity(2, "PRJCBUGEN_T30992-aes-tkip");
        page.btnSave.click();
