package webportal.Orbi.IM68_WPA3.PRJCBUGEN_T30998;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T30998") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the security type from WPA2-Enterprise to WPA3-Enterprise") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30998") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change SSID1 security to open")
    public void step2() {
    ...
    public void step3() {
        ...
        assertTrue(sGet.contains("None"), "check Open is set");
//        boolean checkpoint;
...
//        util.MyCommonAPIs.waitReady();
//        checkpoint = BasicWirelessElements.wireless1securitynone.isSelected();
//        assertTrue(checkpoint,"checkpoint 1 : Open is selected");
    }
    ...
    @Step("Test Step 5: Enter device page / Change SSID1 security to wpa3 enterprise")
    public void step5() {
        boolean checkpoint;
        ddp.openOB2();
