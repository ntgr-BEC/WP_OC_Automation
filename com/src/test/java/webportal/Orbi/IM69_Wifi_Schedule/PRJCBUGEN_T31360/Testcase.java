package webportal.Orbi.IM69_Wifi_Schedule.PRJCBUGEN_T31360;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31360") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T31360") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        wifischedule.setScheduleName("PRJCBUGEN-T31360");
        ...
        wifischedule.deleteWifiSchedule("PRJCBUGEN-T31360");
        boolean result = wifischedule.checkWifiScheduleExists("PRJCBUGEN-T31360");
        assertFalse(result,"WiFi Schedule should not be listed after deleted by user");
