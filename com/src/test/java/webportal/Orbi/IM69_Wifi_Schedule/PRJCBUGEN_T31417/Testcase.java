package webportal.Orbi.IM69_Wifi_Schedule.PRJCBUGEN_T31417;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31417") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Start time and End time with greater and smaller numbers") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31417") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        wifischedule.setScheduleName("PRJCBUGEN-T31417");
        ...
        wifischedule.setDayHour("4", false, "09");
        ...
        wifischedule.setDayMinute("5", false, "45");
        wifischedule.setDayHour("5", false, "05");
        ...
        wifinetwork.selectWifiSchedule("PRJCBUGEN-T31417");
    ...
    public void step7() {
        ...
        MyCommonAPIs.sleepi(120);
        DevicesOrbiWifiSchedulePage wifischedule = new DevicesOrbiWifiSchedulePage();
        wifischedule.deleteWifiSchedule("PRJCBUGEN-T31417");
        ...
        assertTrue(thu_time.contains("10:45am-9:50pm"),"Thursday timeslot is wrong");
        assertTrue(fri_time.contains("7:00am-5:45pm"),"Friday timeslot is wrong");
    }
