package webportal.Orbi.ORBIPRO_SSID_Management.WIFI6SSIDVLAN.PRJCBUGEN_T23388;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23388") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that the CP functionality(Session TIME) works fine on the VLAN enabled SSID even after the lease TIME EXPIRY HAPPENS") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23388") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Set VLAN profile of guest wifi to VLAN 40, Set Expiration to 1 hour")
    public void step3() {
        wifiNetwork.ssidData.ssid = "T23388-" + RandomStringUtils.randomNumeric(5);
        wifiNetwork.ssidData.enableCP = true;
        wifiNetwork.ssidData.sessionTimeout = 1;
        ...
        assertTrue(new BRUtils().getFieldsOrbi("expiration").equals("1"), "check sessionTimeout changed to 1");
    }
}
