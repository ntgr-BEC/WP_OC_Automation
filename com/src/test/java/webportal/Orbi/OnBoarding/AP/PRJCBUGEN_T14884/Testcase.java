package webportal.Orbi.OnBoarding.AP.PRJCBUGEN_T14884;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14884") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify day 0 factory default Orbi router can be onboarded using the Serial # to AP mode") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14884") // It's a testcase id/link from Jira Test Case.
