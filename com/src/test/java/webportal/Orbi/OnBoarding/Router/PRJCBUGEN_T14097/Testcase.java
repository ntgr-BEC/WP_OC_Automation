package webportal.Orbi.OnBoarding.Router.PRJCBUGEN_T14097;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14097") // 对应testrunkey
    @Description("Verify day 0 factory default Orbi router can be onboarded and list all SSID") // 对应用例名字
    @TmsLink("PRJCBUGEN-T14097") // 对应用例详情页的URL最后几位数字
...
//            MyCommonAPIs.sleepi(200);
    ...
    public void step6() {
        ...
        new DevicesDashPage(false).gotoPage();
        MyCommonAPIs.sleepi(150); // avoid traffic block for production server
        new DevicesDashPage().enterDevice(WebportalParam.ob2serialNo);
...
//        new OrbiLoginPage(DevicesOrbiSetupWizardPage.device_setup_router_Info.get("Device_Mode"));
    }
