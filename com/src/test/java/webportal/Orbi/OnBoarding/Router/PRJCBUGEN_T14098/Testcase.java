package webportal.Orbi.OnBoarding.Router.PRJCBUGEN_T14098;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14098") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify day one Orbi router can be onboarded using the Serial #") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14098") // It's a testcase id/link from Jira Test Case.
