package webportal.Orbi.OnBoarding.Router.PRJCBUGEN_T14102;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14102") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify admin user can onboard the day one orbi router") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14102") // It's a testcase id/link from Jira Test Case.
