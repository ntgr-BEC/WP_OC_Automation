package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25483;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25483") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify editing the wifi networks name and save and validate the same should take effect") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25483") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.editSsid(1);
        page.inputSSIDName.setValue(WebportalParam.ob2WifiNetworkName1 + "-change");
        page.btnSave.click();
        MyCommonAPIs.sleepi(180);
        page.gotoPage();
        page.editSsid(1);
        assertTrue(page.inputSSIDName.getValue().equals(WebportalParam.ob2WifiNetworkName1 + "-change"), "Check SSID name changed");
    }
