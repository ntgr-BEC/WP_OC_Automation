package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25484;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25484") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify editing the wifi networks passphrase and save and validate the same should take effect") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25484") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.editSsid(1);
        page.securitySelect.selectOption(1);
        page.SSIDPwd.setValue("newpassword");
        page.btnSave.click();
        MyCommonAPIs.sleepi(180);
        page.gotoPage();
        page.editSsid(1);
        assertTrue(page.SSIDPwd.getValue().equals("newpassword"), "Check password changed");
    }
