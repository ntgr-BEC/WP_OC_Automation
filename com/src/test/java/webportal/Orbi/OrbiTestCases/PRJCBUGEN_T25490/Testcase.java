package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25490;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25490") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the device mode from the device dashboard")
    @TmsLink("PRJCBUGEN-T25490") // It's a testcase id/link from Jira Test Case.
