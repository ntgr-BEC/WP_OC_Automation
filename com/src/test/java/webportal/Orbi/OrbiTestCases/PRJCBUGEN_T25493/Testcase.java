package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25493;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25493") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the remove device functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25493") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Login IM WP success, add devcie if not exist.")
    public void step1() {
    ...
    @Step("Test Step 2: Delete the device")
    public void step2() {
        ...
        assertTrue(new DevicesDashPage().getDeviceName(WebportalParam.ob2serialNo).equals(""), "Check the device is deleted");
    }
