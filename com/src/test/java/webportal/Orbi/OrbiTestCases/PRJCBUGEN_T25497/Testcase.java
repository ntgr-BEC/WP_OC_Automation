package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25497;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25497") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the dashboard data should be refreshed accurately") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25497") // It's a testcase id/link from Jira Test Case.
    ...
    public void step5() {
        ...
        assertTrue(new DevicesDashPage().getDeviceModel(WebportalParam.ob2serialNo).equals(WebportalParam.ob2Model), "Model is correct");
        assertTrue(new DevicesDashPage().getDeviceName(WebportalParam.ob2serialNo).equals(WebportalParam.ob2deveiceName), "Name is correct");
    }
