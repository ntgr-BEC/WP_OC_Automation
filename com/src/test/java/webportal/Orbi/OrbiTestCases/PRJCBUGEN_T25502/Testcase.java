package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25502;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25502") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the scheduled firmware upgrade functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25502") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Click fw upgrade / Set schedule firmware upgrade / Check if the fw is upgraded")
    public void step3() {
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);
        webportalLoginPage.defaultLogin();
        ...
        page.setScheduleUpdate(1, 0,1,0);
        MyCommonAPIs.sleepi(500);
