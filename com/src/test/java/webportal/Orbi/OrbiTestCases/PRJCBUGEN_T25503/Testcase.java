package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25503;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25503") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the device onboarding via serial number") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25503") // It's a testcase id/link from Jira Test Case.
