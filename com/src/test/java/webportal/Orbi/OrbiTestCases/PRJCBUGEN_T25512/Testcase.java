package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25512;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25512") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the pending setup flow gets completed successfully") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25512") // It's a testcase id/link from Jira Test Case.
