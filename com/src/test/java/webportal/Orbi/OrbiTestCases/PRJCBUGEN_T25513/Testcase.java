package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25513;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25513") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the mode while completing day 0 onboarding") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25513") // It's a testcase id/link from Jira Test Case.
