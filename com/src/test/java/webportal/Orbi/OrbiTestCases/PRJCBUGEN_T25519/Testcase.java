package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25519;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25519") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the topology page and to verify its all types of views") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25519") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to topology page / Select tree view and check elements")
    public void step2() {
    ...
    @Step("Test Step 3: Go to topology page / Select abstract view and check elements")
    public void step3() {
        boolean router = false, client = false, isp = false;
        TopologyPage page = new TopologyPage();
        page.gotoPage();
    ...
    @Step("Test Step 4: Go to topology page / Select ssid view and check elements")
    public void step4() {
        boolean router = false, isp = false;
        TopologyPage page = new TopologyPage();
        page.gotoPage();
        page.arrow.click();
        MyCommonAPIs.waitReady();
