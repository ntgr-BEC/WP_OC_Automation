package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25520;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25520") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the device mode from router to AP from the device mode page")
    @TmsLink("PRJCBUGEN-T25520") // It's a testcase id/link from Jira Test Case.
