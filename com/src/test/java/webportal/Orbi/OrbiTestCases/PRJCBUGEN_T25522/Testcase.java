package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25522;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25522") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify enabling and saving content filtering from the content filtering tab")
    @TmsLink("PRJCBUGEN-T25522") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        try {
            ...
            System.out.println("failed to restore CF");
        }
    }
    ...
    @Step("Test Step 2: Open Content Filtering / Enable and save")
    public void step2() {
        
        DevicesOrbiContentFilteringPage contentpage = new DevicesOrbiContentFilteringPage();
        // if enabled, restore to disabled first
    ...
    public void step3() {
        ...
        assertTrue(page.inputEnableCF.isSelected(), "Check if CF is enabled");
    }
}
