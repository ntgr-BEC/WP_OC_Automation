package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25524;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25524") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the wired connected clients on the connected clients page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25524") // It's a testcase id/link from Jira Test Case.
