package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25526;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25526") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the wireless connected clients on the connected clients page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25526") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.editSsid(0);
        page.setSsidName("PRJCBUGEN-T25526");
        page.setSsidSecurity(1, "12345678");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
        boolean checkpoint = true;
        String cmd = String.format("WAFconnect %s %s WPA2PSK aes", "PRJCBUGEN-T25526", "12345678");
        if (!new Javasocket()
