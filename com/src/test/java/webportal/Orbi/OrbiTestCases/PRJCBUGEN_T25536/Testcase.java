package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25536;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25536") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the satellite connected/disconnected on the satellite page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25536") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Goto satellite page and check connected status / Get satellite ip / Logout insight / Reboot satellite")
    public void step2() {
    ...
    @Step("Test Step 3: Login insight and check satellite status")
    public void step3() {
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);
        webportalLoginPage.defaultLogin();
