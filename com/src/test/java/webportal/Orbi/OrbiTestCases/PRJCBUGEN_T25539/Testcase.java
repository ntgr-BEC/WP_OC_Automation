package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25539;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25539") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify enabling the SDM and save on the diagnostic mode page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25539") // It's a testcase id/link from Jira Test Case.
