package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25540;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25540") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify disabling the SDM and save on the diagnostic mode page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25540") // It's a testcase id/link from Jira Test Case.
