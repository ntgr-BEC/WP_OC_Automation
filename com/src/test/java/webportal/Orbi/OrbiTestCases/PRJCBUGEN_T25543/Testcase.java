package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25543;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25543") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the ping test functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25543") // It's a testcase id/link from Jira Test Case.
