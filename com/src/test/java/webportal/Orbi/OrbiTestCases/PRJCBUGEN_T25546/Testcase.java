package webportal.Orbi.OrbiTestCases.PRJCBUGEN_T25546;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25546") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the traceroute functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25546") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Goto troubleshoot page")
    public void step2() {
        DevicesOrbiTroubleshootPage page = new DevicesOrbiTroubleshootPage();
        assertTrue(page.Traceroute("8.8.8.8"), "Check if traceroute success");
    }
