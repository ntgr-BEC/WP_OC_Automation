package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26602;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26602") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the device onboarding via serial number") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26602") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Login IM WP success / Change to ap mode / delete devcie")
    public void step1() {
        ...
        ddp.gotoPage();
        ddp.deleteDeviceYes(WebportalParam.ob2serialNo);
