package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26617;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26617") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify device rename from device dashboard") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26617") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Login to WP / Go to Location 1 / Go to Devices dash page / Enter device and change to ap mode")
    public void step1() {
    ...
    @Step("Test Step 2: Edit device name and check if it is applied")
    public void step2() {
        boolean checkpoint;
