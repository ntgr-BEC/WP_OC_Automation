package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26629;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26629") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID name of the admin type SSID and save") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26629") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change to ap mode / Change ssid name of wifi1")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(0);
        page.setSsidName("PRJCBUGEN-T26629");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
    ...
    @Step("Test Step 3: Go to device local GUI / Check ssid name of wifi1")
    public void step3() {
        boolean checkpoint;
        ...
        util.MyCommonAPIs.waitReady();
        checkpoint = BasicWirelessElements.wireless1ssidname.getValue().equals("PRJCBUGEN-T26629");
        assertTrue(checkpoint,"checkpoint 1 : ssid name of wifi1 is changed");
    }
