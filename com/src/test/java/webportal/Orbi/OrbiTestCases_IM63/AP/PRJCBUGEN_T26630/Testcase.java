package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26630;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26630") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID password of  the admin type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26630") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change to ap mode / Change SSID1 password")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(0);
        page.setSsidSecurity(2, "PRJCBUGEN-T26630");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
    ...
    public void step3() {
        ...
        util.MyCommonAPIs.waitReady();
        checkpoint = BasicWirelessElements.wireless1password.getValue().equals("PRJCBUGEN-T26630");
        assertTrue(checkpoint,"checkpoint 1 : password of wifi1 is changed");
    }
