package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26631;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26631") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the security type of the admin type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26631") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change to ap mode / Change SSID1 security to aes")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
