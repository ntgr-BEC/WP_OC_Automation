package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26635;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26635") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID name of the employee  type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26635") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change to ap mode / Change ssid name of wifi2")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(1);
        page.setSsidName("PRJCBUGEN-T26635");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
    ...
    @Step("Test Step 3: Go to device local GUI / Check ssid name of wifi2")
    public void step3() {
        boolean checkpoint;
        ...
        util.MyCommonAPIs.waitReady();
        checkpoint = BasicWirelessElements.wireless2ssidname.getValue().equals("PRJCBUGEN-T26635");
        assertTrue(checkpoint,"checkpoint 1 : ssid name of wifi2 is changed");
    }
