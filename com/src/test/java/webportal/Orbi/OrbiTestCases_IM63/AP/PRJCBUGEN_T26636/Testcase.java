package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26636;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26636") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID password of the employee type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26636") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change to ap mode / Change SSID2 password")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(1);
        page.setSsidSecurity(2, "PRJCBUGEN-T26636");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
    ...
    @Step("Test Step 3: Go to device local GUI / Check password of wifi2")
    public void step3() {
        String sGet = new BRUtils(BRUtils.api_device_guest_wlan_info, 4).getField("key");
        assertTrue(sGet.contains("PRJCBUGEN-T26636"), "check key is set");
//        boolean checkpoint;
...
//        util.MyCommonAPIs.waitReady();
//        checkpoint = BasicWirelessElements.wireless2password.getValue().equals("PRJCBUGEN-T26636");
//        assertTrue(checkpoint,"checkpoint 1 : password of wifi2 is changed");
    }
