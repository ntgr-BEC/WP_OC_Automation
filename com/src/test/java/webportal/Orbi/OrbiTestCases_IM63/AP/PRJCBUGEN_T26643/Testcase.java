package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26643;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26643") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID password of the IoT  type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26643") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change to ap mode / Change SSID3 password")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(2);
        page.setSsidSecurity(2, "PRJCBUGEN-T26643");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
    ...
    @Step("Test Step 3: Go to device local GUI / Check password of wifi3")
    public void step3() {
        String sGet = new BRUtils(BRUtils.api_device_iot_wlan_info, 4).getField("key");
        assertTrue(sGet.contains("PRJCBUGEN-T26643"), "check key is set");
//        boolean checkpoint;
...
//        util.MyCommonAPIs.waitReady();
//        checkpoint = BasicWirelessElements.wireless3password.getValue().equals("PRJCBUGEN-T26643");
//        assertTrue(checkpoint,"checkpoint 1 : password of wifi3 is changed");
    }
