package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26644;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26644") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the security type of the IoT  SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26644") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change to ap mode / Change SSID3 security to aes")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
    ...
    @Step("Test Step 3: Go to device local GUI / Check wifi3 security")
    public void step3() {
        boolean checkpoint;
        ...
        util.MyCommonAPIs.waitReady();
        checkpoint = BasicWirelessElements.wireless3wpa2aes.isSelected();
    ...
    @Step("Test Step 5: Enter device page / Change SSID3 security to aes-tkip")
    public void step5() {
        boolean checkpoint;
        ddp.openOB2();
    ...
    @Step("Test Step 6: Go to device local GUI / Check wifi3 security")
    public void step6() {
        boolean checkpoint;
        OrbiLoginPage orbiLoginPage = new OrbiLoginPage("admin", WebportalParam.loginPassword, WebportalParam.ob1IPaddress);
        OrbiAllMenueElements BrAllMenueElements = new OrbiAllMenueElements();
        ...
        BasicWirelessElements.wireless3.click();
        util.MyCommonAPIs.waitReady();
        checkpoint = BasicWirelessElements.wireless3tkipandaes.isSelected();
