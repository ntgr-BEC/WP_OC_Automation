package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26666;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26666") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the device mode from AP mode to router mode from the drop down on the device mode tab on the orbi device dashboard")
    @TmsLink("PRJCBUGEN-T26666") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() { // change to ap mode
        ddp.gotoPage();
        ddp.openOB2();
    ...
    @Step("Test Step 3: Change to router mode")
    public void step3() {
        DevicesOrbiDeviceModePage page = new DevicesOrbiDeviceModePage();
