package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26677;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26677") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify disable the secure diagnostic mode functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26677") // It's a testcase id/link from Jira Test Case.
