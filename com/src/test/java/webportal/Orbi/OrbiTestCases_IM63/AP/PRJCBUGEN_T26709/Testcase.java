package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26709;
...
public class Testcase extends TestCaseBase {
    ...
    public String baseip = WebportalParam.ob1IPaddress;
    public String satelliteip = "192.168.100.3";
    ...
    @Story("PRJCBUGEN_T26709") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the auto upgrade functionality of both router and satellite") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26709") // It's a testcase id/link from Jira Test Case.

    @Test(alwaysRun = true, groups = "p100") // Use p1/p2/p3 to high/normal/low on priority
    ...
    public void step1() {
        ...
        MyCommonAPIs.sleepi(120); // wait satellite information update
