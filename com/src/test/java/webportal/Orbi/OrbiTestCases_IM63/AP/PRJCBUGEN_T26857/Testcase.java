package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T26857;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26857") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify delete all notifications") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26857") // It's a testcase id/link from Jira Test Case.
