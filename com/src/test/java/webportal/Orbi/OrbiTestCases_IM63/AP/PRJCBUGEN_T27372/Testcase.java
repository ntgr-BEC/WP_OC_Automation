package webportal.Orbi.OrbiTestCases_IM63.AP.PRJCBUGEN_T27372;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27372") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the firmware upgrade of both the router and the satellite in day-1 mode") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27372") // It's a testcase id/link from Jira Test Case.
