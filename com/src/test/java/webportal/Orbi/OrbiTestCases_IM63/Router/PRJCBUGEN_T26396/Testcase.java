package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26396;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26396") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the mode while completing day 0 onboarding") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26396") // It's a testcase id/link from Jira Test Case.
