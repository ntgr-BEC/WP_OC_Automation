package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26398;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26398") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID passphrase while completing the day 0 onboarding") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26398") // It's a testcase id/link from Jira Test Case.
    ...
    public final static Map<String, String> device_setup_router_Info_pw = new HashMap<String, String>() {
        /**
         * 
         */
...

        {
            ...
            put("WifiNetworkName", WebportalParam.ob2Model);
    ...
    public void step6() {
        ...
        setupWizardPage.SetupOrbiDayODevice(device_setup_router_Info_pw);
        ...
        assertTrue(ret[0].equals(WebportalParam.ob2Model), "check ssid name not changed");
        assertTrue(ret[1].equals(WebportalParam.ob2WifiNetworkPwd1 + "-new"), "check password changed");
    }
