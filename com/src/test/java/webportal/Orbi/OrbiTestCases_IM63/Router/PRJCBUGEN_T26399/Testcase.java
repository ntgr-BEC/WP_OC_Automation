package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26399;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26399") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the pending setup pop should not prompt more than once while completing day 0 flow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26399") // It's a testcase id/link from Jira Test Case.
