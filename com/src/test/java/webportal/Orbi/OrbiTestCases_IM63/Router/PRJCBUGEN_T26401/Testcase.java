package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26401;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26401") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, while on-boarding, rename device, change mode, config ssid and password and no failed comments received") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26401") // It's a testcase id/link from Jira Test Case.
    ...
    public final static Map<String, String> device_setup_router_Info_ssid_pw = new HashMap<String, String>() {
        /**
         * 
         */
...

        {
            ...
            put("WifiNetworkPwd", WebportalParam.ob2WifiNetworkPwd1 + "-newpw");
    ...
    @Step("Test Step 4: Add device in the location;")
    public void step4() {
        Map<String, String> devInfo = new HashMap<String, String>();
        devInfo.put("Serial Number", WebportalParam.ob2serialNo);
        devInfo.put("Device Name", WebportalParam.ob2Name);
    ...
    public void step6() {
        ...
        setupWizardPage.SetupOrbiDayODevice(device_setup_router_Info_ssid_pw);
        ...
        assertTrue(ret[1].equals(WebportalParam.ob2WifiNetworkPwd1 + "-newpw"), "check password changed");
    }
