package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26405;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26405") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify device rename from device dashboard") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26405") // It's a testcase id/link from Jira Test Case.
