package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26415;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26415") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the disconnected clients details such as MAC address, IP address, SSID etc") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26415") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.editSsid(0);
        page.setSsidName("PRJCBUGEN-T26415");
        page.setSsidSecurity(1, "12345678");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
        
        boolean checkpoint = true;
        String cmd = String.format("WAFconnect %s %s WPA2PSK aes", "PRJCBUGEN-T26415", "12345678");
        if (!new Javasocket()
    ...
    @Step("Test Step 3: Disable DUT LAN interface and disconnect the wireless client")
    public void step3() {
    ...
    @Step("Test Step 4: Check wired disconnected device")
    public void step4() {
    ...
    @Step("Test Step 5: Check wireless disconnected device")
    public void step5() {
        new DevicesDashPage().enterDevice(WebportalParam.ob2serialNo);
        DevicesOrbiConnectedClientsPage page = new DevicesOrbiConnectedClientsPage();
        ...
        assertTrue(page.getSSID(WebportalParam.client2name, false).equals("PRJCBUGEN-T26414"), "Check wireless client's SSID");
        assertTrue(page.getMAC(WebportalParam.client2name, false).equals(WebportalParam.client2wifimac), "Check wireless client's mac");
    }
