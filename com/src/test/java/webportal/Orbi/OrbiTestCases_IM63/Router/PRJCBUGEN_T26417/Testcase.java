package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26417;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26417") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T26417") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change ssid name of wifi1")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(0);
        page.setSsidName("PRJCBUGEN-T26417");
        page.btnSave.click();
    ...
    public void step3() {
        ...
        util.MyCommonAPIs.waitReady();
        checkpoint = BasicWirelessElements.wireless1ssidname.getValue().equals("PRJCBUGEN-T26417");
