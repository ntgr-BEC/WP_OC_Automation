package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26422;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26422") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the VLAN profile functionality for the admin type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26422") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        System.out.println("Restore SSID1 vlan to disabled");
        try {
            ...
            System.out.println("Failed to restore SSID1 vlan to default");
        }
    }
    ...
    @Step("Test Step 2: Enter device page / Change SSID1 vlan")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        DevicesOrbiWifiNetworkPage page = new DevicesOrbiWifiNetworkPage();
        page.editSsid(0);
        page.setSsidName("PRJCBUGEN-T26422");
    ...
    @Step("Test Step 3: Go to device local GUI / Check password of wifi1")
    public void step3() {
        String sGet = new BRUtils(BRUtils.api_device_wlan_info, 1).getField("vlanProfile");
        assertTrue(sGet.contains("20"), "check vlanProfile is set");
//        boolean checkpoint = true;
//        String cmd = String.format("WAFconnect %s %s WPA2PSK aes", "PRJCBUGEN-T26422", "12345678");
