package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26423;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26423") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID name of the employee  type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26423") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change ssid name of wifi2")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(1);
        page.setSsidName("PRJCBUGEN-T26423");
        page.btnSave.click();
    ...
    public void step3() {
        ...
        util.MyCommonAPIs.waitReady();
        checkpoint = BasicWirelessElements.wireless2ssidname.getValue().equals("PRJCBUGEN-T26423");
