package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26424;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26424") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T26424") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change SSID2 password")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(1);
        page.setSsidSecurity(2, "PRJCBUGEN-T26424");
        page.btnSave.click();
    ...
    public void step3() {
        String sGet = new BRUtils(BRUtils.api_device_guest_wlan_info, 1).getField("key");
        assertTrue(sGet.contains("PRJCBUGEN-T26424"), "check key is set");
//        boolean checkpoint;
...
//        util.MyCommonAPIs.waitReady();
//        checkpoint = BasicWirelessElements.wireless2password.getValue().equals("PRJCBUGEN-T26424");
