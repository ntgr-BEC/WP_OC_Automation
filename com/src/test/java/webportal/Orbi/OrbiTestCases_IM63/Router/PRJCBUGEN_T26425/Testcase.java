package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26425;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26425") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T26425") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change SSID2 security to aes")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
