package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26431;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26431") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID password of the IoT  type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26431") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change SSID3 password")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.editSsid(2);
        page.setSsidSecurity(2, "PRJCBUGEN-T26431");
        page.btnSave.click();
    ...
    public void step3() {
        String sGet = new BRUtils(BRUtils.api_device_iot_wlan_info, 1).getField("key");
        assertTrue(sGet.contains("PRJCBUGEN-T26431"), "check password is set");
//        boolean checkpoint;
...
//        util.MyCommonAPIs.waitReady();
//        checkpoint = BasicWirelessElements.wireless3password.getValue().equals("PRJCBUGEN-T26431");
