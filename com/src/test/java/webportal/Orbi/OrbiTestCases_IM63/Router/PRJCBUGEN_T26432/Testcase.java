package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26432;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26432") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the security type of the guest type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26432") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change SSID4 authentication to none")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
    ...
    public void step5() {
        ...
        page.SSIDPwd.setValue("PRJCBUGEN-T26432");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
    ...
    public void step6() {
        ...
        checkpoint = BasicGuestPortalElements.authenticationpassword.getValue().equals("PRJCBUGEN-T26432");
