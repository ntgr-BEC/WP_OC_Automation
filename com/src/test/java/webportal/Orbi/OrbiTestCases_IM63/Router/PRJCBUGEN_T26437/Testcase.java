package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26437;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26437") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID name of the Guest  type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26437") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Change SSID4 ssid name")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
        ...
        page.SSIDPwd.setValue("PRJCBUGEN-T26437");
    ...
    public void step3() {
        ...
        checkpoint = BasicGuestPortalElements.authenticationpassword.getValue().equals("PRJCBUGEN-T26437");
