package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26438;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26438") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the SSID password of the Guest  type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26438") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Check 4 SSIDs / Change SSID4 with password default vlan")
    public void step2() {
        ...
        page.SSIDPwd.setValue("PRJCBUGEN-T26438");
    ...
    public void step3() {
        ...
        assertTrue(sGet.contains("PRJCBUGEN-T26438"), "check authPassword is set");
...
//        
//        checkpoint = BasicGuestPortalElements.authenticationpassword.getValue().equals("PRJCBUGEN-T26438");
