package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26442;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26442") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the VLAN profile functionality for the Guest type SSID") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26442") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Check 4 SSIDs / Enable SSID4 with vlan")
    public void step2() {
    ...
    @Step("Test Step 3: Go to device local GUI / Check SSID4 vlan enabled")
    public void step3() {
        String sGet = new BRUtils(BRUtils.api_device_guest_portal_wlan_info, 1).getField("vlanProfile");
