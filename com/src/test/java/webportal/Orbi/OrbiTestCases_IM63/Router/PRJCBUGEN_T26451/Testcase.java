package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26451;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26451") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify changing the static WAN IP to DHCP WAN IP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26451") // It's a testcase id/link from Jira Test Case.
