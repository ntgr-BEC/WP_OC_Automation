package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26470;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26470") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the DNS look up test for orbi device")
    @TmsLink("PRJCBUGEN-T26470") // It's a testcase id/link from Jira Test Case.
