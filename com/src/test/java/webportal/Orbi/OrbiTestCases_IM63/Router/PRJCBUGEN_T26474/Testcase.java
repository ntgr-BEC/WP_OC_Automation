package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26474;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26474") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify enable the secure diagnostic mode functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26474") // It's a testcase id/link from Jira Test Case.
