package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26475;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26475") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify disable the secure diagnostic mode functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26475") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        new DevicesDashPage().enterDevice(WebportalParam.ob2serialNo);
        page.gotoPage();
        assertTrue(!page.portNumbebr.isDisplayed(), "The port number is not displayed");
        assertTrue(!page.inputEnableDiagMod.isSelected(), "The checkbox is not selected");
    }
