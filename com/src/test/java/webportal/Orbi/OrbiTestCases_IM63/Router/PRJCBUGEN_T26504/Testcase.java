package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26504;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26504") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the connected and the disconnected clients should be listed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26504") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.editSsid(0);
        page.setSsidName("PRJCBUGEN-T26504");
        page.setSsidSecurity(1, "12345678");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
        
        boolean checkpoint = true;
        String cmd = String.format("WAFconnect %s %s WPA2PSK aes", "PRJCBUGEN-T26504", "12345678");
        if (!new Javasocket()
    ...
    public void step3() {
        ...
        assertTrue(page.getSSID(WebportalParam.client2name, true).equals("PRJCBUGEN-T26504"), "Check wireless client's SSID");
    ...
    public void step5() {
        ...
        assertTrue(page.getSSID(WebportalParam.client2name, false).equals("PRJCBUGEN-T26504"), "Check wireless client's SSID");
