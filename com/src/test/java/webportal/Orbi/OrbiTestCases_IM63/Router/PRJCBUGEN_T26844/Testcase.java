package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T26844;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26844") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify delete individual notification") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26844") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Detelte one notification")
    public void step3() {
        EventPage page = new EventPage();
        page.gotoPage();
        // get first event information
        String oldeventcontent = page.getnotificationcontent(1);
        // delete first event information
        page.deleteOneEvent2(0);
        // get the first event information, should not be the original one
        String neweventcontent = page.getnotificationcontent(1);
        assertTrue(!neweventcontent.equals(oldeventcontent), "The first event is not deleted");
    }
