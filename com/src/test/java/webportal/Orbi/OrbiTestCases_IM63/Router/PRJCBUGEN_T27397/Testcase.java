package webportal.Orbi.OrbiTestCases_IM63.Router.PRJCBUGEN_T27397;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27397") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("CFD-CESMB-2155-Insight App shows all devices are connected to the router") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27397") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        page.editSsid(0);
        page.setSsidName("PRJCBUGEN-T27397");
        page.setSsidSecurity(1, "12345678");
        page.btnSave.click();
        MyCommonAPIs.sleepsyncorbi();
        boolean checkpoint = true;
        String cmd = String.format("WAFconnect %s %s WPA2PSK aes", "PRJCBUGEN-T27397", "12345678");
        if (!new Javasocket()
    ...
    public void step4() {
        ...
        assertTrue(page.getSSID(WebportalParam.client2name, true).equals("PRJCBUGEN-T27397"), "Check wireless client's SSID");
