package webportal.Orbi.SSID_WAN.Banners.PRJCBUGEN_T27172;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27172") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether user get redirects to the Routers --> Setting page when user clicks on the \"Add Router to Business VPN\" button in Business VPN related Banner") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27172") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.VPNLearnMore.click();
        checkpoint = page.insightservices.exists();
        assertTrue(checkpoint,"checkpoint 1-3 : Link to insight services exists");
        page.btnModalAddRouter.click();
        String currentUrl = util.MyCommonAPIs.getCurrentUrl();
        checkpoint = currentUrl.contains("#/routers/settings/businessVPN");
        assertTrue(checkpoint,"checkpoint 1-4 : Add router button redirects to Business VPN page");
    }
    ...
    public void step3() {
        ...
        page.VPNLearnMore.click();
        checkpoint = page.insightservices.exists();
        assertTrue(checkpoint,"checkpoint 2-3 : Link to insight services exists");
        page.btnModalAddRouter.click();
        String currentUrl = util.MyCommonAPIs.getCurrentUrl();
        checkpoint = currentUrl.contains("#/routers/settings/businessVPN");
        assertTrue(checkpoint,"checkpoint 2-4 : Add router button redirects to Business VPN page");
    }
    ...
    public void step5() {
        ...
        page.VPNLearnMore.click();
        checkpoint = page.insightservices.exists();
        assertTrue(checkpoint,"checkpoint 3-3 : Link to insight services exists");
        page.btnModalAddRouter.click();
        String currentUrl = util.MyCommonAPIs.getCurrentUrl();
        checkpoint = currentUrl.contains("#/routers/settings/businessVPN");
        assertTrue(checkpoint,"checkpoint 3-4 : Add router button redirects to Business VPN page");
    }
    ...
    public void step6() {
        ...
        page.VPNLearnMore.click();
        checkpoint = page.insightservices.exists();
        assertTrue(checkpoint,"checkpoint 4-3 : Link to insight services exists");
        page.btnModalAddRouter.click();
        String currentUrl = util.MyCommonAPIs.getCurrentUrl();
        checkpoint = currentUrl.contains("#/routers/settings/businessVPN");
        assertTrue(checkpoint,"checkpoint 4-4 : Add router button redirects to Business VPN page");
    }
