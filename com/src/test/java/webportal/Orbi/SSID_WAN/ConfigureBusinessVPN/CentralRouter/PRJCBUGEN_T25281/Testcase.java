package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.CentralRouter.PRJCBUGEN_T25281;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25281") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether user are redirected to the newly created Business VPN group on clicking \"View My Business Group\"") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25281") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true,"PRJCBUGEN-T25281",1,"12345678");
        page.clickNext();
