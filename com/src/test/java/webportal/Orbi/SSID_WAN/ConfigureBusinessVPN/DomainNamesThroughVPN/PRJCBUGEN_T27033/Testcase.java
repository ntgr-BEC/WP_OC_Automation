package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.DomainNamesThroughVPN.PRJCBUGEN_T27033;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27033") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify whether on edit / delete of domain name the latest configuration pushed to the router") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27033") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true,"PRJCBUGEN-T27033",1,"12345678");
        page.clickNext();
        ...
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27033", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
        
        page.clickEditVPNGroup("TestGroup");
        page.setPage1VPNGroupInfo("TestGroup", "TestDescription", "1400", true, "arlo2.com");
        page.clickNext();
        page.clickNext();
        page.clickNext(); // save
        util.MyCommonAPIs.waitReady();
    ...
    public void step4() {
        ...
        checkpoint = output.contains("arlo2.com");
