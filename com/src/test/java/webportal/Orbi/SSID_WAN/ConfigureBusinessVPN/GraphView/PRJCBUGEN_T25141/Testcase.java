package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.GraphView.PRJCBUGEN_T25141;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25141") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether we are able to add new business VPN group from graph view page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25141") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to Routers page / User is able to add a VPN group")
    public void step2() {
