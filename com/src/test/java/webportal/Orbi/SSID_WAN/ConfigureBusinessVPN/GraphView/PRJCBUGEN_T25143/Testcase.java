package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.GraphView.PRJCBUGEN_T25143;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25143") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether all the connected remote routers are listed in graph view page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25143") // It's a testcase id/link from Jira Test Case.
