package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.GraphView.PRJCBUGEN_T25146;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25146") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether we are able to edit Business VPN group from Graph view page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25146") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        cirbtnAddRouter.click();
        util.MyCommonAPIs.waitReady();
        util.MyCommonAPIs.sleepi(5);
        page.clickBack(); // goto page1
        page.setPage1VPNGroupInfo("NewTestGroup","NewTestDescription","1000");
        page.clickNext(); // goto page3
        page.setPage3WirelessSettings(true,"SSID-WAN-Auto-Test-New",2,"87654321");
        page.clickNext();
