package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.GraphView.PRJCBUGEN_T25910;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25910") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check in Business VPN graph view page when device is in Cloud connected state we see Green Steady circle around the Orbi device") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25910") // It's a testcase id/link from Jira Test Case.
