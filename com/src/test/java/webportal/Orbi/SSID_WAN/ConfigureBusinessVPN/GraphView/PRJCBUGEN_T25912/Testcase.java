package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.GraphView.PRJCBUGEN_T25912;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25912") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether in Business VPN graph view page when the Link between Central and remote router comes UP we see Orange colour steady line") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25912") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true,"PRJCBUGEN-T25912",1,"12345678");
        page.clickNext();
        ...
        // try reload page to check link status change to link up (within 15 mins)
        checkpoint = false;
        for (int i=0; i< 15; i++) {
