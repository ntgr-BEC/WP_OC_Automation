package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RemoteRouter.PRJCBUGEN_T25287;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25287") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether the user able to select the router mode") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25287") // It's a testcase id/link from Jira Test Case.
