package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RemoteRouter.PRJCBUGEN_T25290;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25290") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether we are able to change the router mode from Home office to Branch office mode with the Edit option.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25290") // It's a testcase id/link from Jira Test Case.
