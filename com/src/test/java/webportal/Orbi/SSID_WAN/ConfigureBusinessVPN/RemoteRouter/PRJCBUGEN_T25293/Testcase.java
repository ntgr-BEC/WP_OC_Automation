package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RemoteRouter.PRJCBUGEN_T25293;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25293") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the behavior of branch office router") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25293") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to Routers page / User create a VPN group with router mode set as branch office.")
    public void step2() {
        boolean checkpoint;
        RoutersBusinessVPNPage page = new RoutersBusinessVPNPage();
        page.gotoPage();
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T25293", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T25293", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
    }
    ...
    public void step3() {
        ...
        for(int i=0;i<5;i++) {
            ...
            // connect to bssid
            checkpoint = true;
            cmd = String.format("WAFconnectBSSID PRJCBUGEN-T25293 12345678 WPA2PSK aes %s", WebportalParam.ob1SSIDWANbssid);
            if (!new Javasocket()
            ...
            checkpoint = true;
            cmd = String.format("WAFconnectBSSID PRJCBUGEN-T25293 12345678 WPA2PSK aes %s", WebportalParam.ob2SSIDWANbssid);
            if (!new Javasocket()
