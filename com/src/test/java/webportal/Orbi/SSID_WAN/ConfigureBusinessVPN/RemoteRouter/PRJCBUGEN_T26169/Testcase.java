package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RemoteRouter.PRJCBUGEN_T26169;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T26169") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the to add a remote router.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T26169") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to Routers page / User can add a remote router")
    public void step2() {
        boolean checkpoint;
