package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RemoteRouter.PRJCBUGEN_T27024;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27024") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, VPN Profile with ORBI 6 device and able to edit the IP address or subnet.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27024") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to Routers page / User can edit ip address and subnet for SXR as remote router")
    public void step2() {
        String central_loc = "";
        ...
        page.setPage2EditRemoteRouter(remote_router, "Default (1)", "172.16.2.1", "172.16.2.0/24");
        ...
        // user edit ip address and subnet for non-default vlan Iot (30) (change 3rd byte)
        page.setPage2EditRemoteRouter(remote_router, "Iot (30)", "172.16.31.1", "172.16.31.0/24");
        checkpoint = page.RouterExist(remote_loc, remote_router, "Employee Home", "172.16.31.1", "172.16.31.0/24");
