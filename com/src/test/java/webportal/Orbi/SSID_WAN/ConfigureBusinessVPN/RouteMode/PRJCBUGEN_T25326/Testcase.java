package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RouteMode.PRJCBUGEN_T25326;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25326") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T25326") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T25326", 1, "12345678");
        page.clickNext();
