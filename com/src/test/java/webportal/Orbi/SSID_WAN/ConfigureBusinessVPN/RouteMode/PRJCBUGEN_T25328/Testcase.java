package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RouteMode.PRJCBUGEN_T25328;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25328") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T25328") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.setPage2AddRemoteRouter(WebportalParam.location2, WebportalParam.ob2deveiceName, 1, false);
        MyCommonAPIs.sleepi(1);
        // click edit (change to Home office)
        page.setPage2EditRemoteRouter(WebportalParam.ob2deveiceName, true);
