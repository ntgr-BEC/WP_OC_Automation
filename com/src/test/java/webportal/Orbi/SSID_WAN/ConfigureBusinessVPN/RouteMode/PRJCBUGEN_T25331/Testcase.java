package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RouteMode.PRJCBUGEN_T25331;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25331") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the behavior of branch office router") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25331") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T25331", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(page.GroupExist("TestGroup", "PRJCBUGEN-T25331", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
    }
    ...
    public void step3() {
        ...
        for(int i=0;i<3;i++) {
            ...
            // connect to bssid
            checkpoint = true;
            cmd = String.format("WAFconnectBSSID PRJCBUGEN-T25331 12345678 WPA2PSK aes %s", WebportalParam.ob1SSIDWANbssid);
            if (!new Javasocket()
            ...
            checkpoint = true;
            cmd = String.format("WAFconnectBSSID PRJCBUGEN-T25331 12345678 WPA2PSK aes %s", WebportalParam.ob2SSIDWANbssid);
            if (!new Javasocket()
