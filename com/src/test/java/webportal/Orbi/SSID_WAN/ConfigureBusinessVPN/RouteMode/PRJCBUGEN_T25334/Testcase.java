package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.RouteMode.PRJCBUGEN_T25334;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25334") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether the user can set any password other than Location password for the remote router when added in VPN group as") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25334") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T25334", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T25334", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
    ...
    public void step3() {
        ...
        assertTrue(checkpoint, "checkpoint 1 : User can set password as the same with location password");
    }
