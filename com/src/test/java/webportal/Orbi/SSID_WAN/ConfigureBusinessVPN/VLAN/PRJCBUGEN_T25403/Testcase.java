package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.VLAN.PRJCBUGEN_T25403;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25403") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("VLAN option is shown only for SXK80 Orbi device while adding as an Remote router.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25403") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        checkpoint = page.GroupExist("VLANGroup", "Secure_VPN", central_router, "Healthy");
