package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.VLAN.PRJCBUGEN_T25404;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25404") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Management VLAN is displayed as Default in VLAN profile option.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25404") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.btnAddRemoteRouter.hover();// hover to move mouse
