package webportal.Orbi.SSID_WAN.ConfigureBusinessVPN.VPNGroup.PRJCBUGEN_T25938;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25938") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the Edit VPN group data.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25938") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        checkpoint = page.EditPage1VPNGroupInfo("NewGroup", "NewDescript", "1300", true, "google.com");;
        assertTrue(checkpoint,"checkpoint 1 : Modidy success.");
