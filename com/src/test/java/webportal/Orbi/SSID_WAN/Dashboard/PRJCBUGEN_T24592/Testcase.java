package webportal.Orbi.SSID_WAN.Dashboard.PRJCBUGEN_T24592;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24592") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify user able to create VPN Group") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24592") // It's a testcase id/link from Jira Test Case.
