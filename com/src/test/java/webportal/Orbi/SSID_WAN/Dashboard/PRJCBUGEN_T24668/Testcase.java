package webportal.Orbi.SSID_WAN.Dashboard.PRJCBUGEN_T24668;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24668") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether User able to view Business VPN table") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24668") // It's a testcase id/link from Jira Test Case.
