package webportal.Orbi.SSID_WAN.Dashboard.PRJCBUGEN_T24679;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24679") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Status that are shown under VPN Health") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24679") // It's a testcase id/link from Jira Test Case.
 ...
 // Each step covers the operation in one page
    ...
    public void step2() {
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "SSID-WAN-Auto-Test1", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
        page.gotoPage();
