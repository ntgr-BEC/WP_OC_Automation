package webportal.Orbi.SSID_WAN.SSID_WANTestcases.AccessControl.PRJCBUGEN_T25997;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25997") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether user able to create an MAC ACL deny rule") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25997") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to Routers page / User add one deny rule on remote router in access control page")
    public void step2() {
        boolean checkpoint;
        RoutersBusinessVPNPage page = new RoutersBusinessVPNPage();
        page.gotoPage();
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T25997", 1, "12345678");
        page.clickNext();
    ...
    public void step3() {
        ...
        for(int i=0;i<3;i++) {
            ...
            cmd = String.format("WAFconnectBSSID PRJCBUGEN-T25997 12345678 WPA2PSK aes %s", WebportalParam.ob2SSIDWANbssid);
            if (!new Javasocket()
