package webportal.Orbi.SSID_WAN.SSID_WANTestcases.VPNGroup.PRJCBUGEN_T24652;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24652") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether all created Business VPN get listed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24652") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.setPage4AccessControl("DESKTOP-7DSR4H7", "08:be:ac:12:ce:c9", 0, WebportalParam.ob1deveiceName);
        ...
        page.clickNext();
        page.cirbtnAdd.click();
        page.setPage4AccessControl("DESKTOP-7DSR4H9", "08:be:ac:12:ce:c1", 0, WebportalParam.ob2deveiceName);
        page.clickNext(); //click next (actual is save btn)
        page.successicon.waitUntil(Condition.appear, 30000, 3000);
        page.btnViewVPNGroup.click();
        util.MyCommonAPIs.waitReady();
        ...
        checkpoint = page.GroupExist("TestGroup1", "SSID-WAN-Auto-Test1", WebportalParam.ob1deveiceName);
        assertTrue(checkpoint, "checkpoint 1 : group 1 exists");
        checkpoint = page.GroupExist("TestGroup2", "SSID-WAN-Auto-Test2", WebportalParam.ob2deveiceName);
