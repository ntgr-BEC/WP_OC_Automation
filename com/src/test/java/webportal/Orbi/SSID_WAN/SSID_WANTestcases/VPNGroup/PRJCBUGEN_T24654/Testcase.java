package webportal.Orbi.SSID_WAN.SSID_WANTestcases.VPNGroup.PRJCBUGEN_T24654;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24654") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify user able to delete business VPN group") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24654") // It's a testcase id/link from Jira Test Case.
