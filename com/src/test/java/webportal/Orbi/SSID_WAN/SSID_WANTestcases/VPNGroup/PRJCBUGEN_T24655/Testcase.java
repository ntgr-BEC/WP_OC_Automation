package webportal.Orbi.SSID_WAN.SSID_WANTestcases.VPNGroup.PRJCBUGEN_T24655;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24655") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify user able to add router to the newly created business VPN group") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24655") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(checkpoint, "checkpoint 1 : new added remote router is shown in table");
    }
