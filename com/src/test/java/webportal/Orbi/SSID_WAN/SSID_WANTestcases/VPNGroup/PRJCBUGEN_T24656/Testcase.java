package webportal.Orbi.SSID_WAN.SSID_WANTestcases.VPNGroup.PRJCBUGEN_T24656;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24656") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify user able to delete router from the business VPN group") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24656") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to Routers page / User add a VPN group / Delete a remote router after the group is created")
    public void step2() {
        boolean checkpoint;
        RoutersBusinessVPNPage page = new RoutersBusinessVPNPage();
        page.gotoPage();
        ...
        assertFalse(checkpoint, "checkpoint 1 : deleted remote router is not shown in table");
    }
