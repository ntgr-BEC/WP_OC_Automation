package webportal.Orbi.SSID_WAN.SSID_WANTestcases.VPNGroup.PRJCBUGEN_T24661;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24661") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether VPN health is shown properly for both Office router and Remote router") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24661") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(checkpoint, "checkpoint 1 : central router is healthy");
        page.gotoRemoteRoutersPage();
        checkpoint = page.RouterHealth(WebportalParam.ob2deveiceName, false, "Healthy");
        assertTrue(checkpoint, "checkpoint 2 : remote router is healthy");
    }
