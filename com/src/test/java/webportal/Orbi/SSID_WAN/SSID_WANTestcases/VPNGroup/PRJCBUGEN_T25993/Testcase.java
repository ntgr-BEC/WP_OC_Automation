package webportal.Orbi.SSID_WAN.SSID_WANTestcases.VPNGroup.PRJCBUGEN_T25993;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25993") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Read and write manager have access to edit Business VPN group") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25993") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Louout and login as readwrite manager / Go to Loation 1 where the central router is located")
    public void step3() {
        UserManage userManage = new UserManage();
        userManage.logout();
        new WebportalLoginPage(true).loginByUserPassword(WebportalParam.managerName, WebportalParam.managerPassword);
    ...
    @Step("Test Step 4: Go to Routers page / User can edit the VPN group")
    public void step4() {
        boolean checkpoint;
        RoutersBusinessVPNPage page = new RoutersBusinessVPNPage();
        page.gotoPage();
        ...
        util.MyCommonAPIs.sleepsyncorbi(); 
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "SSID-WAN-Auto-Test-1", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi(); 
        }
        page.gotoPage();
        checkpoint = page.GroupExist("TestGroup", "SSID-WAN-Auto-Test-1", WebportalParam.ob1deveiceName, "Healthy");
