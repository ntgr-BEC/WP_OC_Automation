package webportal.Orbi.SSID_WAN.SanityBusinessVPNFlow.PRJCBUGEN_T27002;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27002") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the behaviour of Day-one offline Router added to VPN group and brought to cloud connected state") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27002") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T27002", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27002", WebportalParam.ob1deveiceName, "Need Attention")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
        page.gotoPage();
        checkpoint = page.GroupExist("TestGroup", "PRJCBUGEN-T27002", WebportalParam.ob1deveiceName, "Need Attention");
    ...
    public void step5() {
        ...
        RoutersBusinessVPNPage page = new RoutersBusinessVPNPage();
        page.gotoPage();
        checkpoint = page.GroupExist("TestGroup", "PRJCBUGEN-T27002", WebportalParam.ob1deveiceName, "Healthy");
