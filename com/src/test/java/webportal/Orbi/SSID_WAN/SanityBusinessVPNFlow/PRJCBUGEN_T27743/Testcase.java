package webportal.Orbi.SSID_WAN.SanityBusinessVPNFlow.PRJCBUGEN_T27743;
...
//this script is modified for a general case, from 26877 and 26879
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27743") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether Wireless clients connected to remote router's satellite are able to access the VPN") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27743") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Remote client can connect to 1st satellite")
    public void step3() {
    ...
    @Step("Test Step 4: Remote client can connect to 2nd satellite")
    public void step4() {
        boolean checkpoint = false;
        String cmd;
        String satellite_bssid = WebportalParam.ob2sate2SSIDWANbssid;
        if(satellite_bssid.equals("")) {
            return;
        }
