package webportal.Orbi.SXK30.PRJCBUGEN_T25013;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25013") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Add SXR30 via serial number") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25013") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Add device in this location")
    public void step2() {        
