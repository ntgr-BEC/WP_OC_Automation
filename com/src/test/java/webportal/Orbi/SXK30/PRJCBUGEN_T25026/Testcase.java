package webportal.Orbi.SXK30.PRJCBUGEN_T25026;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25026") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("changed  to AP mode   from router")
    @TmsLink("PRJCBUGEN-T25026") // It's a testcase id/link from Jira Test Case.
