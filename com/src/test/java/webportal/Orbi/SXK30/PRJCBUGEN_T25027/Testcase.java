package webportal.Orbi.SXK30.PRJCBUGEN_T25027;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25027") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("changed to Router   mode  form AP")
    @TmsLink("PRJCBUGEN-T25027") // It's a testcase id/link from Jira Test Case.
