package webportal.Orbi.SXK30.PRJCBUGEN_T25043;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25043") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("SSID2 with WPA/WPA2-psk with non default vlan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25043") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Check 4 SSIDs / Change SSID2 security to WPA-PSK/WPA2-PSK")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
    ...
    @Step("Test Step 3: Go to device local GUI / Check SSID2 security is WPA-PSK/WPA2-PSK")
    public void step3() {
