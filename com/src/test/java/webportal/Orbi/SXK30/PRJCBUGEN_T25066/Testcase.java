package webportal.Orbi.SXK30.PRJCBUGEN_T25066;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25066") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("SSID Separation  for ssid 2") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25066") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Enter device page / Check 4 SSIDs / Enable SSID separation for wifi2")
    public void step2() {
        boolean checkpoint;
        ddp.openOB2();
    ...
    @Step("Test Step 3: Go to device local GUI / Check SSID2 separation")
    public void step3() {
        String sGet = new BRUtils(BRUtils.api_device_guest_wlan_info, 1).getField("enableSSIDSeparation");
...
//        util.MyCommonAPIs.waitReady();
//        
//        checkpoint = BasicWirelessElements.wireless2ssidseperation.isSelected();
