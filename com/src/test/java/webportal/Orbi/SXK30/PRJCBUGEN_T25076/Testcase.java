package webportal.Orbi.SXK30.PRJCBUGEN_T25076;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25076") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Topology with sxk 30 in ssid view") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25076") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to topology page / Select ssid view and check elements")
    public void step2() {
