package webportal.Orbi.SXK30.PRJCBUGEN_T25337;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25337") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, day-1 on-boarding in AP mode for SXR80") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T25337") // It's a testcase id/link from Jira Test Case.
