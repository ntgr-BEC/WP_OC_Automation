...
import webportal.Orbi.TEC_update.WifiSecurity.PRJCBUGEN_T30830.Config;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T30830") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("WPA2/WPA3 mixed mode check after fw upgrade(insight mode)") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30830") // It's a testcase id/link from Jira Test Case.
