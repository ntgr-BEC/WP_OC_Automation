package webportal.Orbi.TEC_update.WifiSecurity.PRJCBUGEN_T30947;
...
import webportal.Orbi.TEC_update.WifiSecurity.PRJCBUGEN_T30947.Config;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T30947") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("WPA3-Enterprise mode check after on-boarding") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30947") // It's a testcase id/link from Jira Test Case.
