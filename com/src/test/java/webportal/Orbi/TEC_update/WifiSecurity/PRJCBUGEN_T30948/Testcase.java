...
import webportal.Orbi.TEC_update.WifiSecurity.PRJCBUGEN_T30948.Config;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T30948") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("WPA3-Enterprise mode check after fw upgrade(insight mode)") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T30948") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: DUT standalone mode, enable wireless123 and set security to WPA3 Enterprise")
    public void step2() {
    ...
    public void step3() {
        ...
        assertTrue(page.getWiFiInfo(1, 4).equals("WPA/WPA3-Enterprise"), "wifi1 security is not correct on Insight");
        assertTrue(page.getWiFiInfo(2, 4).equals("WPA/WPA3-Enterprise"), "wifi2 security is not correct on Insight");
        assertTrue(page.getWiFiInfo(3, 4).equals("WPA/WPA3-Enterprise"), "wifi3 security is not correct on Insight");
    ...
    public void step4() {
        ...
        assertTrue(orbiwirelesspage.wireless1wpa3enterprise.getAttribute("checked").equals("checked"), "wifi1 security is not correct on local");
    ...
    @Step("Test Step 5: FW upgrade (before img), security mode should keep on local and on Insight")
    public void step5() {
        
        // FW upgrade
        OrbiDebugSettingsPage pagedebug = new OrbiDebugSettingsPage();
        
        pagedebug.OrbibaseEnableTelenet(baseip, WebportalParam.loginDevicePassword);
        ...
        pagedebug.OrbibaseEnableTelenet(satelliteip, WebportalParam.loginDevicePassword);
    ...
    @Step("Test Step 6: FW upgrade (after img), security mode should keep on local and on Insight")
    public void step6() {
        // FW upgrade
        OrbiDebugSettingsPage pagedebug = new OrbiDebugSettingsPage();
        ...
        new OrbiTelnet(baseip , WebportalParam.loginDevicePassword).orbiTelnetSendCmd(deleteimgcmd);
        MyCommonAPIs.sleepi(3);
        new OrbiTelnet(baseip , WebportalParam.loginDevicePassword).orbiTelnetSendCmd(String.format(downloadimgcmd,WebportalParam.baseafterimg,WebportalParam.TftpSvr));
        MyCommonAPIs.sleepi(3);
        new OrbiTelnet(baseip , WebportalParam.loginDevicePassword).orbiTelnetSendCmd(upgradecmd);
        MyCommonAPIs.sleepi(500);
        ...
        new OrbiTelnet(satelliteip , WebportalParam.loginDevicePassword).orbiTelnetSendCmd(deleteimgcmd);
        MyCommonAPIs.sleepi(3);
        new OrbiTelnet(satelliteip , WebportalParam.loginDevicePassword).orbiTelnetSendCmd(String.format(downloadimgcmd,WebportalParam.satelliteafterimg,WebportalParam.TftpSvr));
        MyCommonAPIs.sleepi(3);
        new OrbiTelnet(satelliteip , WebportalParam.loginDevicePassword).orbiTelnetSendCmd(upgradecmd);
        MyCommonAPIs.sleepi(500); 
