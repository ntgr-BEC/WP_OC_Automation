package webportal.Orbi.WiredBVPN.PRJCBUGEN_T27762;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27762") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Scenario1: verify that all wired clients connected to all ports of the router are able to connect to the VPN tunnel and test ping across all routers and hosts") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27762") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T27762", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27762", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
        
    }
    
    @Step("Test Step 3: Remote wired client and central wired client can ping each other")
    public void step3() {
        ...
        assertTrue(checkpoint, "checkpoint 1 : remote wired client can ping central wired client");
        ...
        assertTrue(checkpoint, "checkpoint 2 : central wired client can ping remote wired client");
    }
