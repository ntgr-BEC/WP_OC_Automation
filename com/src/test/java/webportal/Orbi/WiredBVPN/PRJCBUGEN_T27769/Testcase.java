package webportal.Orbi.WiredBVPN.PRJCBUGEN_T27769;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27769") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Scenario1: verify the functionality of allow hosts under MAC ACL for the wired clients connected across different routers") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27769") // It's a testcase id/link from Jira Test Case.
