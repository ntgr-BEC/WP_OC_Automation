package webportal.Orbi.WiredBVPN.PRJCBUGEN_T27781;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27781") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Scenario2: verify whether the windows wired clients are getting IP from the assigned subnet pool from the employee router") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27781") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T27781", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27781", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
