package webportal.Orbi.WiredBVPN.PRJCBUGEN_T27791;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27791") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Scenario2: verify that the IP config changes are altered in the satellites as well in case the subnet configs are changed") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27791") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T27791", 1, "12345678");
        page.clickNext();
        ...
        util.MyCommonAPIs.sleepsyncorbi();
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27791", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
