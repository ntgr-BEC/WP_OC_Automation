package webportal.Orbi.WiredBVPN.PRJCBUGEN_T27792;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27792") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Scenario2: verify file transfer works across remote routers") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27792") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T27792", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27792", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
        
    }
    
    @Step("Test Step 3: Remote wired client can send file to central wired client")
    public void step3() {
