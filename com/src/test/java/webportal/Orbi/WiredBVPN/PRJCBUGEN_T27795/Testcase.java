package webportal.Orbi.WiredBVPN.PRJCBUGEN_T27795;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27795") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Scenario2: verify that when all diff ports participating in different VLANs can connect to the business VPN") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27795") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T27795", 1, "12345678");
        page.clickNext();
        page.clickNext(); 
        ...
        util.MyCommonAPIs.sleepsyncorbi();
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27795", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
