package webportal.Orbi.WiredBVPN.PRJCBUGEN_T27803;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27803") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Scenario2: Test to verify the functionality when L2 switches are cascaded to an orbi router") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27803") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T27803", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27803", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
