package webportal.Orbi.WiredBVPN.PRJCBUGEN_T27935;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27935") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Scenario1: Host / PC connected to Satellite LAN port is able to ping remote and central routers and its associated devices when the business VPN group is setup") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T27935") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        page.clickNext();
        page.setPage3WirelessSettings(true, "PRJCBUGEN-T27935", 1, "12345678");
        page.clickNext();
        ...
        page.gotoPage();
        if(!page.GroupExist("TestGroup", "PRJCBUGEN-T27935", WebportalParam.ob1deveiceName, "Healthy")) {
            util.MyCommonAPIs.sleepsyncorbi();
        }
