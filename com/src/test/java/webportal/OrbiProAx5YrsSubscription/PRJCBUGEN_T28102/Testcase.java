package webportal.OrbiProAx5YrsSubscription.PRJCBUGEN_T28102;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28102") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify post 6.5 deployment, new Orbi Pro AX on-board on premium account on 2023 will have expiry date with 5 year hard bundle plan")
    @TmsLink("PRJCBUGEN_T28102") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        assertTrue(new InsightServicesPage(false).verifyExpairyDateIsExpected(WebportalParam.ob1serialNo), "Not Found 2028 Text");
    }
