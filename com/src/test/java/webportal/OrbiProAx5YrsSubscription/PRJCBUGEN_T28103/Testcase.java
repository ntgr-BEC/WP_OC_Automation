package webportal.OrbiProAx5YrsSubscription.PRJCBUGEN_T28103;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28103") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, on Purchase order history 'One- year' title is skipped")
    @TmsLink("PRJCBUGEN_T28103") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Check whether Premium account should not have 1 year insight support from that date of on-boarding")
    public void step4() {
        assertTrue(new InsightServicesPage(false).verifyInsightPremiumOneYearsubscriptionNotPresent(WebportalParam.ob1serialNo),
                "1 year insight support from that date of on-boarding");
    }
