package webportal.OrbiProAx5YrsSubscription.PRJCBUGEN_T28105;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28105") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, 5 year subscription is available on device SXK80")
    @TmsLink("PRJCBUGEN_T28105") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 6: Check SXR30 Orbi Device  should have 5 year insight support from that date of on-boarding  ")
    public void step6() {
    ...
    @Step("Test Step 7: Check SXR80 Orbi Device  should have 5 year insight support from that date of on-boarding  ")
    public void step7() {
    ...
    @Step("Test Step 8: Check SXR50 Orbi Device  should have 5 year insight support from that date of on-boarding  ")
    public void step8() {
