package webportal.OrbiProAx5YrsSubscription.PRJCBUGEN_T28452;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28452") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, 5 year subscription is available on device SXK50") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T28452") // It's a testcase id/link from Jira Test Case.
    ...
    public void step5() {
        assertTrue(new InsightServicesPage(false).verifyInsightPremiumOneYearsubscriptionNotPresent(WebportalParam.ob3serialNo),
