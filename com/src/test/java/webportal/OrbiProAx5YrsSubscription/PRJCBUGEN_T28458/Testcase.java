package webportal.OrbiProAx5YrsSubscription.PRJCBUGEN_T28458;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T28458") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("test to verify when 5 year orbi supported device SXK80 is on-boarded to pro account it must not carry 5 year plan") // It's a
                                                                                                                                      // testcase
                                                                                                                                      // title from
                                                                                                                                      // Jira Test
                                                                                                                                      // Case.
    @TmsLink("PRJCBUGEN_T28458") // It's a testcase id/link from Jira Test Case.
    ...
    public void step5() {
        ...
        assertFalse((new InsightServicesPage(false).verifyInsightPremiumFiveYearsubscription(WebportalParam.ob2serialNo)),
