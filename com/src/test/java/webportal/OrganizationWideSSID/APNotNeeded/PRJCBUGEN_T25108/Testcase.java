package webportal.OrganizationWideSSID.APNotNeeded.PRJCBUGEN_T25108;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T25108") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("when one location has 8 ssid and creating ssid") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T25108") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step4() {
          ...
          assertTrue(new OrganizationPage(false).organizationWideSSIDMaxLimitErrorLoc1Msg(locationInfo)," Organization wide SSID is created successfully.");
