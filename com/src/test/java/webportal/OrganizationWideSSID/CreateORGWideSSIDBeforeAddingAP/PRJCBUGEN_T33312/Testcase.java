package webportal.OrganizationWideSSID.CreateORGWideSSIDBeforeAddingAP.PRJCBUGEN_T33312;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33312") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify org-wide-ssid  functionally  when vlan is changed from management  vlan (1) to custom vlan.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T33312") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step2() {
          ...
          locationInfo.put("SSID", "PRJCBUGEN_T33312");
      ...
      public void step4() {
          ...
          assertTrue(new OrganizationPage(false).checkOrgSsidIsExist("PRJCBUGEN_T33312"),"ssid does not exits in Loc 1");
          ...
          new MyCommonAPIs().gotoLoction(WebportalParam.location2);
          new OrganizationPage(false).goWirelessSetting();
          assertTrue(new OrganizationPage(false).checkOrgSsidIsExist("PRJCBUGEN_T33312"),"ssid does not exits in Loc 2");
      }
      ...
      public void step5() {
          ...
          MyCommonAPIs.sleepi(2);
          assertTrue(new APUtils(WebportalParam.ap1IPaddress).getSsidStatus1("PRJCBUGEN_T33312", WebportalParam.ap1Model),"ssid is not pushed to AP");
          MyCommonAPIs.sleepi(10);
          assertTrue(new APUtils(WebportalParam.ap2IPaddress).getSsidStatus1("PRJCBUGEN_T33312", WebportalParam.ap2Model),"ssid is not pushed to AP");
          MyCommonAPIs.sleepi(10);
          int sum = 0;
          while (true) {
              MyCommonAPIs.sleepi(10);
              if (new Javasocket()
                      .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID PRJCBUGEN_T33312")
                      .indexOf("true") != -1) {
                  break;
              } else if (sum > 30) {
          ...
          if (!new Javasocket()
                  .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect PRJCBUGEN_T33312 123456798 WPA2PSK aes")
                  .equals("true")) {
              result1 = false;
              if (new Javasocket()
                      .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect PRJCBUGEN_T33312 123456798 WPA2PSK aes")
      ...
      public void step6() { 
          ...
          new MyCommonAPIs().gotoLoction(WebportalParam.location1);
          new OrganizationPage(false).goWirelessSetting();
          assertTrue(new OrganizationPage(false).checkOrgSsidCustomVlanIsExist("PRJCBUGEN_T33312"),"ssid with Custom VLAN does not exits in Loc 1");
          new OrganizationPage(false).openOrg(WebportalParam.Organizations);
          new MyCommonAPIs().gotoLoction(WebportalParam.location2);
          new OrganizationPage(false).goWirelessSetting();
          assertTrue(new OrganizationPage(false).checkOrgSsidCustomVlanIsExist("PRJCBUGEN_T33312"),"ssid with Custom VLAN does not exits in Loc 1");
