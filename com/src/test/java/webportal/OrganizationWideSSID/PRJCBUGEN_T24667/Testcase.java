package webportal.OrganizationWideSSID.PRJCBUGEN_T24667;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24667") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("create  ssid  wpa2-psk   from  organization setting after adding  AP") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T24667") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step4() {
          ...
          assertTrue(new APUtils(WebportalParam.ap1IPaddress).getSsidStatus1("apwp14270", WebportalParam.ap1Model),"ssid is not pushed to AP1");
          assertTrue(new APUtils(WebportalParam.ap2IPaddress).getSsidStatus1("apwp14270", WebportalParam.ap2Model),"ssid is not pushed to AP2");
          
               
      }
      
      @Step("Test Step 5: Add one more ap to first location;")
      public void step5() {
          new OrganizationPage(false).openOrg(WebportalParam.Organizations);; 
          ...
          assertTrue(new APUtils(WebportalParam.ap3IPaddress).getSsidStatus1("apwp14270", WebportalParam.ap3Model),"ssid is not pushed to AP");
          new AccountPage().enterLocation("office1");
