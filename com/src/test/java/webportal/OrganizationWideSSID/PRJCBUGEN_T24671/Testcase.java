package webportal.OrganizationWideSSID.PRJCBUGEN_T24671;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24671") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("No Edit or Delete operations are allowed to the Org-wide-SSID at location(s) → Settings → WiFi Networks.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T24671") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step4() {
          ...
          new MyCommonAPIs().gotoLoction(WebportalParam.location2);
          new OrganizationPage(false).goWirelessSetting();
          assertTrue(new OrganizationPage(false).verifytoeditdeleteLocationSSID(locationInfo),"Edit/Delete Functionality is available on locations organization wide SSID");
          new OrganizationPage(false).openOrg(WebportalParam.Organizations);
          new MyCommonAPIs().gotoLoction(WebportalParam.location1);
          new OrganizationPage(false).goWirelessSetting(); 
          assertTrue(new OrganizationPage(false).verifytoeditdeleteLocationSSID(locationInfo),"Edit/Delete Functionality is available on locations organization wide SSID");
