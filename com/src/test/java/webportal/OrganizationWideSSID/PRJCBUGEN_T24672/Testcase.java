package webportal.OrganizationWideSSID.PRJCBUGEN_T24672;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24672") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Edit  organization ssid") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T24672") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step3() {
          ...
          new OrganizationPage(false).goToOrgSsid(WebportalParam.Organizations);
          new OrganizationPage(false).editOrgnaizationwideSSID(locationInfo);
