package webportal.OrganizationWideSSID.PRJCBUGEN_T24673;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24673") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Delete  org ssid") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T24673") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step5() {
          ...
          new MyCommonAPIs().gotoLoction(WebportalParam.location1);
          new OrganizationPage(false).goWirelessSetting(); 
          assertTrue(new OrganizationPage(false).verifydelOrgSSIDineachLoc()," Organization wide SSID is not deleted on location.");
