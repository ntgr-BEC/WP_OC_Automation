package webportal.OrganizationWideSSID.PRJCBUGEN_T24674;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24674") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("org ssid with  Rate Limiting") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T24674") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step4() {
          ...
          new OrganizationPage(false).goToOrgSsid(WebportalParam.Organizations);
          MyCommonAPIs.sleepi(10);
          new OrganizationPage(false).editRateLimitorgwidessid(locationInfo.get("SSID"), 5.0000, 10.0000); // need modify
          
          
      }
          
      @Step("Test Step 5:check whether  new ssid is pushed  with rate limit in location 1")
      public void step5() {   
          
          new OrganizationPage(false).openOrg(WebportalParam.Organizations);
          new MyCommonAPIs().gotoLoction(WebportalParam.location1);
          new OrganizationPage(false).goWirelessSetting();
          assertTrue(new OrganizationPage(false).checkOrgSsidRateLimitIsExist("apwp14270"),"ssid does not exits in Loc 1");
          
          new OrganizationPage(false).openOrg(WebportalParam.Organizations);
          new MyCommonAPIs().gotoLoction(WebportalParam.location2);
          new OrganizationPage(false).goWirelessSetting();
          assertTrue(new OrganizationPage(false).checkOrgSsidRateLimitIsExist("apwp14270"),"ssid does not exits in Loc 2");
