package webportal.OrganizationWideSSID.PRJCBUGEN_T24677;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24677") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("org ssid -->on edit enable basic captive portal") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T24677") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step2() {
          ...
          new OrganizationPage(false).enablecaptivePortalforOrgWideSSID();
      }
