package webportal.OrganizationWideSSIDEnhancement.EnterpriseOrgWideSSID.PRJCBUGEN_T34389;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T34389") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify WPA2 Enterprise SSID with 2 bands is pushed to location as well as AP") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T34389") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).deleteSsidYes("PRJCBUGEN_T34389");
    ...
    public void step1() {
      ...
      public void step2() {
          ...
          new OrganizationPage(false).goToOrgSsid(WebportalParam.Organizations);
          Map<String, String> locationInfo = new HashMap<String, String>();
          locationInfo.put("SSID", "PRJCBUGEN_T34389");
      ...
      public void step3() {
          ...
          assertTrue(new APUtils(WebportalParam.ap1IPaddress).getSsidStatus1("PRJCBUGEN_T34389", WebportalParam.ap1Model),"org wide ssid with wpa2 enterprise security is not pushed to AP");
          assertTrue(new APUtils(WebportalParam.ap2IPaddress).getSsidStatus1("PRJCBUGEN_T34389", WebportalParam.ap2Model),"org wide ssid with wpa2 enterprise security is not pushed to AP");
