package webportal.OrganizationWideSSIDEnhancement.EnterpriseOrgWideSSIDAPNotNeeded.PRJCBUGEN_T34387;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T34387") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify WPA3 Enterprise SSID with 2 bands is pushed to newly created location") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T34387") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step2() {
          ...
          orgssidInfo.put("SSID", "PRJCBUGEN_T34387");
