package webportal.OrganizationWideSSIDEnhancement.EnterpriseOrgWideSSIDAPNotNeeded.PRJCBUGEN_T35209;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35209") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify WPA3 Enterprise SSID with 6 GHz band is pushed to newly created location") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35209") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step2() {
          ...
          orgssidInfo.put("SSID", "PRJCBUGEN_T35209");
          orgssidInfo.put("Security", "WPA3 Enterprise");
          new OrganizationPage(false).createOrgSSIdWPA3Enterprise6GHzBand(orgssidInfo);
          new OrganizationPage(false).openOrg(WebportalParam.Organizations); 
...
//          new MyCommonAPIs().sleepi(300);
          ...
          orgssidInfo.put("SSID", "PRJCBUGEN_T35209");
          assertTrue(new OrganizationPage(false).verifylocation1WPA3EnterpriseOrgSSID6Band(orgssidInfo)," org wide ssid with wpa3 enterprise security not pushed successfull.");  
