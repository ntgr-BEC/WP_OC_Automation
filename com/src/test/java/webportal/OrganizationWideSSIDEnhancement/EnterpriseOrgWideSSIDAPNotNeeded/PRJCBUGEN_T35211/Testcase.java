package webportal.OrganizationWideSSIDEnhancement.EnterpriseOrgWideSSIDAPNotNeeded.PRJCBUGEN_T35211;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35211") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify WPA2 Enterprise SSID with 5 GHz band is pushed to newly created location") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T35211") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step2() {
          ...
          orgssidInfo.put("SSID", "PRJCBUGEN_T35211");
          orgssidInfo.put("Security", "WPA2 Enterprise");
          new OrganizationPage(false).createOrgSSIdWPA2Enterprise5GHzBand(orgssidInfo);
          new OrganizationPage(false).openOrg(WebportalParam.Organizations); 
      ...
      public void step3() {
          ...
          orgssidInfo.put("SSID", "PRJCBUGEN_T35211");
          assertTrue(new OrganizationPage(false).verifylocation1WPA2EnterpriseOrgSSID5Band(orgssidInfo)," org wide ssid with wpa2 enterprise security not pushed successfull.");  
