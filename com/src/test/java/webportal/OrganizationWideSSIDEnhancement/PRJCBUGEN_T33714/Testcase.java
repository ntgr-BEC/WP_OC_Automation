package webportal.OrganizationWideSSIDEnhancement.PRJCBUGEN_T33714;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Rename organization wide ssid") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).deleteSsidYes("PRJCBUGEN_T33714");
    ...
    public void step1() {
      ...
      public void step3() {
          ...
          assertTrue(new APUtils(WebportalParam.ap1IPaddress).getSsidStatus1("PRJCBUGEN_T33714", WebportalParam.ap1Model),"ssid is not pushed to AP");
          assertTrue(new APUtils(WebportalParam.ap2IPaddress).getSsidStatus1("PRJCBUGEN_T33714", WebportalParam.ap2Model),"ssid is not pushed to AP");
