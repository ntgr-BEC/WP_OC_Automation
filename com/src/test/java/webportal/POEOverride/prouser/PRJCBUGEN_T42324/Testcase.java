package webportal.POEOverride.prouser.PRJCBUGEN_T42324;
...
public class Testcase extends TestCaseBase {
    ...
    public void step2() {
        ...
        assertTrue(new WirelessQuickViewPage(false).verifyAllPowerSettingOptions(),"Power Setting options are not visible on power settings page");      
