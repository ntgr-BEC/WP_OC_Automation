package webportal.POEOverride.prouser.PRJCBUGEN_T42331;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42331") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("change Power  setting   to  BT from  Auto then  reboot AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42331") // It's a testcase id/link from Jira Test Case.
