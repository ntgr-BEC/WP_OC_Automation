package webportal.POEOverride.prouser.PRJCBUGEN_T42332;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42332") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("change  power  setting   from Auto --> AF -- AT") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42332") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new DevicesDashPage(false).verifypowerModeonDevicedashPageAPstatus(powerMode),"AP Status is not changed to Connected (PoE 802.3af only)");
        MyCommonAPIs.sleepi(5);
        String powerMode1 = "802.3at";
        ...
        assertTrue(new WirelessQuickViewPage(false).verifyAndselectedpowerOptionIsvisbleOrNot(powerMode1),"Power Setting options are not visible on power settings page");
        MyCommonAPIs.sleepi(5);
