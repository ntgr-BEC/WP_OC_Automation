package webportal.POEOverride.prouser.PRJCBUGEN_T42333;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42333") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("change  power  setting   from Auto --> AF -- BT") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42333") // It's a testcase id/link from Jira Test Case.
