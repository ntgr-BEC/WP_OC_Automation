package webportal.POEOverride.prouser.PRJCBUGEN_T42336;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42336") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("changepower setting  from  Auto  --> AT --> BT") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42336") // It's a testcase id/link from Jira Test Case.
