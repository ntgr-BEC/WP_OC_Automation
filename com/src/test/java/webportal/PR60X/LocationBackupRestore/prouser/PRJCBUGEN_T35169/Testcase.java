package webportal.PR60X.LocationBackupRestore.prouser.PRJCBUGEN_T35169;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35169") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify user can edit configure backup at Location level from web portal") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T35169") // It's a testcase id/link from Jira Test Case.
