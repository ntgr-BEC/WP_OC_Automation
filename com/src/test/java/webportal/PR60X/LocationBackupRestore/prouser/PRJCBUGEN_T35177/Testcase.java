package webportal.PR60X.LocationBackupRestore.prouser.PRJCBUGEN_T35177;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35177") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify after restoring the backup the device should go for the reboot") // It's a test case title from Jira
                                                                                                                 // Test Case.
    @TmsLink("PRJCBUGEN-T35177") // It's a testcase id/link from Jira Test Case.
