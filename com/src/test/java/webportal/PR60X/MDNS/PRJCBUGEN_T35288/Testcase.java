package webportal.PR60X.MDNS.PRJCBUGEN_T35288;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35288") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, we can change gateway mode from AP to PR") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T35288") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: enable MDNS for AP;")
    public void step4() {
    ...
    @Step("Test Step 6: change MDNS to  PR;")
    public void step6() {
