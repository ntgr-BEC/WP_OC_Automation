package webportal.PR60X.MDNS.PRJCBUGEN_T35289;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35289") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, we can change gateway mode from PR to AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T35289") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        firststdevInfo.put("Serial Number1", WebportalParam.pr1serialNo);
        firststdevInfo.put("MAC Address1", WebportalParam.pr1macaddress);
    ...
    @Step("Test Step 6: change  MDNS PR to AP;")
    public void step6() {
