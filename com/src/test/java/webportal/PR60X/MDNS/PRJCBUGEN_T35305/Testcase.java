package webportal.PR60X.MDNS.PRJCBUGEN_T35305;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35305") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify, Create New location with No Aps, now verify PR can be on-boarded with mDNS config") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T35305") // It's a testcase id/link from Jira Test Case.
