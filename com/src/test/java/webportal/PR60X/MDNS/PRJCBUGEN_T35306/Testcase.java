package webportal.PR60X.MDNS.PRJCBUGEN_T35306;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35306") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify, Create New location with Aps, mDNS can be enabled with AP as Gateway") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T35306") // It's a testcase id/link from Jira Test Case.
