package webportal.PR60X.MDNS.prouser.PRJCBUGEN_T35290;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35290") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, on moving AP gateway to PR all AP's mDNS policy will get erased") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T35290") // It's a testcase id/link from Jira Test Case.
