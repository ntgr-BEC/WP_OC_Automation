package webportal.PR60X.MDNS.prouser.PRJCBUGEN_T35291;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35291") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, on changing gateway to new selection (AP to PR) we get error pop up") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T35291") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        String message= new PRDashPage().warrningText.getText();
        assertTrue(message.contains("On changing mDNS gateway the configuration applied to the previous device will be deleted."), "error in pop up warrning");
