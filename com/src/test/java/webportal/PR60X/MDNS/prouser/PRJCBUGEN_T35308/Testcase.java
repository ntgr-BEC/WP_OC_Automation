package webportal.PR60X.MDNS.prouser.PRJCBUGEN_T35308;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35308") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, create new location with AP and PR , enabled mDNS gateway as AP first then change it to PR") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T35308") // It's a testcase id/link from Jira Test Case.
