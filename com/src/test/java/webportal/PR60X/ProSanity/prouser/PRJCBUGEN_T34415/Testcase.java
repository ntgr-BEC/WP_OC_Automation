  package webportal.PR60X.ProSanity.prouser.PRJCBUGEN_T34415;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T34415") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to perform traceroute.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T34415") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        SelenideElement Device = troubleshoot.selectOneDevice(WebportalParam.pr1serialNo);
        Device.click();    
        tmpStr = troubleshoot.runPingTestOnDevice(pingTraceroute,domain, WebportalParam.pr1serialNo);
        CompleteResult = troubleshoot.CheckPingResult(WebportalParam.pr1serialNo);
