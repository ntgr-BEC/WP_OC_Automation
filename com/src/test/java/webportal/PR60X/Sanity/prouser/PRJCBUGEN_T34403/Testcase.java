package webportal.PR60X.Sanity.prouser.PRJCBUGEN_T34403;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T34403") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to onboard device at the new location.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T34403") // It's a testcase id/link from Jira Test Case.
