package webportal.PR60X.Sanity.prouser.PRJCBUGEN_T34410;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to enable or disable dual WAN.") // It's a testcase title from Jira Test Case.
    ...
    public void step2() {
        ...
        new PRDashPage().enterDeviceYes(WebportalParam.pr1serialNo);
        assertTrue(new PRDashPage().checkWAN(),"wan is not enabled");
        new PRDashPage().enterDeviceYes(WebportalParam.pr1serialNo);
        new PRDashPage().WAN();
        MyCommonAPIs.sleepi(180);  
        new PRDashPage().enterDeviceYes(WebportalParam.pr1serialNo);
        assertTrue(!new PRDashPage().checkWAN(),"wan is not disabled");
