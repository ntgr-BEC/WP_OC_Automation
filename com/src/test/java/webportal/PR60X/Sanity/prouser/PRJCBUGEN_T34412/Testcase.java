package webportal.PR60X.Sanity.prouser.PRJCBUGEN_T34412;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T34412") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to perform a share diagnostics.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T34412") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        new PRDashPage().shareEmail("apwptest@mailinator.com");

        assertTrue(new PRDashPage().checkAlertIsExist(), "Cannot share diagnostics from email");
}
}
