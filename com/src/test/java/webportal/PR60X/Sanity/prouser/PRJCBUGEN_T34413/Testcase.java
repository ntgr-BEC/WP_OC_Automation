package webportal.PR60X.Sanity.prouser.PRJCBUGEN_T34413;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T34413") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to perform a ping test.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T34413") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        tmpStr = troubleshoot.runOneTestOnDevicePR(domain);
        assertTrue(tmpStr.contains(WebportalParam.getLocText("Success").toLowerCase()), "ping lookup result is not Success.");
        
        CompleteResultAP = troubleshoot.CheckPingResult(WebportalParam.pr1serialNo);
