package webportal.PROPreInvitingUser.Manager.PRJCBUGEN_T40751;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40751") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the Invite read-write Manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40751") // It's a testcase id/link from Jira Test Case.
