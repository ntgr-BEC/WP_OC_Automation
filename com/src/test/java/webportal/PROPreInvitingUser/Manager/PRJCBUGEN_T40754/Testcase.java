package webportal.PROPreInvitingUser.Manager.PRJCBUGEN_T40754;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40754") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user is able to add the all signup information and created the manager account.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40754") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        proAccountInfo.put("Confirm Email", email);
