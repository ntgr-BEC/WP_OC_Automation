package webportal.PROPreInvitingUser.Manager.PRJCBUGEN_T40756;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40756") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user delete the manager account from the manager list using the PRO admin account.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40756") // It's a testcase id/link from Jira Test Case.
