package webportal.PROPreInvitingUser.Manager.PRJCBUGEN_T40757;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40757") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to invite the already deleted manager again from the Insight.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40757") // It's a testcase id/link from Jira Test Case.
