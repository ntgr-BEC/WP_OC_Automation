package webportal.PROPreInvitingUser.Manager.PRJCBUGEN_T40758;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40758") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify a user is able to get the invitation link on email for the again invited manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40758") // It's a testcase id/link from Jira Test Case.
