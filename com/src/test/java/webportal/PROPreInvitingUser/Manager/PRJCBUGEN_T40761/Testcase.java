package webportal.PROPreInvitingUser.Manager.PRJCBUGEN_T40761;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40761") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user is able to see the manager account as active in the PRO admin manager list when the user again invites and login.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40761") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        managerInfo.put("Email Address", mailname + "@yopmail.com");
    ...
    public void step3() {
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);
        webportalLoginPage.loginByUserPassword(WebportalParam.adminName, WebportalParam.adminPassword);
        assertTrue(new ManagerPage().verifyExistingManager(mailname + "@yopmail.com"),"Invite manager failed.");    
    }
