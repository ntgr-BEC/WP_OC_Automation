package webportal.PROPreInvitingUser.Owner.PRJCBUGEN_T40776;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T40776";

    @Feature("PROPreInvitingUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T40776") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user is able to add the all signup information and created the Owner account.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40776") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        proAccountInfo.put("Confirm Email", ownMail1);
