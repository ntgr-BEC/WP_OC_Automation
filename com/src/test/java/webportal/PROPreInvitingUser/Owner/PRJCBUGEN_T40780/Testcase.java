package webportal.PROPreInvitingUser.Owner.PRJCBUGEN_T40780;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify a user is able to get the invitation link on email for the again invited Owner.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40780") // It's a testcase id/link from Jira Test Case.
