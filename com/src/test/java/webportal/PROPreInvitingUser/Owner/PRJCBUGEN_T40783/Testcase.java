package webportal.PROPreInvitingUser.Owner.PRJCBUGEN_T40783;
...
public class Testcase extends TestCaseBase {
    ...
    String ownMail2  = mailname+"2" + "@yopmail.com";
    String organizationName = "PRJCBUGEN_T40783";

    @Feature("PROPreInvitingUser") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T40783") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user is able to see the Owner account as active in the PRO admin Owner list when the user again invites and login.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40783") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        proAccountInfo.put("Confirm Email", ownMail2);
