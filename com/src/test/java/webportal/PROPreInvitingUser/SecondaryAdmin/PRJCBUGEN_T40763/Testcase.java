package webportal.PROPreInvitingUser.SecondaryAdmin.PRJCBUGEN_T40763;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40763") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user is able to get the invitation link on email.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40763") // It's a testcase id/link from Jira Test Case.
