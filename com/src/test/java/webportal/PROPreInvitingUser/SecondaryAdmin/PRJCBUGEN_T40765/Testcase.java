package webportal.PROPreInvitingUser.SecondaryAdmin.PRJCBUGEN_T40765;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40765") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user is able to add the all signup information and created the Secondary Admin account.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40765") // It's a testcase id/link from Jira Test Case.
