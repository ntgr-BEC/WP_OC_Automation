package webportal.PROPreInvitingUser.SecondaryAdmin.PRJCBUGEN_T40767;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40767") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user delete the Secondary Admin account from the Secondary Admin list using the PRO admin account.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40767") // It's a testcase id/link from Jira Test Case.
