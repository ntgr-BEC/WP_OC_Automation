package webportal.PROPreInvitingUser.SecondaryAdmin.PRJCBUGEN_T40768;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40768") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to invite the already deleted Secondary Admin again from the Insight.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40768") // It's a testcase id/link from Jira Test Case.
