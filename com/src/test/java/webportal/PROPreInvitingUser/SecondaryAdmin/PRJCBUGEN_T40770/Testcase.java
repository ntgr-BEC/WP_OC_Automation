package webportal.PROPreInvitingUser.SecondaryAdmin.PRJCBUGEN_T40770;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40770") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user clicks on the invitation URL then its redirects signup page for the again invited manager.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40770") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new WebportalLoginPage(false).verifyLoginPage(), "Invite manager link is not working fine; not landed on login page");
