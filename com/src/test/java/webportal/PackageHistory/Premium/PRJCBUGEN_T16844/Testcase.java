package webportal.PackageHistory.Premium.PRJCBUGEN_T16844;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify that Purchase History tab is clickable for premium") // It's a testcase title from Jira Test Case.
