package webportal.PackageHistory.Pro.PRJCBUGEN_T16849;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16849") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    public void test() throws Exception {
     ...
     // Each step is a single test step from Jira Test Case
        ...
        public void step2() {
            assertTrue(new HamburgerMenuPage().QuantityalongsideCategory());
        }
