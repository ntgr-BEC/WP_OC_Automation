package webportal.PaymentAndSubscription.PRJCBUGEN_T15585;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15585") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check the proper amount calculation is done based on the basic subscription") // It's a testcase title
                                                                                                // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15585") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15585");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T15585");
