package webportal.PaymentAndSubscription.PRJCBUGEN_T15586;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15586") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check the proper amount calculation is done based on the premium subscription") // It's a testcase title
                                                                                                  // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15586") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15586");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T15586");
        ...
        assertTrue(new HamburgerMenuPage().checkDevicesBilling(paymentInfo.get("Number of Device Credits"), "yearly", "AU"),
                "Amount is incorrect.");
    }
