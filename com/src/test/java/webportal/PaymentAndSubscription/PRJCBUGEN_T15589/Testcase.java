package webportal.PaymentAndSubscription.PRJCBUGEN_T15589;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15589") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buy the basic subscription and check it expires properly after 1 year for the account") // It's a testcase title
    // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15589") // It's a testcase id/link from Jira Test Case.
