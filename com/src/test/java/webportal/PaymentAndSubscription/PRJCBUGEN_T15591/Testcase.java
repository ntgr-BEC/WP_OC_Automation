package webportal.PaymentAndSubscription.PRJCBUGEN_T15591;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15591") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify WEB allows to purchase premium subscription for different Netgear supported countries") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15591") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15591");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T15591");
    ...
    @Step("Test Step 3: Create new account in Australia, then check buy premium subscription;")
    public void step3() {
