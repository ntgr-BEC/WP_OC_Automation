package webportal.PaymentAndSubscription.PRJCBUGEN_T15592;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15592") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify WEB allows to purchase Basic subscription for different Netgear supported countries") // It's a testcase title
                                                                                                               // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15592") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15592");
    ...
    @Step("Test Step 2: Check buy basic subscription;")
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T15592");
    ...
    @Step("Test Step 3: Create new account in Australia, then check buy basic subscription;")
    public void step3() {
