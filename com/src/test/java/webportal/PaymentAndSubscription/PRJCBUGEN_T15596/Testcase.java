package webportal.PaymentAndSubscription.PRJCBUGEN_T15596;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15596") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("\"Add promo code\" usage") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15596") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15596");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T15596");
