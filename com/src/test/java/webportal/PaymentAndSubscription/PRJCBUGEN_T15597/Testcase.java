package webportal.PaymentAndSubscription.PRJCBUGEN_T15597;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15597") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user is able to migrate Subscription plan from basic paid to Premium") // It's a testcase title from Jira Test
                                                                                                        // Case.
    @TmsLink("PRJCBUGEN-T15597") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15597");
    ...
    @Step("Test Step 2: Buy basic subscription, then change subscription to premium;")
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T15597");
