package webportal.PaymentAndSubscription.PRJCBUGEN_T15599;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15599") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to do payment after unsupported to supported country change") // It's a testcase title from Jira Test
                                                                                                         // Case.
    @TmsLink("PRJCBUGEN-T15599") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15599");
    ...
    @Step("Test Step 3: Change account country, then check buy premium subscription;")
    public void step3() {
        Map<String, String> profileInfo = new HashMap<String, String>();
        profileInfo.put("Choose Country", "United States");
        ...
        paymentInfo.put("Last Name", "T15599");
