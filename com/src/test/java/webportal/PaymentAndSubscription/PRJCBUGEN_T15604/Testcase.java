package webportal.PaymentAndSubscription.PRJCBUGEN_T15604;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15604") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify WEB allows a user to Summary Dash across all Premium subscription plans (Premium Trail, Premium yearly/monthly)") // It's a
                                                                                                                                           // testcase
                                                                                                                                           // title
    // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T15604") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15604");
    ...
    @Step("Test Step 3: Buy monthly premium subscription, then change to yearly;")
    public void step3() {
        ...
        paymentInfo.put("Last Name", "T15604");
