package webportal.PaymentAndSubscription.PRJCBUGEN_T15607;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15607") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("After clicking \"Place your order\" to check the payment done properly with confirmation screen") // It's a testcase title from
                                                                                                                    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T15607") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15607");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T15607");
