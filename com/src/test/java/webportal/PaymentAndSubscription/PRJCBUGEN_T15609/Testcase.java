package webportal.PaymentAndSubscription.PRJCBUGEN_T15609;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T15609") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify user able to do payment after supported to supported country change") // It's a testcase title from Jira Test
                                                                                                       // Case.
    @TmsLink("PRJCBUGEN-T15609") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T15609");
    ...
    @Step("Test Step 2: Select any supported country, check subscription;")
    public void step2() {
        assertTrue(new HamburgerMenuPage(false).checkUnsupportedCountry().equals("Supported"));
    }

    @Step("Test Step 3: Change account country to any supported country, then check buy premium subscription;")
    public void step3() {
        Map<String, String> profileInfo = new HashMap<String, String>();
        profileInfo.put("Choose Country", "UK");
        ...
        paymentInfo.put("Last Name", "T15609");
