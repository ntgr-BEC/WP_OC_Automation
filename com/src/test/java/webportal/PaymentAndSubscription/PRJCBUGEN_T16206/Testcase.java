package webportal.PaymentAndSubscription.PRJCBUGEN_T16206;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16206") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the Premium yearly - Auto-renewal ON") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16206") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16206");
    ...
    @Step("Test Step 2: Auto-renewal On, check buy premium subscription;")
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16206");
