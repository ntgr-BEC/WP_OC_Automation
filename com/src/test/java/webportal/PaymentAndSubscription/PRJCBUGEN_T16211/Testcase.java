package webportal.PaymentAndSubscription.PRJCBUGEN_T16211;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16211") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the Premium monthly + Auto-renewal ON -> premium yearly + Auto-renewal ON") // It's a testcase title from Jira Test
                                                                                                             // Case.
    @TmsLink("PRJCBUGEN-T16211") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16211");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16211");
