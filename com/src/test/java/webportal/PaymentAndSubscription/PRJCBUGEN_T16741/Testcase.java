package webportal.PaymentAndSubscription.PRJCBUGEN_T16741;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16741") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the Premium monthly + Auto-renewal OFF -> premium yearly + Auto-renewal OFF") // It's a testcase title from Jira
                                                                                                               // Test
                                                                                                               // Case.
    @TmsLink("PRJCBUGEN-T16741") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16741");
    ...
    @Step("Test Step 2: Buy monthly premium subscription, then change subscription to yearly;")
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16741");
        ...
        if (new HamburgerMenuPage(false)
                ...
                && new HamburgerMenuPage().checkDevicesBilling(paymentInfo.get("Number of Device Credits"), "monthly", "US")
                && new HamburgerMenuPage().checkAutoRenewal()) {
            ...
            assertTrue(new HamburgerMenuPage(false).checkSubscriptionScreen(paymentInfo.get("Number of Device Credits"))
                    ...
                    && new HamburgerMenuPage().checkAutoRenewal(), "Buy premium subscription unsuccess.");
        } else {
