package webportal.PaymentAndSubscription.PRJCBUGEN_T16745;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16745") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the purchase device credit with promo code.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16745") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16745");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16745");
        ...
        paymentInfo.put("Promo Code", "insightfeesoff");
        assertTrue(
