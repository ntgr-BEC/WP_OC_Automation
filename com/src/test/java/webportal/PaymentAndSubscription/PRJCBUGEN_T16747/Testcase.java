package webportal.PaymentAndSubscription.PRJCBUGEN_T16747;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16747") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Use American express credit card type to buy device credits based on US") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16747") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16747");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16747");
