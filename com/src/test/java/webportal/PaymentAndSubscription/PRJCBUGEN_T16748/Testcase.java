package webportal.PaymentAndSubscription.PRJCBUGEN_T16748;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16748") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Use American express international credit card type to buy device credits") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16748") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16748");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16748");
        ...
        assertTrue(
                new HamburgerMenuPage(false).checkMonthlySubscriptionScreen(paymentInfo.get("Number of Device Credits"))
                        && new HamburgerMenuPage().checkDevicesBilling(paymentInfo.get("Number of Device Credits"), "monthly", "UK"),
