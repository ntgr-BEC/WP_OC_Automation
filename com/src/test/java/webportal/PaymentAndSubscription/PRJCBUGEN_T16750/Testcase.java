package webportal.PaymentAndSubscription.PRJCBUGEN_T16750;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16750") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Use Discover credit card type to buy device credits based on US") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16750") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16750");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16750");
