package webportal.PaymentAndSubscription.PRJCBUGEN_T16751;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16751") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Use Discover international credit card type to buy device credits") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16751") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16751");
    ...
    @Step("Test Step 2: Check buy yearly premium subscription;")
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16751");
        ...
        assertTrue(
                new HamburgerMenuPage(false).checkSubscriptionScreen(paymentInfo.get("Number of Device Credits"))
                        && new HamburgerMenuPage().checkDevicesBilling(paymentInfo.get("Number of Device Credits"), "yearly", "JP"),
