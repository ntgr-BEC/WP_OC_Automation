package webportal.PaymentAndSubscription.PRJCBUGEN_T16755;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16755") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Use VISA international credit card type to buy device creditss") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16755") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16755");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16755");
