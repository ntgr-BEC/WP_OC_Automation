package webportal.PaymentAndSubscription.PRJCBUGEN_T16757;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16757") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("check the \"Cancel\" button functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16757") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16757");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16757");
