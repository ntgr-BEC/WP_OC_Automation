package webportal.PaymentAndSubscription.PRJCBUGEN_T16760;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16760") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the user should be able to change from one supported country to another supported country.") // It's a testcase
                                                                                                                              // title from Jira
                                                                                                                              // Test
    // Case.
    @TmsLink("PRJCBUGEN-T16760") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16760");
    ...
    @Step("Test Step 2: Check change account country to UK;")
    public void step2() {
