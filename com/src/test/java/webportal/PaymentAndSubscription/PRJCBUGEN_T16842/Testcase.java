package webportal.PaymentAndSubscription.PRJCBUGEN_T16842;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T16842") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("check the \"Cancel\" button functionality") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T16842") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T16842");
    ...
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T16842");
        ...
        if (new HamburgerMenuPage().checkDevicesBilling(paymentInfo.get("Number of Device Credits"), "basic", "US")) {
            new HamburgerMenuPage().cancelSubscription();
            assertTrue(new HamburgerMenuPage(false).checkSubscriptionScreenForBasic(), "Subscription status is incorrect.");
        } else {
            assertTrue(false, "Amount is incorrect.");
        }
    }
