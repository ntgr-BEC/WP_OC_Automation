package webportal.PaymentAndSubscriptionCountryWise.PRJCBUGEN_T17520;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17520") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Yearly  Subscription for  Denmark country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T17520") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Create IM WP account in Denmark success;")
    public void step1() {
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);

        Map<String, String> accountInfo = new HashMap<String, String>();
        accountInfo.put("First Name", mailname);
        accountInfo.put("Last Name", "T17520");
    ...
    @Step("Test Step 2: Check buy Yearly premium subscription in Country Denmark;")
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T17520");
