package webportal.PaymentAndSubscriptionCountryWise.PRJCBUGEN_T17527;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17527") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Monthly Subscription for  UK  country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T17527") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T17527");
    ...
    @Step("Test Step 2: Check buy Monthly premium subscription in Country UK;")
    public void step2() {
