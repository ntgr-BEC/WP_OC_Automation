package webportal.PaymentAndSubscriptionCountryWise.PRJCBUGEN_T17531;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17531") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Monthly Subscription for  Hungary country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T17531") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T17531");
    ...
    @Step("Test Step 2: Check buy Monthly premium subscription in Country Hungary")
    public void step2() {
