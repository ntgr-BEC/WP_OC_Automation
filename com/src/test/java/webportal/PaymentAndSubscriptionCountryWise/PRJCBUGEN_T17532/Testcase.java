package webportal.PaymentAndSubscriptionCountryWise.PRJCBUGEN_T17532;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17532") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Yearly Subscription for  Hungary country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T17532") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T17532");
    ...
    @Step("Test Step 2: Check buy Yearly premium subscription in Country Hungary")
    public void step2() {
        ...
        paymentInfo.put("Last Name", "T17532");
