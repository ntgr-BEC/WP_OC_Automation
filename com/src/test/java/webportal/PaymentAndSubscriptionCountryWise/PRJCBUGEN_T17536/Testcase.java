package webportal.PaymentAndSubscriptionCountryWise.PRJCBUGEN_T17536;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17536") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Yearly Subscription for  Italy country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T17536") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Check buy Yearly premium subscription in Country Italy")
    public void step2() {
