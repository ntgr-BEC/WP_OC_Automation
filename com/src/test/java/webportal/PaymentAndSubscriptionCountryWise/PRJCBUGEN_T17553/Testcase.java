package webportal.PaymentAndSubscriptionCountryWise.PRJCBUGEN_T17553;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17553") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Monthly Subscription for  South Africa country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T17553") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Create IM WP account in South Africa success;")
    public void step1() {
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);

        Map<String, String> accountInfo = new HashMap<String, String>();
        accountInfo.put("First Name", mailname);
        accountInfo.put("Last Name", "T17553");
    ...
    @Step("Test Step 2: Check buy Monthly premium subscription in Country South Africa")
    public void step2() {
