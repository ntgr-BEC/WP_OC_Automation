package webportal.PaymentAndSubscriptionCountryWise.PRJCBUGEN_T17564;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17564") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Monthly Subscription for  US country") // It's a testcase title
                                                                                                                 // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T17564") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 1: Create IM WP account in US success;")
    public void step1() {
        WebportalLoginPage webportalLoginPage = new WebportalLoginPage(true);

        Map<String, String> accountInfo = new HashMap<String, String>();
        accountInfo.put("First Name", mailname);
        accountInfo.put("Last Name", "T17564");
    ...
    @Step("Test Step 2: Check buy Monthly premium subscription in Country US")
    public void step2() {
