package webportal.PingAndTraceroute.AllDevices.PRJCBUGEN_T23037;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23037") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, on location level ping test, once ping test is done , all selected device for ping test has corresponding result > success and failure") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23037") // It's a testcase id/link from Jira Test Case.
