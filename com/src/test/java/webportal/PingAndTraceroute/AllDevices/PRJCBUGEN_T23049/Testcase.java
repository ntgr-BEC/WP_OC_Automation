package webportal.PingAndTraceroute.AllDevices.PRJCBUGEN_T23049;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23049") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, on location level > traceroute test, once traceroute test is done , all selected device for traceroute test has corresponding result > success and failure") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23049") // It's a testcase id/link from Jira Test Case.
