package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23030;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23030") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, ping test can be performed at location level for single device") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23030") // It's a testcase id/link from Jira Test Case.
