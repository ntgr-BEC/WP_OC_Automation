package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23032;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23032") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, ping test is available on trouble shoot page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23032") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        if (troubleshoot.Pinglookupclose.isDisplayed()) {
            troubleshoot.Pinglookupclose.click();
        }
    }
    ...
    public void step2() {
        ...
        assertTrue(troubleshoot.Ping.isDisplayed(), "Ping option is not avilable");
    }
