package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23033;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23033") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, ping test can be done on device level") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23033") // It's a testcase id/link from Jira Test Case.
