package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23034;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23034") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, ping test has customize option") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23034") // It's a testcase id/link from Jira Test Case.
