package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23038;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23038") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, on clicking success on one of the AP at location level , a pop up of detailed ping  test on  that selected device is shown") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23038") // It's a testcase id/link from Jira Test Case.
