package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23040;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23040") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, on trouble shoot button, when 'run test' tile is clicked a pop up with 4 option is available ;ping', 'DNS look up' along with 'Ookla speed test', 'traceroute'") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23040") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(troubleshoot.Ping.isDisplayed() && troubleshoot.Traceroute.isDisplayed() && troubleshoot.ooklaSpeedtest.isDisplayed() && troubleshoot.DNSLookup.isDisplayed(),"ping', 'DNS look up' along with 'Ookla speed test', 'traceroute' Not displayed");
    }
