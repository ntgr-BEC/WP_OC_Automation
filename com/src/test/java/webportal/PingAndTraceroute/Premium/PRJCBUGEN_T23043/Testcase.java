package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23043;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23043") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, traceroute test is available on trouble shoot page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23043") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(troubleshoot.Traceroute.isDisplayed(), "Ping option is not avilable");
    }
