package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23046;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23046") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, advanced setting option has packets per hop, max TTL, Init TTL, interval , port, size") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23046") // It's a testcase id/link from Jira Test Case.
