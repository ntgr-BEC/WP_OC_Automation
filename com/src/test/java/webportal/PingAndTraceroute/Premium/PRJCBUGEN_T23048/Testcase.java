package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23048;
...
public class Testcase extends TestCaseBase {
    String                                domain       = "www.scdssfas.com";
    String                                tmpStr;
    ...
    @Story("PRJCBUGEN_T23048") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify,failure message is notified when traceroute test is failed for any host") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23048") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(tmpStr.contains(WebportalParam.getLocText("Failed").toLowerCase()), "traceroute lookup result is not Success.");
        CompleteResultAP = troubleshoot.CheckTracerouteResult(WebportalParam.ap1serialNo);
        assertTrue(CompleteResultAP.contains(WebportalParam.getLocText("traceroute: bad address 'www.scdssfas.com").toLowerCase()), "ping lookup result is not complete.");       
