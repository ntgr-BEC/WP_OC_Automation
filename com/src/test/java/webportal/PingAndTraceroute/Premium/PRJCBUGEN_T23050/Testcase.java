package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23050;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23050") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, on clicking success , a pop of detailed traceroute test is shown") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23050") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(CompleteResultAP.contains(WebportalParam.getLocText("3 hops max, 46 byte packets").toLowerCase()), "ping lookup result is not complete.");       
