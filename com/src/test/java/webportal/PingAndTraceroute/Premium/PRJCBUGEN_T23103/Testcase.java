package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23103;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23103") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, 'View previous result' option for trace route on device level config") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23103") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        troubleshoot.DeviceTraceroute2.click();  
