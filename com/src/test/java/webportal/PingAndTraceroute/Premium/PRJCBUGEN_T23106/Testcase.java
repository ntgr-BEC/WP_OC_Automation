package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T23106;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23106") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, 'view previous  result' option on ping function on device level config for web") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23106") // It's a testcase id/link from Jira Test Case.
