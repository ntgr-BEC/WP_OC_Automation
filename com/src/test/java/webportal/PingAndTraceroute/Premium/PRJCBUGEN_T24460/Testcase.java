package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T24460;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24460") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, when 'test is in progress' status user is allowed to move around other screens") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24460") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        MyCommonAPIs.sleepi(5);
        assertTrue(troubleshoot.OtherScreen.isDisplayed(),"not able to travrse to otherscreen");
