package webportal.PingAndTraceroute.Premium.PRJCBUGEN_T24461;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24461") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, intermediate hops are shown when test is in progress for Trace route test") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24461") // It's a testcase id/link from Jira Test Case.
 ...
 // Each step is a single test step from Jira Test Case
    ...
    public void step2() {
      ...
      assertTrue(CompleteResultAP.contains(WebportalParam.getLocText("5 hops max, 46 byte packets").toLowerCase()), "ping lookup result is not complete.");       
