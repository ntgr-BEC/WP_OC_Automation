package webportal.PremiumInvoiceDownload.PRJCBUGEN_T33118;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("PremiumInvoiceDownload") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T33118") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Insight Premium Invoice Download for premium user only.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33118") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        assertTrue(new HamburgerMenuPage().checkdownlaodInvoice(), "invoice did not appear");
    }
    ...
    @Step("Test Step 5: Create a organization and location;")
    public void step5() {
    ...
    @Step("Test Step 6: Check Download invoice Present;")
    public void step6() {
