package webportal.PremiumInvoiceDownload.PRJCBUGEN_T33122;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33122") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Insight Premium Invoice Download  Yearly for premium user only.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33122") // It's a testcase id/link from Jira Test Case.
