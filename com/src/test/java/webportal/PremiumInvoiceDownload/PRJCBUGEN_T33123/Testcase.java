package webportal.PremiumInvoiceDownload.PRJCBUGEN_T33123;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33123") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Insight Premium Invoice Download for Monthly premium user only.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33123") // It's a testcase id/link from Jira Test Case.
    ...
    public void step5() throws IOException, SAXException, TikaException {
      ...
      new HamburgerMenuPage().downlaodInvoice();
       ...
       assertTrue(Filecontent.contains("Total Paid 3.00 AUD"),"invoice is not right");
