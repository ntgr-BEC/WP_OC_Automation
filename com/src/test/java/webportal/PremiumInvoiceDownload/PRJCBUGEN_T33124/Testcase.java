package webportal.PremiumInvoiceDownload.PRJCBUGEN_T33124;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33124") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, Insight Premium Invoice Download for  and Multipack premium user only.") // It's a test case title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33124") // It's a testcase id/link from Jira Test Case.
    ...
    public void step5() throws IOException, SAXException, TikaException {
       ...
       assertTrue(Filecontent.contains("Total Paid 229.23 AUD"),"invoice is not right");
