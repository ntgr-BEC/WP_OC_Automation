package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31206;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31206") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - US country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31206") // It's a testcase id/link from Jira Test Case.
