package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31211;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31211") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Denmark country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31211") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Denmark");
                ...
                businessInfo.put("Primary Address of Business", "Ostre Stationsvej");
                businessInfo.put("City", "Odense");
                businessInfo.put("State", "Odense");
