package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31214;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31214") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Germany country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31214") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Germany");
                ...
                businessInfo.put("Primary Address of Business", "Hohenheimer Strasse");
                businessInfo.put("City", "Stuttgart");
                businessInfo.put("State", "Stuttgart");
