package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31215;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31215") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Greece country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31215") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Greece");
                ...
                businessInfo.put("Primary Address of Business", "Psani Beach");
                businessInfo.put("City", "Nafpaktos");
                businessInfo.put("State", "Nafpaktos");
