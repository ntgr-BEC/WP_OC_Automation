package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31216;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31216") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Hong Kong country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31216") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Hong Kong");
                ...
                businessInfo.put("Primary Address of Business", "Mong Kok");
                businessInfo.put("City", "Causeway Bay");
                businessInfo.put("State", "Causeway Bay");
