package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31220;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31220") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Japan country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31220") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Japan");
                ...
                businessInfo.put("Primary Address of Business", "Tatsumicho");
                businessInfo.put("City", "Kyoto");
                businessInfo.put("State", "Kyoto");
                businessInfo.put("Zip Code", "8307");
