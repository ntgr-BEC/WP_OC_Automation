package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31221;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31221") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Lithuania country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31221") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Lithuania");
                ...
                businessInfo.put("Primary Address of Business", "Kaunas");
                businessInfo.put("City", "Kaunas");
                businessInfo.put("State", "Kaunas");
                businessInfo.put("Zip Code", "44293");
