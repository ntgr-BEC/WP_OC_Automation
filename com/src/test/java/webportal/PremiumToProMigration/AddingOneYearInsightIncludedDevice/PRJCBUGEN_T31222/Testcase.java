package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31222;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31222") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Luxembourg country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31222") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Luxembourg");
                ...
                businessInfo.put("Primary Address of Business", "Luxembourg");
                businessInfo.put("City", "Luxembourg");
                businessInfo.put("State", "Luxembourg");
