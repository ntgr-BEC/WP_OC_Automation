package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31226;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31226") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Poland country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31226") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Poland");
                ...
                businessInfo.put("Primary Address of Business", "Warsaw");
                businessInfo.put("City", "Warsaw");
                businessInfo.put("State", "Warsaw");
                businessInfo.put("Zip Code", "00001");
