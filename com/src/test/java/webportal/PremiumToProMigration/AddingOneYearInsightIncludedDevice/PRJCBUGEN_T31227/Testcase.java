package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31227;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31227") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Portugal country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31227") // It's a testcase id/link from Jira Test Case.
