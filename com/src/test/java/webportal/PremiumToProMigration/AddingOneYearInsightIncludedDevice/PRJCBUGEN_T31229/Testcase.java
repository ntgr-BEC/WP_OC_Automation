package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31229;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31229") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Singapore country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31229") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Singapore");
                ...
                businessInfo.put("Primary Address of Business", "Raffles Avenue");
                businessInfo.put("City", "Singapore");
                businessInfo.put("State", "Singapore");
