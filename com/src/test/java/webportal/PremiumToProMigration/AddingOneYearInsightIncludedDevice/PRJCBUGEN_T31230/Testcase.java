package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31230;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31230") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - South Africa country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31230") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "South Africa");
                ...
                businessInfo.put("Primary Address of Business", "Keerom Street");
                businessInfo.put("City", "Western Cape");
                businessInfo.put("State", "Western Cape");
