package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31235;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31235") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Austria country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31235") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Austria");
                ...
                businessInfo.put("Primary Address of Business", "Vienna");
                businessInfo.put("City", "Vienna");
                businessInfo.put("State", "Vienna");
                businessInfo.put("Zip Code", "A1070");
                businessInfo.put("Country", "Austria");
