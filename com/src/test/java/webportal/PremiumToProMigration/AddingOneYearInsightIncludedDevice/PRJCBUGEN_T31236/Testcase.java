package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31236;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31236") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Belgium country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31236") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Belgium");
                ...
                businessInfo.put("Primary Address of Business", "Bodenbroekstraat");
                businessInfo.put("City", "Bodenbroekstraat");
                businessInfo.put("State", "Brussels");
                businessInfo.put("Zip Code", "B1000");
                businessInfo.put("Country", "Belgium");
