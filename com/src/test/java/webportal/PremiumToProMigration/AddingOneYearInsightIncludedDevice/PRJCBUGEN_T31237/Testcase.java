package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31237;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31237") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Bulgaria country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31237") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Bulgaria");
                ...
                businessInfo.put("Primary Address of Business", "Burgas");
                businessInfo.put("City", "Burgas");
                businessInfo.put("State", "Burgas");
                businessInfo.put("Zip Code", "8000");
                businessInfo.put("Country", "Bulgaria");
