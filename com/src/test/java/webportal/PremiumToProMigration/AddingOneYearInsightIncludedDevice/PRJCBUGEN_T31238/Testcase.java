package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31238;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31238") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Croatia country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31238") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Croatia");
                ...
                businessInfo.put("Primary Address of Business", "Cavtat");
                businessInfo.put("City", "Cavtat");
                businessInfo.put("State", "Cavtat");
                businessInfo.put("Zip Code", "20210");
                businessInfo.put("Country", "Croatia");
