package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31239;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31239") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Czech Republic country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31239") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Czech Republic");
                ...
                businessInfo.put("Primary Address of Business", "Prague");
                businessInfo.put("City", "Prague");
                businessInfo.put("State", "Prague");
                businessInfo.put("Zip Code", "15000");
                businessInfo.put("Country", "Czech Republic");
