package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31240;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31240") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Cyprus country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31240") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Cyprus");
                ...
                businessInfo.put("Primary Address of Business", "Poseidonos Avenue");
                businessInfo.put("City", "Paphos");
                businessInfo.put("State", "Paphos");
                businessInfo.put("Zip Code", "8125");
                businessInfo.put("Country", "Cyprus");
