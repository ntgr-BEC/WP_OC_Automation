package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31241;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31241") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Latvia country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31241") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Latvia");
                ...
                businessInfo.put("Primary Address of Business", "Centra rajons");
                businessInfo.put("City", "Riga");
                businessInfo.put("State", "Riga");
                businessInfo.put("Zip Code", "LV1010");
                businessInfo.put("Country", "Latvia");
