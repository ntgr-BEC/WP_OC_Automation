package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31242;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31242") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Malta country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31242") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Malta");
                ...
                businessInfo.put("Primary Address of Business", "Julians");
                businessInfo.put("City", "Julians");
                businessInfo.put("State", "Julians");
                businessInfo.put("Zip Code", "STJ3310");
                businessInfo.put("Country", "Malta");
