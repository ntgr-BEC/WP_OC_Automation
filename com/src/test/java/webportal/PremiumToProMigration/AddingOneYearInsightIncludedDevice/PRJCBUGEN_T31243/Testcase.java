package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31243;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Slovenia country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Slovenia");
                ...
                businessInfo.put("Primary Address of Business", "Portorose");
                businessInfo.put("City", "Portorose");
                businessInfo.put("State", "Portorose");
                businessInfo.put("Zip Code", "6320");
                businessInfo.put("Country", "Slovenia");
