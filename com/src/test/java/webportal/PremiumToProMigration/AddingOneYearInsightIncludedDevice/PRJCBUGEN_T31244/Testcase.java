package webportal.PremiumToProMigration.AddingOneYearInsightIncludedDevice.PRJCBUGEN_T31244;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31243") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Slovakia country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31243") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Slovakia");
                ...
                businessInfo.put("Primary Address of Business", "Bratislava");
                businessInfo.put("City", "Bratislava");
                businessInfo.put("State", "Bratislava");
                businessInfo.put("Zip Code", "81109");
                businessInfo.put("Country", "Slovakia");
