package webportal.PremiumToProMigration.FreeTrail.PRJCBUGEN_T31289;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31289") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Free Trail - Hungary country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31289") // It's a testcase id/link from Jira Test Case.
