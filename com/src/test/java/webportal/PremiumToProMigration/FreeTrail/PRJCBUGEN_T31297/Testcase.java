package webportal.PremiumToProMigration.FreeTrail.PRJCBUGEN_T31297;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31297") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Free Trail - New Zealand country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31297") // It's a testcase id/link from Jira Test Case.
