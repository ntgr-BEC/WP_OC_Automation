package webportal.PremiumToProMigration.FreeTrail.PRJCBUGEN_T31312;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN-T31312") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Free Trail - Cyprus country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31208") // It's a testcase id/link from Jira Test Case.
