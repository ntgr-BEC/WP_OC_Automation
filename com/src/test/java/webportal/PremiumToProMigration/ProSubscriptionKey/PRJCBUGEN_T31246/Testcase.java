package webportal.PremiumToProMigration.ProSubscriptionKey.PRJCBUGEN_T31246;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31246") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow License Key - Denmark country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31246") // It's a testcase id/link from Jira Test Case.
