package webportal.PremiumToProMigration.ProSubscriptionKey.PRJCBUGEN_T31254;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31254") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow License Key - Italy country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31254") // It's a testcase id/link from Jira Test Case.
