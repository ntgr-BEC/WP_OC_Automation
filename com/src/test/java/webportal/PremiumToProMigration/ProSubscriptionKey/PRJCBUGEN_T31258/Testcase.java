package webportal.PremiumToProMigration.ProSubscriptionKey.PRJCBUGEN_T31258;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31258") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow License Key - Netherlands country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31258") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                businessInfo.put("Primary Address of Business", "Stadhouderskade");
                businessInfo.put("City", "Amsterdam");
                businessInfo.put("State", "Amsterdam");
                businessInfo.put("Zip Code", "1011");
