package webportal.PremiumToProMigration.ProSubscriptionKey.PRJCBUGEN_T31264;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31264") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow License Key - Singapore country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31264") // It's a testcase id/link from Jira Test Case.
