package webportal.PremiumToProMigration.ProSubscriptionKey.PRJCBUGEN_T31280;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31280") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow License Key - Australia country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T31280") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).checkCreateProAccountPage("checkNext:" + mailname)) {
                ...
                proAccountInfo.put("Country", "Australia");
