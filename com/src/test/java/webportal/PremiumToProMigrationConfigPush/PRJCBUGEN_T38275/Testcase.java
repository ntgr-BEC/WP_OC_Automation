package webportal.PremiumToProMigrationConfigPush.PRJCBUGEN_T38275;
...
public class Testcase extends TestCaseBase {
    ...
    String              organizationName = "PRJCBUGEN_T38275";
    ...
    @Story("PRJCBUGEN_T38275") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that premium account having BCP SSID with connected client migrated to pro account and verify same config is there or not")                                                                                                                                                             // Case.
    @TmsLink("PRJCBUGEN_T38275") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        ssidInfo.put("SSID", "PRJCBUGEN_T38275");
        ...
        while (true) {
            ...
            if (new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID PRJCBUGEN_T38275")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect PRJCBUGEN_T38275 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
    ...
    public void step6() {
        ...
        new WirelessQuickViewPage().verifyOrganizationWirelessQuickViewPage("PRJCBUGEN_T38275");
    }
