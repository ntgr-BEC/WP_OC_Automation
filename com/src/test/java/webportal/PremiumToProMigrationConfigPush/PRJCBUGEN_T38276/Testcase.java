package webportal.PremiumToProMigrationConfigPush.PRJCBUGEN_T38276;
...
public class Testcase extends TestCaseBase {
    ...
    String              organizationName = "PRJCBUGEN_T38276";
    ...
    @Story("PRJCBUGEN_T38276") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that premium account having 2 band WPA2 Enterprise SSID with connected client migrated to pro account and verify same config is there or not")                                                                                                                                                             // Case.
    @TmsLink("PRJCBUGEN_T38276") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        ssidInfo.put("SSID", "PRJCBUGEN_T38276");
        ...
        new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo nmcli device wifi list | grep -F \"PRJCBUGEN_T38276\"");
        MyCommonAPIs.sleepi(20);
        new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli c add type wifi con-name \"PRJCBUGEN_T38276\" ifname wlp4s0 ssid \"PRJCBUGEN_T38276\"");      
        MyCommonAPIs.sleepi(20);
        new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection modify \"PRJCBUGEN_T38276\" wifi-sec.key-mgmt wpa-eap 802-1x.eap peap 802-1x.phase2-auth mschapv2 802-1x.identity \"teju\" 802-1x.password \"teju\"");
        MyCommonAPIs.sleepi(20);
        new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection up \"PRJCBUGEN_T38276\"");
    ...
    public void step6() {
        ...
        new WirelessQuickViewPage().verifyOrganizationWirelessQuickViewPage("PRJCBUGEN_T38276");
    }
