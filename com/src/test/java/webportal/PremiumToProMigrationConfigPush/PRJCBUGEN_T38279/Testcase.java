package webportal.PremiumToProMigrationConfigPush.PRJCBUGEN_T38279;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T38279";
    ...
    @Story("PRJCBUGEN_T38279") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that premium account having LinkedIn ICP SSID with connected client migrated to pro account and verify same config is there or not") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T38279") // It's a testcase id/link from Jira Test Case.
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
    ...
    public void step5() {
        ...
        ssidInfo.put("SSID", "PRJCBUGEN_T38279");
        ...
        while (true) {
            ...
            if (new Javasocket()
                    .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFfindSSID PRJCBUGEN_T38279")
                    .indexOf("true") != -1) {
                break;
            } else if (sum > 30) {
        ...
        if (!new Javasocket()
                .sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFconnect PRJCBUGEN_T38279 12345678 WPA2PSK aes")
                .equals("true")) {
            result1 = false;
    ...
    public void step8() {
        ...
        new WirelessQuickViewPage().verifyOrganizationWirelessQuickViewPage("PRJCBUGEN_T38279");
    }
