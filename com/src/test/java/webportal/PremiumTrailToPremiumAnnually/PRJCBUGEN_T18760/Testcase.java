package webportal.PremiumTrailToPremiumAnnually.PRJCBUGEN_T18760;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18760") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail to Premium Yearly Subscription for Lithuania country") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18760") // It's a testcase id/link from Jira Test Case.
...
//    }
 ...
 new AccountPage().enterLocation("OnBoardingTest");
    ...
    public void step5() {
        ...
        paymentInfo.put("Street Address", "Gruodzio");
