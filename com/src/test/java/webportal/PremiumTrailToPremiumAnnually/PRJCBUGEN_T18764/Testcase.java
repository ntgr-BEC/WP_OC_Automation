package webportal.PremiumTrailToPremiumAnnually.PRJCBUGEN_T18764;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18764") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail to Premium Yearly Subscription for Norway country") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18764") // It's a testcase id/link from Jira Test Case.
...
//    }
 ...
 new AccountPage().enterLocation("OnBoardingTest");
    ...
    public void step5() {
        ...
        new HamburgerMenuPage(false).upgradeSubscriptionNorway(paymentInfo);
