package webportal.PremiumTrailToPremiumMonthly.PRJCBUGEN_T18697;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18697") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail to Premium Monthly Subscription for Canada country") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18697") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18697");
...
//        new HamburgerMenuPage(false);
    ...
    @Step("Test Step4: Add device To the Network;")
    public void step4() {
