package webportal.PremiumTrailToPremiumMonthly.PRJCBUGEN_T18699;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18699") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail to Premium Monthly Subscription for Finland country") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18699") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18699");
    ...
    @Step("Test Step3: Create new location")
    public void step3() {
...
//        new HamburgerMenuPage(false);
    ...
    @Step("Test Step4: Add device and check whether it throws error while adding second device;")
    public void step4() {
