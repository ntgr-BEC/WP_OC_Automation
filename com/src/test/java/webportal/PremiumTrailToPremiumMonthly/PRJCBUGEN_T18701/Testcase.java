package webportal.PremiumTrailToPremiumMonthly.PRJCBUGEN_T18701;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18701") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail to Premium Monthly Subscription for Germany country") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18701") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18701");
...
//        new HamburgerMenuPage();
 ...
 new AccountPage().enterLocation("OnBoardingTest");
    ...
    @Step("Test Step5: chnage premium Trail to Premium Monthly;")
    public void step5() {
