package webportal.PremiumTrailToPremiumMonthly.PRJCBUGEN_T18710;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18710") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail to Premium Monthly Subscription for Netherlands country") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18710") // It's a testcase id/link from Jira Test Case.
