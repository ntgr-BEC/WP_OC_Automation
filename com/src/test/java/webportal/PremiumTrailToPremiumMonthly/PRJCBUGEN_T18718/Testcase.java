package webportal.PremiumTrailToPremiumMonthly.PRJCBUGEN_T18718;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T18718") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Buying Premium Trail to Premium Monthly Subscription for Spain country") // It's a testcase title
                                                                                                      // from Jira Test Case.
    @TmsLink("PRJCBUGEN_T18718") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T18718");
