package webportal.Premium_To_Pro_Migration.ICP.PRJCBUGEN_T33707;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33707";

    @Feature("Premium_To_Pro_Migration") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T33707") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, user should able to puchase multiple instant captive portal for diff-diff year.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33707") // It's a testcase id/link from Jira Test Case.
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
        ...
        handle.gotoLoction();
        result1 = new HamburgerMenuPage().checkCaptivePortalServicesCredits();
        assertTrue(result1, "<2> Captive portal services credits is incorrect.");
