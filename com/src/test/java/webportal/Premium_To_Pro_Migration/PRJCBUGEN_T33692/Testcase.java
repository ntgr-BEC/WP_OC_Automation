package webportal.Premium_To_Pro_Migration.PRJCBUGEN_T33692;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33692") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that for hard bundle device in account, click on “upgrade to pro subscription” need to fill bussiness details and migrate into pro user.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33692") // It's a testcase id/link from Jira Test Case.
