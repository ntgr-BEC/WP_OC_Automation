package webportal.Premium_To_Pro_Migration.PRJCBUGEN_T33694;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33694";

    @Feature("Premium_To_Pro_Migration") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T33694") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that for non-hard bundle device in account, click on “upgrade to pro subscription” need to enter LSM key and fill bussiness details and migrate into pro user.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33694") // It's a testcase id/link from Jira Test Case.
