package webportal.Premium_To_Pro_Migration.PRJCBUGEN_T33702;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33702";
    ...
    @Story("PRJCBUGEN_T33702") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, On purchase order history user should get link for upgrade to pro subscription without location and devices (hard bundle and non hard bundle)") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33702") // It's a testcase id/link from Jira Test Case.
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
    ...
    @Step("Test Step 4: Verify upgrade to pro link;")
    public void step4() {
        new MyCommonAPIs().open(URLParam.hrefpurchaseHistory, true);
        assertTrue(new HamburgerMenuPage(false).verifyUpgradeToproInPurhaseHstory(), "upgrade to pro link not found");
    }
