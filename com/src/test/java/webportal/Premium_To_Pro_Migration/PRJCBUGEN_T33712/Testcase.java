package webportal.Premium_To_Pro_Migration.PRJCBUGEN_T33712;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33712";
    String initialUrl =  "";

    @Feature("Premium_To_Pro_Migration") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T33712") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that if user click on “Where can I buy a Pro key” then link will redirect on https://www.netgear.com/business/where-to-buy/ for countries – Germany,Spain,France,Italy,Netherlands,Japan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33712") // It's a testcase id/link from Jira Test Case.
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
    ...
    public void step3() {
        ...
        initialUrl = WebDriverRunner.url();
    ...
    public void step4() {
        ...
        assertTrue(new HamburgerMenuPage(false).verifyWherecanIbuyaProkeyURL(),"Where can I buy a Pro key? Link is not present on license page.");
    }
