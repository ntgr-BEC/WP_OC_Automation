package webportal.ProAccountCreation.RegisterFlow.PRJCBUGEN_T45681;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45681") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that the isnight Pro account can be created using the registration flow with a free trail for 25 devices.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T45681") // It's a testcase id/link from Jira Test Case.
