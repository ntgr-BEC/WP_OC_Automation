package webportal.ProAccountCreation.RegisterFlow.PRJCBUGEN_T45682;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45682") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow License Key - US country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T45682") // It's a testcase id/link from Jira Test Case.
