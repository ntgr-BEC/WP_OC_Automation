package webportal.ProAccountCreation.RegisterFlow.PRJCBUGEN_T45683;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45683") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - US country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T45683") // It's a testcase id/link from Jira Test Case.
