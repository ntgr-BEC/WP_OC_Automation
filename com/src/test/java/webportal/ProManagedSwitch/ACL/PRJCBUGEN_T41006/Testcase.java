package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41006;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41006") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("005-Create IP ACL,then disable it") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41006") // It's a testcase id/link from Jira Test Case.
