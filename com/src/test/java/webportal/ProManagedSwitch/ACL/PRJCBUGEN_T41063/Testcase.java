package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41063;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41063") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("009-Permit one source ip address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41063") // It's a testcase id/link from Jira Test Case.
