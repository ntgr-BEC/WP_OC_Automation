package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41079;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41079") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("010-Permit one destination ip address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41079") // It's a testcase id/link from Jira Test Case.
    ...
    public void step5() {
        ...
        assertTrue(SwitchCLIUtils.ACLClass.aclResult.contains(tmpStr), "permiy to any: " + tmpStr);
        tmpStr = "permit " + ipaclIp;
        assertTrue(SwitchCLIUtils.ACLClass.aclResult.contains(tmpStr), "permiy to ip: " + tmpStr);
    }
}
