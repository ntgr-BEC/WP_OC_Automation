package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41090;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41090") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("011-Permit ip acl,match source ip or destination ip") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41090") // It's a testcase id/link from Jira Test Case.
