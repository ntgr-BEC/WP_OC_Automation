package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41108;
...
public class Testcase extends TestCaseBase {
    ...
    public void step5() {
        ...
        assertTrue(SwitchCLIUtils.ACLClass.aclResult.contains(tmpStr), "deny to any: " + tmpStr);
        tmpStr = ipaclIp;
        assertTrue(SwitchCLIUtils.ACLClass.aclResult.contains(tmpStr), "check ip acl: " + tmpStr);
    }
}
