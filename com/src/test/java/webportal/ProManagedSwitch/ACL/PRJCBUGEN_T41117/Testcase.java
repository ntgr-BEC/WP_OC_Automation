package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41117;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41117") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("014-Deny ip acl,match source ip address or destination ip address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41117") // It's a testcase id/link from Jira Test Case.
    ...
    public void step5() {
        ...
        assertTrue(SwitchCLIUtils.ACLClass.aclResult.contains(sRet), sRet);
        sRet = "deny " + ipaclIp;
        assertTrue(SwitchCLIUtils.ACLClass.aclResult.contains(sRet), sRet);
    }
}
