package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41144;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41144") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("018-Reboot switch after set IP ACL") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41144") // It's a testcase id/link from Jira Test Case.
