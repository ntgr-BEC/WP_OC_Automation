package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41163;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41163") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("022-Multiple ACL binding to one vlan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41163") // It's a testcase id/link from Jira Test Case.
