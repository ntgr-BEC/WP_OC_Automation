package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41174;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41174") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("025-Edit device name,ip address,ip mask for manual ip allow policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41174") // It's a testcase id/link from Jira Test Case.
