package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41190;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41190") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("028-Edit device name,ip address,ip mask for manual deny policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41190") // It's a testcase id/link from Jira Test Case.
