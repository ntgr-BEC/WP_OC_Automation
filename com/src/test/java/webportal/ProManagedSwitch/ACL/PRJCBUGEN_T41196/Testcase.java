package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41196;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41196") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("029-Edit access type for manual deny policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41196") // It's a testcase id/link from Jira Test Case.
