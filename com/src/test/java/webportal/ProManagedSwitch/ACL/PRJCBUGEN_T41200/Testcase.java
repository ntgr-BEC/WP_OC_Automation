package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41200;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41200") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("030-Customer allow policy: Create ip acl,device range is disable") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41200") // It's a testcase id/link from Jira Test Case.
