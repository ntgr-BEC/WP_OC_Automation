package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41217;
...
public class Testcase extends TestCaseBase {
    ...
    @Issue("PRJCBUGEN-41217")
    @Feature("Switch.ACL") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T41217") // It's a testcase id/link from Jira Test Case but replace - with _.
