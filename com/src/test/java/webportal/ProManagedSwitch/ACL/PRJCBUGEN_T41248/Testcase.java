package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41248;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41248") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("046-Permit manual source MAC address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41248") // It's a testcase id/link from Jira Test Case.
