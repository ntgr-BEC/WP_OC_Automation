package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41251;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41251") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("047-Permit manual destination MAC address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41251") // It's a testcase id/link from Jira Test Case.
