package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41252;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41252") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("048-Add custom mac addrss,the policy is allow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41252") // It's a testcase id/link from Jira Test Case.
