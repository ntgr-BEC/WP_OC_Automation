package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41257;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41257") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("049-Deny manual source mac address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41257") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(SwitchCLIUtils.ACLClass.aclResult.contains(String.format("deny %s 00:00:00:00:00:00 any", ipaclMac)),
                "1.Deny source mac address");
    }
