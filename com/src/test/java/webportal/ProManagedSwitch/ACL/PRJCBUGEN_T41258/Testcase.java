package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41258;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41258") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("050-Deny manual destination mac address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41258") // It's a testcase id/link from Jira Test Case.
    ...
    // Each step is a single test step from Jira Test Case
    @Step("Test Step 2: 1.action is deny,input destination mac address,option select allow access to this device")
    public void step2() {
