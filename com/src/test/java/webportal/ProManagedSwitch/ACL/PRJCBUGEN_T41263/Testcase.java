package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41263;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41263") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("051-Add custom mac address,the policy is deny") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41263") // It's a testcase id/link from Jira Test Case.
