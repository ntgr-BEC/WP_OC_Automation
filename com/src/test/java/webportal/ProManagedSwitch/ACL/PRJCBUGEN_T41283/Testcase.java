package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41283;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41283") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("062-Delete MAC ACL,the policy is allow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41283") // It's a testcase id/link from Jira Test Case.
