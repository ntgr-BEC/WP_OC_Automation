package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41289;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41289") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("069-Deploy max(26) IP ACL for one vlan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41289") // It's a testcase id/link from Jira Test Case.
