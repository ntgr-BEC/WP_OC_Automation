package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41294;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41294") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("072-Deploy max(26) MAC ACL for one vlan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41294") // It's a testcase id/link from Jira Test Case.
