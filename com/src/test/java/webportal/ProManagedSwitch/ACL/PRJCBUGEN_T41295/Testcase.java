package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41295;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41295") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("073-Add manual mac acl,permit source and des mac address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41295") // It's a testcase id/link from Jira Test Case.
