package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41298;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41298") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("074-Edit manual mac acl,the policy is allow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41298") // It's a testcase id/link from Jira Test Case.
