package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41301;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41301") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("076 -Edit manual mac acl,the policy is deny") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41301") // It's a testcase id/link from Jira Test Case.
