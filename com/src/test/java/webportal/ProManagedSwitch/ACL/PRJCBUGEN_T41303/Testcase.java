package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41303;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41303") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("077-Edit custom mac acl,the policy is deny") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41303") // It's a testcase id/link from Jira Test Case.
