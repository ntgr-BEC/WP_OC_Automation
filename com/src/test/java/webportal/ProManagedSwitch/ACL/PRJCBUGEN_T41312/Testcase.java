package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41312;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41312") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("083-[Network Setup]Edit device name,ip address,ip mask for manual deny policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41312") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        netsp.mamData.devName = "test@083";
        netsp.mamData.devIp = "100.1.1.100";
        netsp.mamData.devMask = "0.255.255.255";
