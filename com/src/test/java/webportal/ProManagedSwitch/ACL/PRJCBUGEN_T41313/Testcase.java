package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41313;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41313") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("084-[Network Setup] Edit access type for manual deny policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41313") // It's a testcase id/link from Jira Test Case.
