package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41319;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41319") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("088-[Network Setup] Delete Customer IP ACL") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41319") // It's a testcase id/link from Jira Test Case.
