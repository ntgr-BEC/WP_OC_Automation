package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41320;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41320") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("089-[Network Setup] Create ACL binding to vlan,then delete the vlan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41320") // It's a testcase id/link from Jira Test Case.
