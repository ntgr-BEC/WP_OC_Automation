package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41322;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41322") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("090-[Network Setup] Edit manual mac acl,the policy is allow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41322") // It's a testcase id/link from Jira Test Case.
