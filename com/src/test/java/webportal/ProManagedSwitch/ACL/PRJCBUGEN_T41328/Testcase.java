package webportal.ProManagedSwitch.ACL.PRJCBUGEN_T41328;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41328") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("093-[Network Setup] Edit custom mac acl,the policy is deny") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41328") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertFalse(SwitchCLIUtils.ACLClass.ispermitACL, "check deny acl");         //deny : so ispermitACL will be false 
    ...
    @Step("Test Step 4: Edit custom deny policy. from-a1:a1:a1:a1:11:22,to-b1:b1:b1:b1:22:33")
    public void step4() {
        netsp.gotoPage();
