package webportal.ProManagedSwitch.CableTest.PRJCBUGEN_T40947;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T40947") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("001-Get Cable Test Status with one port") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40947") // It's a testcase id/link from Jira Test Case.
    @Test(alwaysRun = true, groups = "p1")
    @Issue("PRJCBUGEN-40947")
