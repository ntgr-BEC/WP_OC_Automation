package webportal.SwitchManaged.DhcpRelay.PRJCBUGEN_T35593;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35593") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that if that DHCP relay configuration is applied from the insight portal or in LOCAL GUI of the switch, it should reflected Switch logs") // It's
                                                                                                                                                                           // a
                                                                                                                                                                           // testcase
                                                                                                                                                                           // title
                                                                                                                                                                           // from
    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T35593") // It's a testcase id/link from Jira Test Case.
