package webportal.ProManagedSwitch.DhcpRelay.PRJCBUGEN_T42226;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42226") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that DHCP Snooping and DHCP Relay has Global Configuration & Port Configuration") // It's a testcase title from
                                                                                                                   // Jira Test Case.
    @TmsLink("PRJCBUGEN-T42226") // It's a testcase id/link from Jira Test Case.
