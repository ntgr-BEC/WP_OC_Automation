package webportal.ProManagedSwitch.DhcpRelay.PRJCBUGEN_T42232;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42232") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user able Port configuration has the following lists: Admin Mode & 82 Option Trust Mode") // It's a testcase
                                                                                                                                // title from
    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T42232") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        if (goToRelayPortPage != null) {
            ...
            assertTrue(WiredDhcpRelayElement.dhcpRelayPortConfigAdminMode.exists(), "Admin Mode should be there under DHCP L2 Relay section");
            assertTrue(WiredDhcpRelayElement.dhcpRelayPortConfigTrustMode.exists(), "82 Option Trust Mode should be there under DHCP L2 Relay");
        }
