package webportal.ProManagedSwitch.DhcpRelay.PRJCBUGEN_T42233;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42233") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user able to Navigate to the Port Configuration in the DHCP Relay section") // It's a testcase title from
                                                                                                                   // Jira Test Case.
    @TmsLink("PRJCBUGEN-T42233") // It's a testcase id/link from Jira Test Case.
