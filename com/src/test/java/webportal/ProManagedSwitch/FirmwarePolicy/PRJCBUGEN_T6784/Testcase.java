package webportal.ProManagedSwitch.FirmwarePolicy.PRJCBUGEN_T6784;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6784") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("202 - Create daily Firmware Policy and no end date, update by schedule") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6784") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Select a specific \"Start Date\" and \"End Date\" (PST), select daily recurrence, and \"Never\" end, click \"Save\"")
    public void step2() {
        fmpp.gotoPage();
