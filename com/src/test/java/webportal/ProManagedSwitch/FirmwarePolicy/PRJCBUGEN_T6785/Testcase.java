package webportal.ProManagedSwitch.FirmwarePolicy.PRJCBUGEN_T6785;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6785") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("203 - Create daily Firmware Policy and end after recurrence") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6785") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Select a specific \"Start Date\" and \"End Date\" (PST), select daily recurrence, and set end after 2 recurrence, click \"Save\"")
    public void step2() {
        fmpp.gotoPage();
        fmpp.ddRec.repeatType = 1;
