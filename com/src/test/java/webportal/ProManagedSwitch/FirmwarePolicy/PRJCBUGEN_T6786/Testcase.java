package webportal.ProManagedSwitch.FirmwarePolicy.PRJCBUGEN_T6786;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6786") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("204 - Create daily Firmware Policy and end on specific date, update by schedule")
    @TmsLink("PRJCBUGEN-T6786") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Select a specific \"Start Date\" and \"End Date\" (PST), select daily recurrence, and set end date (e.g. 3rd day), click \"Save\"")
    public void step2() {
        fmpp.gotoPage();
