package webportal.ProManagedSwitch.FirmwarePolicy.PRJCBUGEN_T6788;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6788") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("206 - Create weekly Firmware Policy and end after recurrence") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6788") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Select a specific \"Start Date\" and \"End Date\" (PST), select every Tuesday and Wednesday recurrence, and set end after 3 recurrence, click \"Save\"")
    public void step2() {
        fmpp.gotoPage();
