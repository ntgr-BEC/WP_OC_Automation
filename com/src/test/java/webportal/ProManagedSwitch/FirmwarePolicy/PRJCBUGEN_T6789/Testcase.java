package webportal.ProManagedSwitch.FirmwarePolicy.PRJCBUGEN_T6789;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6789") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("207 - Create weekly Firmware Policy and end on specific date, update by schedule") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6789") // It's a testcase id/link from Jira Test Case.
