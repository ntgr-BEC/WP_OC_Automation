package webportal.ProManagedSwitch.FirmwarePolicy.PRJCBUGEN_T6790;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6790") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("208 - Create Monthly Firmware Policy and no end date, update by schedule") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6790") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Select a specific \"Start Date\" and \"End Date\" (PST), select Monthly at day1 recurrence, and \"Never\" end, click \"Save\"")
    public void step2() {
        fmpp.gotoPage();
