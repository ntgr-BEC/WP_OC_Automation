package webportal.ProManagedSwitch.FirmwarePolicy.PRJCBUGEN_T6792;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6792") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("210 - Create monthly Firmware Policy and end on specific date, update by schedule") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6792") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Select a specific \"Start Date\" and \"End Date\" (PST), select every Monday/Thursday/Sunday recurrence, and set end date (e.g. 5/30), click \"Save\"")
    public void step2() {
        fmpp.gotoPage();
