package webportal.ProManagedSwitch.FirmwarePolicy.PRJCBUGEN_T6797;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6797") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("215 - Trigger firmware schedule upgrade when set network location time zone - 3:30") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6797") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Set user network time zone GMT-4")
    public void step2() {
