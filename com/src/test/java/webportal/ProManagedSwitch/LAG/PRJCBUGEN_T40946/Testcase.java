package webportal.ProManagedSwitch.LAG.PRJCBUGEN_T40946;
...
public class Testcase extends TestCaseBase {
    ...
    String lagName   = "testlag40946";
    String vlanName  = "testvlan946";
    String vlanId    = "946";
    String lagId     = "1";
    int    portIndex = 3;
    ...
    @Story("PRJCBUGEN_T40946") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("001-Create LAG with 1 menbership between two DUTS") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40946") // It's a testcase id/link from Jira Test Case.
