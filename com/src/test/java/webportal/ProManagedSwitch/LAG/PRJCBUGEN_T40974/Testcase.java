package webportal.ProManagedSwitch.LAG.PRJCBUGEN_T40974;
...
public class Testcase extends TestCaseBase {
    ...
    String lagName    = "testlag40974";
    String vlanName   = "testvlan974";
    String vlanId     = "974";
    String lagId      = "1";
    int    portIndex  = 4;
    int    portIndex1 = 5;
    ...
    @Story("PRJCBUGEN_T40974") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("003-Create LAG with LACP mode between two DUTs") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40974") // It's a testcase id/link from Jira Test Case.
