package webportal.ProManagedSwitch.LAG.PRJCBUGEN_T40989;
...
public class Testcase extends TestCaseBase {
    ...
    String lagName    = "testlag40989";
    String lagName1   = "testlag40989";
    ...
    @Story("PRJCBUGEN_T40989") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("004-Config lag with membership already blong to another lag") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40989") // It's a testcase id/link from Jira Test Case.
