package webportal.ProManagedSwitch.LAG.PRJCBUGEN_T41018;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41018") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("006-Create lag when DUT is offline") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41018") // It's a testcase id/link from Jira Test Case.
