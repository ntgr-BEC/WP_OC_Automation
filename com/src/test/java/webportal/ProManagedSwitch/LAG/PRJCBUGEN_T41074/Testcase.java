package webportal.ProManagedSwitch.LAG.PRJCBUGEN_T41074;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41074") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("010-Create a lag and name it as a used name") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41074") // It's a testcase id/link from Jira Test Case.
