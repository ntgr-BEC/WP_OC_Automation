package webportal.ProManagedSwitch.LAG.PRJCBUGEN_T41095;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41095") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("012-Create lag with disabled port") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41095") // It's a testcase id/link from Jira Test Case.
