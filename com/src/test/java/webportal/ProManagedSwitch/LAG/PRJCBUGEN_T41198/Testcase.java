package webportal.ProManagedSwitch.LAG.PRJCBUGEN_T41198;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41198") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("030- LAG selection inside port membership") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41198") // It's a testcase id/link from Jira Test Case.
