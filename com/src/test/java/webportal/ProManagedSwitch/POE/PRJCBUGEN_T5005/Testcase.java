package webportal.ProManagedSwitch.POE.PRJCBUGEN_T5005;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T5005") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("006-Change All PoE ports setting") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T5005") // It's a testcase id/link from Jira Test Case.
    ...
    public void step4() {
        ...
        tmpStr = SwitchCLIUtils.getPoEInfo("g3");
        assertTrue(tmpStr.contains(sCurrentValue), "verify the power limit is set to 7 - 3");
    }
    ...
    public void step10() {
        ...
        tmpStr = SwitchCLIUtils.getPoEInfo("g3");
        assertTrue(SwitchCLIUtils.PoEClass.isEnabled, "verify g3 the power limit is enabled");
    }
