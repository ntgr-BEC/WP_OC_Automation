package webportal.ProManagedSwitch.POE.PRJCBUGEN_T5022;
...
public class Testcase extends TestCaseBase {
    ...
    public String sTestStr = "TSName5022";
    public String sCurrentValue;
    public String sExpectedtValue;

    @Feature("Switch.POE") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T5022") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("025-Disable time schedule for 1 port") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T5022") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: On single port config page,set time schedule to time1")
    public void step3() {
        ButtonElements btn = new ButtonElements();
    ...
    @Step("Test Step 4: On app,config the single port do not use time schedule")
    public void step4() {
        wpsp.openTimeSchedule(sTestStr, 1);
        handle.clickPortPoE(1);
        //handle.clickButton(0);
