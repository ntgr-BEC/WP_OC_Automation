package webportal.ProManagedSwitch.Port.PRJCBUGEN_T4887;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T4887") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("008-Link between 100M half-duplex and auto") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4887") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: config DUT port 1 at 100M half-duplex Switch port1 at auto")
    public void step2() {
