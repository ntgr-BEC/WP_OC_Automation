...
public class Testcase extends TestCaseBase {
    ...
    public void step4() {
        ...
        assertTrue(SwitchCLIUtils.RadiusClass.portStatus == 2, "check radius option on port1");
        tmpStr = SwitchCLIUtils.getRadiusInfo("g" + WebportalParam.sw1LagPort2);
        assertTrue(SwitchCLIUtils.RadiusClass.portStatus == 2, "check radius option on port2");
    }
