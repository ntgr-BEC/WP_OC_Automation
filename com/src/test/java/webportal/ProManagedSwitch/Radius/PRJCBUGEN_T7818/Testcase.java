package webportal.SwitchManaged.Radius.PRJCBUGEN_T7818;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T7818") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("012 - Deploy \"Auto\" mode to per switch on vlan level ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T7818") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        wvp.editPortMode(vlanId, true, false, true);
        handle.sleepsync();
    }
