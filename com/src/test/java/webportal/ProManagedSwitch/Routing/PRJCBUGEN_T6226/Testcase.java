package webportal.ProManagedSwitch.Routing.PRJCBUGEN_T6226;
...
public class Testcase extends TestCaseBase {
    ...
    String ip1      = "106.1.1.1";
    String ip2      = "106.1.1.2";

    @Feature("Switch.Routing") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T6226") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("011-Add ip address to vlan create via \"Voice Vlan\"") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6226") // It's a testcase id/link from Jira Test Case.
