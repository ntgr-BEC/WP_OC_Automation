package webportal.ProManagedSwitch.Routing.PRJCBUGEN_T6229;
...
public class Testcase extends TestCaseBase {
    ...
    String ip1      = "109.1.1.1";
    String ip2      = "109.1.1.2";

    @Feature("Switch.Routing") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T6229") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("014-Add ip address to vlan create via \"Guset+Employee Network\"") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6229") // It's a testcase id/link from Jira Test Case.
