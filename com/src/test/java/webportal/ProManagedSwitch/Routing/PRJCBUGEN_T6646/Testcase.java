package webportal.ProManagedSwitch.Routing.PRJCBUGEN_T6646;
...
public class Testcase extends TestCaseBase {
    ...
    String ip2      = "10.10.1.1";

    @Feature("Switch.Routing") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T6646") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("023-Verify the ip address confiliction on dual switch that in same vlan.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6646") // It's a testcase id/link from Jira Test Case.
