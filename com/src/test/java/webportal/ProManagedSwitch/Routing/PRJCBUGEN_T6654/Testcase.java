package webportal.ProManagedSwitch.Routing.PRJCBUGEN_T6654;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6654") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("031-And a none-default route") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6654") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Add a none-default route")
    public void step2() {
        dssrp.addStaticRoute(false, ip, mask, gw);
        assertTrue(dssrp.getStaticRouteGw().contains(gw), "check gateway");
    }
