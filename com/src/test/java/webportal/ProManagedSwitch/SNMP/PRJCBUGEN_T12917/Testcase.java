package webportal.SwitchManaged.SNMP.PRJCBUGEN_T12917;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T12917") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("006-Edit the exist SNMP config data by Insight") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T12917") // It's a testcase id/link from Jira Test Case.
