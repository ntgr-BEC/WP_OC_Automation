package webportal.ProManagedSwitch.VLANEnhancements.PRJCBUGEN_T32021;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T32021") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Webportal : We should allow users to edit existing VLAN ID's using Network setting flow") // It's a testcase title from Jira Test
                                                                                                            // Case.
    @TmsLink("PRJCBUGEN-T32021") // It's a testcase id/link from Jira Test Case.
...
//        handle.waitCmdReady(vlanId, false);
    ...
    public void step4() {
//        handle.waitCmdReady(vlanId2, false);
//        String tmpStr = handle.getCmdOutput("show vlan", false);
//        assertTrue(tmpStr.contains(vlanId2), "vlan should be created on switch");
        String tmpStr = handle.getCmdOutputShowRunningConfig(false);
