package webportal.ProManagedSwitch.VlanOverhauling.PRJCBUGEN_T11341;
...
public class Testcase extends TestCaseBase {
    ...
    public void step2() {
        ...
        if (netsp.warning1.exists()) {
            netsp.okWarning1.click();
            MyCommonAPIs.sleepi(3); 
        }
        netsp.finishAllStep();
        ...
        System.out.println("777777777");
        netsp.setNetwork4(true, "192.168.111.2", "192.168.111.3");
        if (netsp.warning2.exists()) {
            netsp.skipWarning.click();                    //have a difft warning msg for management vlan and other vlan
            MyCommonAPIs.sleepi(3); 
        }
        netsp.finishAllStep();
    }
