package webportal.ProSignUp.PRJCBUGEN_T131218;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T131218";
  

    @Feature("ProSignUp") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T131218") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Poland country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T131218") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
            ...
            if (new HamburgerMenuPage(false).GotoProAccount(mailname)) {
                ...
                businessInfo.put("City", "Krakow");
                businessInfo.put("State", "Krakow");
