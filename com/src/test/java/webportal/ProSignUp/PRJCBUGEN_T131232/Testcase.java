package webportal.ProSignUp.PRJCBUGEN_T131232;
...
public class Testcase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T131232";
  

    @Feature("ProSignUp") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T131232") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Create Pro Account using a flow Adding Pro Subscription Key - Malta country") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN-T131232") // It's a testcase id/link from Jira Test Case.
