package webportal.ProfileVlan.APAdvance.Premium.PRJCBUGEN_T14476;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14476") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify MAC ACL functionally as non pro admin") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14476") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        if (result1) {
            ...
            new WirelessQuickViewPage().addMacaclDevices(SSID);
...
//                    .equals("false");
//
            new WirelessQuickViewPage().changeMacaclPolicyAndType(SSID, "Local ACL", "Deny");
