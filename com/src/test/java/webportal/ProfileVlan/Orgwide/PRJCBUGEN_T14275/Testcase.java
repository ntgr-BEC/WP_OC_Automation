package webportal.ProfileVlan.Orgwide.PRJCBUGEN_T14275;
...
public class Testcase extends TestCaseBase {
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).deleteSsidYes(SSID);
    ...
    public void step2() {
        ...
        if (!new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "WAFopenconnect "+SSID+"")
                .equals("true")) {
            result1 = false;
