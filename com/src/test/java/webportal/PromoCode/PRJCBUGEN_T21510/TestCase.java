package webportal.PromoCode.PRJCBUGEN_T21510;
...
public class TestCase extends TestCaseBase {
    String organizationName = "PRJCBUGEN_T21510";
    Random r        = new Random();
    ...
    @Description("Verify subscription plan upgrade Basic paid to Annual yearly with promo code.") // It's a testcase title from Jira Test Case.
    ...
    public void step4() {
        ...
        paymentInfo.put("Last Name", "T21510");
