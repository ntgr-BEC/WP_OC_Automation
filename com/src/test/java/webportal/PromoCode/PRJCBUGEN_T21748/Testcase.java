package webportal.PromoCode.PRJCBUGEN_T21748;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21748") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that the total amount is zero or not after applying the promo code.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T21748") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        accountInfo.put("Last Name", "T21748");
    ...
    public void step4() {
        ...
        paymentInfo.put("Last Name", "T21748");
        ...
        assertTrue(new HamburgerMenuPage(false).checkPromoCode(paymentInfo), "Payment page display incorrect.");
    }
