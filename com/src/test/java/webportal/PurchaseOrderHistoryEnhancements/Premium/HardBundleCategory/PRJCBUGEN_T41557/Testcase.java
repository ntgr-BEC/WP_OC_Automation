package webportal.PurchaseOrderHistoryEnhancements.Premium.HardBundleCategory.PRJCBUGEN_T41557;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41557") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("[Premium]Test to verify when the user deleted the onboarded hard-bundle device then the hard-bundle device entry was deleted from the Insight Included with Hardware") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T41557") // It's a testcase id/link from Jira Test Case.
