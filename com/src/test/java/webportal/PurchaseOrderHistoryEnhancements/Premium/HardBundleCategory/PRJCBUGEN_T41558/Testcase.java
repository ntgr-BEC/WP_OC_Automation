package webportal.PurchaseOrderHistoryEnhancements.Premium.HardBundleCategory.PRJCBUGEN_T41558;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("[Premium]Test to verify when the user deleted the onboarded hard-bundle device for AP, Switch, ORBI, PRX60 then the verify AP, switch , ORBI, PRX60 device entry deleted from the Insight Included with Hardware") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T41558") // It's a testcase id/link from Jira Test Case.
