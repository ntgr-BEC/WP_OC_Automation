package webportal.PurchaseOrderHistoryEnhancements.Pro.DownloadCSVfile.PRJCBUGEN_T41567;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41567") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Insight Included with Hardware CSV Download.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T41567") // It's a testcase id/link from Jira Test Case.
