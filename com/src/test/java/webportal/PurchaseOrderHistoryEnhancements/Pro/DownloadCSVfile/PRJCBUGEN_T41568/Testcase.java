package webportal.PurchaseOrderHistoryEnhancements.Pro.DownloadCSVfile.PRJCBUGEN_T41568;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41568") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Pro User Insight Licenses CSV Download.") // It's                                                                                                                                                     // Jira
    // Test
    // Case.
    @TmsLink("PRJCBUGEN_T41568") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
      ...
      public void step2() throws InterruptedException {
          ...
          assertTrue(new HamburgerMenuPage().verifyInsightLicenseCSVFileDownload(),"CSV File is not downloaded properly");
