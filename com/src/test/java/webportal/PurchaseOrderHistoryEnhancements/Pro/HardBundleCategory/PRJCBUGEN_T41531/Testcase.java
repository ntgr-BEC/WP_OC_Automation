package webportal.PurchaseOrderHistoryEnhancements.Pro.HardBundleCategory.PRJCBUGEN_T41531;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T41531") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify when we onboard the hard bundle device in the account then in the purchase order history create the new tile with Insight Included with Hardware") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T41531") // It's a testcase id/link from Jira Test Case.
