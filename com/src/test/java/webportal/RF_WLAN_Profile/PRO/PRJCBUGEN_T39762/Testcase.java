package webportal.RF_WLAN_Profile.PRO.PRJCBUGEN_T39762;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T39762") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that in Manage Profiles, we should provide an option to create, view, edit and delete RF profiles in Pro User") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T39762") // It's a testcase id/link from Jira Test Case.
