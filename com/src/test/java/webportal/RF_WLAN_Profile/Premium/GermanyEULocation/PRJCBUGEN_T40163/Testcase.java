package webportal.RF_WLAN_Profile.Premium.GermanyEULocation.PRJCBUGEN_T40163;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40163") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user shoud not be able to delete the RF Profile which is already assigned to the AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40163") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Assign RF Profiles and verify created RF profile not able to delete")
    public void step3() {
        ...
        new WirelessQuickViewPage().GotoRF();
        assertTrue(new WirelessQuickViewPage(false).verifyNotAbletodeleteRF(RFdata.get("RFName")),"RF Profile able to delete");
        new DevicesDashPage().GoToDevicesDashPage();      
