package webportal.RF_WLAN_Profile.Premium.PRJCBUGEN_T39697;
...
public class Testcase extends TestCaseBase {
    ...
    @Step("Test Step 2: Verify check create RF Profile under Manage Profile tab on wireless settings page")
    public void step2() {
