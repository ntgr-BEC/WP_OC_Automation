package webportal.RF_WLAN_Profile.Premium.PRJCBUGEN_T39754;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T39754") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check whether on AP reboot assigned RF profile is taking effect") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T39754") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Assign RF Profile and verify")
    public void step2() {
    ...
    @Step("Test Step 3: Unassign RF Profile and verify")
    public void step3() {
        new DevicesDashPage().GoToDevicesDashPage();
        ...
        String RF = new DevicesDashPage().devicesRF(WebportalParam.ap1serialNo).getText();
        String RF1 = new DevicesDashPage().devicesRF(WebportalParam.ap2serialNo).getText();
        assertTrue(RF.contains("N/A"),"RF is not set properly");
