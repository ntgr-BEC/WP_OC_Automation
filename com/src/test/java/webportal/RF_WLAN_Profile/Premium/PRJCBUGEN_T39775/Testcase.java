package webportal.RF_WLAN_Profile.Premium.PRJCBUGEN_T39775;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T39775") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that the devices which are already onboarded, user can assign or reassign or unassign RF profiles to/from Aps.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T39775") // It's a testcase id/link from Jira Test Case.
