package webportal.RF_WLAN_Profile.Premium.PRJCBUGEN_T39780;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T39780") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that in the Device Tab, If no RF profile is mapped, we will show \"N/A\" column") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T39780") // It's a testcase id/link from Jira Test Case.
