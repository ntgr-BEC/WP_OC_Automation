package webportal.RF_WLAN_Profile.Premium.PRJCBUGEN_T39783;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T39783") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("User should have following section upon editing the new RF-Profile General tab, Device tab, Radio Settings, Instant WiFi Preferred Channels") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T39783") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new WirelessQuickViewPage(false).VerifyGenaralRF(RFdata),"");
