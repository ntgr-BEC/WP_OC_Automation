package webportal.RF_WLAN_Profile.Premium.PRJCBUGEN_T40188;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40188") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether on assigning RF profile to an AP , the AP channel gets allocate from the Preferred channel list of RF Profile")                                                                                                                                                                       // Case.
    @TmsLink("PRJCBUGEN_T40188") // It's a testcase id/link from Jira Test Case.
