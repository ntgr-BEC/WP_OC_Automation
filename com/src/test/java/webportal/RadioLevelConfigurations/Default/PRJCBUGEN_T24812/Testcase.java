package webportal.RadioLevelConfigurations.Default.PRJCBUGEN_T24812;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24812") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("5 Ghz  low radio status  is enable By default") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24812") // It's a testcase id/link from Jira Test Case.
