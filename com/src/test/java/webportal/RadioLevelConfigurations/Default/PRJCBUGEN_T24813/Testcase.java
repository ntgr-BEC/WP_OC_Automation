package webportal.RadioLevelConfigurations.Default.PRJCBUGEN_T24813;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24813") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("5 Ghz high  radio status  is enable By default") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24813") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Check 5Ghz High radio status  is enable By default;")
    public void step2() {
