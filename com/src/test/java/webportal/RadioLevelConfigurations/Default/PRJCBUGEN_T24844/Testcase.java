package webportal.RadioLevelConfigurations.Default.PRJCBUGEN_T24844;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24844") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, radio mode for 2.4 GHz has 11b, 11bg, 11ng standards for WAC505,510,540,564") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24844") // It's a testcase id/link from Jira Test Case.
