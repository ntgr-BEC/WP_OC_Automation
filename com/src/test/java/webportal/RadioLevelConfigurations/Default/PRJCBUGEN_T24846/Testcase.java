package webportal.RadioLevelConfigurations.Default.PRJCBUGEN_T24846;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24846") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, radio mode for 5 GHz has 11a, 11na, 11ac, 11ax for WAX AP") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24846") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: configured to 11a for 2 GHz WAX;")
    public void step2() {
        ...
        new WirelessQuickViewPage(false).Radiomode5low.selectOption(mode3);
        assertTrue(new WirelessQuickViewPage(false).RadioMode5ghzlow(mode3), "default value is not right");   
