package webportal.RadioLevelConfigurations.Default.PRJCBUGEN_T24855;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24855") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("wireless mode as b for 2.4ghz at location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24855") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: configured to 11b for 2 GHz;")
    public void step2() {
