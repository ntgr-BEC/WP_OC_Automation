package webportal.RadioLevelConfigurations.Default.PRJCBUGEN_T24856;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24856") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("wireless mode as na for 5ghz low  at location ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24856") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: configured to 11na for 5 GHz;")
    public void step2() {
