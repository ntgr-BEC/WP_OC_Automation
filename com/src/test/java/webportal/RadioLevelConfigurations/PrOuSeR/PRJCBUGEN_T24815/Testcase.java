package webportal.RadioLevelConfigurations.PrOuSeR.PRJCBUGEN_T24815;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24815") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("5 high  SSID is broadcast  or not when 5high  ghz radios are disable  in Ap  for wac3") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24815") // It's a testcase id/link from Jira Test Case.
