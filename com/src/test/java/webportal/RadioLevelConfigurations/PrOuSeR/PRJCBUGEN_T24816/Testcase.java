package webportal.RadioLevelConfigurations.PrOuSeR.PRJCBUGEN_T24816;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24816") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("5 low  SSID is broadcast   or not when 5 low  ghz radios are disable  in Ap  for wac3 ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24816") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().Enable5low(Enable1);      
