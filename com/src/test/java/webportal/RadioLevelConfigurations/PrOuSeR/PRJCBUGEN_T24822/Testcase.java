package webportal.RadioLevelConfigurations.PrOuSeR.PRJCBUGEN_T24822;
...
public class Testcase extends TestCaseBase {
    ...
    String cmd1 = "iwconfig wifi1vap0 | grep Access";

    @Feature("RadioLevelConfigurations") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T24822") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("SSID is broadcast or not when both radios are disable in Ap") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24822") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage(false).Enable24(Enable1);
        MyCommonAPIs.sleepi(10);
    ...
    String WACAP1 = new APUtils(WebportalParam.ap2IPaddress).get80211status(cmd1);
