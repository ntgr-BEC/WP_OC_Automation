package webportal.RadioLevelConfigurations.PrOuSeR.PRJCBUGEN_T24841;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24841") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, radio mode can be configured to 11a, 11na for 5 GHz") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24841") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: configured to 11na for 5 GHz;")
    public void step3() {
