package webportal.RadioLevelConfigurations.PrOuSeR.PRJCBUGEN_T24842;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T24842") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify, radio mode can be configured to 11b, 11bg for 2.4 GHz") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T24842") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: configured to 11b for 2.4 GHz;")
    public void step2() {
    ...
    @Step("Test Step 3: configured to 11bg for 2.4 GHz;")
    public void step3() {
