package webportal.RfParameters.PrOUser.PRJCBUGEN_T36180;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T36180") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify,RF parameter is a part of first config") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T36180") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 3: Add device and wait for it to come online")
    public void step3()
    {
        ...
        MyCommonAPIs.sleepi(40);
          ...
          @Step("Test Step 4: Chexk for config push;") 
          public void step4()
          {
