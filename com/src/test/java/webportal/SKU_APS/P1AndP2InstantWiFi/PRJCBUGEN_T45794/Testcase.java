package webportal.SKU_APS.P1AndP2InstantWiFi.PRJCBUGEN_T45794;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45794") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify instant wifi  with  default  prefered  channel WBE710 and  WBE718 in Australia") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T45794") // It's a testcase id/link from Jira Test Case.
...
//        webportalLoginPage.defaultLogin();
    ...
    @Step("Test Step 4: Add WIFI ssid ;")
    public void step4() {
    ...
    @Step("Test Step 5: Instant Wifi Default radio modes take a list ")
    public void step5() {
        ...
        MyCommonAPIs.sleepi(10);
        assertTrue(new WirelessQuickViewPage(false).validateAllGHzValuesFromSSHArePresentInUI(),"Default Radio Modes not matching with UI");
