package webportal.SKU_APS.P3AndP4ChannelListValidationAPS.PRJCBUGEN_T45822;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify the channel for 2.4ghz for WBE710 in Singapore") // It's a testcase title from Jira Test Case.
