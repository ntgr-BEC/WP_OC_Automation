package webportal.SKU_APS.P3AndP4ChannelListValidationNAEU.WAX6XX.PRJCBUGEN_T46993;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46993") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify the channel for  6ghz for WAX6XX in Cyprus") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T46993") // It's a testcase id/link from Jira Test Case.
