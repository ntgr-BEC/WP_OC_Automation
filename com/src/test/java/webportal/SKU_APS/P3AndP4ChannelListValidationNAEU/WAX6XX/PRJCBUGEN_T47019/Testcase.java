package webportal.SKU_APS.P3AndP4ChannelListValidationNAEU.WAX6XX.PRJCBUGEN_T47019;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T47019") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify the channel for 2.4ghz for WAX6XX in Hungary") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T47019") // It's a testcase id/link from Jira Test Case.
