package webportal.SKU_APS.P3AndP4ChannelListValidationNAEU.WBE7XX.PRJCBUGEN_T46756;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify the channel for 2.4ghz for WBE7XX in US") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T46756") // It's a testcase id/link from Jira Test Case.
