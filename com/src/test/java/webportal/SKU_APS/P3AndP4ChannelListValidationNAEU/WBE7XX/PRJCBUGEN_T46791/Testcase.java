package webportal.SKU_APS.P3AndP4ChannelListValidationNAEU.WBE7XX.PRJCBUGEN_T46791;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T46791") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify the channel for  6ghz for WBE7XX in Finland") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T46791") // It's a testcase id/link from Jira Test Case.
