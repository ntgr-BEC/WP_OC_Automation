package webportal.SKU_APS.P3AndP4TestCases.WBE718.PRJCBUGEN_T45793;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify the channel for  6ghz for WBE718 in Australia") // It's a testcase title from Jira Test Case.
