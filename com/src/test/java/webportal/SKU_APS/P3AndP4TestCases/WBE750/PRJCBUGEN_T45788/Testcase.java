package webportal.SKU_APS.P3AndP4TestCases.WBE750.PRJCBUGEN_T45788;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify the channel for 2.4ghz for WBE750 in Australia") // It's a testcase title from Jira Test Case.
