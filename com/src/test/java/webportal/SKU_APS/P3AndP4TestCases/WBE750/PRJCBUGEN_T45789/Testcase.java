package webportal.SKU_APS.P3AndP4TestCases.WBE750.PRJCBUGEN_T45789;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify the channel for 5 ghz for WBE750 in Australia") // It's a testcase title from Jira Test Case.
