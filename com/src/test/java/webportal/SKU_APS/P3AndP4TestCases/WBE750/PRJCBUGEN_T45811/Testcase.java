package webportal.SKU_APS.P3AndP4TestCases.WBE750.PRJCBUGEN_T45811;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T45811") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify the channel for  5ghz for WBE750 in New Zealand") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T45811") // It's a testcase id/link from Jira Test Case.
