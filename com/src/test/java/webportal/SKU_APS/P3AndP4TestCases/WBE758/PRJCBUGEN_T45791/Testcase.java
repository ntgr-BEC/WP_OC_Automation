package webportal.SKU_APS.P3AndP4TestCases.WBE758.PRJCBUGEN_T45791;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("verify the channel for 2.4ghz for WBE758 in Australia") // It's a testcase title from Jira Test Case.
