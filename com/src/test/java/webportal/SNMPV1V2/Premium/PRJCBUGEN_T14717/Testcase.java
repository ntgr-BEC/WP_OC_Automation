package webportal.SNMPV1V2.Premium.PRJCBUGEN_T14717;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14717") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the user can enable/ disable the SNMP Traps") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14717") // It's a testcase id/link from Jira Test Case.
