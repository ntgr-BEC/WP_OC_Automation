package webportal.SNMPV1V2.Pro_admin.PRJCBUGEN_T14728;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14728") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Validate the Community String field and the rules associated.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14728") // It's a testcase id/link from Jira Test Case.
