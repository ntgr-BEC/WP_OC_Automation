package webportal.SNMPV1V2.Pro_admin.PRJCBUGEN_T14729;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14729") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if Premium user can access (edit) the SNMP configuration page on the Insight App and Web Portal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14729") // It's a testcase id/link from Jira Test Case.
...
//        handle.gotoLocationWireSettings();
    ...
    @Step("Test Step 3: Change IP address by Insight")
    public void step3() {
        sIp = "11.11.11.17";
        snmpp.setSnmp(false, sIp, sPw, false);
        handle.waitCmdReady(sIp, false);
    ...
    @Step("Test Step 4: Change the community string by Insight")
    public void step4() {
        sPw = "test@test123";
