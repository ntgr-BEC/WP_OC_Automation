package webportal.SNMPV1V2.Pro_admin.PRJCBUGEN_T14732;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14732") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the SNMP feature can be configured (config received) for all the SNMP Supported Insight Switches") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14732") // It's a testcase id/link from Jira Test Case.
