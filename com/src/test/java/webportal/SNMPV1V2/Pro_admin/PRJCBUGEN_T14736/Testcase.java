package webportal.SNMPV1V2.Pro_admin.PRJCBUGEN_T14736;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T14736") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify if the user can edit the community Strings and the same is readonly") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T14736") // It's a testcase id/link from Jira Test Case.
