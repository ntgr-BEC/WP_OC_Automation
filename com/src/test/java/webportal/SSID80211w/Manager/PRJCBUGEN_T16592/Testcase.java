package webportal.SSID80211w.Manager.PRJCBUGEN_T16592;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify the 802.11w SSID option should be visible in case of secured SSID created by the user.Manager") // It's a testcase title from Jira Test Case.
