package webportal.SSID80211w.Premium.PRJCBUGEN_T16593;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify the 802.11w SSID option should not be visible in case of an open SSID created by the user.Premium") // It's a testcase title from Jira Test Case.
