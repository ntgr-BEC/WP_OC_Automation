package webportal.SanityTestCase.Upgrade_Test.Auto_Update.PRJCBUGEN_38835;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("SanityTestCase_Auto_Update") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_38835") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Auto_Update firmware testing for WAC505") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-38835") // It's a testcase id/link from Jira Test Case.
        ...
        //while (runTime < 21 ) {
            ...
            for (String fw : lsFirmware) {
                ...
                if (ddp.waitDevicesReConnected(devSerialNo)) {
                    ...
                    if (fmp.waitForUpdateAvailable() && fmp.Autoupdate(false)) {
                        passUpgradeCount++;
