package webportal.SanityTestCase.Upgrade_Test.Continues_firmware_upgradetest.PRJCBUGEN_38529;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("SanityTestCase_Continues_firmware_upgradetest") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_38529") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Continues_firmware_upgradetest firmware testing for WAC505") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-38529") // It's a testcase id/link from Jira Test Case.
