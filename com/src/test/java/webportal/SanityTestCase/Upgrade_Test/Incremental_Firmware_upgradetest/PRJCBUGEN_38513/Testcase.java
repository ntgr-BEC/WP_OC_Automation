package webportal.SanityTestCase.Upgrade_Test.Incremental_Firmware_upgradetest.PRJCBUGEN_38513;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("SanityTestCase_Incremental_Firmware_upgradetest") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_38513") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Incremental_Firmware_upgradetest firmware testing for WAC505") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-38513") // It's a testcase id/link from Jira Test Case.
