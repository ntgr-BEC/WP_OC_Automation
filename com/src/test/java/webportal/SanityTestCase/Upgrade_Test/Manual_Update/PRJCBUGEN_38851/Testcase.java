package webportal.SanityTestCase.Upgrade_Test.Manual_Update.PRJCBUGEN_38851;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("SanityTestCase_Manual_Update") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_38851") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Manual_Update firmware testing for WAC505") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-38851") // It's a testcase id/link from Jira Test Case.
