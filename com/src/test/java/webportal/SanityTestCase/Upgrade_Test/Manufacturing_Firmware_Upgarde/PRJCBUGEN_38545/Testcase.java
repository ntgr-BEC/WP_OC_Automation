package webportal.SanityTestCase.Upgrade_Test.Manufacturing_Firmware_Upgarde.PRJCBUGEN_38545;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("SanityTestCase_UpdateALL") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_38545") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Manufacturing_Firmware_Upgarde firmware testing for WAC505") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-38545") // It's a testcase id/link from Jira Test Case.
