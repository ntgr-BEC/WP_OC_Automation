package webportal.SanityTestCase.Upgrade_Test.Schedule_Update.PRJCBUGEN_38867;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("SanityTestCase_Schedule_Update") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_38867") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Schedule_Update firmware testing for WAC505") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-38867") // It's a testcase id/link from Jira Test Case.
