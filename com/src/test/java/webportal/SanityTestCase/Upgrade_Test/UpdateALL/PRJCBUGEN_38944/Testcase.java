package webportal.SanityTestCase.Upgrade_Test.UpdateALL.PRJCBUGEN_38944;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_38944") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Incremental firmware testing for WAC505") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-38944") // It's a testcase id/link from Jira Test Case.
