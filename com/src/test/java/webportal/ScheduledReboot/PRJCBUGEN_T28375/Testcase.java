package webportal.ScheduledReboot.PRJCBUGEN_T28375;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T283675") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, reboot 'status' will be successful, failed'") // It's a testcase title from Jira Test Case.
...
//        new DevicesDashPage().waitDevicesReConnected(WebportalParam.ap1serialNo);
    ...
    public void step2() {
        ...
        firststdevInfo.put("Serial Number", WebportalParam.ap5serialNo);
       ...
       assertTrue(new OrganizationPage(false).checkstatus(WebportalParam.ap5serialNo), "Warnning pop up did not appear");
    }
