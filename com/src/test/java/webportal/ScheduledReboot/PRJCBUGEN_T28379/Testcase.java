package webportal.ScheduledReboot.PRJCBUGEN_T28379;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T283679") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, user can pick start date, time, end time, end date") // It's a testcase title from Jira Test Case.
