package webportal.ScheduledReboot.PRJCBUGEN_T28382;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T283682") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify, on scheduling a reboot a green acknowledgement banner is shown") // It's a testcase title from Jira Test Case.
