package webportal.ScheduledReboot.PRJCBUGEN_T28386;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify, one device can be part of one scheduled reboot") // It's a testcase title from Jira Test Case.
