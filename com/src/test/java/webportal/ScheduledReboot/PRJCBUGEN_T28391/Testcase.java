package webportal.ScheduledReboot.PRJCBUGEN_T28391;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify, 'View all Schedules' will have Schedule Name, Location, Devices, Last triggered, Start Date and time, End date and time and Repeats") // It's a testcase title from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new OrganizationPage(false).CheckScheduler(Name), "Scheduler information is missing");
