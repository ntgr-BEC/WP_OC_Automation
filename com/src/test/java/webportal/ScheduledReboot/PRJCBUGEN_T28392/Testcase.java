package webportal.ScheduledReboot.PRJCBUGEN_T28392;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify, notification is received on Apps and Web while device is going for reboot") // It's a testcase title from Jira Test Case.
    ...
    public void step3() {
        assertTrue(new OrganizationPage(false).NotificationSchedule(WebportalParam.ap1serialNo),"Notification does not exits");
