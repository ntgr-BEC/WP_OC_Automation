package webportal.ScheduledWiFi.Manager.PRJCBUGEN_T15985;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify if the user can configure the same WiFi Scheduler to different SSID.Manager")// It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 3: configure the same WiFi Scheduler to different SSID;")
    public void step3() {
        Map<String, String> locationInfo = new HashMap<String, String>();
