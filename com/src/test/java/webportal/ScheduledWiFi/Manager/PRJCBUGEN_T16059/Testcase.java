package webportal.ScheduledWiFi.Manager.PRJCBUGEN_T16059;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify whether SSID  get enabled only between in the Scheduled time.Manager")// It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Add WIFI ssid and SSID enabled only b/n in the Scheduled time;")
    public void step2() {
