package webportal.ScheduledWiFi.Manager.PRJCBUGEN_T16060;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that other than the Scheduled time SSID stays in disabled state.Manager")// It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Schedule WIFI ssid and other than Scheduled time SSID stays in disabled state;")
    public void step2() {
