package webportal.ScheduledWiFi.Manager.PRJCBUGEN_T16095;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify whether Config Backup works for WiFi Schedule.Manager") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Add WIFI ssid and check Config Backup works for WiFi Schedule;")
    public void step2() {
