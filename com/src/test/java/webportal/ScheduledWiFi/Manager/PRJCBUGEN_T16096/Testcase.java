package webportal.ScheduledWiFi.Manager.PRJCBUGEN_T16096;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify whether Config restore works for WiFi Schedule.Manager") // It's a testcase title from Jira Test Case.
    ...
    @Step("Test Step 2: Add WIFI ssid and check Config restore works for WiFi Schedule;")
    public void step2() {
