package webportal.ScheduledWiFi.Premium.PRJCBUGEN_T16058;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify if user updates the timezone in Network location it gets updated in the WiFi Scheduler page.Premium") // It's a testcase title from Jira Test Case.
