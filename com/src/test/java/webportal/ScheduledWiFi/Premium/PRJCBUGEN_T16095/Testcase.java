package webportal.ScheduledWiFi.Premium.PRJCBUGEN_T16095;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify whether Config Backup works for WiFi Schedule.Premium") // It's a testcase title from Jira Test Case.
...
//        new DevicesDashPage().checkDeviceInAdminAccount();
    ...
    @Step("Test Step 2: Add WIFI ssid and Config Backup for WiFi Schedule")
    public void step2() {
