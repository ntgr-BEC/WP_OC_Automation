package webportal.ScheduledWiFi.Premium.PRJCBUGEN_T16096;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify whether Config restore works for WiFi Schedule.Premium") // It's a testcase title from Jira Test Case.
...
//        new DevicesDashPage().checkDeviceInAdminAccount();
    ...
    @Step("Test Step 2: Add WIFI ssid and Config restore for WiFi Schedule;")
    public void step2() {
        AccountPage AccountPage = new AccountPage();
        HashMap<String, String> locationInfo = new HashMap<String, String>();
        HashMap<String, String> locationInfo1 = new HashMap<String, String>();
        HashMap<String, String> locationInfo2 = new HashMap<String, String>();
        ...
        new AccountPage().mainpage.click();
        handle.gotoLoction();
        locationInfo1.put("SSID", "apwp16096");
        locationInfo1.put("Security", "Open");
        new WirelessQuickViewPage().editWifiYes(locationInfo1);
        new AccountPage().mainpage.click();
        
        locationInfo2.put("Name", "apwp16096");
        new AccountPage().ssidconfigrestore(WebportalParam.location1,locationInfo2);
