package webportal.ScheduledWiFi.Pro.PRJCBUGEN_T15931;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify the \"pick start time\" functionality while selecting days for wifi schedule on the wireless dashboard on web portal.Pro") // It's a testcase title from Jira Test Case.
