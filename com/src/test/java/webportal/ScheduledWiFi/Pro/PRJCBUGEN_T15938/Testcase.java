package webportal.ScheduledWiFi.Pro.PRJCBUGEN_T15938;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify the user should be able to edit the scheduled configurations.Pro")// It's a testcase title from Jira Test Case.
