package webportal.ScheduledWiFi.Pro.PRJCBUGEN_T15983;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify if the user able disables the  WiFi scheduler.Pro")// It's a testcase title from Jira Test Case.
