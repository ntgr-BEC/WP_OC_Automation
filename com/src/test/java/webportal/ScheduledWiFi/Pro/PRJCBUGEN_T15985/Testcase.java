package webportal.ScheduledWiFi.Pro.PRJCBUGEN_T15985;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify if the user can configure the same WiFi Scheduler to different SSID.Pro")// It's a testcase title from Jira Test Case.
 ...
 // Each step is a single test step from Jira Test Case
    ...
    @Step("Test Step 2: Schedule SSID;")
    public void step2() {
