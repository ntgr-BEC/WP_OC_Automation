package webportal.ScheduledWiFi.Pro.PRJCBUGEN_T16057;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify whether Network location timezone and the WiFi scheduler time zone is same.Pro") // It's a testcase title from Jira Test Case.
