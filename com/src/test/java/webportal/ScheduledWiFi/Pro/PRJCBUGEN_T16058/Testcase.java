package webportal.ScheduledWiFi.Pro.PRJCBUGEN_T16058;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify if user updates the timezone in Network location it gets updated in the WiFi Scheduler page.Pro") // It's a testcase title from Jira Test Case.
 ...
 // Each step is a single test step from Jira Test Case
    ...
    @Step("Test Step 2: Updated network and check time zone of scheduled ssid")
    public void step2() {
