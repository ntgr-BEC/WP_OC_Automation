package webportal.ScheduledWiFi.Pro.PRJCBUGEN_T16060;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that other than the Scheduled time SSID stays in disabled state.Pro")// It's a testcase title from Jira Test Case.
 ...
 // Each step is a single test step from Jira Test Case
    ...
    @Step("Test Step 2: Schedule ssid andc check other than the Scheduled time SSID stays in disabled state;")
    public void step2() {
        ...
        while (true) {
            ...
            if (new Javasocket()
                ...
                assertTrue(true, "Client get connected.");
                break;
            }
            sum += 1;
        }
