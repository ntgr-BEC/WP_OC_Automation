package webportal.ScreenNavigationProAcct.PRJCBUGEN_T34370;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Topology page Navigation in the pro accounn") // It's a testcase title from Jira Test Case.
