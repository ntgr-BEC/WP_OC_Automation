package webportal.ScreenNavigationProAcct.PRJCBUGEN_T34381;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T34381") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("IM-7.0-Notifications page navigation in the pro Account") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T34381") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        assertTrue(new  DeviceScreenNavigationPage().verifyNotifications()," Notifications Screen is not complete");
