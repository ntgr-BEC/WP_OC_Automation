package webportal.Seperation80211.prousER.PRJCBUGEN_T39885;
...
public class Testcase extends TestCaseBase {
  ...
  Map<String, String> ssidInfo = new HashMap<String, String>();
    ...
    @Story("PRJCBUGEN_T39885") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN_T39885") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2:  Add WIFI ssid with fastroaming and check for config push;")
    public void step2() {
    ...
    @Step("Test Step 3: Change the security to open and check for fastroaming status")
    public void step3() {
        ssidInfo.put("Security", "Open");
        ssidInfo.remove("Password");
        new WirelessQuickViewPage().editWifiYes(ssidInfo);
        assertFalse(new APUtils(WebportalParam.ap1IPaddress).get11REnableStatusnew(WebportalParam.ap1Model),"Fastroaming not enabled");
     }
