package webportal.SrilankaSupportEUSKU.PRJCBUGEN_T37928;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T37928") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify the channel for 2.4 Ghz on WAX610 in Srilanka") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T37928") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Open AP Setting and in radio and channels get all channels for 2.4GHz;")
    public void step2() {
