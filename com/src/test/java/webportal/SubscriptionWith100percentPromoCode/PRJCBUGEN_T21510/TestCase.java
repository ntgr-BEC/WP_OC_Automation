package webportal.SubscriptionWith100percentPromoCode.PRJCBUGEN_T21510;
...
public class TestCase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T21510") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the premium annual purchase for N Devices with promo code.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T21510") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        assertTrue(
                new HamburgerMenuPage(false).BuyMultipleDevices(paymentInfo,2),
                "Buy premium subscription for Second Device is unsuccessful.");
    }
