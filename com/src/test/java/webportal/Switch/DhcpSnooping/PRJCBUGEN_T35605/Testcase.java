package webportal.Switch.DhcpSnooping.PRJCBUGEN_T35605;
...
public class Testcase extends TestCaseBase {
    ...
    public void step2() {
        ...
        wdsp.enablePortSpecificConfigOnPort(Integer.toString(Integer.parseInt(WebportalParam.sw1LagPort1)-1), null,"Invalid Packets");
        handle.refresh();
        wdsp.enablePortSpecificConfigOnPort(Integer.toString(Integer.parseInt(WebportalParam.sw1LagPort2)-1), null,"Invalid Packets");
        handle.refresh();
        ...
        assertTrue(WiredDhcpSnoopingElement.txtPortInvalidPacketsCheck(Integer.toString(Integer.parseInt(WebportalParam.sw1LagPort2)-1)).isDisplayed());
    ...
    public void step3() {
        ...
        handle.refresh();
        assertFalse(WiredDhcpSnoopingElement.txtPortInvalidPacketsCheck(Integer.toString(Integer.parseInt(WebportalParam.sw1LagPort1)-1)).isDisplayed());
        
        assertFalse(MyCommonAPIs.getCmdOutput("show running-config interfaces " + WebportalParam.sw1LagPort1CLI, false)
                .contains("ip dhcp snooping logging"), "Invalid packets logging should be disabled");
