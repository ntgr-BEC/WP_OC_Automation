package webportal.Switch.Event.PRJCBUGEN_T4933;
...
public class Testcase extends TestCaseBase {
    ...
    public void step3() {
        assertTrue(handle.pageSource().contains(EventElement.sNotifications), "there must be a event with Notification type");
    }
