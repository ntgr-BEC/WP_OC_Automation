package webportal.Switch.Routing.PRJCBUGEN_T6222;
...
public class Testcase extends TestCaseBase {
    ...
    @Step("Test Step 2: Add gateway same as management gateway")
    public void step2() {
        rtp.setGateway(gateway);
        assertTrue(handle.getPageErrorMsg().contains("the same subnet"), "nexthop address of any specified static route can't");
    }
}
