package webportal.Switch.Routing.PRJCBUGEN_T6228;
...
public class Testcase extends TestCaseBase {
    ...
    String ip1      = "108.1.1.1";
    String ip2      = "108.1.1.2";

    @Feature("Switch.Routing") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T6228") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("012-Add ip address to vlan create via \"Custom Setup\"") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6228") // It's a testcase id/link from Jira Test Case.

    @Test(alwaysRun = true, enabled = false, groups = "p3") // Use p1/p2/p3 to high/normal/low on priority
