package webportal.Switch.SpanningTree.PRJCBUGEN_T6059;
...
public class Testcase extends TestCaseBase {
    ...
    int           iMode;
    String        lagName = "testlag6059";

    @Feature("Switch.SpanningTree") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T6059") // It's a testcase id/link from Jira Test Case but replace - with _.
