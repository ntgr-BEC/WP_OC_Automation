package webportal.Switch.SwitchRoutingVLANEnhancement.PRJCBUGEN_T17729;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T17729") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("012-Change Network Inteface mode from DHCP to Static on device IP Setting page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T17729") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 4: Config success, check from Insight and Switch local")
    public void step4() {
        ddp.gotoPage();
        ddp.waitDevicesReConnected(WebportalParam.sw1serialNo);
