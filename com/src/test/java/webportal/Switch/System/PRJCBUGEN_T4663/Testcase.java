package webportal.Switch.System.PRJCBUGEN_T4663;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    public void step6() {
        ...
        assertTrue(SwitchCLIUtils.isLagPort(WebportalParam.getSwitchLag(false, false)), "addport lag");
        assertTrue(SwitchCLIUtils.isLagPort(WebportalParam.getSwitchLag(false, true)), "addport lag");
