package webportal.Switch.System.PRJCBUGEN_T4946;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T4946") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("045- Waive the reload command") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4946") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        publicButton.reLoadIcon.click();
        publicButton.NoDontReload.click();
        DevicesDashPage devicesDashPage1 = new DevicesDashPage();
