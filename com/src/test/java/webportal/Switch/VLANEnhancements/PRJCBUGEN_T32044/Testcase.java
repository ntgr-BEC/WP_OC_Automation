package webportal.Switch.VLANEnhancements.PRJCBUGEN_T32044;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    public void step3() {
        ...
        ddp.enterDevicesSwitchSummary(WebportalParam.sw1serialNo);
    }
    ...
    public void step6() {
        ...
        assertTrue(vlanlist.contains("1"), "In Existing VLAN setting VLAN 1");
        assertTrue(vlanlist.contains("25"), "In Existing VLAN setting VLAN 25");
        assertTrue(vlanlist.contains("35"), "In Existing VLAN setting VLAN 25");
    }
    ...
    public void step8() {
        ...
        assertTrue(!vlan_id.contains("25"), "Hover port 5, VLAN 25 should not exist");
        assertTrue(!vlan_id.contains("35"), "Hover port 5, VLAN 35 should exist"); // vlan 35 not set as trunk, so should not exist
    }
