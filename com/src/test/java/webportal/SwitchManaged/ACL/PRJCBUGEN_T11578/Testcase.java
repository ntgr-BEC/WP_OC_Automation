package webportal.SwitchManaged.ACL.PRJCBUGEN_T11578;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T11578") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("082-[Network Setup] Edit access type for manual ip allow policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T11578") // It's a testcase id/link from Jira Test Case.
