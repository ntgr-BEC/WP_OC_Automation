package webportal.SwitchManaged.ACL.PRJCBUGEN_T11587;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T11587") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("091-[Network Setup] Edit custom mac acl,the policy is allow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T11587") // It's a testcase id/link from Jira Test Case.
