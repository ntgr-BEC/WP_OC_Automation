package webportal.SwitchManaged.ACL.PRJCBUGEN_T11588;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T11588") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("092-[Network Setup] Edit manual mac acl,the policy is deny") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T11588") // It's a testcase id/link from Jira Test Case.
