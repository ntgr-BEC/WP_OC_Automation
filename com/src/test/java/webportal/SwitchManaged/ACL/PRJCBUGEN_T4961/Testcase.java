package webportal.SwitchManaged.ACL.PRJCBUGEN_T4961;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4961") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("044-Create mac acl for a vlan,then delete the vlan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4961") // It's a testcase id/link from Jira Test Case.
