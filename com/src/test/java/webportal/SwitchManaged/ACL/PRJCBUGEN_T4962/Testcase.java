package webportal.SwitchManaged.ACL.PRJCBUGEN_T4962;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4962") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("045-Test MAC ACL name") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4962") // It's a testcase id/link from Jira Test Case.
