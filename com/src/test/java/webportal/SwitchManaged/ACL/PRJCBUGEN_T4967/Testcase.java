package webportal.SwitchManaged.ACL.PRJCBUGEN_T4967;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4967") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("050-Deny manual destination mac address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4967") // It's a testcase id/link from Jira Test Case.
