package webportal.SwitchManaged.ACL.PRJCBUGEN_T4970;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4970") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("060-Set MAC ACL when the switch is down") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4970") // It's a testcase id/link from Jira Test Case.
