package webportal.SwitchManaged.ACL.PRJCBUGEN_T4982;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4982") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("075-Edit custom mac acl,the policy is allow") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4982") // It's a testcase id/link from Jira Test Case.
