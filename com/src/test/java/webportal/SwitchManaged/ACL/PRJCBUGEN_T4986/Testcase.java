package webportal.SwitchManaged.ACL.PRJCBUGEN_T4986;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4986") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("024-Test IP mask of manual allow policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4986") // It's a testcase id/link from Jira Test Case.
