package webportal.SwitchManaged.ACL.PRJCBUGEN_T4988;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4988") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("026-Edit access type for manual ip allow policy") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4988") // It's a testcase id/link from Jira Test Case.
