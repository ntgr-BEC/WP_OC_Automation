package webportal.SwitchManaged.ACL.PRJCBUGEN_T4994;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4994") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("032-Customer allow policy: Edit From") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4994") // It's a testcase id/link from Jira Test Case.
