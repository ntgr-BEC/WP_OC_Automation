package webportal.SwitchManaged.ACL.PRJCBUGEN_T4999;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T4999") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("037-Delete Customer IP ACL") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4999") // It's a testcase id/link from Jira Test Case.
