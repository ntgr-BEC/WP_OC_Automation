package webportal.SwitchManaged.ACL.PRJCBUGEN_T5000;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T5000") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("038-Create IP ACL binding to vlan,then delete the vlan") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T5000") // It's a testcase id/link from Jira Test Case.
