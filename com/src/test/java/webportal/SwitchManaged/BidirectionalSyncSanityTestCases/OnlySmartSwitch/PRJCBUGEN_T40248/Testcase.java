package webportal.SwitchManaged.BidirectionalSyncSanityTestCases.OnlySmartSwitch.PRJCBUGEN_T40248;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40248") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that when the switch is not added in insight then the status should be \"not registered\" under the toggle button in the local GUI") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40248") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        ...
        new DevicesDashPage().deleteDeviceNo(WebportalParam.sw1IPaddress);
    ...
    public void step2() {
         ...
         String status =new SwitchGUIPage().DeviceStatusInInsight.getText();
         System.out.println(status);
         assertTrue(status.contains("Not Registered"), "device is added in insight");
