package webportal.SwitchManaged.BidirectionalSyncSanityTestCases.PRJCBUGEN_T40211;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40211") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the port description updated on local UI should reflect in Insight portal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40211") // It's a testcase id/link from Jira Test Case.
