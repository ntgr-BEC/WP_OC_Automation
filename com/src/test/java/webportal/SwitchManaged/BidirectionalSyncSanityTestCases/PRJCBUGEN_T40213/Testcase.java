package webportal.SwitchManaged.BidirectionalSyncSanityTestCases.PRJCBUGEN_T40213;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40213") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Enable admin mode from local UI should reflect in Insight portal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40213") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
        System.out.println("println"+WebportalParam.sw1LagPort1CLI);
    ...
    public void step2() {
         ...
         new SwitchGUIPage().PORTAdmin(WebportalParam.sw1Model,WebportalParam.sw1LagPort1CLI, Dis );
    ...
    public void step3() {
        ...
        boolean PostDis = devicesSwitchConnectedNeighboursPortConfiqSettingsPage.isEnable();
        System.out.println(PostDis);
        
        assertTrue(PostDis, "device is added in insight");
