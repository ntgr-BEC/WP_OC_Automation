package webportal.SwitchManaged.BidirectionalSyncSanityTestCases.PRJCBUGEN_T40214;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40214") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify disable admin mode from local UI should reflect in Insight portal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40214") // It's a testcase id/link from Jira Test Case.
