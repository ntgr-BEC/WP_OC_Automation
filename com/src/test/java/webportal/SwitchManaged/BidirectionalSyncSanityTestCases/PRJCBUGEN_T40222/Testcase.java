package webportal.SwitchManaged.BidirectionalSyncSanityTestCases.PRJCBUGEN_T40222;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40222") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify disable DHCP snooping mode from local UI and the changes should not reflect in Insight portal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40222") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
         ...
         new SwitchGUIPage().DHCPsnoopingmode(WebportalParam.sw1Model, false);
    }
    ...
    public void step3() {
        ...
        assertTrue(!WiredDhcpSnoopingElement.dhcpSnoopingModebutton.isSelected(), "DHCP Snooping Mode disabled");
