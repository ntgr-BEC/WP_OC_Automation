package webportal.SwitchManaged.BidirectionalSyncSanityTestCases.PRJCBUGEN_T40224;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T40224") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify disable MAC address validation from local UI and the changes should not reflect in Insight portal") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40224") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
         ...
         new SwitchGUIPage().MACAddressValidation(WebportalParam.sw1Model, false);
    }
