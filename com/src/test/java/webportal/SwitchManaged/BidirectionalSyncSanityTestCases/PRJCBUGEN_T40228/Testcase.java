package webportal.SwitchManaged.BidirectionalSyncSanityTestCases.PRJCBUGEN_T40228;
...
public class Testcase extends TestCaseBase {
    ...
    String VLANID = "9";
    String VLANName = "AutomationBEC9";
    String VLANNameEdit = "AutomationBEC10";
    ...
    @Story("PRJCBUGEN_T40228") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify Edit a VLAN from local UI and it should reflect in Insight portal.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T40228") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
         ...
         new SwitchGUIPage().EditVLAN(WebportalParam.sw1Model, VLANName, VLANNameEdit);
    }
    ...
    public void step3() {
        ...
        if (vlans.contains(VLANNameEdit)) {
            micResult = true;
        } else {
            micResult = false;
            assertTrue(micResult, "------Check Point 4: "+VLANNameEdit+" is show:" + vlans);
        }
