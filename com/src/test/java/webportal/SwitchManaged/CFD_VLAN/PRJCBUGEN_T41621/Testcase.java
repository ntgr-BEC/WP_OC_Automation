package webportal.SwitchManaged.CFD_VLAN.PRJCBUGEN_T41621;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T41621") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether we are able to configure VLAN for all the ports of switch") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T41621") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 5: Now configure VLAN 100 Trunk port")
    public void step5() {
    ...
    @Step("Test Step 6: Now go-to Switch Device dashboard page and mouse hover the Port 5")
    public void step6() {
        ddpmg.gotoPage();
        ddpmg.enterDevice(WebportalParam.sw1serialNo);
        ...
        String trimmedVlanList = String.join(", ", vlan_id1, vlan_id2, vlan_id3);
