package webportal.SwitchManaged.DhcpSnooping.PRJCBUGEN_T35601;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T35601") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user is able to enable DHCP snooping mode based on the VLAN config for a particular VLAN") // It's a testcase
                                                                                                                                 // title from Jira
                                                                                                                                 // Test Case.
