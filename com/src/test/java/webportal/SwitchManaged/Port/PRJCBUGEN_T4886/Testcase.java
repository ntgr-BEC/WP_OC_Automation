...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Step("Test Step 2: config DUT port 1 at 10M half-duplex Switch port1 at auto")
    public void step2() {
    ...
    public void step4() {
        ...
        if (SwitchCLIUtilsMNG.PortClass.sPortSpeed.contains("10") && SwitchCLIUtilsMNG.PortClass.duplexMode == 2) {
            micResult = true;
        } else {
            micResult = false;
