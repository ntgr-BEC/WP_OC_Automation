package webportal.SwitchManaged.SNMP.PRJCBUGEN_T12914;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T12914") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("005-Remove SNMP config data by Insight") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T12914") // It's a testcase id/link from Jira Test Case.
