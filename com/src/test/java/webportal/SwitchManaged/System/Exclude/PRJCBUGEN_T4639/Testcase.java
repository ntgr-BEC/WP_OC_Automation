package webportal.SwitchManaged.System.Exclude.PRJCBUGEN_T4639;
...
//         }
//         assertTrue(micResult);
        System.out.print(devicesSwitchConnectedNeighboursPortConfiqSummaryPage.getByteSent());
        System.out.print(devicesSwitchConnectedNeighboursPortConfiqSummaryPage.getByteRecv());
...
//         assertTrue(devicesSwitchConnectedNeighboursPortConfiqSummaryPage.PortDescription.getText().length() > 0, "checklength of port desc");
    }
