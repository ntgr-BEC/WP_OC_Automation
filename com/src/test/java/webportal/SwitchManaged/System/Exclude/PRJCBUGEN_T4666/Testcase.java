package webportal.SwitchManaged.System.Exclude.PRJCBUGEN_T4666;
...
public class Testcase extends TestCaseBase implements Config {
    ...
    @Story("PRJCBUGEN_T4666") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("043-Cache Factory default deployment") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T4666") // It's a testcase id/link from Jira Test Case.
    @Test(enabled = false, alwaysRun = true, groups = "p4") // p3
    ...
    @Step("Test Step 2: create VLAN 666")
    public void step2() {
        handle.getCmdOutputLines("vlan database; vlan 666", false);
        String tmpStr = handle.getCmdOutput("show vlan", false);
        assertTrue(tmpStr.contains("666"));
    }
    ...
    public void step9() {
        ...
        String tmpStr = handle.getCmdOutput("show vlan", false);
        assertFalse(tmpStr.contains("666"));
    }
