package webportal.SwitchManaged.VlanOverhauling.PRJCBUGEN_T11330;
...
public class Testcase extends TestCaseBase {
    ...
    public void step5() {
        ...
        assertTrue(SwitchCLIUtilsMNG.isTagPort("g1", vlanId), "port g1 is Tagged");
    ...
    public void step7() {
        ...
        assertFalse(SwitchCLIUtilsMNG.isTagPort("g1", vlanId), "port g1 is not Tagged");
    }
}
