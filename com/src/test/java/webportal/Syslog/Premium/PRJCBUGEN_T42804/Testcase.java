package webportal.Syslog.Premium.PRJCBUGEN_T42804;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42804") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that IP address field is accepting only IP address") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42804") // It's a testcase id/link from Jira Test Case.
