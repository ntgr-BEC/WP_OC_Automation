package webportal.Syslog.Premium.PRJCBUGEN_T42805;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42805") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that Port number field is accepting only integer values") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42805") // It's a testcase id/link from Jira Test Case.
