package webportal.Syslog.Premium.PRJCBUGEN_T42806;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42806") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Syslog level feature  remain at selected level even after reboot") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42806") // It's a testcase id/link from Jira Test Case.
