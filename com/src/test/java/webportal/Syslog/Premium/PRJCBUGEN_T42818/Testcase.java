package webportal.Syslog.Premium.PRJCBUGEN_T42818;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42818") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify Enterprise scenario with Syslog enabled") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42818") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new DeviceGroupPage().gotoLocationDashboard();
    ...
    public void step3() {
        ...
        new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo nmcli device wifi list | grep -F \"apwp22345\"");
        MyCommonAPIs.sleepi(20);
        new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli c add type wifi con-name \"apwp22345\" ifname wlp4s0 ssid \"apwp22345\"");      
        MyCommonAPIs.sleepi(20);
        new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection modify \"apwp22345\" wifi-sec.key-mgmt wpa-eap 802-1x.eap peap 802-1x.phase2-auth mschapv2 802-1x.identity \"teju\" 802-1x.password \"teju\"");
        MyCommonAPIs.sleepi(20);
        new Javasocket().sendCommandToWinClient(WebportalParam.clientip, WebportalParam.clientport, "sudo -S nmcli connection up \"apwp22345\"");
    }
    ...
    public void step5(){
        ...
        if(result.contains("logSettings:syslogStatus 1") && result.contains("logSettings:syslogSrvIp "+Global) && result.contains("logSettings:syslogSrvPort 514")) {
            status = true;
        }
