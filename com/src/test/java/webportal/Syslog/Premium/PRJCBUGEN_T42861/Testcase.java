package webportal.Syslog.Premium.PRJCBUGEN_T42861;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42861") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the popup message when giving invalid IP address to the UI") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42861") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to Syslog and enable with wrong ip")
    public void step2() {
        new DeviceGroupPage().GoToSysLog(WebportalParam.location1);
        assertTrue(new DeviceGroupPage().verifyWrongIpAddresserrorMesage("11111111", "514"),"Not Getting error for Wrong IP Address");
    }
