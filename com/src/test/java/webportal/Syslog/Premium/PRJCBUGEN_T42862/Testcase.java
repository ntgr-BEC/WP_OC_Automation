package webportal.Syslog.Premium.PRJCBUGEN_T42862;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T42862") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the popup message when giving  invalid PORT address to the UI") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T42862") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 2: Go to Syslog and enable with wrong port")
    public void step2() {
        new DeviceGroupPage().GoToSysLog(WebportalParam.location1);
        assertTrue(new DeviceGroupPage().verifyWrongPorterrorMesage("1.1.1.1", "514abcedf"),"Not Getting error for Wrong IP Address");
    }
    
    
    @Step("Test Step 3: Go to Syslog and enable; verify success message")
    public void step3() {
