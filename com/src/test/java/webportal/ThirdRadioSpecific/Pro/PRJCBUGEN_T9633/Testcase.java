package webportal.ThirdRadioSpecific.Pro.PRJCBUGEN_T9633;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T9633") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify user is able to set5ghzhigh configuration for WAC 540 in radio and channel page in WEB for pro") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T9633") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp9633");
    }
    ...
    public void step2() {
        ...
        ssidInfo.put("SSID", "apwp9633");
        ssidInfo.put("Security", "WPA2 Personal Mixed");
        ssidInfo.put("Password", "123456798");
        new WirelessQuickViewPage().addSsid(ssidInfo);

        new DevicesDashPage().enterDevice(WebportalParam.ap1serialNo);
        channelInfo.put("5GHz high channel", "128/5.64GHz(DFS)");
        channelInfo.put("5GHz high channel width", "20MHz");
        channelInfo.put("5GHz high output power", "Half");
        new DevicesApRadioAndChannelsPage().configRadioAndChannel(channelInfo);
        ...
        assertTrue(sshChannelInfo.get("5GHz high channel").contains("channel 128")
                && sshChannelInfo.get("5GHz high output power").contains("txPower 1")
