package webportal.ThirdRadioSpecific.Pro.PRJCBUGEN_T9638;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T9638") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("verify user is able to set 2.4 &5 ghz configuration for WAC 510 in radio and channel page in WEB for pro") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T9638") // It's a testcase id/link from Jira Test Case.
    ...
    public void tearDown() {
        ...
        new WirelessQuickViewPage().deleteSsidYes("apwp9638");
    }
    ...
    public void step2() {
        ...
        assertTrue(sshChannelInfo.get("2.4GHz channel").contains("channel 6") && sshChannelInfo.get("2.4GHz output power").contains("txPower 1")
                && sshChannelInfo.get("2.4GHz channel width").contains("channelWidth 1")
                && sshChannelInfo.get("5GHz channel").contains("channel 157") && sshChannelInfo.get("5GHz output power").contains("txPower 2")
