package webportal.Topology.PROuser.PRJCBUGEN_T22726;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22753") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Reboot  functional  on more details tool tip") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22753") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        new WirelessQuickViewPage(false).RebootTopology(); 
