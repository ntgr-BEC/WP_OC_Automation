package webportal.Topology.PROuser.PRJCBUGEN_T22728;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22728") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Abstract View  with ,1   Switch and  Access point   and all device are online") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22728") // It's a testcase id/link from Jira Test Case.
