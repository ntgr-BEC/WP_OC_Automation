package webportal.Topology.PROuser.PRJCBUGEN_T22730;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22730") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Tree view with 1 Access point and few wireless clients and all device are online") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22730") // It's a testcase id/link from Jira Test Case.
    ...
    public void step2() {
        ...
        new WirelessQuickViewPage(false).treeView();
