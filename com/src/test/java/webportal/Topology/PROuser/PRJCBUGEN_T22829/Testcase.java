package webportal.Topology.PROuser.PRJCBUGEN_T22829;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T22829") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Abstract View  with 1  Router ,1 Switch and 1 Access point   and all device are online") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T22829") // It's a testcase id/link from Jira Test Case.
