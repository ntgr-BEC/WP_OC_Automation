package webportal.TwoFA.PRJCBUGEN_T6143;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6143") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify what happens when user enters wrong OTP in SMS Text Message verification method") // It's a testcase title from Jira Test
                                                                                                           // Case.
    @TmsLink("PRJCBUGEN-T6143") // It's a testcase id/link from Jira Test Case.
