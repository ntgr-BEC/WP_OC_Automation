package webportal.TwoFA.PRJCBUGEN_T6147;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T6147") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether already used OTP can be used to authenticate another device for the same account") // It's a testcase title from
                                                                                                                    // Jira Test Case.
    @TmsLink("PRJCBUGEN-T6147") // It's a testcase id/link from Jira Test Case.
