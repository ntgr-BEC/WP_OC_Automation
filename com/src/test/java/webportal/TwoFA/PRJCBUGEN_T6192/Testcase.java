package webportal.TwoFA.PRJCBUGEN_T6192;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify what happens to the already logged in users when an primary user enables Two-Factor verification") // It's a testcase title
                                                                                                                            // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T6192") // It's a testcase id/link from Jira Test Case.
