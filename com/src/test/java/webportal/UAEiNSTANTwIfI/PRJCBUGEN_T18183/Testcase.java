package webportal.UAEiNSTANTwIfI.PRJCBUGEN_T18183;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify instant wifi functionally as non pro user for country UAE") // It's a testcase title from Jira Test Case.
...
//        new HamburgerMenuPage(false).createAccount(accountInfo);
    ...
    public void step2() {
        ...
        locationInfo.put("Zip Code", "00000");
