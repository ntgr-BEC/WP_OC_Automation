package webportal.UAEiNSTANTwIfI.PRJCBUGEN_T18184;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify instant wifi functionally as non pro user for country Korea Republic") // It's a testcase title from Jira Test Case.
...
//        accountInfo.put("Country", "Korea Republic");
//
//        new HamburgerMenuPage(false).createAccount(accountInfo);
    ...
    public void step2() {
        ...
        locationInfo.put("Zip Code", "0 1000");
