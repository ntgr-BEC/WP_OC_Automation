package webportal.URL_Filter.PRJCBUGEN_T14480;
...
public class Testcase extends TestCaseBase {
    ...
    @Step("Test Step 4: connect client to this ssid;")
    public void step4() {
    ...
    @Step("Test Step 5: Check whether user is able to open url or not;")
    public void step5() {
        new DevicesDashPage().waitDevicesReConnected(WebportalParam.ap1serialNo);
        if (new WirelessQuickViewPage().checkClientConnect(WebportalParam.clientwlanmac)) {
            String ipaddress = new WirelessQuickViewPage().getClientIP(WebportalParam.clientwlanmac);
