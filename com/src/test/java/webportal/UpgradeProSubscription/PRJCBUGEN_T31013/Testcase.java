package webportal.UpgradeProSubscription.PRJCBUGEN_T31013;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31013") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify the upgrade functionality of Insight Premium to Insight Pro") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T31013") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        businessInfo.put("Primary Address of Business", "Rue Jean Engling");
