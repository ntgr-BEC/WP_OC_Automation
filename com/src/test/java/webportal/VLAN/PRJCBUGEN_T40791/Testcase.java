package webportal.VLAN.PRJCBUGEN_T40791;
...
public class Testcase extends TestCaseBase {
    ...
    String vlan ="VLANPort10";
    String id ="10";
    Map<String, String> locationInfo = new HashMap<String, String>();

    @Feature("VLAN") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T40791") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify whether in location level --> VLAN/ Network Setup --> create VLAN flow if user tries to move next page without assigning an Port mode to the selected ports we will get Warning message") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40791") // It's a testcase id/link from Jira Test Case.
