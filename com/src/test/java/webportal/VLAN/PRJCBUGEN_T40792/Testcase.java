package webportal.VLAN.PRJCBUGEN_T40792;
...
public class Testcase extends TestCaseBase {
    ...
    String vlan ="VLANPort";
    String id ="6";
    Map<String, String> locationInfo = new HashMap<String, String>();

    @Feature("VLAN") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T40792") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Check in Wired setting page  --> VLAN/ Network Setup existing VLAN on edit if user tries to move next page without assigning an Port mode to the selected ports we will get Warning message") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T40792") // It's a testcase id/link from Jira Test Case.
