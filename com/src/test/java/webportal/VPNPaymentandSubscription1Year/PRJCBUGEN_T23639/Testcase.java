package webportal.VPNPaymentandSubscription1Year.PRJCBUGEN_T23639;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23639") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy VPN license subscription 1 year- Switzerland") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23639") // It's a testcase id/link from Jira Test Case.
