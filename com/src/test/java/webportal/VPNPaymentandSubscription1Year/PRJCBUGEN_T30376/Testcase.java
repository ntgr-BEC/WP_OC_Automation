package webportal.VPNPaymentandSubscription1Year.PRJCBUGEN_T30376;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy VPN license subscription 1 year - Bulgaria ") // It's a testcase title from Jira Test Case.
