package webportal.VPNPaymentandSubscription1Year.PRJCBUGEN_T30379;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy VPN license subscription 1 year - Croatia ") // It's a testcase title from Jira Test Case.
