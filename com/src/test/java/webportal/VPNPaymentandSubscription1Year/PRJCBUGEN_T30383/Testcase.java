package webportal.VPNPaymentandSubscription1Year.PRJCBUGEN_T30383;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Verify that user can buy VPN license subscription 1 year - Slovakia ") // It's a testcase title from Jira Test Case.
