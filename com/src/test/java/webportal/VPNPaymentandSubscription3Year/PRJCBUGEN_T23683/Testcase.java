package webportal.VPNPaymentandSubscription3Year.PRJCBUGEN_T23683;
...
//    Map<String, String> paymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Feature("VPN Payment and Subscription 3 Year") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T23683") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy VPN license subscription 3 year Romania ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23683") // It's a testcase id/link from Jira Test Case.
...
//      new HamburgerMenuPage(false).clickAddInsightIncludedDevices();
    ...
    @Step("Test Step 3: VPN Cancelation;")
    public void step3() {
