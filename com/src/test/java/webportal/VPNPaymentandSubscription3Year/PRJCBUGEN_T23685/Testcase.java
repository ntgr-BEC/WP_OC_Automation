package webportal.VPNPaymentandSubscription3Year.PRJCBUGEN_T23685;
...
//    Map<String, String> paymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Story("PRJCBUGEN_T23685") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy VPN license subscription 3 year South Africa ") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23685") // It's a testcase id/link from Jira Test Case.
