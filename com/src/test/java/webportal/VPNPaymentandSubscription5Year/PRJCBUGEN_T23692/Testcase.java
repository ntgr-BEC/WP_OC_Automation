package webportal.VPNPaymentandSubscription5Year.PRJCBUGEN_T23692;
...
//    Map<String, String> paymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Description("Verify that user can buy VPN license subscription 5 year  - Australia") // It's a testcase title from Jira Test Case.
