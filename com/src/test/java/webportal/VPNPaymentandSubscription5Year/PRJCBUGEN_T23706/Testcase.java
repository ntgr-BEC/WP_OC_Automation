package webportal.VPNPaymentandSubscription5Year.PRJCBUGEN_T23706;
...
//    Map<String, String> paymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Description("Verify that user can buy VPN license subscription 5 year  - Netherlands") // It's a testcase title from Jira Test Case.
