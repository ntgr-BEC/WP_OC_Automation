package webportal.VPNPaymentandSubscription5Year.PRJCBUGEN_T23707;
...
//    Map<String, String> paymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Story("PRJCBUGEN_T23707") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy VPN license subscription 5 year  - Norway") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23707") // It's a testcase id/link from Jira Test Case.
