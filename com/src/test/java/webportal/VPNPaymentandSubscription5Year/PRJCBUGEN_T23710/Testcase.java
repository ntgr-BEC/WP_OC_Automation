package webportal.VPNPaymentandSubscription5Year.PRJCBUGEN_T23710;
...
//    Map<String, String> paymentInfo = new CommonDataType().PAYMENT_INFO;
    ...
    @Feature("VPN Payment and Subscription 5 Year") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T23710") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy VPN license subscription 5 year  - Romania") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23710") // It's a testcase id/link from Jira Test Case.
