package webportal.VPNPaymentandSubscription5Year.PRJCBUGEN_T23718;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T23718") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Verify that user can buy VPN license subscription 5 year  - US") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T23718") // It's a testcase id/link from Jira Test Case.
