package webportal.WAX615APS.PRJCBUGEN_T29396;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T29396") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Instant Wifi for channel Width dynamic 20,40,80,160 Mhz") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T29396") // It's a testcase id/link from Jira Test Case.
    ...
    new WirelessQuickViewPage(false).ChannelWidth2ghz(width);
    MyCommonAPIs.sleepi(3);
