package webportal.WAX625_Canada_APS_SKU.PRJCBUGEN_T31411;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("WAX625_Canada_APS") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T31411") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Adding  WAX625 APS SKU   AP in  hongkong  location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31411") // It's a testcase id/link from Jira Test Case.
