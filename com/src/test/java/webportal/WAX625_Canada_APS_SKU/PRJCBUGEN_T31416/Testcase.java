package webportal.WAX625_Canada_APS_SKU.PRJCBUGEN_T31416;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T31416") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Adding  WAX625 APSKU   AP in  newzealand  location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31416") // It's a testcase id/link from Jira Test Case.
