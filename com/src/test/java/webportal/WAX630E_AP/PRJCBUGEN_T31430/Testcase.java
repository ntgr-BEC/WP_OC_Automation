package webportal.WAX630E_AP.PRJCBUGEN_T31430;
...
public class Testcase extends TestCaseBase {
    ...
    @Feature("WAX630E_AP") // It's a folder/component name to make test suite more readable from Jira Test Case.
    @Story("PRJCBUGEN_T31430") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Adding  WAX630E APS SKU   AP in  hongkong  location") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T31430") // It's a testcase id/link from Jira Test Case.
