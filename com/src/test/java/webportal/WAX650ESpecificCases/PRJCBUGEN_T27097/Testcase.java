package webportal.WAX650ESpecificCases.PRJCBUGEN_T27097;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T27097") 
    @Description("Verify when changing Bands from Dual band to All band, Security gets auto configured tp WPA3 Personal Mixed.") 
    @TmsLink("PRJCBUGEN_T27097") 
    ...
    public void step2(){
        ...
        assertTrue(new WirelessQuickViewPage(false).changeWifiBand1(ssidInfo));                         
    }
