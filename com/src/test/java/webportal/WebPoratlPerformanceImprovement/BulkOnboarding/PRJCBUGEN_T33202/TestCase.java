package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33202;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33202";
    ...
    @Story("PRJCBUGEN_T33202") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user slould be able to navigate on location device screen.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33202") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33202\\Bulkonbord.csv";
