package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33207;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33207";
    ...
    @Story("PRJCBUGEN_T33207") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should be able to add 500 + devices and page loading performance is very slow in screen.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33207") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33207\\Bulkonbord.csv";
        ...
        OrganizationPage.openOrg(organizationName);
        new AccountPage(false).enterLocation(locationName);
        assertTrue(new DevicesDashPage().divDeviceListCSV.isDisplayed(), "export icon is not visible");
