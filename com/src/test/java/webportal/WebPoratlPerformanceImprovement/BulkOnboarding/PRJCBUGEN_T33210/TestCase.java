package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33210;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33210";
    ...
    @Story("PRJCBUGEN_T33210") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that pagination count should increase when user add more devcies in device list.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T3320") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33210\\Bulkonbord.csv";
        ...
        assertTrue(new DeviceBulkOnboardingPage().devicelist1.isDisplayed(),"1st device list found ");
        ...
        filePath1 = filePath1 + "PRJCBUGEN_T33210\\Bulkonbord1.csv";
        ...
        assertTrue(new DeviceBulkOnboardingPage().devicelist2.isDisplayed(),"2st device list found ");
    }
