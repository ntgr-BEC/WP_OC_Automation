package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33212;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33212";
    ...
    @Story("PRJCBUGEN_T33212") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user needs to click on next load 250 button to see more devices in next pages.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33212") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33212\\Bulkonbord.csv";
    ...
    public void step4() {
        ...
        assertTrue(new DevicesDashPage(false).DeviceNext(), "not able to see correct count of devices in device screen");
