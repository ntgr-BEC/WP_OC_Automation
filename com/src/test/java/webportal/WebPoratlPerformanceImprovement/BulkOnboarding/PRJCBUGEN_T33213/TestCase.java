package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33213;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33213";
    ...
    @Story("PRJCBUGEN_T33213") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the performance of Switchs, Aps and ORBIs in device screen within 100 devices.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33213") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33213\\Bulkonbord.csv";
