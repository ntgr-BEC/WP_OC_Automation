package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33215;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33215";
    ...
    @Story("PRJCBUGEN_T33215") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the performance when more 500 + devices in devices list.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33215") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33215\\Bulkonbord.csv";
