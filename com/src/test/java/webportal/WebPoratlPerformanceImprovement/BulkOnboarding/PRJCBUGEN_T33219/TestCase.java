package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33219;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33219";
    ...
    @Story("PRJCBUGEN_T33219") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the performance of Wired screen for 500 + devices in device list.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33219") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33219\\Bulkonbord.csv";
