package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33220;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33220";
    ...
    @Story("PRJCBUGEN_T33220") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the performance of Mobile screen for 500 + devices in device list.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33220") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33220\\Bulkonbord.csv";
    ...
    public void step4() {
        ...
        assertTrue(new  DeviceScreenNavigationPage().verifyMobile(),"Mobile screen is not complete");
        MyCommonAPIs.sleepi(15);
    }
    
    @Step("Test Step 5: able to see correct count of devices in device screen ")
    public void step5() {
