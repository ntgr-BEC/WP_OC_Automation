package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33223;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33223";
    ...
    @Story("PRJCBUGEN_T33223") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that On dashboard, Click on settings option and navigate to devices list -> Loader should not show for 500 + devices in list.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33223") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33223\\Bulkonbord.csv";
    ...
    public void step4() {
        ...
        new OrganizationPage(false).open(URLParam.hrefOrg, true);
        
        assertTrue( new DevicesDashPage().previousOrg.isDisplayed()  ,"appeared soon");
