package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33224;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33224";
    ...
    @Story("PRJCBUGEN_T33224") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify the performance of summary screen, Properties status and System health status should be displayed.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33224") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33224\\Bulkonbord.csv";
