package webportal.WebPoratlPerformanceImprovement.BulkOnboarding.PRJCBUGEN_T33226;
...
public class TestCase extends TestCaseBase {
    ...
    String organizationName = "PRJCBUGEN_T33226";
    ...
    @Story("PRJCBUGEN_T33226") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that on device screen,user can see devices with change value from filter in every page.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33226") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        filePath = filePath + "PRJCBUGEN_T33226\\Bulkonbord.csv";
    ...
    public void step4() {
        ...
        assertTrue(new DevicesDashPage(false).DeviceSearch(" 4XU44441000FB"), "not able to see correct count of devices in device screen");
