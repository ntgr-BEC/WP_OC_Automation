package webportal.WebPoratlPerformanceImprovement.PRJCBUGEN_T33203;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33203") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @Step("Test Step 2: user should able be to see export icon on right corrner above devices list")
    public void step2() {
