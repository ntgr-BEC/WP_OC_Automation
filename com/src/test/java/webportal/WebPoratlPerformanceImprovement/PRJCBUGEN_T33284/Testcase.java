package webportal.WebPoratlPerformanceImprovement.PRJCBUGEN_T33284;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33284") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that device list should be displayed with status.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33284") // It's a testcase id/link from Jira Test Case.
