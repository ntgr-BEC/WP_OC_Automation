package webportal.WebPoratlPerformanceImprovement.PRJCBUGEN_T33368;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33368") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that secondary admin has read only access.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33368") // It's a testcase id/link from Jira Test Case.
