package webportal.WebPoratlPerformanceImprovement.PRJCBUGEN_T33460;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33460") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that all location, device of premium should be displayed on pro account after migration.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN_T33460") // It's a testcase id/link from Jira Test Case.
