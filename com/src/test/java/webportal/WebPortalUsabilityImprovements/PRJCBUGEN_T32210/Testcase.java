package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32210;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32210") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should able to see error message If location Radius is not enabled and configured.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32210") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
     ...
     public void step3() {
         ...
         ssidInfo.put("SSID", "PRJCBUGEN_T32210");
