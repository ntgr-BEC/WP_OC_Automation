package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32212;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32212") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that web portal need to provide a linkage in the above error message so that user can directly go to the Redius screen and can enable and configure the radius.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32212") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
     ...
     public void step3() {
         ...
         ssidInfo.put("SSID", "PRJCBUGEN_T32212");
