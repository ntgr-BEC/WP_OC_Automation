package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32214;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32214") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should able to see Radius screen at two places – Location setting, wired setting.") // It's a
                                                                                                                               ...
                                                                                                                               // from Jira Test
                                                                                                                               // Case.
    @TmsLink("PRJCBUGEN-T32214") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
     ...
     public void step3() {
         ...
         ssidInfo.put("SSID", "PRJCBUGEN_T32214");
