package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32215;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32215") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should able to redirect on location setting – Radius with the linkage in the error message.") // It's a
                                                                                                                               // testcase title
                                                                                                                               // from Jira Test
                                                                                                                               // Case.
    @TmsLink("PRJCBUGEN-T32215") // It's a testcase id/link from Jira Test Case.
