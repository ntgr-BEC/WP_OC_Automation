package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32216;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32216") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that user should able to see location password on device screen.") // It's
    @TmsLink("PRJCBUGEN-T32216") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 5:Verify User should able to see location password on device screen.")
    public void step5() {
        assertTrue(new DevicesDashPage(false).VerifyUserCanSeeThePwd(), "User not able to see the pwd");
    }
