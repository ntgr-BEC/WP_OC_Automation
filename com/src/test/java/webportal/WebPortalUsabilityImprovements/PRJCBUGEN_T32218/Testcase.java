package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32218;
...
//        page.deleteOrganizationNew(organizationName1);
    ...
    public void step1() {
     ...
     @Step("Test Step 5: Going inside the device by dobleClick")
     public void step5() {
         new DevicesDashPage().DobleClickOnDeviceStatus();
     }
     
     @Step("Test Step 6:Verify User should able to see the changed password")
     public void step6() {
         Selenide.refresh();
         assertTrue(new DevicesDashPage(false).VerifyUserAbleToPwdReadOnly(NewPwd), "User not able to Read the pwd");
     }
