package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32219;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify that passwords are masked by default.") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T32219") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 5:Verify User should able to verify password are masked by default.")
    public void step5() {
        Selenide.refresh();
