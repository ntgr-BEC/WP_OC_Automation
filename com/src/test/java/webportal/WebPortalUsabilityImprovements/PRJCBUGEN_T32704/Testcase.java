package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32704;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify that support user should not able to see admin password on device dashboard screen.") // It's a
                                                                                                                               // testcase title
                                                                                                                               // from Jira Test
                                                                                                                               // Case.
    @TmsLink("PRJCBUGEN-T32704") // It's a testcase id/link from Jira Test Case.
    ...
    public void step5() {
        assertTrue(new DevicesDashPage(false).VerifySupportUserNotAbleToSeeThePwd(WebportalParam.loginDevicePassword), "Support User are able to see the pwd");
    }
}
