package webportal.WebPortalUsabilityImprovements.PRJCBUGEN_T32707;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32707") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify that support user should able to see location counting on location screen.") // It's a
                                                                                                                               // testcase title
                                                                                                                               // from Jira Test
                                                                                                                               // Case.
    @TmsLink("PRJCBUGEN-T32707") // It's a testcase id/link from Jira Test Case.
    ...
    public void step1() {
     ...
     @Step("Test Step 2: Create an organization with 2 locations")
     public void step2() {
     ...
     @Step("Test Step 3: Verify Support user should able to see location counting on location screen.")
     public void step3() {
         assertTrue(new AccountPage(false).verifySportUsrAbletoSeeLoCountOnLocScreen(), "Location Count Is Wrong");
