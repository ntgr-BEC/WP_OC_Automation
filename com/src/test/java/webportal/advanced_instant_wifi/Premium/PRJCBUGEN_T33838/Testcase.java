package webportal.advanced_instant_wifi.Premium.PRJCBUGEN_T33838;
...
public class Testcase extends TestCaseBase {
    ...
    @Description("Test to verify instant wifi through ssh is working") // It's a testcase title from Jira Test Case.
