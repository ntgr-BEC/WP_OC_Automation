package webportal.advanced_instant_wifi.Premium.PRJCBUGEN_T33859;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33859") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify instant wifi Deselect All option is working") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33859") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        Map<String, String> locationInfo = new HashMap<String, String>();
        locationInfo.put("SSID", "ap@33859");
    ...
    @Step("Test Step 5:click on all De-Select link and click optimize Now Button and Verify sucesse message")
    public void step5() {
    ...
    @Step("Test Step 7:  Click on optimize Now Button and Verify error message popup should contain 'Select at least 3 channels from each of the bands' ")
    public void step7() {
        assertTrue(new WirelessQuickViewPage(false).verifyError_Select_at_least3channels_from_each_of_the_bands());
