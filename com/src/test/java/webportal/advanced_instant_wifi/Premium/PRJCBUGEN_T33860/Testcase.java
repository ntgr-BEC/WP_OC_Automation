package webportal.advanced_instant_wifi.Premium.PRJCBUGEN_T33860;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33860") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify instant wifi 5GHz Band should show error while selecting only 3 channels from low band.") // It's a testcase title
                                                                                                                           // from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33860") // It's a testcase id/link from Jira Test Case.
    ...
    public void step3() {
        ...
        Map<String, String> locationInfo = new HashMap<String, String>();
        locationInfo.put("SSID", "ap@33860");
    ...
    public void step7() {
        assertTrue(new WirelessQuickViewPage(false).verifyError_Select_at_least_3_channels_from_the_5_GHz_high_band());
