package webportal.advanced_instant_wifi.Premium.PRJCBUGEN_T33862;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T33862") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify instant wifi 5GHz Band should show error while selecting only 3 channels from high band.") // It's a
                                                                                                                            // testcase
                                                                                                                            // title from
                                                                                                                            // Jira Test
                                                                                                                            // Case.
    @TmsLink("PRJCBUGEN-T33862") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 7:  Click on optimize Now Button and Verify the Error message' ")
    public void step7() {
        assertTrue(new WirelessQuickViewPage(false).verifyError_msg_Select_at_least_3_channels_from_the_5_GHz_low_bands());
