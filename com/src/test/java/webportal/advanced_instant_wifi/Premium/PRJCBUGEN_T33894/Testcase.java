package webportal.advanced_instant_wifi.Premium.PRJCBUGEN_T33894;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32894") // It's a testcase id/link from Jira Test Case but replace - with _.
    ...
    @TmsLink("PRJCBUGEN-T33894") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 5:  Verify Device Configuration Text Link Open Device Summary Page ")
    public void step5() {
        assertTrue(new WirelessQuickViewPage(false).verifyDeviceConfigurationLinkOpenDeviceSummaryPage());
