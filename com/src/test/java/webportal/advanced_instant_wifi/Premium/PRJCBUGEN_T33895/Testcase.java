package webportal.advanced_instant_wifi.Premium.PRJCBUGEN_T33895;
...
public class Testcase extends TestCaseBase {
    ...
    @Story("PRJCBUGEN_T32895") // It's a testcase id/link from Jira Test Case but replace - with _.
    @Description("Test to verify device configuration link button should land on summary page") // It's a testcase title from Jira Test Case.
    @TmsLink("PRJCBUGEN-T33895") // It's a testcase id/link from Jira Test Case.
    ...
    @Step("Test Step 5:  Clicking on Plus icon and print all Radio Settings data on console ")
    public void step5() {
        new WirelessQuickViewPage(false).clickOnPlusIconForOpen_RadioSetting();
        new WirelessQuickViewPage(false).printAll_2_4GHZ_RadioSettingDetails();
        new WirelessQuickViewPage(false).printAll_5GHZ_LowRadioSettingDetails();
        new WirelessQuickViewPage(false).printAll_5GHZ_HighRadioSettingDetails();
